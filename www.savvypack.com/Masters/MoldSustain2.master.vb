...
Partial Class Masters_MoldSustain2
    ...
    '    Dim ArrPageList() As String = GetPageList()
    '    Dim Flag As Boolean = False
    '    Dim i As New Integer
    '    Try
    '        For i = 0 To ArrPageList.Length - 1
    '            If Not Flag Then
    '                Flag = Request.Url.OriginalString.Contains(ArrPageList(i))
    '            End If
    '        Next

    '        If Session("S2UserRole") <> "AADMIN" Then
    '            If Session("S2CaseId") < 1000 Then
    '                imgUpdate.Enabled = False
    '                imgUpdate.ImageUrl = "~/Images/UpdateDec.gif"
    '            End If
    '        End If
    '        If Session("S2ServiceRole") = "ReadOnly" Then
    '            If Not Flag Then
    '                imgUpdate.Enabled = False
    '                imgUpdate.ImageUrl = "~/Images/UpdateDec.gif"
    '            End If
        ...
        Try
            ...
            Else
                If Session("MoldS2UserRole") <> "AADMIN" Then
                    If Session("MoldS2CaseId") < 1000 Then
                        'imgUpdate.Visible = False
                        imgUpdate.Enabled = False
                        imgUpdate.ImageUrl = "~/Images/UpdateDec.gif"
                    End If

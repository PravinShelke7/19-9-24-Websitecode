...
Imports ToolCCS
Imports LogFiles
Partial Class Masters_SavvyPackMenu
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                'lnkSavvy.Attributes.Add("onclick", "return OpenNewWindow('OnlineForm/ProjectManager.aspx');")
    ...
    Protected Sub lnkStud_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkStud.Click
        Try
            Response.Redirect("~/Studies/multiclientstudy.aspx")
        Catch ex As Exception
            lblError.Text = "Error:lnkStud_Click " + ex.Message.ToString()
        End Try
    End Sub

    Protected Sub lnkProf_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkProf.Click
        Try
            Response.Redirect("~/Profile.aspx")
        Catch ex As Exception
            lblError.Text = "Error:lnkProf_Click " + ex.Message.ToString()
        End Try
    End Sub

    Protected Sub lnkOData1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkOData1.Click
        Try
            Response.Redirect("~/SavvyPack/PkgMrktDataBase.aspx", False)
        Catch ex As Exception
            lblError.Text = "Error:lnkOData1_Click " + ex.Message.ToString()
        End Try
    End Sub

    Protected Sub lnkCPK_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCPK.Click
        Try
            Response.Redirect("~/InteractiveServices/InteractiveKb.aspx", False)
        Catch ex As Exception
            lblError.Text = "Error:lnkCPK_Click " + ex.Message.ToString()
        End Try
    End Sub
    ...
    Protected Sub lnkCons_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkCons.Click
        Try
            Response.Redirect("~/Consulting/Consulting.aspx")
        Catch ex As Exception
            lblError.Text = "Error:lnkCons_Click " + ex.Message.ToString()
        End Try
    End Sub
    ...
    Protected Sub lnkWebc_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkWebc.Click
        Try
            Response.Redirect("~/WebConferenceN/WebConf.aspx")
        Catch ex As Exception
            lblError.Text = "Error:lnkWebc_Click " + ex.Message.ToString()
        End Try
    End Sub
    ...
    Protected Sub lnkSavvy_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkSavvy.Click
        Try
            ...
            Else
                ...
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "UManager", "OpenWindowMaster3('http://www.savvypack.com/OnlineForm/ProjectManager.aspx');", True)
            End If
        Catch ex As Exception
            lblError.Text = "Error:lnkCntUs_Click " + ex.Message.ToString()
        End Try
	...
	Protected Sub imgShpcart_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgShpcart.Click
        Try
            If Session("UserId") = Nothing Then
                ScriptManager.RegisterStartupScript(Me, Me.GetType(), "Login_SavvyPack", "OpenLoginPopup('SC');", True)
            Else
                Response.Redirect("~/ShoppingCart/OrderReview.aspx", False)
            End If
        Catch ex As Exception
    ...
    Protected Sub btnShopCart_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShopCart.Click
        Try
            Response.Redirect("~/ShoppingCart/OrderReview.aspx", False)
        Catch ex As Exception

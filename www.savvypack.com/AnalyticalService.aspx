<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AnalyticalService.aspx.vb"
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .AnalyticalService_old
        {
            background-image: url("Images/Proto-Labs-Manufacturing-Injection-MoldingHighRES.jpg");
...
<body>
    ...
    <div class=" container-fluid AnalyticalService ">
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <td colspan="2">
                            <span style="font-weight: bold; color: #825f05; font-family: Verdana; font-size: 14px;">
                                Questions?</span><br/> <span style="font-weight: normal; color: Black; font-family: Verdana;
                                    font-size: 13px;">Call us at [1] 952-405-7500 or</span>
                            <br />

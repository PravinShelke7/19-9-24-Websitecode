...
Partial Class savvypack
    ...
    Public Shared Function GetSlides() As AjaxControlToolkit.Slide()
        Return New AjaxControlToolkit.Slide() {New AjaxControlToolkit.Slide("SlideShow/images/Sunset.jpg", "Sunset", "Setting sun"), New AjaxControlToolkit.Slide("SlideShow/images/Winter.jpg", "Winter", "Wintery..."), New AjaxControlToolkit.Slide("SlideShow/images/Water lilies.jpg", "Water lillies", "Lillies in the water"), New AjaxControlToolkit.Slide("SlideShow/images/VerticalPicture.jpg", "Sedona", "Portrait style picture")}
    End Function
	...
	Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            Try
                objUpdataData.InsertSPUserDetails(txtEmail.Text.Trim(), txtFName.Text.Trim(), txtLName.Text.Trim())
    ...
    Protected Function GetEmailBodyData(ByVal fName As String, ByVal lName As String, ByVal EMAILADDRESS As String) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<p>Dear " + fName + " " + lName + ",<br/><br/>   Thank you for contacting us regarding your interest in SavvyPack® Project. We have received your request and will respond within 24 hours. </p>"

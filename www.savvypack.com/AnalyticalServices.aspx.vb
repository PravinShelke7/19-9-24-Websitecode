...
Partial Class AnalyticalServices
    ...
    Protected Function GetEmailBodyData(ByVal fName As String, ByVal lName As String, ByVal EMAILADDRESS As String) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<td><img src='" + dsEmail.Tables(0).Rows(0).Item("URL").ToString() + "/Images/Packaging_Consulting2.gif' /> "
            ...
            StrSqlBody = StrSqlBody + "<p>Dear " + fName + " " + lName + ",<br/><br/>   Thank you for contacting us regarding your interest in SavvyPack® Analytical Services. We have received your request and will respond within 24 hours. </p>"
            ...
            StrSqlBody = StrSqlBody + "Allied Development Sales Team<br/><br/>Allied Development Corp.<br/>12750 Nicollet Ave. Suite 305<br/>Burnsville, MN USA 55044<br/><a style='font-family:verdana;' href='http://www.allied-dev.com'>www.allied-dev.com</a><br/>Phone: 1-952-898-2000</div> "
            StrSqlBody = StrSqlBody + "</p> "
    ...
    Public Sub SendEmail(ByVal strBody As String, ByVal EmailAdd As String, ByVal FirstName As String)
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                Item = New MailAddress("sales@allied-dev.com", "Sales")
                _CC.Add(Item)

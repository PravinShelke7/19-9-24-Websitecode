<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserAddressDetails.aspx.vb"
    Inherits="WebConferenceN_UserAddressDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Web Conference Shopping Cart Addresses</title>
    <link href="../App_Themes/SkinFile/AlliedNew.css" rel="stylesheet" type="text/css" />
    <script type="text/JavaScript">
        function AddressDet(AddDes, AddId, OrderAmt) {

            var count = 0;
            //alert(AddDes+"-"+ AddId+"-"+OrderAmt);
            ...
            var hidAddDes = document.getElementById('<%= hidAddDesc.ClientID%>').value;

            if (AddId.toString() != "0") {
                window.opener.document.getElementById(hidAdddes).innerText = AddDes;
                window.opener.document.getElementById(hidAddDes).value = AddDes;
                window.opener.document.getElementById(hidAddId).value = AddId;
            }
            else {
                window.opener.document.getElementById(hidAdddes).innerText = "No One Selected";
                window.opener.document.getElementById(hidAddDes).value = "No One Selected"; ;
                window.opener.document.getElementById(hidAddId).value = AddId;
            }
            //Setting order Amount
            var flag = "0";
            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "N";
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd1').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd1').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd2').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd2').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd3').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd3').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd4').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd4').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd5').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd5').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd6').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd6').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd7').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd7').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd8').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd8').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd9').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd9').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd10').value != "0") {
                count = count + 1;
                if (window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnlnkAtAdd10').value == window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnUserId').value) {
                    window.opener.document.getElementById('ctl00_ContentPlaceHolder1_hdnIsLogINuser').value = "Y";
                }
            }
            window.opener.document.getElementById('ctl00_ContentPlaceHolder1_lblAmt').innerText = OrderAmt * count;

            //window.opener.document.getElementById('ctl00_ContentPlaceHolder1_btnRef').click();
            window.close();
        }
...
//            }
            ...
            if (AddHeader == "") {
                errorMsg1 += "\Address Description cannot be blank.\n";
                errorMsg += alert(errorMsg1);
                return false;
            }
            else {
        ...
        //            var hidAddId = document.getElementById('<%= hidAddID.ClientID%>').value;
        //            var hidAddDes = document.getElementById('<%= hidAddDesc.ClientID%>').value;
        //          //  alert(document.getElementById('<%= hidAddDes.ClientID%>').value)             ;
        //            if (AddId.toString() != "0") {                
        //                window.opener.document.getElementById(hidAdddes).innerText = AddDes;              
        //                window.opener.document.getElementById(hidAddDes).value = AddDes;
        //                window.opener.document.getElementById(hidAddId).value = AddId;
        ...
        //            }
        //           
        ////window.document.getElementById('<%= hidType.ClientID%>').Value="pppppp";
        // //alert(document.getElementById('<%= hidType.ClientID%>').value);
        //           if  (document.getElementById('<%= hidType.ClientID%>').value=='Y')
        //          { 
        //          
        //          window.opener.document.getElementById('ctl00_ContentPlaceHolder1_btnRef').click();
        //          }
...
<body style="background-color: #dae5f5;">
    ...
    <div id="divGrid" runat="server">
                ...
                <td align="center">
                    <div id="divList" runat="server" style="width: 700px; overflow: scroll;">
                        <asp:GridView runat="server" ID="grdUserAddress" DataKeyNames="USERADDRESSID" Width="1500px"
                            ...
                            BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" PageSize="5" EnableModelValidation="True">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Select User" SortExpression="USERNAME" Visible="false">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Select User" SortExpression="USERNAME">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkUserName" runat="server" Text='<%# bind("USERNAME")%>' CssClass="Link"
                                            OnClick="lnkUser_Click"></asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" Width="180px" />
                                    <HeaderStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
                                ...
                                <asp:BoundField DataField="ADDHEADER" HeaderText="Address Description" SortExpression="ADDHEADER">
                                </asp:BoundField>
                ...
                <td>
                    <table width="80%" cellpadding="1px" cellspacing="1px">
                        ...
                        <tr class="AlterNateColor1" style="width: 100%">
                            ...
                            <td style="width: 65%; text-align: left; height: 20px;">
                                <asp:TextBox ID="txtEmail" Style="width: 370px; font-size: 11px;" runat="server"
                                    MaxLength="60" AutoPostBack="true" onchange="javascript:CheckSP(this);"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr class="AlterNateColor2" style="width: 100%">
                            ...
                            <td style="width: 65%; text-align: left; height: 20px;">
                                <asp:TextBox ID="txtCEmail" Style="width: 370px; font-size: 11px;" runat="server"
                                    MaxLength="60" onchange="javascript:CheckSP(this);"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="AlterNateColor1" style="width: 50%">
                            <td style="width: 30%; text-align: right">
                                <span style="color: Red; font-size: 14px;">*</span>
                                <asp:Label ID="lblAddHeader" runat="server" Style="color: #421995;" Text="Address Description:" ToolTip="Description in your own words"
                                    CssClass="NormalLabel"></asp:Label>
                            </td>
                            <td style="width: 65%; text-align: left">
                                <asp:TextBox ID="txtAHeader" MaxLength="25" Style="width: 160px; font-size: 11px;"
                                    AutoPostBack="true" runat="server" onchange="javascript:CheckSP(this);"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr class="AlterNateColor2" style="width: 50%">
                            ...
                            <td style="width: 65%; text-align: left">
                                <asp:TextBox ID="txtFax" Style="width: 300px; font-size: 11px;" MaxLength="25" runat="server"
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                        <asp:TextBox ID="txtState" Style="width: 160px; font-size: 11px;" MaxLength="25"
                                            runat="server" Visible="false" onchange="javascript:CheckSP(this);"></asp:TextBox>
                        ...
                        <tr class="AlterNateColor1" style="width: 50%">
                            ...
                            <td style="width: 65%; text-align: left">
                                <asp:TextBox ID="txtCity" Style="width: 160px; font-size: 11px;" MaxLength="25" runat="server"
                                    onchange="javascript:CheckSP(this);"></asp:TextBox>
                        ...
                        <tr class="AlterNateColor2" style="width: 50%">
                            ...
                            <td style="width: 65%; text-align: left">
                                <asp:TextBox ID="txtCompNameE" Style="width: 300px; font-size: 11px;" MaxLength="50"
                                    runat="server" Enabled="false" onchange="javascript:CheckSP(this);"></asp:TextBox>
                            </td>
                        </tr>
                        <tr class="AlterNateColor1" style="width: 50%">
                            <td style="width: 30%; text-align: right;">
        ...
        <asp:HiddenField ID="hidAddDesc" runat="server" />

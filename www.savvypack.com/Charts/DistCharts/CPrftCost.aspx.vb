...
Partial Class Charts_DistCharts_CPrftCost
        ...
        Try
            If PrftCost = "PRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "Dist-Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "Dist-Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            Else
                If ChartType = "RBC" Then
                    Page.Title = "Dist-Combine Cost Bar Chartt"
                    rwType.Visible = True
                Else
                    Page.Title = "Dist-Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception

...
Partial Class Charts_E1Charts_CRProftAndLoss
...
#End Region
    ...
    Protected Sub GetTypes()
        Try
            ...
            MyConnection = System.Configuration.ConfigurationManager.AppSettings("EconConnectionString")

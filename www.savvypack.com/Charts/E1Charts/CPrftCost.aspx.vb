...
Partial Class Charts_E1Charts_CPrftCost
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            dsPref = GetPref(Session("E1UserName"))
            GetPageTitle()
        ...
        Try
            If PrftCost = "PRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1-Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1-Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf PrftCost = "CPRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1-Customer Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1-Customer Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf PrftCost = "COST" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1-Combine Cost Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1-Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf PrftCost = "CCOST" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1-Customer Combine Cost Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1-Customer Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception
    ...
    Protected Function GetPref(ByVal UserName As String) As DataSet
        ...
        Dim objGetData As New E1GetData.Selectdata()
        Try
            ds = objGetData.GetChartPrefrences(Session("USERID"))
            Return ds
        Catch ex As Exception
    ...
    Protected Sub GetBPPerUnitC(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            DsDataView.RowFilter = "CASEID = " + Session("E1CaseId")

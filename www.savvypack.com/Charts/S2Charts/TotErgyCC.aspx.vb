...
Partial Class Charts_Sustain2_TotalEnergyComp
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                StrSQl = StrSQl + "ROUND((RMERGY+RMPACKERGY+DPPACKERGY+PACKGEDPRODPACK),0) AS ""Purchased Materials"", "
                StrSQl = StrSQl + "ROUND((PROCERGY+PROCERGYS2),0)AS ""Process"", "
                StrSQl = StrSQl + "ROUND((RMANDPACKTRNSPTERGY+DPTRNSPTERGY+TRSPTTOCUS+PPPTRNSPT+PACKGEDPRODTRNSPT),0) AS ""Transportation"" "
    ...
    Private Sub DrawChart(ByVal Dts As DataTable, ByVal DtsPref As DataTable)
        Try
            ...
            myImage.language = "EN"
            myImage.pcScript = pcScript + "Y-axis.SetText(" + DtsPref.Rows(0).Item("Title6").ToString() + ")"
            myImage.outputType = "JPEG"
            myImage.fallback = "STRICT"
            ' myImage.addHTMLTable("graph", "Energy")

...
Partial Class Charts_S2Charts_CWaterCharts2
    ...
    Protected Sub GetCustomerPerUnit(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        perUnit = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / SALESVOLUMELB, 0)
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        perUnit = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()), 0)
                    End If
                End If
                If customerSaleUnit = 0 Then
    ...
    Protected Sub GetCustomerPerWight(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        perwt = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / SALESVOLUMELB, 0)
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        perwt = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()), 0)
                    End If
                End If
                If customerSaleUnit <> 0 Then

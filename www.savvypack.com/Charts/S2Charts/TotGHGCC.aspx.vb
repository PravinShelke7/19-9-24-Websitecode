...
Partial Class Charts_Sustain2_TotalGreenHouseCaseComp
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                StrSQl = StrSQl + "ROUND((RMGRNHUSGAS+RMPACKGRNHUSGAS+DPPACKGRNHUSGAS+PACKGEDPRODPACKGRNHUSGAS),0) AS ""Purchased Materials"", "
                StrSQl = StrSQl + "ROUND((PROCGRNHUSGAS+PROCGRNHUSGASS2),0)AS ""Process"", "
                StrSQl = StrSQl + "ROUND((RMANDPACKTRNSPTGRNHUSGAS+DPTRNSPTGRNHUSGAS+TRSPTTOCUSGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS),0) AS ""Transportation"" "
                ...
                StrSqlPref = "SELECT USERNAME, UNITS, CURRENCY, CURR, CONVERSIONFACTOR, TITLE1, TITLE2, TITLE3, TITLE4, TITLE5, TITLE6 FROM  CHARTPREFERENCES WHERE USERNAME='" + Session("User").ToString() + "'"
    ...
    Private Sub DrawChart(ByVal Dts As DataTable, ByVal DtsPref As DataTable)
        Try
            ...
            myImage.language = "EN"
            myImage.pcScript = pcScript + "Y-axis.SetText(" + DtsPref.Rows(0).Item("Title4").ToString() + ")"

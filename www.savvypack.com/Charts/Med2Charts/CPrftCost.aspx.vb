...
Partial Class Charts_Med2Charts_CPrftCost
        ...
        Try
            If PrftCost = "PRFT" Or PrftCost = "CPRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "Med2-Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "Med2-Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            Else
                If ChartType = "RBC" Then
                    Page.Title = "Med2-Combine Cost Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "Med2-Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception

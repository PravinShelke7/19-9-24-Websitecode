<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CRProftAndLoss.aspx.vb" Inherits="Charts_Med2Charts_CRProftAndLoss" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Med2-Combine Profit And Loss Bar Chart</title>
                    ...
                    <table width="50%" >
                        <tr>
                            <td>
                              ...
                              <td align="left">
                                <asp:DropDownList ID="ddltype" runat="server" CssClass="dropdown"  Width="250"></asp:DropDownList> 
                            </td>
                         </tr>
                          <tr>
                            <td>

...
Partial Class Charts_CombineCharts_CEnergyCharts
...
#End Region
    ...
    Protected Sub GetTotal(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                Data = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + ""), 3)
    ...
    Protected Sub bynUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try

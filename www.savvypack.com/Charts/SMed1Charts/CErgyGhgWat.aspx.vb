...
Partial Class Charts_SMed1Charts_CErgyGhgWat
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_SMed1CHARTS_CERGYGHGWAT")
    End Sub
...
#End Region
        ...
        Try
            If ErgyGHG = "ERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed1-Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Customer Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed1-Customer Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "GHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed1-Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CGHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Customer Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed1-Customer Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "WATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed1-Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CWATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Customer Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed1-Customer Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CEOL" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed1-Customer Combine End Of Life Bar Chart"
                    rwType.Visible = True
                End If
            End If
        Catch ex As Exception
        ...
        Try
            ...
            For i = 0 To Cnt
                ...
                Else
                    ...
                    pcScript = pcScript + "" + Graphtype + ".addHoverText(1," + (i + 1).ToString() + ",Value:" + Transportation.ToString() + "<br/>Unit:" + HoverText.ToString() + ")"
                    pcScript = pcScript + "" + Graphtype + ".addHoverText(2," + (i + 1).ToString() + ",Value:" + Process.ToString() + "<br/>Unit:" + HoverText.ToString() + ")"
                    pcScript = pcScript + "" + Graphtype + ".addHoverText(3," + (i + 1).ToString() + ",Value:" + Purchased.ToString() + "<br/>Unit:" + HoverText.ToString() + ")"
                End If
            Next
    ...
    Protected Sub GetBEPerUnitC(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            DsDataView.RowFilter = "CASEID = " + Session("SMed1CaseId")
            ...
            For i = 0 To Cnt
                ...
                If ChartType = "RBC" Then
                    ...
                    pcScript = pcScript + Graphtype + ".addHoverText(1," + (i + 1).ToString() + ",Value:" + Data.ToString() + ")"
                Else
                    If CDbl(customerSaleUnit) = 0 Then
                        If CDbl(DsData.Rows(i).Item("VOLUME").ToString()) > 0 Then
                    ...
                    pcScript = pcScript + "" + Graphtype + ".addHoverText(1," + (i + 1).ToString() + ",Value:" + Transportation.ToString() + ")"
                    pcScript = pcScript + "" + Graphtype + ".addHoverText(2," + (i + 1).ToString() + ",Value:" + Process.ToString() + ")"
                    pcScript = pcScript + "" + Graphtype + ".addHoverText(3," + (i + 1).ToString() + ",Value:" + Purchased.ToString() + ")"
                End If
            Next
        ...
        Try
            ...
            For i = 0 To Cnt
                ...
                Else
                    ...
                    Process = FormatNumber(DsData.Rows(i).Item("PROCWater") * DsPref.Rows(0).Item("CONVGALLON"), 3)

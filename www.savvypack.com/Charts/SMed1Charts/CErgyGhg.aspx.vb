...
Partial Class Charts_SMed1Charts_CErgyGhg
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_SMED1CHARTS_CERGYGHG")
    End Sub
        ...
        Try
            ...
            For i = 0 To Cnt
                ...
                Else
                    ...
                    pcScript &= "" + Graphtype + ".setSeries(" & DsData.Rows(i).Item("CASEDE") & ";" & Purchased & ";" & Process & ";" & Transportation & ")"
        ...
        Try
            ...
            For i = 0 To Cnt
                ...
                Else
                    ...
                    Process = FormatNumber(DsData.Rows(i).Item("PROCGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT"), 3)

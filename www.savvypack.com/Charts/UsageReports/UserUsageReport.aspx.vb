...
Imports System.IO
Partial Class Charts_UsageReports_UserUsageReport
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            Dim obj As New CryptoHelper
            Dim UserId As String = obj.Decrypt(Request.QueryString("UserId"))
            lblTag.Text = "Copyright 1997 - " + Now.Year().ToString() + " SavvyPack Corporation"
            GetUsageReoprts("ECON1", UserId)
            GetUsageReoprts("ECON2", UserId)
            GetUsageReoprts("SUSTAIN1", UserId)
            GetUsageReoprts("SUSTAIN2", UserId)
        Catch ex As Exception
            lblError.Text = "Error:Page_Load" + ex.Message
        End Try
    End Sub

    Protected Sub GetUsageReoprts(ByVal Schema As String, ByVal UserId As String)
        ...
        Dim Path As String = Server.MapPath("UsageXML/" + Schema + "_UserID_" + UserId + ".xml")
        Try

    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                Dim UserName As String = Session("MoldE1UserName")
                ...
                StrSqlPref = "SELECT TITLE1,TITLE2,TITLE3,TITLE4 FROM  CHARTPREFERENCES WHERE USERID=" + UserId + ""
                ...
                SalaryPrice.InnerHtml = myImage.getEmbeddingHTML

...
Partial Class Charts_MoldE1Charts_CPrftCost
...
#End Region
        ...
        Try
            If PrftCost = "PRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1 Mold-Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1 Mold-Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf PrftCost = "CPRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1 Mold-Customer Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1 Mold-Customer Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf PrftCost = "COST" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1 Mold-Combine Cost Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1 Mold-Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf PrftCost = "CCOST" Then
                If ChartType = "RBC" Then
                    Page.Title = "E1 Mold-Customer Combine Cost Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E1 Mold-Customer Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception
    ...
    Protected Sub GetBPPerUnitC(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            DsDataView.RowFilter = "CASEID = " + Session("MoldE1CaseId")

    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            If Session("back") = "" Then
                ...
                Response.Redirect("../Pages/Med1/Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE112") + "")
            Else
                ...
                Dim UserName As String = Session("Med1UserName")
                ...
                Dim MyConnection As String = System.Configuration.ConfigurationManager.AppSettings("MedEcon1ConnectionString")
                ...
                StrSqlCountry = "Select CountryId,(CountryDE1||''||CountryDE2)As CountryDes From ECON.Country  order by CountryDes"
                StrSqlCountry1 = "Select CountryId,(CountryDE1||''||CountryDE2)As CountryDes From ECON.Country  order by CountryDes"
                ...
                StrSqlPostion1 = "Select Persid,(Persde1||''||Persde2)As Des from ECON." + CountryDetail1(0).ToString() + " Order by Des"
                StrSqlPostion2 = "Select Persid,(Persde1||''||Persde2)As Des from ECON." + CountryDetail2(0).ToString() + "  Order by Des "
                StrSqlPref = "SELECT TITLE1,TITLE2,TITLE3,TITLE4 FROM  ECON.CHARTPREFERENCES WHERE USERID=" + UserId + ""
                ...
                StrSQl = StrSQl + "FROM ECON." + CountryDetail1(1).ToString() + "  A, "
                StrSQl = StrSQl + "ECON." + CountryDetail2(1).ToString() + " B, "
                StrSQl = StrSQl + "ECON.CHARTPREFERENCES, "
                StrSQl = StrSQl + "ECON.CURRENCYARCH CURR "
                StrSQl = StrSQl + "WHERE A.EFFDATE = B.EFFDATE "
                StrSQl = StrSQl + "AND A.PERSID = " + MatID + ""
                StrSQl = StrSQl + "AND B.PERSID = " + NewMatID + ""
                ...
                StrSQl = StrSQl + "AND A.EFFDATE BETWEEN TO_DATE(ADD_MONTHS(TRUNC(SYSDATE, 'MONTH'),-12*" + YearValue + ")) "
                StrSQl = StrSQl + "AND TO_DATE(ADD_MONTHS(TRUNC(SYSDATE, 'MONTH'),-0)) "
                StrSQl = StrSQl + "AND CHARTPREFERENCES.USERID=" + UserId + " "

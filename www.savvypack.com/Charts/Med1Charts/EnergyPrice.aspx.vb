    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                Dim StrSqlPref As String = "SELECT TITLE1,TITLE2,TITLE3,TITLE4 FROM  ECON.CHARTPREFERENCES WHERE USERID='" + Session("UserID").ToString().ToUpper() + "'"
                ...
                StrSQl = StrSQl + "FROM ECON.ENERGYARCH A, "
                StrSQl = StrSQl + "ECON.ENERGYARCH B, "

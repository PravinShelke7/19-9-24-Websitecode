    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                Dim StrSqlPref As String = "SELECT TITLE1,TITLE2,TITLE3,TITLE4,TITLE8,CURRENCY FROM  ECON.CHARTPREFERENCES WHERE USERID=" + UserId + ""
                ...
                'StrSQl = StrSQl + "(A.PRICE*(CURR.CURPUSD)/CHARTPREFERENCES.CONVWT) ID1, "
                'StrSQl = StrSQl + "(B.PRICE*(CURR.CURPUSD)/CHARTPREFERENCES.CONVWT) ID2 "
                'StrSQl = StrSQl + "FROM MATERIALSARCH A, "
                'StrSQl = StrSQl + "MATERIALSARCH B, "
                'StrSQl = StrSQl + "CHARTPREFERENCES , "
                'StrSQl = StrSQl + "CURRENCYARCH CURR "
                'StrSQl = StrSQl + "WHERE A.EFFDATE = B.EFFDATE "
                'StrSQl = StrSQl + "AND A.MATID =  " + MatID + ""
                'StrSQl = StrSQl + "AND B.MATID = " + NewMatID + ""
                ...
                'StrSQl = StrSQl + "AND UPPER(CHARTPREFERENCES.USERNAME)='" + Session("E1UserName").ToString().ToUpper() + "' "
                ...
                If CInt(DtsPref.Tables(0).Rows(0).Item("CURRENCY")) = 0 Then
                    ...
                    StrSQl = StrSQl + "LEFT OUTER JOIN ECON.MATERIALSARCH A "
                    StrSQl = StrSQl + "ON CARCH.EFFDATE=A.EFFDATE AND A.MATID=" + MatID + " "
                    StrSQl = StrSQl + "LEFT OUTER JOIN ECON.MATERIALSARCH B "
                    ...
                    StrSQl = StrSQl + "WHERE CPREF.USERID=" + UserId + " "

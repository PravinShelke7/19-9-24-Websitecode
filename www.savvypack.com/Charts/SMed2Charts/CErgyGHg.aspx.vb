...
Partial Class Charts_SMed2Charts_CErgyGHg
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_SMed2CHARTS_CERGYGHG")
    End Sub
        ...
        Try
            ...
            For i = 0 To Cnt
                ...
                Else
                    ...
                    Process = FormatNumber(DsData.Rows(i).Item("TPROCERGY"), 3)

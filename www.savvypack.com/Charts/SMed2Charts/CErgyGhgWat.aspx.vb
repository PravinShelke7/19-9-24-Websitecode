...
Partial Class Charts_SMed2Charts_CErgyGhgWat
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_SMED2CHARTS_CERGYGHGWAT")
    End Sub
        ...
        Try
            If ErgyGHG = "ERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed2-Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed2-Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "GHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed2-Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed2-Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "WATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "SMed2-Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SMed2-Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception

<%@ Page Language="VB"  AutoEventWireup="false" CodeFile="CWaterCharts2.aspx.vb" MasterPageFile="~/Masters/SMed2Chart.master"
 Inherits="Charts_SMed2Charts_CWaterCharts2" Title="SMed2-Combine Water Bar Chart" %>
                            ...
                            <td>
                              ...
                              <td align="left">
                                <asp:DropDownList ID="ddltype" runat="server" CssClass="dropdown"  Width="250">
                                     ...
                                     <asp:ListItem  Text="Process (SMed2)" Value="PROCWATERS2"></asp:ListItem>                                   
                                     <asp:ListItem  Text="Packaged Product Packaging(SMed2)" Value="PACKGEDPRODPACKWATER"></asp:ListItem> 
                                     <asp:ListItem  Text="PPP Transport(SMed2)" Value="PPPTRNSPTWATER"></asp:ListItem> 
                                     <asp:ListItem  Text="Packaged Product Transport(SMed2)" Value="PACKGEDPRODTRNSPTWATER"></asp:ListItem> 

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGHGCharts.aspx.vb" Inherits="Charts_SMed2Charts_CGHGCharts" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SMed2-Combine GHG Bar Chart</title>
                            ...
                            <td>
                              ...
                              <td align="left">
                                <asp:DropDownList ID="ddltype" runat="server" CssClass="dropdown"  Width="250">
                                     ...
                                     <asp:ListItem  Text="Process (SMed2)" Value="PROCGRNHUSGASS2"></asp:ListItem>                                   
                                     <asp:ListItem  Text="Packaged Product Packaging(SMed2)" Value="PACKGEDPRODPACKGRNHUSGAS"></asp:ListItem> 
                                     <asp:ListItem  Text="PPP Transport(SMed2)" Value="PPPTRNSPTGRNHUSGAS"></asp:ListItem> 
                                     <asp:ListItem  Text="Packaged Product Transport(SMed2)" Value="PACKGEDPRODTRNSPTGRNHUSGAS"></asp:ListItem> 

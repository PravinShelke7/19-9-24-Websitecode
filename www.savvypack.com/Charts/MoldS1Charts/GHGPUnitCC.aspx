<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GHGPUnitCC.aspx.vb" Inherits="Charts_Sustain1_GreenHousePerUnitCaseComp" %>
                ...
                <tr>
                    <td align="center" style="background-color: #5B5B5B; height: 50px;">
                        <asp:Label ID="lblyear" runat="server" ForeColor="White" Font-Bold="true" Font-Size="18px"
                            Text="GHG Per Unit Comparison"></asp:Label>
                    </td>
                    <td style="width: 10px;">
                        &nbsp;
                    </td>

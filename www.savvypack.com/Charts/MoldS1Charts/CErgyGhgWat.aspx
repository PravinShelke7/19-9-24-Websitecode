<%@ Page Language="VB" MasterPageFile="~/Masters/MoldS1Chart.master" AutoEventWireup="false"
    CodeFile="CErgyGhgWat.aspx.vb" Inherits="Charts_MoldS1Charts_CErgyGhgWat" Title="Untitled Page" %>
                            ...
                            <table width="50%">
                                ...
                                <tr>
                                    ...
                                    <td align="left" id="CnvT2" runat="server" visible="false">
                                        <asp:DropDownList ID="ddlCnTypeEol" runat="server" CssClass="dropdown" Width="200"
                                            AutoPostBack="false">

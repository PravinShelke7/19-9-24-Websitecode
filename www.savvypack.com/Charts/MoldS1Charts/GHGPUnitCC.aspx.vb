...
Partial Class Charts_Sustain1_GreenHousePerUnitCaseComp
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                StrSQl = StrSQl + "ROUND((RMGRNHUSGAS+RMPACKGRNHUSGAS+DPPACKGRNHUSGAS),0) AS ""Purchased Materials"", "
                StrSQl = StrSQl + "ROUND((PROCGRNHUSGAS),0)AS ""Process"", "
                StrSQl = StrSQl + "ROUND((RMANDPACKTRNSPTGRNHUSGAS+DPTRNSPTGRNHUSGAS+TRSPTTOCUSGRNHUSGAS),0) AS ""Transportation"" "
                ...
                StrSqlPref = "SELECT USERID, UNITS, CURRENCY, CURR, CONVERSIONFACTOR,CONVAREA, TITLE1, TITLE2, TITLE3, TITLE4, TITLE5, TITLE6 FROM  CHARTPREFERENCES WHERE USERID='" + Session("USERID").ToString() + "'"
    ...
    Private Sub DrawChart(ByVal Dts As DataTable, ByVal DtsPref As DataTable)
        Try
            ...
            For i = 0 To Count - 1
                ...
                Transportation = FormatNumber((Dts.Rows(i).Item("Transportation") * DtsPref.Rows(0).Item("CONVERSIONFACTOR")) / SalesVolumeUnit, 3)
                Process = FormatNumber((Dts.Rows(i).Item("Process") * DtsPref.Rows(0).Item("CONVERSIONFACTOR")) / SalesVolumeUnit, 3)
                Purchased = FormatNumber((Dts.Rows(i).Item("Purchased Materials") * DtsPref.Rows(0).Item("CONVERSIONFACTOR")) / SalesVolumeUnit, 3)
            ...
            myImage.language = "EN"
            myImage.pcScript = pcScript + "Y-axis.SetText(" + DtsPref.Rows(0).Item("Title4").ToString() + " gr gas/unit)"

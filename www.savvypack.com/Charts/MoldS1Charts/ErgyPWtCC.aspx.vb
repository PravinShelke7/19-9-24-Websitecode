...
Partial Class Charts_Sustain1_EnergyPerWeightCaseComp
...
#End Region
    ...
    Private Sub DrawChart(ByVal Dts As DataTable, ByVal DtsPref As DataTable)
        Try
            ...
            myImage.language = "EN"
            myImage.pcScript = pcScript + "Y-axis.SetText(" + DtsPref.Rows(0).Item("Title6").ToString() + "/" + DtsPref.Rows(0).Item("Title4").ToString() + ")"

...
Partial Class Charts_MoldS1Charts_CErgyGhgWat
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_MoldS1CHARTS_CERGYGHGWAT")
    End Sub
...
#End Region
        ...
        Try
            If ErgyGHG = "ERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S1 Mold-Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Customer Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S1 Mold-Customer Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "GHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S1 Mold-Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CGHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Customer Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S1 Mold-Customer Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "WATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S1 Mold-Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CWATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Customer Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S1 Mold-Customer Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "CEOL" Then
                If ChartType = "RBC" Then
                    Page.Title = "S1 Mold-Customer Combine End Of Life Bar Chart"
                    rwType.Visible = True
                End If
            End If
        Catch ex As Exception
    ...
    Protected Sub GetBEPerUnitC(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            DsDataView.RowFilter = "CASEID = " + Session("MoldS1CaseId")

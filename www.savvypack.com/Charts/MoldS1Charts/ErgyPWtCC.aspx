<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ErgyPWtCC.aspx.vb" Inherits="Charts_Sustain1_EnergyPerWeightCaseComp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Energy Per Weight Comparison</title>
...
<body>
    ...
    <div id="Charts" runat="server">
        <div>
            ...
            <asp:Label ID="mat" runat="server" Font-Names="Verdana" Font-Size="14Px"></asp:Label>
            <br />
            <br />
            <table cellpadding="0" cellspacing="0" border="0" style="height: 400;">
                <tr>
                    <td align="center" style="background-color: #5B5B5B; height: 50px;">
                        <asp:Label ID="lblyear" runat="server" ForeColor="White" Font-Bold="true" Font-Size="18px"
                            Text="Energy Per Weight Comparison"></asp:Label>
                    </td>
                    <td style="width: 10px;">
                        &nbsp;
                    </td>
                ...
                <tr>
                    <td style="height: 219px" valign="top">
                        <form id="EnergyCmp" action="EnergyPerWeightCaseComp.aspx" runat="server" method="post">
                        <table border="0" cellpadding="0" cellspacing="0" style="height: 200px; background-color: #5B5B5B;
                            width: 700px; color: White;">
                            <tr>
                                <td valign="top">

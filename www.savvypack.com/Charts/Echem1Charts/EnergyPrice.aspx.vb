...
Partial Class Charts_Echem1Charts_EnergyPrice
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                Dim StrSqlPref As String = "SELECT TITLE1,TITLE2,TITLE3,TITLE4 FROM  CHARTPREFERENCES WHERE USERID='" + Session("USERID").ToString() + "'"
                ...
                StrSQl = StrSQl + "AND A.EFFDATE BETWEEN TO_DATE(ADD_MONTHS(TRUNC(SYSDATE, 'MONTH'),-12*  " + YearValue + ")) AND TO_DATE(ADD_MONTHS(TRUNC(SYSDATE, 'MONTH'),-0)) "
                StrSQl = StrSQl + "AND UPPER(CHARTPREFERENCES.USERNAME)='" + UserName.ToUpper() + "' "

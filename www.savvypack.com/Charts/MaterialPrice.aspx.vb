    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Else
                ...
                Dim StrSqlPref As String = "SELECT TITLE1,TITLE2,TITLE3,TITLE4,TITLE8,CURRENCY FROM  CHARTPREFERENCES WHERE USERID='" + Session("USERID").ToString() + "'"
                ...
                If CInt(DtsPref.Tables(0).Rows(0).Item("CURRENCY")) = 0 Then
                    ...
                    StrSQl = StrSQl + "FROM CURRENCYARCH CARCH "
                    ...
                    StrSQl = StrSQl + "INNER JOIN CHARTPREFERENCES CPREF "
                    StrSQl = StrSQl + "ON CARCH.CURID=1 "
                    StrSQl = StrSQl + "WHERE CPREF.USERID='" + Session("USERID").ToString() + "' "

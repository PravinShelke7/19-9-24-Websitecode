...
Partial Class Charts_S4Charts_CErgyGhg
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_S4CHARTS_CERGYGHG")
    End Sub
...
#End Region
        ...
        Try
            ...
            Else
                ...
                Else
                    ...
                    dtCatSet = objS4GetData.GetCategorySetByID(ddlCategorySet.SelectedValue)
                    If dtCatSet.Rows.Count > 0 Then
                        dt = objS4GetData.GetCategoryBySet(ddlCategorySet.SelectedValue, "")
                        If dt.Rows.Count > 0 Then
                            For i = 0 To dt.Rows.Count - 1
                                ds = objS4GetData.GetCategoryItemBycategory(dt.Rows(i).Item("CATEGORYID").ToString())
        ...
        Try
            If ErgyGHG = "ERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "S4-Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S4-Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "WATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "S4-Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S4-Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            Else
                If ChartType = "RBC" Then
                    Page.Title = "S4-Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S4-Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception
    ...
    Function GetStackbarChartDetails(ByVal DsData As DataTable, ByVal DsPref As DataTable, ByVal Contype As String) As String
        ...
        Try
            ...
            dsCategories = ObjGetS4data.GetCategoryBySet(ddlCategorySet.SelectedValue, "")
            ...
            For k = 0 To Cnt
                ...
                Else
                    SalesVolumeLb = DsData.Rows(k).Item("SVOLUME")
                End If

             
                pcsetSeries = pcsetSeries + "" + Graphtype + ".setSeries(" & DsData.Rows(k).Item("CASEID") & ";"
                For i = 0 To dsCategories.Rows.Count - 1
                    dsitems = ObjGetS4data.GetCategoryItemBycategory(dsCategories.Rows(i).Item("Categoryid").ToString())

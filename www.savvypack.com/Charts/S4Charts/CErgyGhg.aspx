<%@ Page Language="VB" MasterPageFile="~/Masters/S4Charts.master" AutoEventWireup="false" CodeFile="CErgyGhg.aspx.vb" Inherits="Charts_S4Charts_CErgyGhg" title="Untitled Page" %>
                        ...
                        <div style="margin-left: 10px; margin-top: 10px; text-align: left;">
                            <table width="65%">
                                ...
                                <tr id="Tr1" runat="server">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddlChartType" runat="server" CssClass="DropDown" AutoPostBack="true"
                                            Width="200">
                                   ...
                                   <tr id="ROWCategoryset" runat="server" visible="false">
                                    ...
                                    <td>
                                        <a href="../../Pages/Sustain4/Category/ManageCategory.aspx" class="Link" style="font-size: 13px;

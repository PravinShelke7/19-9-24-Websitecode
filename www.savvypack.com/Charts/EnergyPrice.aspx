<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EnergyPrice.aspx.vb" Inherits="EnergyPriceChart" %>

<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Energy Price Chart</title>
...
<body style="margin-top: 0px;">
    <form runat="server" id="form1" action="EnergyPrice.aspx">
            ...
            <tr style="height: 20px">
                <td>
                    <table style="background-color:Black;width:100%; color: White;" border="0" cellpadding="5" cellspacing="5">
                        ...
                        <tr style="height: 50px;">
                            <td style="height: 22px;color:White;margin-left:100px;width:30%;font-size:13px;font-family:Verdana" align="right" >
                                <b>Country Selection:</b></td>
                            <td style="width:30%" >
                                &nbsp;<asp:DropDownList ID="ddlCountry" CssClass="NormalDropDown" Width="250px" runat="server">
                                </asp:DropDownList>
                            </td>                           
                        <tr>

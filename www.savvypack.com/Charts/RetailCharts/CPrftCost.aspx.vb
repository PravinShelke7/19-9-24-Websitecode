...
Partial Class Charts_RetailCharts_CPrftCost
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            dsPref = GetPref(Session("RetlUserName"))
            GetPageTitle()
        ...
        Try
            If PrftCost = "PRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "Retail-Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "Retail-Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            Else
                If ChartType = "RBC" Then
                    Page.Title = "Retail-Combine Cost Bar Chartt"
                    rwType.Visible = True
                Else
                    Page.Title = "Retail-Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception
    ...
    Protected Function GetPref(ByVal UserName As String) As DataSet
        ...
        Try
            ds = objGetData.GetChartPrefrences(UserName)
            Return ds
        Catch ex As Exception

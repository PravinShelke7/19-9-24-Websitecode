<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CWaterCharts2.aspx.vb" MasterPageFile="~/Masters/MoldS2Chart.master"
    Inherits="Charts_MoldS2Charts_CWaterCharts2" Title="S2 Mold-Combine Water Bar Chart" %>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="ddltype" runat="server" CssClass="dropdown" Width="250">
                                            ...
                                            <asp:ListItem Text="Process (S2)" Value="PROCWATERS2"></asp:ListItem>
                                            <asp:ListItem Text="Packaged Product Packaging(S2)" Value="PACKGEDPRODPACKWATER"></asp:ListItem>
                                            <asp:ListItem Text="PPP Transport(S2)" Value="PPPTRNSPTWATER"></asp:ListItem>
                                            <asp:ListItem Text="Packaged Product Transport(S2)" Value="PACKGEDPRODTRNSPTWATER"></asp:ListItem>

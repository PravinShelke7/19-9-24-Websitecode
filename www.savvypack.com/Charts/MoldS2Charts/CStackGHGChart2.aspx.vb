...
Partial Class Charts_MoldS2Charts_CStackGHGChart2
    ...
    Protected Sub GetCustomerTotal(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To DsData.Rows.Count - 1
                If DsData.Rows(i).Item("CASEID").ToString() = Session("MoldS2CaseId") Then
            ...
            For i = 0 To Cnt
                ...
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        Transportation = FormatNumber(DsData.Rows(i).Item("TRNSPTGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()), 0)
                        Process = FormatNumber(DsData.Rows(i).Item("PROCESSGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()), 0)
                        Purchased = FormatNumber(DsData.Rows(i).Item("PURMATERIALGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()), 0)
                    End If
                End If
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        If CDbl(customerSaleValue * lbToUnit) <> 0 Then
                            Transportation = FormatNumber((DsData.Rows(i).Item("TRNSPTGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / SALESVOLUMELB) / CDbl(customerSaleValue * lbToUnit), 3)
                            Process = FormatNumber((DsData.Rows(i).Item("PROCESSGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / SALESVOLUMELB) / CDbl(customerSaleValue * lbToUnit), 3)
                            Purchased = FormatNumber((DsData.Rows(i).Item("PURMATERIALGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / SALESVOLUMELB) / CDbl(customerSaleValue * lbToUnit), 3)
                        End If
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        If CDbl(customerSaleValue) <> 0 Then
                            Transportation = FormatNumber((DsData.Rows(i).Item("TRNSPTGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())) / CDbl(customerSaleValue), 3)
                            Process = FormatNumber((DsData.Rows(i).Item("PROCESSGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())) / CDbl(customerSaleValue), 3)
                            Purchased = FormatNumber((DsData.Rows(i).Item("PURMATERIALGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())) / CDbl(customerSaleValue), 3)
                        End If
                    End If
                End If
                pcScript &= "" + Graphtype + ".setSeries(" & DsData.Rows(i).Item("CASEDE") + "<br/>(" + HoverText.ToString() + ");" & Transportation & ";" & Process & ";" & Purchased & ")"
        ...
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        If CDbl(customerSaleValue) <> 0 Then
                            Transportation = FormatNumber((DsData.Rows(i).Item("TRNSPTGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / SALESVOLUMELB) / CDbl(customerSaleValue), 3)
                            Process = FormatNumber((DsData.Rows(i).Item("PROCESSGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / SALESVOLUMELB) / CDbl(customerSaleValue), 3)
                            Purchased = FormatNumber((DsData.Rows(i).Item("PURMATERIALGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / SALESVOLUMELB) / CDbl(customerSaleValue), 3)
                        End If
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        If CDbl(customerSaleValue * UnitTolb) <> 0 Then
                            Transportation = FormatNumber((DsData.Rows(i).Item("TRNSPTGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())) / CDbl(customerSaleValue * UnitTolb), 3)
                            Process = FormatNumber((DsData.Rows(i).Item("PROCESSGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())) / CDbl(customerSaleValue * UnitTolb), 3)
                            Purchased = FormatNumber((DsData.Rows(i).Item("PURMATERIALGRNHUSGAS") * DsPref.Rows(0).Item("CONVWT") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())) / CDbl(customerSaleValue * UnitTolb), 3)
                        End If
                    End If
                End If
                pcScript &= "" + Graphtype + ".setSeries(" & DsData.Rows(i).Item("CASEDE") + "<br/>(" + HoverText.ToString() + ");" & Transportation & ";" & Process & ";" & Purchased & ")"

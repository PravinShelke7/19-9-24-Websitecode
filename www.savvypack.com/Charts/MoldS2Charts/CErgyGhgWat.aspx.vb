...
Partial Class Charts_MoldS2Charts_CErgyGhgWat
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_MoldS2CHARTS_CERGYGHGWAT")
    End Sub
        ...
        Try
            If ErgyGHG = "ERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "S2 Mold-Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S2 Mold-Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "GHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "S2 Mold-Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S2 Mold-Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "WATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "S2 Mold-Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "S2 Mold-Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception

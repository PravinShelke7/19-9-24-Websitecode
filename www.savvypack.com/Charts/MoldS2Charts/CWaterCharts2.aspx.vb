...
Partial Class Charts_MoldS2Charts_CWaterCharts2
...
#End Region
    ...
    Protected Sub GetCustomerTotal(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            lblHeading.Text = ddltype.SelectedItem.Text + " Customer Water Chart"
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        Data = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / SALESVOLUMELB, 0)
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        Data = FormatNumber(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()), 0)
                    End If
                End If
    ...
    Protected Sub GetCustomerPerUnit(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        perUnit = DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / SALESVOLUMELB
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        perUnit = DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())
                    End If
                End If
                If customerSaleUnit = 0 Then
    ...
    Protected Sub GetCustomerPerWight(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        perwt = DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / SALESVOLUMELB
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        perwt = DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * DsPref.Rows(0).Item("CONVGALLON") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString())
                    End If
                End If
                If customerSaleUnit <> 0 Then

...
Partial Class Charts_MoldS2Charts_CEnergyCharts2
    ...
    Protected Sub GetCustomerPerUnit(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        perunit = CDbl(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * customerSaleValue / SALESVOLUMELB)
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        perunit = CDbl(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()))
                    End If
                End If
                If customerSaleUnit = 0 Then
    ...
    Protected Sub GetCustomerPerWight(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To Cnt
                ...
                If customerSaleUnit = 0 Then
                    If CDbl(SALESVOLUMELB) > 0.0 Then
                        perwt = CDbl(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * customerSaleValue / SALESVOLUMELB)
                    End If
                Else
                    If CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()) > 0 Then
                        perwt = CDbl(DsData.Rows(i).Item("" + ddltype.SelectedItem.Value + "") * customerSaleValue / CDbl(DsData.Rows(i).Item("FINVOLMUNITS").ToString()))
                    End If
                End If

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GHGPwtCC.aspx.vb" Inherits="Charts_Sustain2_GreenHousePerWeightCaseComp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>GHG Per Weight Comparison</title>
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="height: 400;">
                <tr>
                    <td align="center" style="background-color: #5B5B5B; height: 50px;">
                        <asp:Label ID="lblyear" runat="server" ForeColor="White" Font-Bold="true" Font-Size="18px"
                            Text="GHG Per Weight Comparison"></asp:Label>
                    </td>
                    <td style="width: 10px;">
                        &nbsp;
                    </td>
                ...
                <tr>
                    <td style="height: 219px" valign="top">
                        <form id="GHGCmp" action="GreenHousePerWeightCaseComp.aspx" runat="server" method="post">

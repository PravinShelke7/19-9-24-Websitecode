...
Partial Class Charts_MoldE2Charts_CPrftCost
        ...
        Try
            If PrftCost = "PRFT" Then
                If ChartType = "RBC" Then
                    Page.Title = "E2 Mold-Combine Profit And Loss Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E2 Mold-Combine Profit And Loss  Stack Chart"
                    rwType.Visible = False
                End If
            Else
                If ChartType = "RBC" Then
                    Page.Title = "E2 Mold-Combine Cost Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "E2 Mold-Combine Cost Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception
    ...
    Protected Sub GetBPPerUnitC(ByVal DsData As DataTable, ByVal DsPref As DataTable)
        Try
            ...
            For i = 0 To DsData.Rows.Count - 1
                If DsData.Rows(i).Item("CASEID").ToString() = Session("MoldE2CaseId") Then

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VendorSelectionBatch.aspx.vb" Inherits="Charts_SavvyPackProCharts_PopUp_VendorSelectionBatch" %>
                                            ...
                                            <tr id="Tr3" runat="server">
                                                <td id="Td3" style="padding-top: 10px;" runat="server">
                                                    <div id="ContentPagemargin" style="overflow: auto; height: 410px;" runat="server">
                                                        ...
                                                        <asp:GridView Width="1120px" CssClass="grdProject"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Createmultiplechart.aspx.vb" Inherits="Charts_SavvyPackProCharts_Tools_Createmultiplechart" %>
                        ...
                        <table>
                                    ...
                                    <table width="1200px">
                                        ...
                                        <tr class="AlterNateColor1">
                                            <td>
                                                ...
                                                <asp:Button ID="btnCreate" runat="server" Text="Create Bar/Pie Chart" CssClass="Button" Visible ="false"  OnClientClick="return MakeVisible('divM');"
                                                    Style="margin-left: 50px;"></asp:Button>
                                                <asp:Button ID="btnCreateLine" runat="server" Text="Create Line chart" CssClass="Button" Visible ="false"  OnClientClick="return MakeVisible('divML');"
                                                    Style="margin-left: 50px;"></asp:Button>
                                                <asp:Button ID="btnlinegrp" runat="server" Text="Create Line chart for Batches" CssClass="Button" OnClientClick="return MakeVisible('divMLG');"
                                                    Style="margin-left: 50px;"></asp:Button>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <asp:Table ID="tblChart" runat="server" CellPadding="0" CellSpacing="1" Style="margin-left: 50px;">
                    </asp:Table>
                                </td>
                            </tr>

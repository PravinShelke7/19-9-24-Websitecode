...
Partial Class Charts_SDistCharts_CErgyGhgWat
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_CHARTS_SDistCHARTS_CERGYGHGWAT")
    End Sub
        ...
        Try
            If ErgyGHG = "ERGY" Then
                If ChartType = "RBC" Then
                    Page.Title = "SDist-Combine Energy Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SDist-Combine Energy Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "GHG" Then
                If ChartType = "RBC" Then
                    Page.Title = "SDist-Combine GHG Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SDist-Combine GHG Stack Chart"
                    rwType.Visible = False
                End If
            ElseIf ErgyGHG = "WATER" Then
                If ChartType = "RBC" Then
                    Page.Title = "SDist-Combine Water Bar Chart"
                    rwType.Visible = True
                Else
                    Page.Title = "SDist-Combine Water Stack Chart"
                    rwType.Visible = False
                End If
            End If
        Catch ex As Exception

...
Partial Class Charts_Schem1Charts_CEolCharts
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            Else
                ...
                GetData(DsData, CaseId1, CaseId2, Session("Schem1UserName"))
    ...
    Protected Sub GetData(ByRef Ds As DataTable, ByVal CaseId1 As String, ByVal CaseId2 As String, ByVal userName As String)
        Try
            ...
            StrSql = StrSql + "on Upper(Pref.USERNAME)='" + userName + "' "
        ...
        Try
            ...
            For i = 0 To DsData.Rows.Count - 1
                If DsData.Rows(i).Item("CASEID").ToString() = Session("Schem1CaseId") Then
                    customerSaleValue = FormatNumber(CDbl(DsData.Rows(i).Item("CUSSALESVOLUME").ToString()), 0)
                End If
            Next

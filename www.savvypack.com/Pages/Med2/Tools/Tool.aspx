<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_MedEcon2_Tools_Tool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Med2-Tools</title>
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from SMed2 to Med2. Do you want to proceed?"
            }
 ...
 function ShareMessageNew(Case, User, Flag) 
        ...
        {
          var MaxCount="<%=Session("Med2MaxCaseCount")%>";       
   ...
   <div id="AlliedLogo">
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"  Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Med2/Default.aspx" 
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Med2-Tools')" onmouseout="UnTip()" style="width:840px;">
                     Med2 - Tools
                                    ...
                                    <td>
                                           ...
                                           <asp:Button ID="btnCopyPcase" runat="server" Text="Copy" CssClass="ButtonWMarigin" OnClientClick="return CreateMessage('ddlPCases','NCC');"
                                            ...
                                            <asp:Button ID="btnPShareCase" runat="server" Text="Share Access" CssClass="ButtonWMarigin" OnClientClick="return MakeVisible('divshareAccess');"
                                             ...
                                             onmouseover="Tip('Synchronize this Case from SMed2 to Med2')" onmouseout="UnTip()" style="margin-left:10px" />
                                    ...
                                    <tr class="AlterNateColor4">
                                     ...
                                     <tr class="AlterNateColor1">
                                      ...
                                      <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:TextBox id="txtCaseDe3" onKeyUp="javascript:Count(this);"  onChange="javascript:Count(this);" runat="server" CssClass="MediumTextBox" Style="text-align:left;width:255px;"

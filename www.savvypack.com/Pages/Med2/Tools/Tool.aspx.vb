...
Imports ToolCCS
Partial Class Pages_MedEcon2_Tools_Tool
    Inherits System.Web.UI.Page
#Region "Browser Refresh Check"
    Dim objRefresh As zCon.Net.Refresh

    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON2_TOOLS_TOOL")
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            If Session("Med2UserRole") = "AADMIN" Then
    ...
    Protected Sub GetBCaseDetails()
        Dim objGetData As New Med2GetData.Selectdata() 'change made E1GetData by Med2GetData
    ...
    Protected Sub GetUserDetails()
        ...
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetUserCompanyUsers(Session("Med2UserName").ToString()) 'Replace E1UserName
            With ddlUsers
                .DataSource = ds
    ...
    Protected Sub GetTotalCaseCount()
        ...
        Try
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(ddlUsers.SelectedItem.Text, "MedE2")
    ...
    Protected Sub btnCopyBcase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCopyBcase.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                Flag = CopyCase(SCaseId, TCaseId, "MedEcon2ConnectionString") 'Replace EconConnectionString
                Flag = CopyCase(SCaseId, TCaseId, "MedSustain2ConnectionString") 'Replace Sustain1ConnectionString
                If Flag Then
                    GetPCaseDetails()
                    GetTotalCaseCount()
    ...
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                obj.CaseAccess(UserName, CaseId, "MedEcon2ConnectionString")
                obj.CaseAccess(UserName, CaseId, "MedSustain2ConnectionString")
                GetTotalCaseCount()
                Flag = True
            End If
    ...
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                obj.CaseSynch(SCaseId, TCaseId, "SMED2", "MED2", "MedEcon2ConnectionString", "SystemConnectionString")
                Flag = True
            End If
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            GetPCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from SMed2 to Med2');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                CaseId = ddlPCases.SelectedValue.ToString()
                obj.CaseRename(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MedEcon2ConnectionString")
                GetPCaseDetails()

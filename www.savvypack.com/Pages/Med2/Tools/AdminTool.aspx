<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdminTool.aspx.vb" Inherits="Pages_MedEcon2_Tools_AdminTool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Med2-Admin Tools</title>
   ...
   <%-- <center>--%>
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Med2 - Admin Tools')" onmouseout="UnTip()" style="width:840px;">
                     Med2 - Admin Tools

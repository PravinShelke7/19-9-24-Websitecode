...
Partial Class Pages_MedEcon2_Default
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON2_DEFAULT")
    End Sub
...
#End Region
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("Med2UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("Med2ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("Med2UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("Med2ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("Med2MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
            'Set for License Administrator
            Session("Med2LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("Med2LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
        Catch ex As Exception
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            Else
                If Session("Med2LicAdmin") = "N" Then
    ...
    Protected Sub SetToolButton()
        Try
            If Session("Med2ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("Med2CaseId") = ddlBaseCases.SelectedValue.ToString()
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("Med2CaseId") = ddlPCase.SelectedValue.ToString()
            If Not objRefresh.IsRefresh Then
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MedEcon2ConnectionString")
            GetPCaseDetails()

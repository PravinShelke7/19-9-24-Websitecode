<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CResultCostDep2.aspx.vb" Inherits="Pages_MedEcon2_Results_CResultCostDep2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Med2-Customer Cost with Depreciation Comparison</title>
            ...
            <tr>
                <td>
                     <div class="PageHeading" id="divMainHeading" style="width:840px;">
                         Med2 - Customer Cost with Depreciation Comparison 
                     </div>

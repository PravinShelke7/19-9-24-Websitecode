...
Partial Class Pages_MedEcon2_Results_ResultsPLwithDEP
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med2 - Profit and Loss Statement with Depreciation"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON2_RESULTS_RESULTSPLWITHDEP")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                UnitPrice = Request.Form("ctl00$Med2ContentPlaceHolder$UNITPP").Replace(",", "")
                UnitType = Request.Form("ctl00$Med2ContentPlaceHolder$UNITTYPE")
                'Check For IsNumric

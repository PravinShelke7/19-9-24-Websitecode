...
Partial Class Pages_MedEcon2_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med2 - Customer Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON2_ASSUMPTIONS_CUSTOMERIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$Med2ContentPlaceHolder$PRODPUR").Replace(",", "")
                SHIPDIST = Request.Form("ctl00$Med2ContentPlaceHolder$SHIPDIST").Replace(",", "")
                MILCOST = Request.Form("ctl00$Med2ContentPlaceHolder$MILCOST").Replace(",", "")
                'Check For IsNumric

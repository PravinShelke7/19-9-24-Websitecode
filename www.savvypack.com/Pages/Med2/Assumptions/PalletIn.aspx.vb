...
Partial Class Pages_MedEcon2_Assumptions_PalletIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med2 - Pallet Packaging Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON2_ASSUMPTIONS_PALLETIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Pallet(i - 1) = Request.Form("ctl00$Med2ContentPlaceHolder$hidPalid" + i.ToString() + "")
                    Number(i - 1) = Request.Form("ctl00$Med2ContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                    NoOfUses(i - 1) = Request.Form("ctl00$Med2ContentPlaceHolder$NOFUSE" + i.ToString() + "").Replace(",", "")
                    PrefWeight(i - 1) = Request.Form("ctl00$Med2ContentPlaceHolder$W" + i.ToString() + "").Replace(",", "")
                    PrefPrice(i - 1) = Request.Form("ctl00$Med2ContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$Med2ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")

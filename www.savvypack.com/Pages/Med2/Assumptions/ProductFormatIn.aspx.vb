...
Partial Class Pages_MedEcon2_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med2 - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON2_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("Med2ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$Med2ContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$Med2ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

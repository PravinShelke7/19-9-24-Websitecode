...
Partial Class Pages_MedEcon2_PopUp_CasesViewer
            ...
            If Session("Med2LicAdmin") = "N" Then
                If Request.QueryString("CTYPE") <> "AP" Then
                    If Request.QueryString("GrpID") <> "0" Then
                        ds = objGetData.GetGroupPCases(Session("UserId"), CaseDe1, CaseDe2, Request.QueryString("GrpID").ToString())
                    Else
                        ds = objGetData.GetPropCases(Session("UserId"), CaseDe1, CaseDe2)
                    End If

                Else
                    ds = objGetData.GetApprovedCases(Session("UserId"), CaseDe1, CaseDe2)
                End If

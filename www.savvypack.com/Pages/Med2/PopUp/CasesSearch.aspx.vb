...
Partial Class Pages_MedEcon2_PopUp_CasesSearch
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            If hidCaseid.Value = "hidPropCase" Or hidCaseid.Value = "hidTargetApp" Or hidCaseid.Value = "hidTargetProp" Then
                ...
                Else
                    ds = objGetData.GetPropCasesByLicense(Session("Med2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If
            Else
                If Session("Med2LicAdmin") = "N" Then
                ...
                Else
                    ds = objGetData.GetAppCasesByLicense(Session("Med2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If

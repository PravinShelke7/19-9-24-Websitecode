...
Partial Class Pages_MedEcon2_PopUp_GetE1CasePopup
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            ds = objGetData.GetEcon1Cases(-1, Session("Med2CaseId").ToString(), txtCaseDe1.Text.Trim.ToString(), txtCaseDe2.Text.Trim.ToString(), Session("UserId").ToString())

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GroupDetails.aspx.vb" Inherits="Pages_MedEcon2_PopUp_GroupDetails" %>
...
<body>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left; width: 830px;">
            ...
            <div style="width: 830px;  overflow: auto;">
                <asp:GridView Width="800px" runat="server" ID="grdGrpCases" DataKeyNames="GROUPID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkGrpId" runat="server" CssClass="Link" Text='<%# bind("CDES1")%>'
                                    OnClick="lnkGrpId_Click"></asp:LinkButton>
                            </ItemTemplate>

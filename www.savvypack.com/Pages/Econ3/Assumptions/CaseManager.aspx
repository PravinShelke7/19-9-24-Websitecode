<%@ Page Title="E3-Case Manager" Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_Econ3_Assumptions_CaseManager" %>
         ...
         <table width="98%" style="text-align:left;">
            <tr style="height:20px;">
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft"> 
                        <a href="../Results/Result1.aspx" class="Link" target="_blank">Dierct Material W/depreciation (Currency)</a>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                       ...
                       <td class="StaticTdLeft"> 
                        <a href="../Results/Result2.aspx" class="Link" target="_blank">Dierct Material W/depreciation (Per Unit Weight)</a>
                    </td>
                </tr>
                <tr class="AlterNateColor1"> 
                    <td class="StaticTdLeft">
                    ...
                    <td class="StaticTdLeft">  
                        <a href="../Results/Result3.aspx" class="Link" target="_blank">Dierct Material W/depreciation (Per Unit)</a>                                              
                    </td>
                </tr>
                <tr class="AlterNateColor2"> 
                    <td class="StaticTdLeft">
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft"> 
                           <a href="../../../Charts/E3Charts/CPrftCost.aspx" class="Link" target="_blank">Graphic Tool</a>

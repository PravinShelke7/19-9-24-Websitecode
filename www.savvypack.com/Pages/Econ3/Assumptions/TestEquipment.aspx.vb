...
Partial Class Pages_Econ3_Assumptions_TestEquipment
...
#End Region
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                Link.CssClass = "Link"
                                GetEquipmentInDetails(Link, hid, CInt(dstbl.Tables(k).Rows(0).Item("ASSETID" + i.ToString() + "").ToString()))
                        ...
                        Case 13
                            ...
                            For k = 0 To DataCnt
                                ...
                                'tdInner.Controls.Add(lbl)
                                GetDeptDetails(Link, hid, dstbl.Tables(k).Rows(0).Item("DEP" + i.ToString() + "").ToString(), arrCaseID(k).ToString())
                                If arrCaseID(k) <= 1000 Then
                                    Link.NavigateUrl = Nothing
                                End If
                                'tdInner.Controls.Add(lbl)
    ...
    Protected Sub GetDeptDetails(ByRef LinkDep As HyperLink, ByVal hid As HiddenField, ByVal ProcId As Integer, ByVal CaseId As String)
        Dim Ds As New DataSet
        Dim ObjGetdata As New E1GetData.Selectdata()
        Dim Path As String = String.Empty
        Try
    ...
    Public Shared Function UpdateCase(ByVal CaseID As String, ByVal index As String, ByVal EQ() As String, ByVal NUM() As String, ByVal COST() As String, ByVal DEP() As String) As Array
        Try
            Dim ObjGetData As New E1GetData.Selectdata()
    ...
    <System.Web.Services.WebMethod()> _
    Public Shared Function UpdateAllCases(ByVal CaseID As String, ByVal index As String, ByVal flag As String, ByVal EQ() As String, ByVal NUM() As String, ByVal COST() As String, ByVal DEP() As String) As Array
        Try

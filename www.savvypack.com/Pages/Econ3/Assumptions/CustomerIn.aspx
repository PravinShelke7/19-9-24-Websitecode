<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="CustomerIn.aspx.vb" Inherits="Pages_Econ3_Assumptions_CustomerIn" title="E3-Customer Assumptions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Econ3ContentPlaceHolder" Runat="Server">
    ...
    <script type="text/javascript">
            ...
            var SessionID="<%=Session("E3SessionID")%>";   
             var CompID="<%=Session("AssumptionID")%>";    
              ...
              for (m = 0; m < countVal; m++) {
                ...
                arrSHIPDIST = document.getElementById("ctl00_Econ3ContentPlaceHolder_SHIPDIST" + eval(index)).value;
                arrMILCOST = document.getElementById("ctl00_Econ3ContentPlaceHolder_MILCOST" + eval(index)).value;
                ...
                //alert('Hi');
                  if (m == 0) 
                  {
                    if(caseId1>1000)
                      {
                       PageMethods.UpdateAllCases(caseId1, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 1) 
                  {
                      if(caseId2>1000)
                      {
                       PageMethods.UpdateAllCases(caseId2, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 2) {
                    if(caseId3>1000)
                      {
                       PageMethods.UpdateAllCases(caseId3, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 3) {
                    if(caseId4>1000)
                      {
                       PageMethods.UpdateAllCases(caseId4, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                   ...
                   if(caseId5>1000)
                      {
                       PageMethods.UpdateAllCases(caseId5, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 5) {
                   if(caseId6>1000)
                      {
                       PageMethods.UpdateAllCases(caseId6, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 6) {
                    if(caseId7>1000)
                      {
                       PageMethods.UpdateAllCases(caseId7, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 7) {
                   if(caseId8>1000)
                      {
                       PageMethods.UpdateAllCases(caseId8, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 8) {
                    if(caseId9>1000)
                      {
                       PageMethods.UpdateAllCases(caseId9, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
                  else if (m == 9) {
                    if(caseId10>1000)
                      {
                       ...
                       PageMethods.UpdateAllCases(caseId10, index, flag,  arrSHIPDIST, arrMILCOST, onSucceedAll, onErrorAll);
                       }
                  }
           ...
           function onSucceedAll(result) 
           {
              ...
              var SHIPDISTN=document.getElementById("ctl00_Econ3ContentPlaceHolder_SHIPDIST" + eval(index)).value;
                      document.getElementById("ctl00_Econ3ContentPlaceHolder_SHIPDIST" + eval(index)).value=addCommas(parseFloat(SHIPDISTN.replace(',','')).toFixed(0));

                      var MILCOSTN=document.getElementById("ctl00_Econ3ContentPlaceHolder_MILCOST" + eval(index)).value;
                      document.getElementById("ctl00_Econ3ContentPlaceHolder_MILCOST"  + eval(index)).value=addCommas(parseFloat(MILCOSTN.replace(',','')).toFixed(3));
...
document.cookie = "W_13=W_13;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2099 20:47:11 UTC;";
      ...
      <script>
          function removeSession() {
              // localStorage.removeItem("A13");
              document.cookie = "U_13=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
          }

          window.setInterval(function () {

//              if (localStorage.getItem("A13") != null) {
//                  localStorage.removeItem("A13");
//                  location.reload();
             ...
             if(checkNumericAll())
           {
            ...
            document.getElementById("ctl00_Econ3ContentPlaceHolder_loading").style.display = 'inline';
             ...
             //alert(index);
              ...
              //alert(document.getElementById("ctl00_Econ3ContentPlaceHolder_SHIPDIST"));
              //alert(document.getElementById("ctl00_Econ3ContentPlaceHolder_MILCOST"));


             PageMethods.UpdateCase(caseId, index, arrSHIPDIST, arrMILCOST, onSucceed, onError);
                  return false;
            }
            else
            {
        ...
        function addCommas(nStr)
{
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Customer Specifications')" onmouseout="UnTip()" >
                  Econ3 - Customer Specifications
                </td>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                           ...
                           <input type="checkbox" id="ctl00_Econ3ContentPlaceHolder_PP" checked="checked"  onclick="showhideALL3('ctl00_Econ3ContentPlaceHolder_PP'); " />Product Purchase
                             <br />
                          <input type="checkbox" id="ctl00_Econ3ContentPlaceHolder_SD" checked="checked"  onclick="showhideALL3('ctl00_Econ3ContentPlaceHolder_SD'); " />Shipping Distance
                             <br />                           
                          <input type="checkbox" id="ctl00_Econ3ContentPlaceHolder_MC" checked="checked"  onclick="showhideALL3('ctl00_Econ3ContentPlaceHolder_MC'); " />Mileage Cost
                             <br />
                         </div>   

...
Imports E3GetData
Imports E3UpInsData
Partial Class Pages_Econ3_Category_ManageCategory
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Dim objGetData As New E3GetData.Selectdata
        Dim objUpdate As New E3UpInsData.UpdateInsert
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            dt = objE3GetData.GetCategoryBySet(ddlCatSet.SelectedValue, "")
    ...
    Protected Sub btnAddCat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddCat.Click
        ...
        Try
            ...
            For i = 0 To txtCatCount.Text - 1
                strCategory(i) = Request.Form("ctl00$Econ3ContentPlaceHolder$CATNAME" + (i + 1).ToString())
                'Checking Duplicate
    ...
    Protected Sub btnAddCategory_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddCategory.Click
        Try
            Response.Redirect("~/Pages/Econ3/Category/AddEditCategory.aspx")
        Catch ex As Exception

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="AddEditCategory.aspx.vb" 
Inherits="Pages_Econ3_Category_AddEditCategory" title="Add/Edit Category Item" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Econ3ContentPlaceHolder" runat="Server">
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width: 840px">
        <tr style="height: 20px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('E3 - Manage Category Items')"
                    onmouseout="UnTip()" style="width: 800px;">
                    Econ3 - Manage Category Items
                </div>
                <div style="text-align:right ">
                   <asp:HyperLink ID="lnkEditCategory" runat="server" Text="Go to Charts" CssClass="Link" style="font-size:13px;"
                                    ...
                                    Font-Bold="true" NavigateUrl="~/Pages/Econ3/Category/ManageCategory.aspx"  ></asp:HyperLink>
                </div>

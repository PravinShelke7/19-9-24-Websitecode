<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false"
    CodeFile="ManageCategory.aspx.vb" Inherits="Pages_Econ3_Category_ManageCategory"
    Title="E3-Manage Category" %>
...

{
   ...
   return IsNumber;
     ...
     function checkDeletedDrop()
    {
      ...
      {       
        var txtCount=document.getElementById("<%=txtCatCount.ClientId%>").value;
        //var PrevCount=document.getElementById("ctl00$Econ3ContentPlaceHolder$hdnPrevCount").value;
      ...
      function CheckCategory()
      {
           ...
           {
             var txtCat=document.getElementById("ctl00_Econ3ContentPlaceHolder_CATNAME"+i).value;
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:820px">
        <tr style="height:10px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('E3 - Manage Category Set')"
                    onmouseout="UnTip()" style="width: 820px;">
                    Econ3 - Manage Category Set
                </div>
                 <div style="text-align:right ">
                   <asp:HyperLink ID="HyperLink1" runat="server" Text="Go to Charts" CssClass="Link" style="font-size:15px;"
                                    Font-Bold="true" NavigateUrl="~/Charts/E3Charts/CPrftCost.aspx"></asp:HyperLink>
                </div>
            </td>
        </tr>
        <tr>

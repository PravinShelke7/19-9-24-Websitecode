...
Partial Class Pages_Econ3_Results_ResultsplDep2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/E3Charts/CPrftCost.aspx?CaseId=" + obj.Encrypt(AssumptionId) + "&PrftCost=" + objCryptoHelper.Encrypt("PRFT") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&IsDep=" + objCryptoHelper.Encrypt("Y") + "&CType=" + objCryptoHelper.Encrypt("PWeight") + "') "
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            For i = 0 To DataCnt
                ...
                ds = objGetData.GetProfitAndLossDetails(arrCaseID(i), True)
                        ...
                        Case 1
                            ...
                            For k = 0 To DataCnt
                                ...
                                If CDbl(dstbl.Tables(k).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                    perwt = CDbl(CDbl(dstbl.Tables(k).Rows(0).Item("PL" + i.ToString() + "").ToString()) * CDbl(dstbl.Tables(k).Rows(0).Item("CURR").ToString())) / CDbl(dstbl.Tables(k).Rows(0).Item("SVOLUME").ToString())

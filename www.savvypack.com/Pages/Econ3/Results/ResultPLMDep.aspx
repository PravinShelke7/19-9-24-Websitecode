<%@ Page AutoEventWireup="false" CodeFile="ResultPLMDep.aspx.vb" Inherits="Pages_Econ3_Results_ResultPLMDep"
    Language="VB" MasterPageFile="~/Masters/Econ3.master" Title="Revenue Price by Weight With Depreciation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Econ3ContentPlaceHolder" Runat="Server">
  ...
  <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Econ3 - Revenue Price by Weight With Depreciation')" onmouseout="UnTip()" >
                  Econ3 - Revenue Price by Weight With Depreciation

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="ResultsCost2.aspx.vb" Inherits="Pages_Econ3_Results_ResultsCost2" title="E3-Manufacturing Cost (Weight)" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script type="text/javascript">
         function removeSession() {
            // localStorage.removeItem("R8");
document.cookie = "W8=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
         }

         window.setInterval(function () {

            // if (localStorage.getItem("R8") != null) {
              //   localStorage.removeItem("R8");
               //  location.reload();
             //}
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Manufacturing Cost (Weight)')" onmouseout="UnTip()" >
                  Econ3 - Manufacturing Cost (Weight) 
                </td>

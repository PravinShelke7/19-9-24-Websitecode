<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="Resultspl2.aspx.vb" Inherits="Pages_Econ3_Results_Resultspl2" title="E3-Profit And Loss(Per Unit Weight)" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	  <script type="text/javascript">
        function removeSession() {
            ...
            document.cookie = "W2=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
        }
...
//                location.reload();
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Profit And Loss (Per Unit Weight)')" onmouseout="UnTip()" >
                  Econ3 - Profit And Loss (Per Unit Weight) 
                </td>

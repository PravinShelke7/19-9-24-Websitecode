<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="ResultsCostD3.aspx.vb" Inherits="Pages_Econ3_Results_ResultsCostD3" title="E3-Manufacturing Cost with Depreciation (Unit)" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Econ3ContentPlaceHolder" Runat="Server">
	...
	<script type="text/javascript">
          function removeSession() {
              ...
              document.cookie = "W_12=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
          }

          window.setInterval(function () {

//              if (localStorage.getItem("R12") != null) {
//                  localStorage.removeItem("R12");
//                  location.reload();
              //              }
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Manufacturing Cost with Depreciation (Unit)')" onmouseout="UnTip()" >
                  Econ3 - Manufacturing Cost with Depreciation (Unit) 
                </td>

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="ResultsCostD2.aspx.vb" Inherits="Pages_Econ3_Results_ResultsCostD2" title="E3-Manufacturing Cost with Depreciation (Weight)" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script type="text/javascript">
         function removeSession() {
             ...
             document.cookie = "W_11=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
         }

         window.setInterval(function () {

//             if (localStorage.getItem("R11") != null) {
//                 localStorage.removeItem("R11");
//                 location.reload();
             //             }
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Manufacturing Cost with Depreciation (Weight)')" onmouseout="UnTip()" >
                  Econ3 - Manufacturing Cost with Depreciation (Weight) 
                </td>

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="Resultspl1.aspx.vb" Inherits="Pages_Econ3_Results_Resultspl1" title="E3-Profit And Loss (Currency)" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script type="text/javascript">
      function removeSession(val1) {
          ...
          document.cookie = "W1=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
      }
...
//              location.reload();
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Profit And Loss (Currency)')" onmouseout="UnTip()" >
                  Econ3 - Profit And Loss (Currency) 
                </td>

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="ResultsplDep1.aspx.vb" Inherits="Pages_Econ3_Results_ResultsplDep1" title="E3-Profit And Loss with Depreciation" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	   <script type="text/javascript">
         function removeSession() {
             ...
             document.cookie = "W4=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
         }

         window.setInterval(function () {

//             if (localStorage.getItem("R4") != null) {
//                 localStorage.removeItem("R4");
//                 location.reload();
             //             }
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Profit And Loss with Depreciation (Currency)')" onmouseout="UnTip()" >
                  Econ3 - Profit And Loss with Depreciation (Currency) 
                </td>

<%@ Page AutoEventWireup="false" CodeFile="ResultsCost1.aspx.vb" Inherits="Pages_Econ3_Results_ResultsCost1"
    Language="VB" MasterPageFile="~/Masters/Econ3.master" Title="E3-Manufacturing Cost (Currency)" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Manufacturing Cost (Currency)')" onmouseout="UnTip()" >
                  Econ3 - Manufacturing Cost (Currency) 
                </td>

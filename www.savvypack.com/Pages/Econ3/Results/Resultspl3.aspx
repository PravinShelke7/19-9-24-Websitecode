<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="Resultspl3.aspx.vb" Inherits="Pages_Econ3_Results_Resultspl3" title="E3-Profit And Loss (Per Unit)" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script type="text/javascript">
        function removeSession() {
            ...
            document.cookie = "W3=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
        }

        window.setInterval(function () {

//            if (localStorage.getItem("R3") != null) {
//                localStorage.removeItem("R3");
//                location.reload();
            //            }
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Profit And Loss (Per Unit)')" onmouseout="UnTip()" >
                  Econ3 - Profit And Loss (Per Unit) 
                </td>

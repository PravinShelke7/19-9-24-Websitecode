...
Partial Class Pages_Econ3_Results_Result3
        ...
        Try
            ...
            For k = 0 To DataCnt
                ...
                For cnt = 0 To 2
                    ...
                    ElseIf cnt = 1 Then
                        Title = "(" + dstbl.Tables(k).Rows(0).Item("TITLE2").ToString() + "/" + dsRestbl.Tables(k).Rows(0).Item("SUNITLBL").ToString() + ")"
                        InnerTdSetting(td, "25%", "Right")
                    Else
                        If dsRestbl.Tables(k).Rows(0).Item("FINVOLMSI").ToString() > 1 Then
                            Title = "(" + dsRestbl.Tables(k).Rows(0).Item("PUN").ToString() + ")"
                        Else
                            Title = "(" + dsRestbl.Tables(k).Rows(0).Item("PUN1").ToString() + ")"
                        End If
                        InnerTdSetting(td, "25%", "Right")
                    End If
                    td.Text = Title
                                    ...
                                    For cnt = 0 To 2
                                        ...
                                        ElseIf cnt = 1 Then
                                            If dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() <> "" Then
                                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() / dsRestbl.Tables(k).Rows(0).Item("SUNITVAL").ToString(), 4)
                                            Else
                                                lbl.Text = "0"
                                            End If
                                            lbl.Width = "100"
                                        ...
                                        Else
                                            If dsRestbl.Tables(k).Rows(0).Item("FINVOLMSI").ToString() > 1 Then
                                                If dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() <> "" Then
                                                    lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() * CDbl(dsRestbl.Tables(k).Rows(0).Item("SUNIT").ToString()) / CDbl(dsRestbl.Tables(k).Rows(0).Item("CURR").ToString()), 4)
                                                Else
                                                    lbl.Text = "0"
                                                End If
                                            Else
                                                If dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() <> "" Then
                                                    lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() * CDbl(dsRestbl.Tables(k).Rows(0).Item("SUNIT1").ToString()) / CDbl(dsRestbl.Tables(k).Rows(0).Item("CURR").ToString()), 4)
                                                Else
                                                    lbl.Text = "0"
                                                End If
                                            End If
                                    ...
                                    For cnt = 0 To 2
                                        ...
                                        ElseIf cnt = 1 Then
                                            If dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() <> "" Then
                                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() / dsRestbl.Tables(k).Rows(0).Item("SUNITVAL").ToString(), 4)
                                            Else
                                                lbl.Text = "0"
                                            End If
                                            lbl.Width = "100"
                                        ...
                                        Else
                                            If dsRestbl.Tables(k).Rows(0).Item("FINVOLMSI").ToString() > 1 Then
                                                If dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() <> "" Then
                                                    lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() * CDbl(dsRestbl.Tables(k).Rows(0).Item("SUNIT").ToString()) / CDbl(dsRestbl.Tables(k).Rows(0).Item("CURR").ToString()), 4)
                                                Else
                                                    lbl.Text = "0"
                                                End If
                                            Else
                                                If dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() <> "" Then
                                                    lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() * CDbl(dsRestbl.Tables(k).Rows(0).Item("SUNIT1").ToString()) / CDbl(dsRestbl.Tables(k).Rows(0).Item("CURR").ToString()), 4)
                                                Else
                                                    lbl.Text = "0"
                                                End If
                                            End If

<%@ Page AutoEventWireup="false" CodeFile="ResultPLMUnitDep.aspx.vb" Inherits="Pages_Econ3_Results_ResultPLMUnitDep"
    Language="VB" MasterPageFile="~/Masters/Econ3.master" Title="Revenue Price by Unit With Depreciation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Econ3ContentPlaceHolder" Runat="Server">
  ...
  <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip(' Econ3 - Revenue Price by Unit With Depreciation')" onmouseout="UnTip()" >
                  Econ3 - Revenue Price by Unit With Depreciation

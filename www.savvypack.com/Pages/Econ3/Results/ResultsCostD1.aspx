<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="ResultsCostD1.aspx.vb" Inherits="Pages_Econ3_Results_ResultsCostD1" title="E3-Manufacturing Cost with Depreciation (Currency)')" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script type="text/javascript">
        function removeSession() {
            ...
            document.cookie = "W_10=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
        }

        window.setInterval(function () {

//            if (localStorage.getItem("R10") != null) {
//                localStorage.removeItem("R10");
//                location.reload();
            //            }
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Manufacturing Cost with Depreciation (Currency)')" onmouseout="UnTip()" >
                  Econ3 - Manufacturing Cost with Depreciation (Currency) 
                </td>

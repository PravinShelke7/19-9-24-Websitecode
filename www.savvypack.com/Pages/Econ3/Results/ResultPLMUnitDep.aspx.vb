...
Partial Class Pages_Econ3_Results_ResultPLMUnitDep
...
#Region "Grid"
    Public Sub GridDet()
        ...
        Try
            ...
            dsEqid = objGetData.GetPackSpecGrpDataUNITMonthlyDep(grpComma, CountArrB, DateCount, Session("USerId"))
    ...
    Private Sub BindGrid()
        Try
            ...
            For Each Gr As GridViewRow In grdMaterials.Rows
                ...
                Gr.Cells(4).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D5").ToString(), 4)
                Gr.Cells(5).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D6").ToString(), 4)

                Gr.Cells(6).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D7").ToString(), 4)
                Gr.Cells(7).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D8").ToString(), 4)
                Gr.Cells(8).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D9").ToString(), 4)
                Gr.Cells(9).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D10").ToString(), 4)
                Gr.Cells(10).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D11").ToString(), 4)
                Gr.Cells(11).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D12").ToString(), 4)
                Gr.Cells(12).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D13").ToString(), 4)
                Gr.Cells(13).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D14").ToString(), 4)
                Gr.Cells(14).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D15").ToString(), 4)
                Gr.Cells(15).Text = FormatNumber(dsEqid.Tables(0).Rows(Gr.RowIndex).Item("D16").ToString(), 4)
                        ...
                        Else
                            For i = 0 To count
                                ...
                                If dstbl.Tables(i).Rows(0).Item("PL" + (l + 1).ToString()).ToString() <> "" Then
                                    tdInner.Text = FormatNumber((CDbl(dstbl.Tables(arrCaseID(i)).Rows(0).Item("PL" + (l + 1).ToString()).ToString()) * CDbl(dstbl.Tables(arrCaseID(i)).Rows(0).Item("CURR").ToString())) / (CDbl(dstbl.Tables(arrCaseID(i)).Rows(0).Item("SUNITVAL").ToString())), 4)
                                End If

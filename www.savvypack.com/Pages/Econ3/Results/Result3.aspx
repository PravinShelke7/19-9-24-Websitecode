<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="Result3.aspx.vb" Inherits="Pages_Econ3_Results_Result3" title="E3-Direct Materials with Depreciation (Per Unit)" %>
...
//              location.reload();
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Direct Materials with Depreciation (Per Unit)')" onmouseout="UnTip()" >
                  Econ3 - Direct Materials with Depreciation (Per Unit) 
                </td>

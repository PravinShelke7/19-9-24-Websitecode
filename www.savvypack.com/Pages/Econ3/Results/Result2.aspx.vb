...
Partial Class Pages_Econ3_Results_Result2
                                    ...
                                    For cnt = 0 To 1
                                        ...
                                        Else
                                            If dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() <> "" Then
                                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODZ" + i.ToString() + "").ToString() / dsRestbl.Tables(k).Rows(0).Item("SVOLUME").ToString(), 3)
                                            Else
                                                lbl.Text = "0"
                                            End If
                                    ...
                                    For cnt = 0 To 1
                                        ...
                                        Else
                                            If dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() <> "" Then
                                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("Col1" + (i - 10).ToString() + "").ToString() / dsRestbl.Tables(k).Rows(0).Item("SVOLUME").ToString(), 3)
                                            Else
                                                lbl.Text = "0"
                                            End If
                                            InnerTdSetting(td, "50%", "Right")

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="ResultsplDep3.aspx.vb" Inherits="Pages_Econ3_Results_ResultsplDep3" title="E3-Profit And Loss with Depreciation (Per Unit)" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script type="text/javascript">
        function removeSession() {
            ...
            document.cookie = "W6=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
        }

        window.setInterval(function () {

//            if (localStorage.getItem("R6") != null) {
//                localStorage.removeItem("R6");
//                location.reload();
            //            }
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Profit And Loss with Depreciation (Per Unit) ')" onmouseout="UnTip()" >
                  Econ3-Profit And Loss with Depreciation (Per Unit) 
                </td>

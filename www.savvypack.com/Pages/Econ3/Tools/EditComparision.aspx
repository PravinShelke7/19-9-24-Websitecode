<%@ Page Title="E3-Edit Comparison" Language="VB" MasterPageFile="~/Masters/Econ3.master"
    AutoEventWireup="false" CodeFile="EditComparision.aspx.vb" Inherits="Pages_Econ3_Tools_EditComparision" %>

<asp:Content ID="Content2" ContentPlaceHolderID="Econ3ContentPlaceHolder" runat="Server">
    ...
    <table width="840px">
        <tr align="left">
            <td style="width: 43%" class="PageHeading" onmouseover="Tip('E3-Edit Comparison')"
                onmouseout="UnTip()">
                Econ3 - Edit Comparison
            </td>
        </tr>
    </table>
    <br />

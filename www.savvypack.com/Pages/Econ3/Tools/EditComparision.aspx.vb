...
Imports E3GetData
Imports E3UpInsData
Partial Class Pages_Econ3_Tools_EditComparision
    ...
    Protected Sub bindDetails()
        Try
            ...
            If Session("SavvyModType") <> "1" Then
                Dts1 = GetData.GetEditCasesE3(Session("USERID").ToString(), AssumptionId, "true", Session("E3LicAdmin"))
                Dts2 = GetData.GetEditCasesE3(Session("USERID").ToString(), AssumptionId, "false", Session("E3LicAdmin"))
            Else

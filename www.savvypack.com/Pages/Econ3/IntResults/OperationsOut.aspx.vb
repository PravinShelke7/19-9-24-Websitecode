...
Partial Class Pages_Econ3_IntResults_OperationsOut
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            For i = 0 To DataCnt
                ...
                ds = objGetData.GetOpreationsOutDetails(arrCaseID(i))
            ...
            For i = 0 To DataCnt
                ...
                If Cunits <> Units Or CCurrTitle <> CurrTitle Then
                    Headertext = "Case#:" + arrCaseID(i).ToString() + " " + dsCaseDetails.Tables(0).Rows(0).Item("COUNTRYDES").ToString() + "<br/>" + dsCaseDetails.Tables(0).Rows(0).Item("CaseDes").ToString() + "<br/> <span  style='color:red'>Unit / Currency Mismatch</span>" + "<input type='hidden' value='" + arrCaseID(i).ToString() + "' name='Case" + i.ToString() + "'/>"
                Else
                    Headertext = "Case#:" + arrCaseID(i).ToString() + " " + dsCaseDetails.Tables(0).Rows(0).Item("COUNTRYDES").ToString() + "<br/>" + dsCaseDetails.Tables(0).Rows(0).Item("CaseDes").ToString() + "<input type='hidden' value='" + arrCaseID(i).ToString() + "' name='Case" + i.ToString() + "'/>"
                End If
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEPTS" + i.ToString())
                        ...
                        Case 3
                            ...
                            LeftTdSetting(tdInner, "Production Volume (Capacity) " + Title + "", trInner, "AlterNateColor2")
                            trInner.ID = "PVC_" + i.ToString()
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PV" + i.ToString() + "").ToString(), 0)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 4
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("FEQV" + i.ToString() + "").ToString(), 0).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 5
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("FV" + i.ToString() + "").ToString(), 0).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 6
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("AD" + i.ToString() + "").ToString(), 1).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("AW" + i.ToString() + "").ToString(), 1).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 8
                            tdInner = New TableCell
                            Title = "(%)"
                            LeftTdSetting(tdInner, "Department Utilization " + Title + "", trInner, "AlterNateColor1")
                            trInner.ID = "DU_" + i.ToString()
                            ...
                            For k = 0 To DataCnt
                                ...
                                If CDbl(dstbl.Tables(k).Rows(0).Item("PV" + i.ToString() + "").ToString()) > 0.0 Then
                                    volPer = (CDbl(dstbl.Tables(k).Rows(0).Item("FV" + i.ToString() + "").ToString()) / CDbl(dstbl.Tables(k).Rows(0).Item("PV" + i.ToString() + "").ToString())) * 100

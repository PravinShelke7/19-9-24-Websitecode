<%@ Page Language="VB" MasterPageFile="~/Masters/Econ3.master" AutoEventWireup="false" CodeFile="PersonnelOut.aspx.vb" Inherits="Pages_Econ3_IntResults_PersonnelOut" title="E3-Personnel Plan ,Payroll, and Department Breakdown" %>
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/tip_balloon.js"></script>
	 <script>
          function removeSession() {
              ...
              document.cookie = "V3=;domain=.savvypack.com;path=/;expires=Fri, 19 Jun 2000 20:47:11 UTC;";
          }
...
//                  location.reload();
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Personnel Plan ,Payroll, and Department Breakdown')" onmouseout="UnTip()" >
                  Econ3 - Personnel Plan ,Payroll, and Department Breakdown
                </td>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent3"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <input type="checkbox" id="ctl00_Econ3ContentPlaceHolder_PD" checked="checked"   onclick="showhideMax('ctl00_Econ3ContentPlaceHolder_PD'); " />Position Description
                             <br />
                          <input type="checkbox" id="ctl00_Econ3ContentPlaceHolder_WK" checked="checked"  onclick="showhideMax('ctl00_Econ3ContentPlaceHolder_WK'); " />Number of Workers
                             <br />                           
                          <input type="checkbox" id="ctl00_Econ3ContentPlaceHolder_PR" checked="checked"  onclick="showhideMax('ctl00_Econ3ContentPlaceHolder_PR'); " />Payroll
                             <br />

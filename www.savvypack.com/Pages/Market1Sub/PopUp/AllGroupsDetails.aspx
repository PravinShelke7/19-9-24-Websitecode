<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllGroupsDetails.aspx.vb" Inherits="Pages_Market1Sub_PopUp_AllGroupsDetails" %>
...
<body style="width: 100%; margin: 0 0 0 0;background-color: #D3E7CB">
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection12" style="width: 100%;text-align: left;">
            ...
            <div style="width:958px; overflow: auto; margin-left:30px;height:450px;">
                <asp:GridView  CssClass="GrdUsers" runat="server" ID="grdGroup" Width="940px" DataKeyNames="GROUPID"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="GROUPNAME" HeaderText="Group Descriptor1" SortExpression="GROUPNAME">
                            <ItemStyle Width="150px" Wrap="true" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="GROUPDES" HeaderText="Group Descriptor2" SortExpression="GROUPDES">
                            <ItemStyle Width="200px" Wrap="true" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="REPORTID" HeaderText="Report(s)" SortExpression="REPORTID">
                            <ItemStyle Width="200px" Wrap="true" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="REPORTID" HeaderStyle-HorizontalAlign="Left" Visible="false"

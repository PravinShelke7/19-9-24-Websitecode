        ...
        Try
            ...
            If dsRp.Tables(0).Rows.Count > 0 Then
                If ddlColType.SelectedItem.Text = "CAGR" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "7", RptID.ToString(), Session("RPTTYPE"), dsRp.Tables(0).Rows(0).Item("RPTTYPEDES").ToString(), "15", "", Session.SessionID)
                Else
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "7", RptID.ToString(), Session("RPTTYPE"), dsRp.Tables(0).Rows(0).Item("RPTTYPEDES").ToString(), "16", colValueId, Session.SessionID)
                End If
            End If

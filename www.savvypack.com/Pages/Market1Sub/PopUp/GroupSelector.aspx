<%@ Page Title="Group Selector" Language="VB" MasterPageFile="~/Masters/M1PopUp.master"
    AutoEventWireup="false" CodeFile="GroupSelector.aspx.vb" Inherits="Pages_Market1_PopUp_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left">
            ...
            <asp:TreeView ID="grpTree" runat="server" ShowExpandCollapse="true" Font-Size="14px"
                ShowLines="true" ForeColor="Black" BorderWidth="1px">
            </asp:TreeView>
            <asp:Label ID="lblGrp" runat="server" Text="No Groups" Visible="false" Font-Bold="true"
                Font-Size="Medium" Style="text-align: center;"></asp:Label>
        </div>
    </div>

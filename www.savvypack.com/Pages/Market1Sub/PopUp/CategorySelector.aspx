<%@ Page Title="Category Selector" Language="VB" MasterPageFile="~/Masters/M1PopUp.master" AutoEventWireup="false" CodeFile="CategorySelector.aspx.vb" Inherits="Pages_Market1_PopUp_CategorySelector" %>
...
//alert(hidCatId);
 ...
 <div id="ContentPagemargin" style="width:100%;margin:0 0 0 0">
       <div id="PageSection1" style="text-align:left">
        ...
        <asp:TreeView ID="prdTree" runat="server" ShowExpandCollapse="true" Font-Size="14px" ShowLines="true" ForeColor="Black"   BorderWidth="1px"   >
                   </asp:TreeView>
        </div>
        </div>

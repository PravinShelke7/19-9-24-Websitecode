<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GroupDetails.aspx.vb" Inherits="Pages_Market1Sub_PopUp_GroupDetails" %>
...
<div style="height:10px; width:650px" ></div>
           ...
           <asp:GridView Width="800px" runat="server" ID="grdGrpReports" DataKeyNames="GROUPID" AutoGenerateSelectButton="false"
                    AllowPaging="false" AllowSorting="true" AutoGenerateColumns="False" 
                    CellPadding="4" ForeColor="#333333" GridLines="None">
                    <FooterStyle BackColor="#32659A" Font-Bold="True" ForeColor="White" />
                    <RowStyle CssClass="AlterNateColor1" />
                    <AlternatingRowStyle CssClass="AlterNateColor2" />
                    <HeaderStyle Height="25px" BackColor="#6B696B"  Font-Bold="True" Font-Size="12px" ForeColor="White" />
                    ...
                    <Columns>
                        <asp:BoundField DataField="GROUPID" HeaderText="GROUPID" SortExpression="GROUPID" Visible="false">  
                           ...
                           <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME" Visible="true" 
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkGrpId" runat="server" Width="140px"

<%@ Page Language="VB" MasterPageFile="~/Masters/M1PopUp.master" AutoEventWireup="false"
    CodeFile="FilterSelector.aspx.vb" Inherits="Pages_Market1_PopUp_FilterSelector"
    Title="M1 Subscription-Filter Selector" %>
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <table style="width: 500px">
                ...
                <tr id="rwFilterValue" runat="server" visible="false">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlFilterValue" runat="server" CssClass="Smalldropdown">
                        </asp:DropDownList>
                        <asp:LinkButton ID="lnkProductTree" Style="font-size: 14px" runat="server" CssClass="Link"
                            Width="180px" OnClientClick="return ShowPopup('CategorySelector.aspx?Des=ctl00_ContentPlaceHolder1_lnkProductTree&Id=ctl00_ContentPlaceHolder1_hidCatID&CatDes=ctl00_ContentPlaceHolder1_hidCatDes1');">Select Cateogry</asp:LinkButton>
                    </td>
                </tr>
            </table>
            <table style="width: 500px">

...
Partial Class Pages_Market1Sub_PopUp_PivotFilter
  ...
  Session("GrpRptId") = Request.QueryString("RptID").ToString()
    ...
    Protected Sub btnSumitt_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSumitt.Click
        ...
        Try
            ...
            If hidValue <> 0 Then
                ...
                If ddlFilterType.SelectedItem.Text = "Region" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "8", filterValueID, Session.SessionID)
                ElseIf ddlFilterType.SelectedItem.Text = "Country" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "9", filterValueID, Session.SessionID)
                ElseIf ddlFilterType.SelectedItem.Text = "Product" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "6", filterValueID, Session.SessionID)
                ElseIf ddlFilterType.SelectedItem.Text = "Package" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "7", filterValueID, Session.SessionID)
                ElseIf ddlFilterType.SelectedItem.Text = "Group" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "11", filterValueID, Session.SessionID)
                ElseIf ddlFilterType.SelectedItem.Text = "Material" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "10", filterValueID, Session.SessionID)
                ElseIf ddlFilterType.SelectedItem.Text = "Component" Then
                    objUpIns.InsertLog(Session("UserId"), Session("MLogInLog"), "9", RptID.ToString(), "Pivot", dsRep.Tables(0).Rows(0)("RPTTYPEDES").ToString(), "12", filterValueID, Session.SessionID)
                End If
    ...
    Protected Sub getFilterSelector()
        ...
        Try
            dsRpt = objGetDate.GetPivotReportFiltersByRepId(Request.QueryString("RptID").ToString(), Request.QueryString("Seq").ToString())
            'dsRow = objGetDate.GetUsersReportRows(Request.QueryString("RptID").ToString())
            ds = objGetDate.GetFilterSelector(dsRpt.Tables(0).Rows(0).Item("FILTERTYPEID").ToString())
            ...
            End With
            hidCatID.Value = "0"
            If dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Region" Then  'For Region
                GetRegionSet()
            ...
            ElseIf dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Category" Or dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Group" Then 'for Category and Group
            ...
            ElseIf dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Package" Then  'For Package
                GetPackageValue(Request.QueryString("RptID").ToString())
            ElseIf dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Material" Then ' For Material
                GetMaterialValue(Request.QueryString("RptID").ToString())
            ElseIf dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Product" Then ' For Product
                GetProductValue(Request.QueryString("RptID").ToString())
            ElseIf dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "MaterialGrp" Then
                GetMaterialGroupValue(Request.QueryString("RptID").ToString())
            ElseIf dsRpt.Tables(0).Rows(0).Item("FILTERTYPE").ToString() = "Component" Then
                GetComponentValue(Request.QueryString("RptID").ToString())

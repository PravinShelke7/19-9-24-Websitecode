<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetMatPopUp.aspx.vb" Inherits="Pages_SavvyPackPro_Popup_GetMatPopUp" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Get Materials</title>
    ...
    <script type="text/JavaScript">
        ...
        function MaterialDetail(Category, MatId, Material, Mouseover, Bmat, Density) {
         
            var hidMatdes = document.getElementById('<%= hidMatdes.ClientID%>').value;
            var hidMatId = document.getElementById('<%= hidMatId.ClientID%>').value;
            var hidDensityInnerText = document.getElementById('<%= hidDensityInnerText.ClientID%>').value;   
            var hidDensity = document.getElementById('<%= hidDensity.ClientID%>').value;   
            var j;
            var i = hidMatId;
            i = i.match(/\d+$/)[0];
            ...
            if ((Bmat == "Blend1") || (Bmat == "Blend2") || (Bmat == "Blend3") || (Bmat == "Blend4") || (Bmat == "Blend5")) {
                alert("This material's work is in under process.")
            }
                //For Other materials
            else {
                ...
                window.opener.document.getElementById(hidDensityInnerText).innerHTML = Density;
                window.opener.document.getElementById(hidDensity).value = Density;
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="ContentPagemargin" style="width: 1246px; margin: 0 0 0 0">
            <div id="PageSection1" style="text-align: left; margin-left: 2px; margin-right: 2px; margin-bottom: 7px;">
                ...
                <div id="Materials" runat="Server" style="width: 1240px; height: 550px; overflow: auto; margin-right: 10px">
                    <asp:GridView Width="1200px" runat="server" ID="grdMaterials" DataKeyNames="MATID"
                        ...
                        <Columns>
                            <asp:BoundField DataField="MATID" HeaderText="MATID" SortExpression="MATID" Visible="false"></asp:BoundField>
            ...
            <asp:HiddenField ID="hidDensityInnerText" runat="server" />
            <asp:HiddenField ID="hidDensity" runat="server" />
        </div>

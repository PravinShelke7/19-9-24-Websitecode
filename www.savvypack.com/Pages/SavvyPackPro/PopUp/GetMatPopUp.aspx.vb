...
Partial Class Pages_SavvyPackPro_Popup_GetMatPopUp
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        Try
            ...
            hidDensityInnerText.Value = Request.QueryString("Density").ToString()
            hidDensity.Value = Request.QueryString("HidDen").ToString()
                    ...
                    If i < ds.Tables(0).Rows.Count Then
                        Select Case j
                            Case 1
                                ...
                                Link.NavigateUrl = "GetMatPopUp.aspx?Des=" + hidMatdes.Value + "&Id=" + hidMatid.Value + "&GradeDes=" + hidGradedes.Value + "&GradeId=" + hidGradeid.Value + "&SG=" + hidSG.Value + "&MatDes=" + hidMatD.Value + " &Grp=" + Link.Text + "&LinkId=" + Link.ID + "&Flag=Y&Density=" + hidDensityInnerText.Value + "&HidDen=" + hidDensity.Value + ""
                                i = i + 1
            ...
            If e.Row.RowType = DataControlRowType.DataRow Then
                If ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() <> "0" Then
                    ...
                    If (hidMatGrp.Value).ToUpper() = "RESIN" Then
                        ...
                        End If
                        'No density
                        DsMatDensity = objGetDataSPP.GetMatSGByMatID(ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString())
                        If DsMatDensity.Tables(0).Rows.Count > 0 Then
                            DensityM = DsMatDensity.Tables(0).Rows(0).Item("SG").ToString()
                        Else
                            DensityM = "0"
                        End If
                        'End
                        btn.Attributes("onclick") = "javascript:return MaterialDetail('" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "'," + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() + ",'" + GradeValue + "','" + MouseoverValue + "','" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDE2").ToString() + "','" + DensityM + "')"
                    ...
                    Else
                        ...
                        End If
                        'No density
                        'If ds.Tables(0).Columns.Contains("Density") Then
                        '    DensityM = ds.Tables(0).Rows(e.Row.RowIndex).Item("DENSITY").ToString()
                        'Else
                        '    DensityM = "0"
                        'End If
                        DsMatDensity = objGetDataSPP.GetMatSGByMatID(ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString())
                ...
                Else
                    Dim btn As LinkButton = DirectCast(e.Row.FindControl("lnkBtnval"), LinkButton)
                    btn.Attributes("onclick") = "javascript:return MaterialDetail('" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "'," + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() + ",'','','" + "','" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDE2").ToString() + "',0)"
                End If
            End If
        End If

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetSelectGroup.aspx.vb" Inherits="Pages_SavvyPackPro_PopUp_GetSelectGroup" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME" Visible="true"
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblPermsnID" runat="server" Visible="false" Text='<%# Bind("PERMISSIONID")%>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:BoundField DataField="SpecID" HeaderText="Spec(s)" SortExpression="SpecID">
                                <ItemStyle Width="250px" Wrap="true" HorizontalAlign="Left" CssClass="NormalLabel" />
                                <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>

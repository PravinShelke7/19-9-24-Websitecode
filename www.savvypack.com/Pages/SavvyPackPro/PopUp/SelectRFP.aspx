<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelectRFP.aspx.vb" Inherits="Pages_SavvyPackPro_PopUp_SelectRFP" %>
    ...
    <form id="form1" runat="server" defaultbutton="btnSearch">
        <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0;">
            <div id="PageSection1" style="text-align: left">
                ...
                <div style="width: 820px; height: 300px; overflow: auto; margin-left: 10px;">
                    <asp:Label ID="lblNRF" runat="server" Text="No Record Found." Visible="false"></asp:Label>
                    <asp:GridView Width="800px" CssClass="grdProject" runat="server" ID="grdRfpDetails"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Name" SortExpression="DES1">
                                <ItemTemplate>
                                    <a href="#" onclick="RFPSearch('<%#Container.DataItem("ID")%>','<%#Container.DataItem("RFPDESPOS")%>')"
                                        class="SavvyLink">

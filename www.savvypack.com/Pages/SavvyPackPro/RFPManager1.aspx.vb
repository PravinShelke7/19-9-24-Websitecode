...
Imports System.Net
Partial Class Pages_SavvyPackPro_RFPManager1
...
#Region "RFP"
    ...
    '    Try
    '        objUpIns.AddRfp(txtRFPNm.Text.Trim().Replace("'", "''").ToString(), txtRfpDes.Text.Trim().Replace("'", "''").ToString(), Session("UserId"))
    '        Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinRename", "alert('RFP created successfully');", True)
    '        txtRFPNm.Text = ""
    '        txtRfpDes.Text = ""
...
#Region "Vendor Config"
    ...
    Protected Sub GetUsersList()
        ...
        Try
            Ds = objGetdata.GetUserList(txtKey.Text.Trim.ToString())
...
#End Region
    ...
    '    Try
    '        DsExistusr = objGetdata.GetLinkedVendor(Session("USERID"))
    ...
    '                If lblUserID.Text = DsExistusr.Tables(0).Rows(i).Item("USERID").ToString() Then
    '                    check.Checked = True
    '                End If
    '            Next
    '        Next

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SupplierPrice_Analysis.aspx.vb" Inherits="Pages_SavvyPackPro_SupplierPrice_Analysis" %>
        ...
        <div id="divCreate" style="margin-top: 0px; margin-left: 2px;" runat="server" visible="true">
            <table style="width: 848px">
                <tr class="AlterNateColor4">
                    <td class="PageSHeading" style="font-size: 14px;" colspan="2">Price Details
                    </td>
                </tr>
                <tr class="AlterNateColor1" id="Tr1" runat="server" visible="true">
                    <td align="right" class="style1" style="width: 100px; font-weight: bold;">Price name: 
                    </td>
                    <td class="style2">

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ConfigureRFP_Supplier.aspx.vb"
    Inherits="Pages_SavvyPackPro_ConfigureRFP_Supplier" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upd1" runat="server">
            <ContentTemplate>
                ...
                <table style="width: 1100px; overflow: auto; font-family: Verdana; font-size: 14px;">
                    <tr class="AlterNateColor2">
                        <td style="padding-left: 10px; padding-top: 15px;">
                            <ajaxToolkit:TabContainer ID="tabRfpSManager" Height="550px" runat="server" ActiveTabIndex="1"
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlPrice" runat="server">
                                            <table class="ContentPage" style="margin-top: 15px; overflow: auto; width: 1012px; height: 500px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="btnUpdatePrice" runat="server" Text="Update" CssClass="ButtonWMarigin" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                ...
                                <ajaxToolkit:TabPanel runat="server" HeaderText="Price & Cost" ToolTip="Price & Cost" TabIndex="3"
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlSMPC1" runat="server">
                                            <table class="ContentPage" runat="server" style="margin-top: 15px; overflow: auto; width: 1012px; height: 500px;">
                                                <tr>
                                                    <td>
                                                        <div style="overflow: auto; height: 430px;">
                                    ...
                                    <ContentTemplate>
                                        <asp:Panel ID="PnlOp" runat="server">
                                            <table class="ContentPage" style="margin-top: 15px; overflow: auto; width: 1012px; height: 500px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Button ID="BtnUpdate1" runat="server" Text="Update" CssClass="ButtonWMarigin" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </asp:Panel>
                                ...
                                <ajaxToolkit:TabPanel runat="server" HeaderText="Investment Manager" Visible="false" ToolTip="Investment Manager" TabIndex="6"
                                    ID="tabBagmaking">
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlBagMaking" runat="server">
                                            <table class="ContentPage" id="tblBagMaking" runat="server" style="margin-top: 15px; overflow: auto; width: 1012px; height: 50px;">
                                                <tr>
                                                    <td>
                                                        <div class="PageHeading" id="div6" runat="server" style="text-align: center;">
                                                            Investment Manager
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <asp:Button ID="btnUpdateBM" runat="server" Text="Update" /></td>
                                                </tr>
                                ...
                                <ajaxToolkit:TabPanel runat="server" HeaderText="Structure" ToolTip="Structure" ID="tabStruct" TabIndex="7">
                                    <ContentTemplate>
                                        <asp:Panel ID="pnlStruct" runat="server">
                                            <table class="ContentPage" style="overflow: auto; width: 1012px; height: 500px;">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="overflow: auto; height: 430px;">
                                                            <asp:Label ID="lblNoStructData" runat="server" Text="No Record Found" Visible="false"
                                                                CssClass="Error"></asp:Label>

            ...
            <table style="width: 1110px;">
                <tr class="AlterNateColor2">
                    <td style="padding-left: 10px; padding-top: 15px;">
                        <ajaxToolkit:TabContainer ID="tabIssueRFP" Height="550px" Width="1090px" runat="server" ActiveTabIndex="0"
                            AutoPostBack="true" Enabled="false">
                            <ajaxToolkit:TabPanel runat="server" HeaderText="Issue RFP" ToolTip="Issue RFP" ID="tabValidate">
                                <ContentTemplate>
                                                    ...
                                                    <div id="ContentPagemargin" style="overflow: auto; height: 410px;" runat="server">
                                                        <asp:Label ID="lblNOVendor" runat="server" CssClass="NormalLabel" Visible="False"
                                                            Text="No record found."></asp:Label>
                                                             <asp:Label ID="lblDesc" runat="server" CssClass="CalculatedFeilds" Visible="False" Font-Bold="True"
                                                            Text="Submit the RFP to following vendors." Height ="30px"></asp:Label>

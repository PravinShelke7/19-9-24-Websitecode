<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BuyerUserProfile.aspx.vb"
    Inherits="Pages_SavvyPackPro_BuyerUserProfile" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Buyers User Profile</title>
...
<body>
    ...
    <ajaxToolkit:TabContainer ID="tabBuyerManager" Height="560px" runat="server" ActiveTabIndex="0"
        Width="1020px" AutoPostBack="true">
                                        ...
                                        <table width="98%" style="text-align: left;">
                                            <tr class="AlterNateColor1">
                                                ...
                                                <td style="width:2137px;">
                                                    <asp:Label ID="lblFname" runat="server"  Font-Size="12px" Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                                <td >
                                               ...
                                               <td style="width:2137px;">
                                                    <asp:Label ID="lblLname" runat="server" class="Link"  Font-Size="12px"
                                            ...
                                            <tr class="AlterNateColor1">
                                                ...
                                                <td style="width:2137px;">
                                                    <asp:Label ID="lblEAdrs" runat="server" class="Link"  Font-Size="12px"
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                               ...
                                               <td style="width:2137px;">
                                                    <asp:Label ID="lblPN" runat="server" class="Link"  Font-Size="12px"
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                                ...
                                                <td style="width:2137px;">
                                                    <asp:Label ID="lblMN" runat="server" class="Link" Font-Size="12px"
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                              ...
                                              <td style="width:2137px;">
                                                    <asp:Label ID="lblSaddr" runat="server" class="Link" Font-Size="12px" 
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                               ...
                                               <td style="width:2137px;">
                                                    <asp:Label ID="lblCtry" runat="server" class="Link" Font-Size="12px" 
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                               ...
                                               <td style="width:2137px;">
                                                    <asp:Label ID="lblS" runat="server" class="Link" Font-Size="12px" 
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                               ...
                                               <td style="width:2137px;">
                                                    <asp:Label ID="lblC" runat="server" class="Link" Font-Size="12px" 
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr class="AlterNateColor1">
                                               ...
                                               <td style="width:2137px;">
                                                    <asp:Label ID="lblZC" runat="server" class="Link" Font-Size="12px" 
                                                        Style="margin-left: 5px;"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
        ...
        <ajaxToolkit:TabPanel runat="server" HeaderText="Transferring Ownership" ToolTip="Transferring Ownership"
            ID="tabtabTOwnership">
            <ContentTemplate>
                <asp:Panel ID="tabTOwnership" runat="server">
                    <table class="ContentPage" id="tblTO" runat="server" style="margin-top: 15px; width: 980px;">
                        <tr runat="server">
                            <td runat="server">
                        ...
                        <tr runat="server" class="AlterNateColor3">
                            <td runat="server" align="center" class="PageSHeading">

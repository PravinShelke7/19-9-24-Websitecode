<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CreatePrice.aspx.vb" Inherits="Pages_SavvyPackPro_CreatePrice" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="divPriceTool" style="margin-top: 0px; margin-left: 2px;" runat="server" visible="true">
            <table style="width: 1200px">
                <tr class="AlterNateColor4">
                    <td class="PageSHeading" style="font-size: 14px;" colspan="2">Price Tool
                    </td>
                </tr>
        ...
        <div id="divCreate" style="margin-top: 0px; margin-left: 2px;" runat="server" visible="false">
            <table style="width: 1200px">
                <tr class="AlterNateColor4">
                    <td class="PageSHeading" style="font-size: 14px;" colspan="2">Create Own Price
                    </td>
                </tr>
                <tr class="AlterNateColor1" id="Tr1" runat="server" visible="true">
                    <td align="right" style="width: 150px;">Price name:
                    </td>
                    <td>
                        <asp:TextBox ID="txtPriceName" runat="server" Width="200px" CssClass="SmallTextBox" Style="text-align: left;"
                            MaxLength="50" AutoPostBack="false"></asp:TextBox>

                    </td>
                </tr>
                <tr class="AlterNateColor1" id="rowRows" runat="server" visible="true">
                    <td align="right" style="width: 150px;">No.of Columns:
                    </td>
                    <td>
                        <asp:TextBox ID="txtRw" runat="server" value="0" CssClass="SmallTextBox" Style="text-align: left;"
                            MaxLength="5" AutoPostBack="false"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="reqtxtRw" runat="server" ControlToValidate="txtRw"
                            ErrorMessage="*"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr class="AlterNateColor5" style="display: none;">
                    <td colspan="2">
                        <asp:Table ID="tblCAGR" runat="server" CellPadding="0" CellSpacing="1" Style="margin-left: 50px;">
                        </asp:Table>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    ...
                    <td>
                        ...
                        <asp:Button ID="btnSAVE" runat="server" Text="Save" CssClass="ButtonWMarigin" />
                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="ButtonWMarigin" />
                    </td>
                </tr>

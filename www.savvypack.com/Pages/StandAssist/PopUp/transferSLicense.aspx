<%@ Page Language="VB" AutoEventWireup="false" CodeFile="transferSLicense.aspx.vb"
    Inherits="Popup_transferSLicense" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function cmessageORG() {
            var msg = "You are going to transfer Structure Assistant service to this User. Do you want to proceed?"
            if (confirm(msg)) {
                return true;
            }
            else {
        ...
        function cmessage() {
            ...
            if (licAdm == "Y") {
                alert("You can not transfer Structure Assistant privileges from License Administrator user. Please select different User.");
                return false;
            }
            else {
                ...
                if (confirm('You are going to transfer Structure Assistant privileges from user ' + FromUser + ' to user ' + Tosuer + '. Only one transfer is allowed per license per year. Do you want to proceed?')) {
                ...
                <div id="msg1" runat="server">
                    <table cellpadding="4" cellspacing="2">
                        <tr class="AlterNateColor4">
                            <td style="font-size: 14px; font-family: Verdana; padding-left: 120px; font-weight: bold;"
                                colspan="2">
                                Transfer License
                            </td>
                        </tr>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AllGroupsDetails.aspx.vb"
    Inherits="Pages_StandAssist_PopUp_AllGroupsDetails" %>
        ...
        <div id="PageSection12" style="width: 100%; text-align: left;">
            ...
            <div style="width: 100%; text-align: center;">
                <asp:Label ID="lblmsg" runat="server" Visible="false" Width="700px" Style="text-align: cente;
                    font-size: 16px; font-weight: bold; color: Red;"> </asp:Label></div>
            <div style="width: 990px; overflow: auto;">
                <asp:GridView CssClass="GrdUsers" runat="server" ID="grdGroup" Width="940px" DataKeyNames="GROUPID"
                    AllowPaging="false" AllowSorting="false" AutoGenerateColumns="False" CellPadding="4"
                    Font-Size="11px" ForeColor="#333333" GridLines="None" CellSpacing="1">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CASEID" HeaderText="Structure(s)" SortExpression="CASEID">
                            <ItemStyle Width="200px" Wrap="true" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>

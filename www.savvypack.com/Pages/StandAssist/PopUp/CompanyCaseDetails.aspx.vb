...
Imports System.Math
Partial Class Pages_StandAssist_PopUp_CompanyCaseDetails
            ...
            If Not IsPostBack Then
                ...
                Try
                   ...
                   If Request.QueryString("Type").ToString() = "CPROP" Then
                        objUpIns.InsertLog1(Session("UserId").ToString(), "26", "Opened Company Structure(s) PopUp", "", Session("LogInCount").ToString(), Session.SessionID, "", "", "", "", GroupVal)
                    Else
                        objUpIns.InsertLog1(Session("UserId").ToString(), "26", "Opened Company Structure(s) PopUp", "", Session("LogInCount").ToString(), Session.SessionID, "", "", "", "", GroupVal)
                    End If
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            If Request.QueryString("TYPE").ToString() = "CPROP" Then
                If Request.QueryString("GrpID").ToString() = "0" Then
                    ds = objGetData.GetCompCaseByLic(Session("USERID"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), Session("SBALicenseId"))
                Else
                    ds = objGetData.GetCompCaseDetailsByGroupLic(txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), Request.QueryString("GrpID").ToString())
                End If
            ElseIf Request.QueryString("TYPE").ToString() = "BCPROP" Then
                If Request.QueryString("GrpID").ToString() = "0" Then
                    ds = objGetData.GetCompAllUserPropCaseByLic(txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), Session("SBALicenseId"))
                End If
            End If
    ...
    Protected Sub gvDocuments_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles grdCaseSearch.RowDataBound
        ...
        If Request.QueryString("Type").ToString() = "CPROP" Then
            If (e.Row.RowType = DataControlRowType.DataRow) Then
                ...
                If (e.Row.RowIndex = 0) Then
                    ...
                    e.Row.Style.Add("vertical-align", "middle")
        ...
        ElseIf Request.QueryString("Type").ToString() = "COMP" Then
            e.Row.Cells(5).Visible = False
            e.Row.Cells(6).Visible = False
            e.Row.Cells(7).Visible = False
        End If

        If Request.QueryString("Type").ToString() = "BCPROP" Then
            ...
            grdCaseSearch.Columns(4).HeaderStyle.Width = 210
            grdCaseSearch.Columns(6).HeaderStyle.Width = 165
            grdCaseSearch.Columns(7).HeaderStyle.Width = 145
            ...
            grdCaseSearch.Columns(7).ItemStyle.Width = 150
        ...
        Else
            ...
            grdCaseSearch.Columns(4).ItemStyle.Width = 200
            grdCaseSearch.Columns(6).HeaderStyle.Width = 200
            grdCaseSearch.Columns(6).ItemStyle.Width = 300
        End If
        ...
        Try
            ...
            Try
                ...
                Else
                    GroupVal = Request.QueryString("GrpID").ToString()
                End If
                objUpIns.InsertLog1(Session("UserId").ToString(), "26", "Clicked on Button Search, Searched Text: " + txtCaseDe1.Text + " ", "", Session("LogInCount").ToString(), Session.SessionID, "", "", "", "", GroupVal)
            Catch ex As Exception
        ...
        Try
            ...
            Try
                ...
                Else
                    GroupVal = Request.QueryString("GrpID").ToString()
                End If
                objUpIns.InsertLog1(Session("UserId").ToString(), "26", "Clicked on Sort, Sorted by: " + e.SortExpression + " ", "", Session("LogInCount").ToString(), Session.SessionID, "", "", "", "", GroupVal)
            Catch ex As Exception
        ...
        Try
            ...
            Try
                ...
                Else
                    GroupVal = Request.QueryString("GrpID").ToString()
                End If
                objUpIns.InsertLog1(Session("UserId").ToString(), "26", "Selected Structure #" + hidCase.Value, hidCase.Value, Session("LogInCount").ToString(), Session.SessionID, "", "", "", "", GroupVal)
            Catch ex As Exception

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CaseDetails.aspx.vb" Inherits="Pages_StandAssist_PopUp_CaseDetails" %>
        ...
        <div id="PageSection1" style="text-align: left;margin-left:3px;margin-right:3px;margin-bottom:7px;">
            ...
            <td>
             <asp:Label ID="lblPcase" runat="server" CssClass="CalculatedFeilds" Visible="true" style="font-size:16px;color:Red;"
              Text="Currently you have no Proprietary Structures defined. You can create a Structure through Manage Structures."></asp:Label>
            </td>
            </tr>
            </table>
             <div id="container" style="width:1140px; height:485px; overflow: auto;">
        
                <asp:GridView runat="server" ID="grdCaseSearch" DataKeyNames="CaseId" Width="1110px" 
                    AutoGenerateSelectButton="false" AllowPaging="false" AllowSorting="true" AutoGenerateColumns="False" style="margin-left:5px;" 
                    ShowHeader="true" CellPadding="0" CellSpacing="2" ForeColor="#333333" GridLines="None" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Sponsor Message"  Visible="true">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkFileName" runat="server" CssClass="Link" CausesValidation="false" CommandArgument = '<%#Eval("FILENAME")%>' OnClick="OpenPDF">Click Here</asp:LinkButton>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" CssClass="ALNITEM"  />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>

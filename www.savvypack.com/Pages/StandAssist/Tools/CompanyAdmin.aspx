<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CompanyAdmin.aspx.vb" Inherits="Pages_StandAssist_Tools_CompanyAdmin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Company Admin Tools</title>
    ...
    <script type="text/javascript">
        ...
        function CheckSP(text) {
            ...
            var a = /\<|\>|\&#|\\/;
            if ((document.getElementById("txtCompDes1").value.match(a) != null) || (document.getElementById("txtCompDes2").value.match(a) != null) || (document.getElementById("txtCompDes3").value.match(a) != null) || (document.getElementById("txtApp").value.match(a) != null)) {
                var object = document.getElementById(text.id)  //get your object
                ...
                else if (text.id == "txtCompDes3") {
                    alert("You cannot use the following COMBINATIONS of characters:< > \\  &# in Technical Description. Please choose alternative characters.");
                }
        ...
        function Message(Case, Flag) {
            ...
            if (Flag == 'UC') {
                ...
                if (document.getElementById("txtCompDes1").value.split(' ').join('').length == 0) {
                    ...
                    msg = "You are going to update description for Structure " + Case1.value + ". Do you want to proceed?"
    ...
    <center>
        ...
        <table class="ContentPage" id="ContentPage" runat="server" style="width: 845px">
            <tr style="height: 20px">
                <td>
                    <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Company Administration Tools')"
                    ...
                    <div id="ContentPagemargin" runat="server">
                        <div id="PageSection1" style="text-align: left">
                            ...
                            <table width="820px">
                                <tr class="AlterNateColor4">
                                    <td class="PageSHeading" style="font-size: 14px;">
                                        Proprietary Company Structures
                                    </td>
                                </tr>
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:LinkButton ID="lnkBaseCase" Style="font-size: 14px; padding-left: 10px" runat="server"
                                            CssClass="Link" Width="500px" OnClientClick="return ShowPopup('../PopUp/CompanyCaseDetails.aspx?Des=lnkBaseCase&Id=hidBaseCase&IdD=hidBaseCaseD&SponsBy=hidSpons&Type=BCPROP&GrpId=0&CaseId=0');">Select Structure</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr class="AlterNateColor1" style="height: 30px">
                                    <td>
                            ...
                            <div style="display: none; margin-top: 40px;" id="divCopy" runat="server">
                                <table width="820px">
                                    <tr class="AlterNateColor4">
                                        <td class="PageSHeading" style="font-size: 14px;">
                                            Target Proprietary Company Structure
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:LinkButton ID="lnkTransferCase" Style="font-size: 14px; padding-left: 10px"
                                                runat="server" CssClass="Link" Width="500px" OnClientClick="return ShowPopup('../PopUp/CompanyCaseDetails.aspx?Des=lnkTransferCase&Id=hidTransferCase&IdD=hidTransferCaseD&SponsBy=hidSpons&Type=CPROP&GrpId=0');">Select Structure</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:Button ID="btnPS2T" runat="server" Text="Transfer" CssClass="ButtonWMarigin"
                                                OnClientClick="return CaseCopyCheck('hidBaseCase','hidTransferCase');" onmouseover="Tip('Transfer On Target')"
                                                onmouseout="UnTip()" />
                                    ...
                                    <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCompDes3" runat="server" CssClass="MediumTextBox" Style="text-align: left;"
                                                TextMode="MultiLine" Height="100px" Width="489px" onKeyUp="javascript:Count(this);"

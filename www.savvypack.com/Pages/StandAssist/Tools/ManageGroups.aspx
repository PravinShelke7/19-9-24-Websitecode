<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageGroups.aspx.vb" Inherits="Pages_StandAssist_Tools_ManageGroups" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        {
            var a = /\<|\>|\&#|\\/;
            if ((document.getElementById("txtGDES1").value.match(a) != null) || (document.getElementById("txtGDES2").value.match(a) != null) || (document.getElementById("txtGAPP").value.match(a) != null)) 
            {
                var object = document.getElementById(text.id)  //get your object
                if (text.id=="txtGDES1")
	            {
    ...
    <div id="MasterContent">
        ...
        <div>
            <table class="SBAModule" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                <tr>
                    <td style="padding-left: 790px;vertical-align:middle;margin-top:23px;">
                                        ...
                                        <asp:GridView Width="1190px" CssClass="GrdUsers" runat="server" ID="grdCase" DataKeyNames="GROUPID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="GROUP APPLICATION" HeaderStyle-HorizontalAlign="Left"
                                                    Visible="true" SortExpression="APPLICATION">
                                                    <ItemTemplate>

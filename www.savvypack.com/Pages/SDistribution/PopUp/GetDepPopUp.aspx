<%@ Page Language="VB" MasterPageFile="~/Masters/SDistPopUp.master" AutoEventWireup="false" CodeFile="GetDepPopUp.aspx.vb" Inherits="Pages_SDistribution_PopUp_GetDepPopUp" title="SDist-Get Department" %>
             ...
             <table cellpadding="0" cellspacing="2">
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          <asp:TextBox ID="txtDepDe2" runat="server" CssClass="SearchTextBox"  Width="200px" Visible="false"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>

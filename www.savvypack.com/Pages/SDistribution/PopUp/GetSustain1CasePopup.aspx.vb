...
Partial Class Pages_SDistribution_PopUp_GetSustain1CasePopup
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            ds = objGetData.GetSustain1Cases(-1, Session("SDistCaseId").ToString(), txtCaseDe1.Text.Trim.ToString(), txtCaseDe2.Text.Trim.ToString(), Session("USERID").ToString())

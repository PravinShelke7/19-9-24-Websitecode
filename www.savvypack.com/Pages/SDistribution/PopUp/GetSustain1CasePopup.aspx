<%@ Page Language="VB" MasterPageFile="~/Masters/SDistPopUp.master" AutoEventWireup="false" CodeFile="GetSustain1CasePopup.aspx.vb" Inherits="Pages_SDistribution_PopUp_GetSustain1CasePopup" title="Sustain1 Cases" %>
                    ...
                    <Columns>
                        <asp:BoundField DataField="CaseId" HeaderText="CaseId" SortExpression="CaseId" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="Case Des1" SortExpression="Casede1">                              
                                <ItemTemplate>
                                   <a href="#" onclick="CaseDes('<%#Container.DataItem("CASDES")%>','<%#Container.DataItem("CaseId")%>')" class="Link"><%#Container.DataItem("CaseId")%>:<%#Container.DataItem("Casede1")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="50%" />
                                <HeaderStyle HorizontalAlign="Left" /> 
                          </asp:TemplateField>
                         <asp:BoundField DataField="Casede2" HeaderText="Case Des2" SortExpression="Casede2" Visible="true"> 

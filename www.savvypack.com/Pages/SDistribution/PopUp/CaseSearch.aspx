<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CaseSearch.aspx.vb" Inherits="Pages_SDistribution_PopUp_CaseSearch" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SDist-CaseDetails</title>
     ...
     <script type="text/JavaScript">
         ...
         function CaseViewer() {
             ...
             if (hidCaseid == "ddlPCase") {
                 URL = "CaseViewer.aspx?CaseDe1=" + CaseDe1.value + "&CaseDe2=" + CaseDe2.value + "&CType=P"
             }
             else {
    ...
    <div id="ContentPagemargin" style="width:100%;margin:0 0 0 0">
       <div id="PageSection1" style="text-align:left">
        <asp:Label ID="_lErrorLble" runat="server"></asp:Label>
             <table cellpadding="0" cellspacing="2">
                    ...
                    <tr>
                        ...
                        <td>
                             ...
                             <asp:Button ID="btnCaseViewer" Text="Case Viewer" runat="server" CssClass="Button" Visible="false" OnClientClick="return CaseViewer();" />
                        </td>
           ...
           <asp:GridView Width="400px" runat="server" ID="grdCaseSearch" DataKeyNames="CaseId" AutoGenerateSelectButton="false"

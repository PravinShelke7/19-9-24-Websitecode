<%@ Page Language="VB" MasterPageFile="~/Masters/SDistPopUp.master" AutoEventWireup="false" CodeFile="GetMatPopUp.aspx.vb" Inherits="Pages_SDistribution_PopUp_GetMatPopUp" title="SDist-Get Materials" %>
                    ...
                    <Columns>
                        <asp:BoundField DataField="MATID" HeaderText="MATID" SortExpression="MATID" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="Material Des1" SortExpression="MATDE1">                              
                                <ItemTemplate>
                                   <a href="#" onclick="MaterialDet('<%#Container.DataItem("MATDES")%>','<%#Container.DataItem("MATID")%>')" class="Link"><%#Container.DataItem("MATID")%>:<%#Container.DataItem("MATDE1")%></a>
                                </ItemTemplate>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CaseViewer.aspx.vb" Inherits="Pages_SDistribution_PopUp_CaseViewer" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SDist-Case Viewer</title>
        ...
        <asp:Label ID="_lErrorLble" runat="server"></asp:Label>
         ...
         <table width="90%">
             ...
             <tr class="AlterNateColor1">
                <td>
                    <asp:DropDownList ID="ddlCases" CssClass="DropDown" Width="80%" runat="server"></asp:DropDownList>
                </td>
             </tr> 
             <tr class="AlterNateColor1">
                <td>  

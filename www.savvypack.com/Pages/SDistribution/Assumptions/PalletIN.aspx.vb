...
Partial Class Pages_SDistribution_Assumptions_PalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Pallet Configuration Assumptions "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_ASSUMPTIONS_PALLETIN")
    End Sub
            ...
            For i = 1 To 16  'Bug #375_1
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                        'Case 5
                        '    HeaderTdSetting(tdHeader, "", "New", "1")
                        '    Header2TdSetting(tdHeader2, "", "", "1")
                ...
                For j = 1 To 16 'Bug #375_1
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            '    InnerTdSetting(tdInner, "", "Center")
                            '    chk = New CheckBox
                            '    If CInt(ds.Tables(0).Rows(0).Item("NW" + i.ToString() + "").ToString()) = 1 Then
                            '        chk.Checked = True
                            '    Else
                            '        chk.Checked = False
                            '    End If
                            '    chk.ID = "NEW" + i.ToString()
    ...
    Protected Sub UpdatePage()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        Pallet(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidPalid" + i.ToString() + "")
                        Number(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                        NoOfUses(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$NOUSE" + i.ToString() + "").Replace(",", "")
                        PrefWeight(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$WP" + i.ToString() + "").Replace(",", "")
                        PrefErgy(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                        PrefCO2(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$GHGP" + i.ToString() + "").Replace(",", "")
                        PrefWater(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                        PrefSHIPD(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$SDP" + i.ToString() + "").Replace(",", "")
                        Dept(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidPalletDepid" + i.ToString() + "")
                        If Request.Form("ctl00$SDistContentPlaceHolder$NEW" + i.ToString() + "") = "on" Then
                            WNew(i - 1) = "1"
                        Else
                            WNew(i - 1) = "0"
                        End If
                        ...
                        End If
                    Next
                    'ObjUpIns.PalletUpdate(CaseId, Pallet, Number, NoOfUses, PrefWeight, PrefErgy, PrefCO2, PrefRECOV, PrefSUSM, PrefPCREC, PrefSHIPD, Dept, WNew, ViewState("TabId").ToString())
                    ObjUpIns.PalletUpdate(CaseId, Pallet, Number, NoOfUses, PrefWeight, PrefErgy, PrefCO2, PrefRECOV, PrefSUSM, PrefPCREC, PrefSHIPD, Dept, WNew, PrefWater, ViewState("TabId").ToString())

                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        PrefRECOV(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$RECP" + i.ToString() + "").Replace(",", "")
                        PrefSUSM(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                        PrefPCREC(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$PCRECP" + i.ToString() + "").Replace(",", "")
                        'Check Numeric
                        ...
                        End If
                    Next
                    ObjUpIns.PalletUpdate(CaseId, Pallet, Number, NoOfUses, PrefWeight, PrefErgy, PrefCO2, PrefRECOV, PrefSUSM, PrefPCREC, PrefSHIPD, Dept, WNew, PrefWater, ViewState("TabId").ToString()) 'Bug #375_1
                End If

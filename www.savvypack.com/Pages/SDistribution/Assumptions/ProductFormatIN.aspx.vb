...
Partial Class Pages_SDistribution_Assumptions_ProductFormatIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                If Session("SDistServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$SDistContentPlaceHolder$hidProductid")
                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$SDistContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

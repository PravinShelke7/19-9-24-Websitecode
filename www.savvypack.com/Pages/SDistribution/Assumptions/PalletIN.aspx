<%@ Page Language="VB" MasterPageFile="~/Masters/SDistribution.master" AutoEventWireup="false" CodeFile="PalletIN.aspx.vb" Inherits="Pages_SDistribution_Assumptions_PalletIN" title="SDist-Pallet Configuration Assumptions" %>
<asp:Content ID="Content1" ContentPlaceHolderID="SDistContentPlaceHolder" Runat="Server">
   ...
   <script type="text/JavaScript">
      ...
      <table cellpadding="0" cellspacing="0" style="border-collapse:collapse;text-align:center;padding-left:55px;">
            <tr>
                <td> 

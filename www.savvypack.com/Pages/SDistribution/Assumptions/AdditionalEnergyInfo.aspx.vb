...
Partial Class Pages_SDistribution_Assumptions_AdditionalEnergyInfo
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Additional Energy Info"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDISTRIBUTION_ASSUMPTIONS_ADDITIONALENERGYINFO")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 2
                    EnergyConsum1(i) = Request.Form("ctl00$SDistContentPlaceHolder$ENERGYCONSUMAP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric
                ...
                For i = 0 To 3
                    EnergyConsum2(i) = Request.Form("ctl00$SDistContentPlaceHolder$ENERGYCONSUMBP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric
                ...
                Next
                For i = 0 To 3
                    EnergyConsum3(i) = Request.Form("ctl00$SDistContentPlaceHolder$ENERGYCONSUMCP" + (i + 1).ToString()).Replace(",", "")
                    '  EnergyConsum3(i) = Request.Form("ctl00$SDistContentContentPlaceHolder$ENERGYCONSUMCP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric

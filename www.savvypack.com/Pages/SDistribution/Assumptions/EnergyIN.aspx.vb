...
Partial Class Pages_SDistribution_Assumptions_EnergyIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetWizard()
        ...
        Wizardbtn.OnClientClick = "return Wizard('Wizard.aspx?Type=ERGY');"
    ...
    Protected Sub GetWizard2()
        ...
        Wizardbtn2.OnClientClick = "return Wizard('Wizard.aspx?Type=GHG');"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Energy Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_ASSUMPTIONS_ENERGYIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 1
                    ERGPPREF(i) = Request.Form("ctl00$SDistContentPlaceHolder$ERGPPREF" + (i + 1).ToString() + "")
                    'Check For IsNumric
                    ...
                    End If
                Next
                'CFACTORPREF = Request.Form("ctl00$SDistContentPlaceHolder$CFACTORPREF") 'Bug #375_1
                CFACTORPREF(0) = Request.Form("ctl00$SDistContentPlaceHolder$CFACTORPREF1")
                CFACTORPREF(1) = Request.Form("ctl00$SDistContentPlaceHolder$CFACTORPREF2")

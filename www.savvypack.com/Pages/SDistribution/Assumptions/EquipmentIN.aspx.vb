...
Partial Class Pages_SDistribution_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_ASSUMPTIONS_EQUIPMENTIN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    PARP(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$PLANTAREAP" + i.ToString() + "").Replace(",", "")
                    ECP(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$NTGP" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    WATERP(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "") 'Bug #375_1
                    ASSETNUM(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$ASSETNUM" + i.ToString() + "") 'Bug #375
                    ...
                    If Not IsNumeric(WATERP(i - 1)) Then 'Bug #375_1
                        Response.Redirect("../Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE113").Replace("+", "!Plus!").Replace("#", "!Hash!").Replace("&", "!And!") + "")
                    End If
                ...
                Next
                'ObjUpIns.EquipmentUpdate(CaseId, hidAssetId, PARP, ECP, NGCP, hidAssetDep, ASSETNUM) 'Bug #375
                ObjUpIns.EquipmentUpdate(CaseId, hidAssetId, PARP, ECP, NGCP, WATERP, hidAssetDep, ASSETNUM) 'Bug #375

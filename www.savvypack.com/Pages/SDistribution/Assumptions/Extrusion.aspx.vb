...
Partial Class Pages_SDistribution_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Material Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_ASSUMPTIONS_EXTRUSION")
    End Sub
                ...
                For j = 1 To 10
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            If ds.Tables(0).Rows(0).Item("IC" + i.ToString() + "").ToString() = 1 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 6
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("WEIGHT" + i.ToString() + "").ToString(), 4)
                            txt.MaxLength = 6
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 7
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Qty(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$SDistContentPlaceHolder$IC" + i.ToString() + "") <> "" Then
                        PComp(i - 1) = 1
                    Else
                        PComp(i - 1) = 0
                    End If
                    SCase(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$R" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$E" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$SDistContentPlaceHolder$hidDepid" + i.ToString() + "")
                    'Check For IsNumric
                ...
                Next
                plate = Request.Form("ctl00$SDistContentPlaceHolder$radPlate")

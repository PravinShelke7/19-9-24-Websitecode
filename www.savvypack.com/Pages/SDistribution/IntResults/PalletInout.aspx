<%@ Page Language="VB" MasterPageFile="~/Masters/SDistribution.master" AutoEventWireup="false" CodeFile="PalletInout.aspx.vb" Inherits="Pages_SDistribution_Assumptions_PalletInout" title="SDist-Product Packaging Results" %>
            ...
            <table cellspacing="0" cellpadding="0" style="border-collapse:collapse;width:100%">
                <tr>
                    <td style="padding-left:0px" valign="top">
                       <asp:Table ID="tblComparision" runat="server" CellPadding="2" CellSpacing="1"></asp:Table>
                    </td>

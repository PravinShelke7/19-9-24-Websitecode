...
Partial Class Pages_SDistribution_IntResults_SummerySheetIntm
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Scorecard Intermediate"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_INTRESULTS_SUMMERYSHEETINTM")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                M10 = Request.Form("ctl00$SDistContentPlaceHolder$M10").Replace(",", "")
                M11 = Request.Form("ctl00$SDistContentPlaceHolder$M11").Replace(",", "")
                'Check For IsNumric

...
Partial Class Pages_SDistribution_Assumptions_PalletInout
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Product Packaging Results')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Product Packaging Results"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_ASSUMPTIONS_PALLETINOUT")
    End Sub
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            For i = 1 To 3
                ...
                Select Case i
                    Case 1
                        HeaderTdSetting(tdHeader, "180px", "Item ", "1")
                        trHeader.Controls.Add(tdHeader)
                    Case 2
                        HeaderTdSetting(tdHeader, "120px", "Value", "1")
                        trHeader.Controls.Add(tdHeader)
                    Case 3
                        HeaderTdSetting(tdHeader, "140px", "Units", "1")
                        trHeader.Controls.Add(tdHeader)
                End Select

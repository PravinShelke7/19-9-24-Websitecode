...
Partial Class Pages_SDistribution_Results_GhgRes2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Customer Greenhouse Gas Results Statement')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Sustain2 - Customer Greenhouse Gas Results2 Statement "
    End Sub

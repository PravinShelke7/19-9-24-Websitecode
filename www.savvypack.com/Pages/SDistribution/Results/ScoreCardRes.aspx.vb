...
Partial Class Pages_SDistribution_Results_ScoreCardRes
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Scorecard Results "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDistribution_RESULTS_SCORECARDRES")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 9
                    LowRange(i) = Request.Form("ctl00$SDistContentPlaceHolder$LOWP_" + i.ToString() + "").Replace(",", "")
                    HighRange(i) = Request.Form("ctl00$SDistContentPlaceHolder$HIGHP_" + i.ToString() + "").Replace(",", "")
                    Weightings(i) = Request.Form("ctl00$SDistContentPlaceHolder$WTP_" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric
                    ...
                    If i > 7 Then
                        RawStore(i) = Request.Form("ctl00$SDistContentPlaceHolder$RW" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

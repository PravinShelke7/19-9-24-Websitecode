<%@ Page Language="VB" MasterPageFile="~/Masters/SDistribution.master" AutoEventWireup="false" CodeFile="WaterRes2.aspx.vb" Inherits="Pages_SDistribution_Results_WaterRes2" title="SDist - Customer Water Statement" %>
        ...
        <table cellspacing="2" style="width:700px">
         <tr>
                   <td>
                    ...
                    <td>
                      <asp:TextBox ID="txtNewSaleValue" runat="Server" CssClass="MediumTextBox" 
                            ></asp:TextBox>

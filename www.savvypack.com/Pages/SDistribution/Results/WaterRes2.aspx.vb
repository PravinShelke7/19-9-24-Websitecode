...
Partial Class Pages_SDistribution_Results_WaterRes2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SDistribution - Customer Water Statement "
    End Sub

    Protected Sub GetContentPlaceHolder()
        ctlContentPlaceHolder = Page.Master.FindControl("SDistributionContentPlaceHolder")
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SDISTRIBUTION_RESULTS_WATERRES2")
    End Sub
            ...
            For i = 1 To 6
                ...
                Select Case i
                    ...
                    Case 5
                        ...
                        trHeader2.Controls.Add(tdHeader2)
                    Case 6
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE10").ToString() + " water/unit)"
                        ...
                        Case 3
                            ...
                            If CInt(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                ...
                                If divVal > 0 Then
                                    ...
                                    '    arrCustomerTotal(i - 1) = lbl.Text
                                    'ElseIf i = 12 Then
                                    '    lbl.Text = FormatNumber(totWater * customerSaleValue / divVal, 0)
                                    '    arrCustomerTotal(i - 1) = lbl.Text
                                    'ElseIf i = 13 Then
                                    '    lbl.Text = FormatNumber(totPurMat * customerSaleValue / divVal, 0)
                                    '    arrCustomerTotal(i - 1) = lbl.Text
                                    'ElseIf i = 14 Then
                                    '    lbl.Text = FormatNumber(totProcess * customerSaleValue / divVal, 0)
                                    '    arrCustomerTotal(i - 1) = lbl.Text
                                    'ElseIf i = 15 Then
                                    '    lbl.Text = FormatNumber(totTransp * customerSaleValue / divVal, 0)
                                    '    arrCustomerTotal(i - 1) = lbl.Text
                                    'ElseIf i = 16 Then
                                    '    lbl.Text = FormatNumber(totWater * customerSaleValue / divVal, 0)
                                    '    arrCustomerTotal(i - 1) = lbl.Text
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Try
            ...
            If Not objRefresh.IsRefresh Then
                cusSalesVolume = Request.Form("ctl00$SDistContentPlaceHolder$txtNewSaleValue")
                ...
                Calculate()
                '    'Update Server Date
                'ObjUpIns.ServerDateUpdate(CaseId, Session("SDistUserName"))
            End If
            GetPageDetails()
        Catch ex As Exception

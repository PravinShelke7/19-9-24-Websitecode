...
Partial Class Pages_SDistribution_Results_ErgyRes2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Customer Energy Statement "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_Pages_Sustain2_Results_ErgyRes2")
    End Sub
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                ...
                                If divVal > 0 Then
                                    ...
                                    ''    arrCustomerTotal(i - 1) = lbl.Text
                                    ''ElseIf i = 12 Then
                                    ''    lbl.Text = FormatNumber(totEnergy * customerSaleValue / divVal, 0)
                                    ''    arrCustomerTotal(i - 1) = lbl.Text
                                    ''ElseIf i = 13 Then
                        ...
                        Case 4
                            ...
                            If CDbl(arrCustomerTotal(11)) <> 0 Then
                                If IsNumeric(arrCustomerTotal(11)) Then

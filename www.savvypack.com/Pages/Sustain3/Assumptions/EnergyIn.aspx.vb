...
Partial Class Pages_Sustain3_Assumptions_EnergyIn
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                str.Append("<tr align='right'> <td style='width:50%'>" + FormatNumber(dstbl.Tables(k).Rows(0).Item("ERGYS" + (j - 1).ToString() + "").ToString(), 3) + "</td> <td>" + FormatNumber(dstbl.Tables(k).Rows(0).Item("ERGYP" + (j - 1).ToString() + "").ToString(), 3) + "</td> </tr>")
                                str.Append("</table>")
                                tdInner.Text = str.ToString()
                                InnerTdSetting(tdInner, DWidth, "Center")
                                trInner.Controls.Add(tdInner)

<%@ Page Title="S3-Personnel" Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false" CodeFile="PersonnelIn.aspx.vb" Inherits="Pages_Sustain3_Assumptions_PersonnelIn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Sustain3ContentPlaceHolder" Runat="Server">
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Personnel')" onmouseout="UnTip()" >
                  Personnel
                </td>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_PD" checked="checked"   onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_PD'); " />Position Description
                          <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_NOW" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_NOW'); " />Number of Workers
                             <br />

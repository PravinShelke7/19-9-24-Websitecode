...
Partial Class Pages_Sustain3_Assumptions_OperationsIn
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                Else
                                    tdInner.Text = dstbl.Tables(k).Rows(0).Item("EQUIPDES" + i.ToString() + "").ToString()
                                End If
                                'tdInner.Text = dstbl.Tables(k).Rows(0).Item("EQUIPDES" + i.ToString() + "").ToString()
                        ...
                        Case 3
                           tdInner = New TableCell
                            ...
                            trInner.ID = "WEBWS_" + i.ToString()
                            For k = 0 To DataCnt
                                'Equipment Description
                                tdInner = New TableCell
                                If dstbl.Tables(k).Rows(0).Item("Unit" + i.ToString() + "").ToString() = "fpm" Then
                                    tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("OPWEBWIDTHSUGG" + i.ToString() + "").ToString(), 2)
                                ElseIf dstbl.Tables(k).Rows(0).Item("Unit" + i.ToString() + "").ToString() = "cpm" Then
                                    tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("OPEXITSSUGG" + i.ToString() + "").ToString(), 2)
                                End If
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 4
                            tdInner = New TableCell
                            Title = "(" + dstbl.Tables(0).Rows(0).Item("TITLE9").ToString() + ")"
                            LeftTdSetting(tdInner, "Web Width/Cavities Pref." + Title, trInner, "AlterNateColor1")
                            trInner.ID = "WEBWP_" + i.ToString()
                            For k = 0 To DataCnt
                                'Equipment Description
                                tdInner = New TableCell
                                If dstbl.Tables(k).Rows(0).Item("Unit" + i.ToString() + "").ToString() = "fpm" Then
                                    tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("OPWEBWIDTHPREF" + i.ToString() + "").ToString(), 2)
                                ElseIf dstbl.Tables(k).Rows(0).Item("Unit" + i.ToString() + "").ToString() = "cpm" Then
                                    tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("OPEXITSPREF" + i.ToString() + "").ToString(), 2)
                                End If
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 5
                            ...
                            For k = 0 To DataCnt
                                tdInner = New TableCell
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("ANNUALRUNHOURS" + i.ToString() + "").ToString(), 2)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 6
                            ...
                            tdInner = New TableCell
                            LeftTdSetting(tdInner, "Instantaneous Rate", trInner, "AlterNateColor1")
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("INSTANTANEOUSRATE" + i.ToString() + "").ToString(), 2)
                                InnerTdSetting(tdInner, DWidth, "Right")
                        ...
                        Case 8
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                'txt = New TextBox
                                'txt.Text = FormatNumber(ds.Tables(0).Rows(i).Item("INSTANTANEOUS2RATE" + j.ToString() + "").ToString(), 0)
                                'TextBoxSetting(txt, "NormalTextBox")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("INSTANTANEOUS2RATE" + i.ToString() + "").ToString(), 2)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(txt)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 9
                            ...
                            For k = 0 To DataCnt
                                ...
                                'TextBoxSetting(txt, "NormalTextBox")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("DOWNTIME" + i.ToString() + "").ToString(), 1)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(txt)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 10
                            ...
                            For k = 0 To DataCnt
                                ...
                                'txt.Text = FormatNumber(ds.Tables(0).Rows(i).Item("NTGP" + j.ToString() + "").ToString(), 0)
                                'TextBoxSetting(txt, "NormalTextBox")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODUCTIONWAST" + i.ToString() + "").ToString(), 1)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(txt)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 11
                            ...
                            tdInner = New TableCell
                            Title = "(%)"
                            LeftTdSetting(tdInner, "Design Waste " + Title + "", trInner, "AlterNateColor2")
                            trInner.ID = "DW_" + i.ToString()
                            For k = 0 To DataCnt
                                'Design Waste
                                tdInner = New TableCell
                                'txt = New TextBox
                                'txt.Text = FormatNumber(ds.Tables(0).Rows(i).Item("NTGP" + j.ToString() + "").ToString(), 0)
                                'TextBoxSetting(txt, "NormalTextBox")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("DESIGNWAST" + i.ToString() + "").ToString(), 1)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                trInner.Controls.Add(tdInner)
                            Next
                    End Select

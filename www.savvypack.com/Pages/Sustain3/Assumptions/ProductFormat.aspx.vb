...
Partial Class Pages_Sustain3_Assumptions_ProductFormat
...
#End Region
                    ...
                    Select Case j
                        ...
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                'Container  Weight
                                tdInner = New TableCell
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("CONTWT").ToString(), 4)
                                InnerTdSetting(tdInner, "", "Right")
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 8
                            ...
                            tdInner = New TableCell
                            Title = "(" + dstbl.Tables(0).Rows(0).Item("Title8").ToString() + ")"
                            LeftTdSetting(tdInner, "Packaging Weight Preffered " + Title + "", trInner, "AlterNateColor1")
                            trInner.ID = "PP_1"
                            For k = 0 To DataCnt

                                'Container  Weight
                                tdInner = New TableCell
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODWTPREF").ToString(), 4)
                                InnerTdSetting(tdInner, "", "Right")
                                trInner.Controls.Add(tdInner)
                            Next
    ...
    'Protected Function GetProductCombo(ByVal Unit As String) As DropDownList
    '    Dim ddl As New DropDownList
    '    Dim ds As New DataSet()
    '    Dim objGetData As New S1GetData.Selectdata
    '    Try
    '        ds = objGetData.GetProductFormt(Unit)
    '        With ddl
    '            .DataSource = ds
    '            .DataTextField = "Des"

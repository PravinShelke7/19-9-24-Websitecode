<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false"
    CodeFile="AdditionalEnergyInfo.aspx.vb" Inherits="Pages_Sustain3_Assumptions_AdditionalEnergyInfo"
   title="S3-Additional Energy Info"%>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <b>Plant Space</b>   
                          <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_PROD" checked="checked"  onclick="showhideALL1('ctl00_Sustain3ContentPlaceHolder_PROD'); " />Production
                          <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_WAR" checked="checked"  onclick="showhideALL1('ctl00_Sustain3ContentPlaceHolder_WAR'); " />Warehouse
                          <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_OFF" checked="checked"  onclick="showhideALL1('ctl00_Sustain3ContentPlaceHolder_OFF'); " />Office
                          <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_SUPP" checked="checked"  onclick="showhideALL1('ctl00_Sustain3ContentPlaceHolder_SUPP'); " />Support
                          <br />

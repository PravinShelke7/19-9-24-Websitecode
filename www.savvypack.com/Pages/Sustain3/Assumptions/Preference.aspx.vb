...
Partial Class Pages_Sustain3_Assumptions_Preferences
                ...
                For j = 1 To 6
                    ...
                    Select Case j
                        Case 1
                            ...
                            LeftTdSetting(tdInner, "Inventory Type", trInner, "AlterNateColor2")
                            trInner.ID = "INV_1"
                            For k = 0 To DataCnt
                                tdInner = New TableCell
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                tdInner = New TableCell
                                dsMat = objGetData.GetEffDate(dstbl.Tables(k).Rows(0).Item("INVENTORYTYPE").ToString())
                                tdInner.Text = dsMat.Tables(0).Rows(0).Item("EDATE").ToString()
                                InnerTdSetting(tdInner, "", "Right")
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 5
                            tdInner = New TableCell
                            Dim var As String
                            LeftTdSetting(tdInner, "Discrete Calculations", trInner, "AlterNateColor2")
                            trInner.ID = "CALC_1"
                            For k = 0 To DataCnt
                                tdInner = New TableCell
                                var = dstbl.Tables(k).Rows(0).Item("ISDSCTNEW").ToString()
                                If var = "Y" Then
                                    tdInner.Text = "Shipped together"
                                Else
                                    tdInner.Text = "Shipped Separately"
                                End If
                                InnerTdSetting(tdInner, "", "Right")
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 6
                            tdInner = New TableCell
                            Dim var As String
                            LeftTdSetting(tdInner, "Design Waste Calculations", trInner, "AlterNateColor1")
                            trInner.ID = "DESC_1"
                            For k = 0 To DataCnt
                                tdInner = New TableCell
                                var = dstbl.Tables(k).Rows(0).Item("DFLAG").ToString()
                                If var = "N" Then
                                    tdInner.Text = "Old"
                                Else
                                    tdInner.Text = "New"

<%@ Page Title="S3-Process equipment" Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false" CodeFile="EquipmentIn.aspx.vb" Inherits="Pages_Sustain3_Assumptions_EquipmentIn" %>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_AT" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_AT'); " />Area Type
                           <br /> 
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_PAS" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_PAS'); " />Plant Area Sugg.
                             <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_PAP" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_PAP'); " />Plant Area Pref.
                             <br />
                          ...
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_ECP" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_ECP'); " />Electricity Consumption Pref.
                                                        <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_NCS" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_NCS'); " />Process Natural Gas Consumption Sugg.
                             <br />
                          <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_NCP" checked="checked"  onclick="showhideALL2('ctl00_Sustain3ContentPlaceHolder_NCP'); " />Process Natural Gas Consumption Pref.
                             <br />

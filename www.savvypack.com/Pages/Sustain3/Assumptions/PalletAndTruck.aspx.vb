...
Partial Class Pages_Sustain3_Assumptions_PalletAndTruck
                ...
                Select Case j
                    ...
                    Case 2
                        ...
                        For k = 0 To DataCnt
                            ...
                            'Pallet Width
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("P" + (j - 1).ToString() + "").ToString(), 0)
                    ...
                    Case 14
                        ...
                        For k = 0 To Datacnt
                            ...
                            'TextBoxSetting(txt, "NormalTextBox")
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("CALCULATEDWEIGHT").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            'tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Next

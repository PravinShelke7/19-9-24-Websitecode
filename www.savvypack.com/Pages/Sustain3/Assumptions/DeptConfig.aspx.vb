...
Partial Class Pages_Sustain3_Assumptions_DeptConfig
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P1").ToString()
                        ...
                        Case 3
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P2").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 4
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P3").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 5
                            ...
                            For k = 0 To DataCnt    'Next Process 3
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P4").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 6
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P5").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P6").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 8
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P7").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 9
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P8").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 10
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P9").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 11
                            ...
                            For k = 0 To DataCnt
                                ...
                                ddl = New DropDownList
                                ddl = GetDepartment()
                                ddl.SelectedValue = dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P10").ToString()
                                tdInner.Text = ddl.SelectedItem.Text
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(ddl)
                                trInner.Controls.Add(tdInner)

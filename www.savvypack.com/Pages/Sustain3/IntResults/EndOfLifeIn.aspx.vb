...
Partial Class Pages_Sustain3_IntResults_EndOfLifeIn
        ...
        Try
            ...
            For i = 0 To 1
                ...
                If i = 0 Then
                    ...
                    Else
                        Title = "<b>Sales Volume (" + dstbl.Tables(0).Rows(0).Item("SALESUNIT1").ToString() + ")</b> "
                    End If
                Else
                    Title = "<b>Sales Volume (" + dstbl.Tables(0).Rows(0).Item("SALESUNIT2").ToString() + ")</b> "
                End If

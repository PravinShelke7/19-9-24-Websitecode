<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Error.aspx.vb" Inherits="Pages_Sustain3_Errors_Error" %>
...
<body>
    ...
    <div id="MasterContent">
     ...
     <div id="AlliedLogo">
       ...
       <div>
        <table class="S3Module" cellpadding="0" cellspacing="0"  style="border-collapse:collapse">
            <tr>
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('S3-Tools')" onmouseout="UnTip()" style="width:840px;">
                     Sustain3 - Error

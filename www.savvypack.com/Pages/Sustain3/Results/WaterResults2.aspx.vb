...
Partial Class Pages_Sustain3_Results_WaterResults2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/S3Charts/CErgyGHG.aspx?ErgyGHG=" + objCryptoHelper.Encrypt("WATER") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&CType=" + objCryptoHelper.Encrypt("PWeight") + "') "
                    ...
                    Select Case i
                        ...
                        Case 11
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                If CDbl(dstbl.Tables(k).Rows(0).Item("SVOLUME")) <> 0 Then
                                    tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("T8").ToString() / dstbl.Tables(k).Rows(0).Item("SVOLUME").ToString().ToString(), 3)
                                Else
                                    tdInner.Text = "na"
                                End If
                                InnerTdSetting(tdInner, DWidth, "Right")
                        ...
                        Case 13
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                If CDbl(dstbl.Tables(k).Rows(0).Item("SVOLUME")) <> 0 Then
                                    tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("T10").ToString() / dstbl.Tables(k).Rows(0).Item("SVOLUME").ToString().ToString(), 3)
                                Else
                                    tdInner.Text = "na"
                                End If
                                InnerTdSetting(tdInner, DWidth, "Right")

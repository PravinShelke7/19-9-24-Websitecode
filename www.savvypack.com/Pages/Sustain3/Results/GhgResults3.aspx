<%@ Page Title="S3-Greenhouse Gas (Per Unit)" Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false" CodeFile="GhgResults3.aspx.vb" Inherits="Pages_Sustain3_Results_GhgResults3" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:58%" class="PageHeading" 
                    onmouseover="Tip('S3-Greenhouse Gas (Per Unit)')" onmouseout="UnTip()" >
                  S3-Greenhouse Gas (Per Unit)
                </td>

<%@ Page Title="S3-Greenhouse Gas (Total)" Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false" CodeFile="GhgResults1.aspx.vb" Inherits="Pages_Sustain3_Results_GhgResults1" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:58%" class="PageHeading" 
                    onmouseover="Tip('S3-Greenhouse Gas (Total)')" onmouseout="UnTip()" >
                     S3-Greenhouse Gas (Total)
                </td>

...
Partial Class Pages_Sustain3_Results_WaterResults1
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/S3Charts/CErgyGHG.aspx?ErgyGHG=" + objCryptoHelper.Encrypt("WATER") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&CType=" + objCryptoHelper.Encrypt("Total") + "') "

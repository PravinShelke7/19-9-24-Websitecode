<%@ Page Title="S3-Greenhouse Gas (Per Unit Weight)" Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false" CodeFile="GhgResults2.aspx.vb" Inherits="Pages_Sustain3_Results_GhgResults2" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:58%" class="PageHeading" 
                    onmouseover="Tip('S3-Greenhouse Gas (Per Unit Weight)')" onmouseout="UnTip()" >
                  S3-Greenhouse Gas (Per Unit Weight)
                </td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                           ...
                           <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_M9" checked="checked"   onclick="showhideALLCnt('ctl00_Sustain3ContentPlaceHolder_M9',1); " />Transport to Customer
                             <br />
                           <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_M10" checked="checked"   onclick="showhideALLCnt('ctl00_Sustain3ContentPlaceHolder_M10',1); " />Total Greenhouse Gas
                             <br />
                           ...
                           <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_M13" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain3ContentPlaceHolder_M13',1); " />Transportation
                             <br />
                           <input type="checkbox" id="ctl00_Sustain3ContentPlaceHolder_M14" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain3ContentPlaceHolder_M14',1); " />Total Greenhouse Gas

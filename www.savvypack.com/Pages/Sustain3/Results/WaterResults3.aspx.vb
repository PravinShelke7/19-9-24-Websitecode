...
Partial Class Pages_Sustain3_Results_WaterResults3
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/S3Charts/CErgyGHG.aspx?ErgyGHG=" + objCryptoHelper.Encrypt("WATER") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&CType=" + objCryptoHelper.Encrypt("PUnit") + "') "
                    ...
                    Select Case i
                        ...
                        Case 3
                            ...
                            For k = 0 To DataCnt
                                ...
                                str.Append("<tr align='right' style='font-weight:bold'> <td style='width:50%'> <td style='width:50%'>(" + dstbl.Tables(k).Rows(0).Item("SUNIT").ToString() + ")</td> </tr>")
                                str.Append("</table>")
                        ...
                        Case 4
                            tdInner = New TableCell
                            Title = "(" + dstbl.Tables(0).Rows(0).Item("TITLE10").ToString() + " water/" + dstbl.Tables(0).Rows(0).Item("TITLE8").ToString() + ")"

<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain3.master" AutoEventWireup="false"
    CodeFile="AddEditCategory.aspx.vb" Inherits="Pages_Sustain3_Category_AddEditCategory"
    Title="S3-Add/Edit Category Item" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Sustain3ContentPlaceHolder" runat="Server">
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width: 840px">
        <tr style="height: 20px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('S3 - Add/Edit Category Items')"
                    onmouseout="UnTip()" style="width: 800px;">
                    Sustain3 - Add/Edit Category Items
                </div>
                <div style="text-align: right">
                    <asp:HyperLink ID="lnkEditCategory" runat="server" Text="Go to Charts" CssClass="Link"
                        Style="font-size: 13px;" Font-Bold="true" NavigateUrl="~/Charts/S3Charts/CErgyGhg.aspx"></asp:HyperLink>
                    <asp:HyperLink ID="lnkPrev" runat="server" Text="Go to Prev. Page" CssClass="Link"
                        Style="font-size: 13px; margin-left: 10px;" Font-Bold="true" NavigateUrl="~/Pages/Sustain3/Category/ManageCategory.aspx"></asp:HyperLink>
                </div>
            </td>
        </tr>
        <tr>

...
Imports S3GetData
Imports S3UpInsData
Partial Class Pages_Sustain3_Category_AddEditCategory
    ...
    Protected Sub bindDetails()
        Dim objGetData As New S3GetData.Selectdata
        Dim objUpdateData As New S3UpInsData.UpdateInsert
    ...
    Protected Sub Transfer1(ByVal Fromlst As ListBox, ByVal Tolst As ListBox, ByVal IsAll As Boolean)
        ...
        Try
            ...
            Dim cntVal As String = Request.Form("ctl00$Sustain3ContentPlaceHolder$lstRegion1")
    ...
    Protected Sub Transfer2(ByVal Fromlst As ListBox, ByVal Tolst As ListBox, ByVal IsAll As Boolean)
        ...
        Try
            ...
            Dim cnt As Integer = 0
            Dim cntVal As String = Request.Form("ctl00$Sustain3ContentPlaceHolder$lstRegion2")
            Dim strCount() As String = Regex.Split(cntVal, ",")

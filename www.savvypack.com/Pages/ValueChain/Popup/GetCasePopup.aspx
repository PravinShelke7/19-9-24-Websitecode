<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetCasePopup.aspx.vb" Inherits="Pages_ValueChain_Popup_GetCasePopup"
title="Get Module Cases" %>
<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Cases Popup</title>
                    ...
                    <Columns>
                        <asp:BoundField DataField="CaseId" HeaderText="CaseId" SortExpression="CaseId" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="Case Des1" SortExpression="Casede1">                              
                                <ItemTemplate>
                                   <a href="#" onclick="CaseDes('<%#Container.DataItem("CASDES1")%>','<%#Container.DataItem("CaseId")%>')" class="Link"><%#Container.DataItem("CaseId")%>:<%#Container.DataItem("Casede1")%></a>
                                </ItemTemplate>

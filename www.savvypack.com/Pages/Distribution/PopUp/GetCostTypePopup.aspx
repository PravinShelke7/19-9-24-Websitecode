<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetCostTypePopup.aspx.vb" Inherits="Pages_Distribution_PopUp_GetCostTypePopup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Edist-Cost type details</title>
   ...
   <div id="ContentPagemargin" style="width:100%;margin:0 0 0 0">
       <div id="PageSection1" style="text-align:left">
        <asp:Label ID="_lErrorLble" runat="server"></asp:Label>
           ...
           <asp:GridView Width="400px" runat="server" ID="grdCostType" DataKeyNames="costID" AutoGenerateSelectButton="false"
                    ...
                    <Columns>
                        <asp:BoundField DataField="costID" HeaderText="costID" SortExpression="costID" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="Pos Des1" SortExpression="palletde1">                              
                                <ItemTemplate>
                                   <a href="#" onclick="PositionDet('<%#Container.DataItem("costdes")%>','<%#Container.DataItem("costID")%>')" class="Link">

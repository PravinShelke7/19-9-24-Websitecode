...
Partial Class Pages_Distribution_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("OnClick", "return CheckForSEquipment('" + ctlContentPlaceHolder.ClientID + "','hidAssetId','ASSETNUM')")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    ASSETNUM(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                ...
                Next
                ObjUpIns.SupportEquipmentUpdate(CaseId, hidAssetId, AP, ECP, NGP, hidAssetDep, ASSETNUM)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

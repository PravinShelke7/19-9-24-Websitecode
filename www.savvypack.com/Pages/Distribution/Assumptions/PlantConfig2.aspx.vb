...
Partial Class Pages_Distribution_Assumptions_PlantConfig2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Plant Space Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_PLANTCONFIG2")
    End Sub
        ...
        Try
            ...
            For i = 1 To 2
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        HeaderTdSetting(tdHeader, "100px", "Area", "1")
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                If i = 1 Then
                                    ...
                                    lbl.Text = "<span style='margin-right:10px'>" + FormatNumber(ds.Tables(0).Rows(0).Item("AR" + i.ToString() + "").ToString(), 0) + "</span>"
                                ...
                                Else
                                    ...
                                    txt.Width = 70
                                    txt.ID = "AR" + (i - 3).ToString()
                                    txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("AR" + (i - 3).ToString() + "").ToString(), 0)
                                    txt.MaxLength = 12
            ...
            For i = 1 To 2
                ...
                Select Case i
                    ...
                    Case 2
                        InnerTdSetting(tdInner, "", "Right")
                        tdInner.Text = "<span style='margin-right:8px' class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("ARTOT").ToString(), 0) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                End Select
            Next
            trInner.Height = 30
            ...
            For i = 1 To 4
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        Header2TdSetting(tdHeader2, "94px", "Sugessted", "1")
                        Header2TdSetting(tdHeader1, "94px", TITLE1, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    Case 3
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE2") + "/" + ds.Tables(0).Rows(0).Item("TITLE7") + ")"
                        Header2TdSetting(tdHeader2, "94px", "Preferred", "1")
                        Header2TdSetting(tdHeader1, "94px", Title, "1")
                        trHeader2.Controls.Add(tdHeader2)
                    Case 4
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE2") + Title.ToString() + ")"
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 2 To 4
                    AREA(i - 2) = Request.Form("ctl00$DistributionContentPlaceHolder$AR" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric
                ...
                For i = 0 To 5
                    PrefLease(i) = Request.Form("ctl00$DistributionContentPlaceHolder$PREF" + (i + 1).ToString() + "").Replace(",", "")
                    'Check For IsNumric

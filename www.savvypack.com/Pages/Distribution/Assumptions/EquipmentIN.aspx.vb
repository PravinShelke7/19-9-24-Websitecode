...
Partial Class Pages_Distribution_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_EQUIPMENTIN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    hidAssetId(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    AP(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$AP" + i.ToString() + "")
                    PAP(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$PAP" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$ECP" + i.ToString() + "")
                    NGP(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$NGP" + i.ToString() + "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$ASSETNUM" + i.ToString() + "") 'Bug #375

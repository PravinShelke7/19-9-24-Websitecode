...
Partial Class Pages_Distribution_Assumptions_TruckPalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Pallet and Truck Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_TRUCKPALLETIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 5
                    Pallet(i) = Request.Form("ctl00$DistributionContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                    Truck(i) = Request.Form("ctl00$DistributionContentPlaceHolder$T" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

...
Partial Class Pages_Distribution_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Material Assumption"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("PAGES_Distribution_ASSUMPTIONS_EXTRUSION")
    End Sub
...
#End Region
            ...
            For i = 1 To 13
                ...
                Select Case i
                    ...
                    Case 7
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 8
                        HeaderTdSetting(tdHeader, "105px", "Module Type", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 9
                        HeaderTdSetting(tdHeader, "105px", "Cases", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                ...
                For j = 1 To 13
                    ...
                    Select Case j
                        ...
                        Case 8
                            ...
                            Link.Width = 105
                            Link.CssClass = "Link"
                            GetModTypeDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("MT" + i.ToString() + "").ToString()), "hypCaseDes" + i.ToString(), "hidCaseId" + i.ToString())
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
                        Case 9
                            ...
                            Link.Width = 105
                            Link.CssClass = "Link"
                            GetCaseDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("C" + i.ToString() + "").ToString()), ds.Tables(0).Rows(0).Item("MT" + i.ToString() + "").ToString(), "hidModTypeId" + i.ToString())
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
    ...
    Protected Sub GetModTypeDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal CaseIdE1 As Integer, ByVal strCaseLink As String, ByVal strCaseId As String)
        Dim Ds As New DataSet
        Dim ObjGetdata As New DistGetData.Selectdata()
        Dim hidval As New HiddenField
        Dim Path As String = String.Empty
        Try
            ...
            Ds = ObjGetdata.GetModuleType(CaseIdE1, "")
    ...
    Protected Sub GetCaseDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal CaseIdE1 As Integer, ByVal modId As String, ByVal modTypeId As String)
        ...
        Try
            ...
            Ds = ObjGetdata.GetModuleCases(CaseIdE1, CaseId, "", "", Session("USERID").ToString(), modId)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Price(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$PRICE" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$REC" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$EP" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidDepid" + i.ToString() + "")
                    ModType(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidModTypeId" + i.ToString() + "")
                    ModCases(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    If Request.Form("ctl00$DistributionContentPlaceHolder$PCOMP" + i.ToString() + "") <> "" Then
                        PC(i - 1) = 1
                    Else
                        PC(i - 1) = 0
                    End If
                ...
                Next
                plate = Request.Form("ctl00$DistributionContentPlaceHolder$radPlate")
                ObjUpIns.ExtrusionUpdate(CaseId, Material, Weight, Price, Recycle, Extra, PC, Dept, ModType, ModCases, plate, True)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

...
Partial Class Pages_Distribution_Assumptions_FixedCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Fixed Cost Guidelines"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_FIXEDCOST")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    FixedCostVal(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$FIXCOST" + i.ToString() + "").Replace(",", "")
                    FixedCostPref(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$FCPREF" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$DistributionContentPlaceHolder$hidFCDepid" + i.ToString() + "")
                ...
                Next
                depreciate = Request.Form("ctl00$DistributionContentPlaceHolder$DEPYEARS").Replace(",", "")

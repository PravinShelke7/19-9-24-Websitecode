...
Partial Class Pages_Distribution_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("E2ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$DistributionContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$DistributionContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

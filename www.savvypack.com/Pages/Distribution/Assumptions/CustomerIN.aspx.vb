...
Partial Class Pages_Distribution_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Customer Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_ASSUMPTIONS_CUSTOMERIN")
    End Sub
...
#End Region
        ...
        Try
            ...
            For p = 1 To 4
                ...
                Select Case p
                    Case 1
                        Title = ""
                        HeaderTdSetting(tdHeader, "", "Shipping Type", "1")
            ...
            For q = 1 To 4
                ...
                Select Case q
                    Case 1
                        ...
                        GetShippingType(ddl, ds.Tables(0).Rows(0).Item("SHIPTYPE").ToString())
    ...
    Protected Sub GetShippingType(ByVal ddl As DropDownList, ByVal Id As String)
        Dim objGetData As New DistGetData.Selectdata
        Dim ds As New DataSet
        Try
            ds = objGetData.GetShipingSelector(0, "")
            With ddl
                .DataSource = ds
        ...
        Catch ex As Exception
            ErrorLable.Text = "Error:GetShippingType:" + ex.Message.ToString() + ""
        End Try
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$DistributionContentPlaceHolder$PRODPUR").Replace(",", "")
                SHIPDIST = Request.Form("ctl00$DistributionContentPlaceHolder$SHIPDIST").Replace(",", "")
                MILCOST = Request.Form("ctl00$DistributionContentPlaceHolder$MILCOST").Replace(",", "")
                SHIPTYPE = Request.Form("ctl00$DistributionContentPlaceHolder$SHIPTYPE").Replace(",", "")
                'Check For IsNumric
                ...
                ObjUpIns.CustomerInUpdate(CaseId, PRODPUR, SHIPDIST, MILCOST, SHIPTYPE)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

...
Imports ToolCCS
Partial Class Pages_Distribution_Tools_Tool
    Inherits System.Web.UI.Page
#Region "Browser Refresh Check"
    Dim objRefresh As zCon.Net.Refresh

    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_Pages_Distribution_Tools_Tool")
    End Sub
...
#End Region
    ...
    Protected Sub GetBCaseDetails()
        Dim objGetData As New DistGetData.Selectdata() 'change made E1GetData by DistGetData
    ...
    Protected Sub GetUserDetails()
        ...
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetUserCompanyUsers(Session("DistUserName").ToString()) 'Replace E1UserName
            With ddlUsers
                .DataSource = ds
    ...
    Protected Sub GetTotalCaseCount()
        ...
        Dim dsSUserMaxCountDist As New DataSet()
        Dim dsSUserMaxCountSDist As New DataSet()
        ...
        Try
            ...
            dsSUserMaxCountDist = objGetData.GetSelectedUserDetails(ddlUser2.SelectedItem.Text, "EDISTRIBUTION")
            dsSUserMaxCountSDist = objGetData.GetSelectedUserDetails(ddlUser2.SelectedItem.Text, "SDistribution")
            If dsSUserMaxCountDist.Tables(0).Rows.Count > 0 Then
                hidUserMaxCaseCount.Value = CInt(dsSUserMaxCountDist.Tables(0).Rows(0).Item("MAXCASECOUNT")).ToString()
                hidTotalSCount.Value = CInt(dsSUserCount.Tables(0).Rows(0).Item("TOTALCOUNT")).ToString()
            Else

                If dsSUserMaxCountSDist.Tables(0).Rows.Count > 0 Then
                    hidUserMaxCaseCount.Value = dsSUserMaxCountSDist.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString().Trim()
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(ddlUsers.SelectedItem.Text, "EDISTRIBUTION")
    ...
    Protected Sub btnCopyBcase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCopyBcase.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                Flag = CopyCase(SCaseId, TCaseId, "DistributionConnectionString") 'Replace EconConnectionString
                Flag = CopyCase(SCaseId, TCaseId, "SDistributionConnectionString") 'Replace Sustain1ConnectionString
                If Flag Then
                    GetPCaseDetails()
                    GetTotalCaseCount()
    ...
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                obj.CaseAccess(USERID, CaseId, "DistributionConnectionString")
                obj.CaseAccess(USERID, CaseId, "SDistributionConnectionString")
                GetTotalCaseCount()
                Flag = True
            End If
    ...
    Protected Sub btnShareCopy_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareCopy.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                Flag = CopyCase(SCaseId, TCaseId, "DistributionConnectionString")
                Flag = CopyCase(SCaseId, TCaseId, "SDistributionConnectionString")
                If Flag Then
                    GetPCaseDetails()
                    GetTotalCaseCount()
    ...
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                obj.CaseSynch(SCaseId, TCaseId, "SDistribution", "Distribution", "DistributionConnectionString", "SystemConnectionString")
                Flag = True
            End If
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            GetPCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from SDist to EDist');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                CaseId = ddlPCases.SelectedValue.ToString()
                obj.CaseRename(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString(), txtCaseDe2.Text.Trim.ToString(), txtCaseDe3.Text.Trim.ToString(), "DistributionConnectionString")
                GetPCaseDetails()
    ...
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                obj.CaseDelete(Session("USERID").ToString(), CaseId.ToString(), "DistributionConnectionString")
                obj.CaseDelete(Session("USERID").ToString(), CaseId.ToString(), "SDistributionConnectionString")
                GetPCaseDetails()
                GetTotalCaseCount()
...
#Region "Tools Function"
    Protected Function CreateCase(ByVal USERID As String) As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateCase(USERID, "DistributionConnectionString", "EDist", 0)
            obj.CreateCase(USERID, "SDistributionConnectionString", "EDist", CaseId)
            Return CaseId

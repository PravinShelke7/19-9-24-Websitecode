...
Partial Class Pages_Distribution_Results_PrintCaseSummary
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Print Case Summary"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Distribution_RESULTS_PRINTCASESUMMARY")
    End Sub
                ...
                For j = 1 To 2
                    ...
                    Select Case j
                        ...
                        Case 1
                            ...
                            If i = 1 Then
                                tdInner.Text = "<b>Unit Price</b>"
                            Else
                                tdInner.Text = "<b>Product Volume</b>"
                            End If
                        ...
                        Case 2
                            ...
                            lbl = New Label()
                            If i = 1 Then
                                lbl.Text = FormatNumber(CDbl(ds.Tables(0).Rows(0).Item("UNITPRICE").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString()), 3)
                            Else
                                lbl.Text = FormatNumber(CDbl(ds.Tables(0).Rows(0).Item("PVOLUME").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString()), 0)
                            End If
            ...
            For i = 1 To 4
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE2").ToString() + ")" 'TITLE8 Replaced by TITLE2
                        Header2TdSetting(tdHeader1, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)

...
Partial Class Pages_Distribution_Results_CResultspl
                    ...
                    For j = 1 To 7
                        ...
                        Select Case j
                            ...
                            Case 4
                                ...
                                Dim salesVolume, salesVolume2 As Double
                                lbl = New Label()
                                salesVolume = CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("CONVWT").ToString())
                                ...
                                'perwt1 = CDbl(ds1.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("PVOLUME").ToString())
            ...
            For i = 1 To 7
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        ' Code For Td Units
                        If CInt(ds1.Tables(0).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                            Title = "(" + ds1.Tables(0).Rows(0).Item("title6").ToString() + " per " + ds1.Tables(0).Rows(0).Item("title3").ToString() + ")"
                        ElseIf CInt(ds1.Tables(0).Rows(0).Item("finvolmunits").ToString()) > 0 Then
                    ...
                    Case 3
                        ...
                        ' Code For Td Units
                        If CInt(ds2.Tables(0).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                            Title = "(" + ds2.Tables(0).Rows(0).Item("title6").ToString() + " per " + ds2.Tables(0).Rows(0).Item("title3").ToString() + ")"
                        ElseIf CInt(ds2.Tables(0).Rows(0).Item("finvolmunits").ToString()) > 0 Then
                    ...
                    For j = 1 To 7
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                lbl = New Label()
                                'Code For Total Column
                                If CDbl(ds1.Tables(0).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                                    perunit = CDbl(ds1.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("finvolmsi").ToString()) * 100 * CDbl(ds1.Tables(0).Rows(0).Item("CURR").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("convarea").ToString())
                                ...
                                ElseIf CDbl(ds1.Tables(0).Rows(0).Item("finvolmunits").ToString()) > 0 Then
                                    ...
                                    'lbl.Text = FormatNumber(perunit, 2)
                                Else
                                    lbl.Text = "na"
                                End If
                                tdInner.Controls.Add(lbl)
                            ...
                            Case 3
                                ...
                                If CDbl(ds2.Tables(0).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                                    perunit = CDbl(ds2.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(ds2.Tables(0).Rows(0).Item("finvolmsi").ToString()) * 100 * CDbl(ds2.Tables(0).Rows(0).Item("CURR").ToString()) / CDbl(ds2.Tables(0).Rows(0).Item("convarea").ToString())
                                    lbl.Text = FormatNumber(perunit, 3)
                            ...
                            Case 4
                                ...
                                'Code For Total Comparision Column
                                If CDbl(ds1.Tables(0).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                                    perunit1 = CDbl(ds1.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("finvolmsi").ToString()) * 100 * CDbl(ds1.Tables(0).Rows(0).Item("CURR").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("convarea").ToString())
                                ElseIf CDbl(ds1.Tables(0).Rows(0).Item("finvolmunits").ToString()) > 0 Then
                                ...
                                If CDbl(ds2.Tables(0).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                                    perunit2 = CDbl(ds2.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(ds2.Tables(0).Rows(0).Item("finvolmsi").ToString()) * 100 * CDbl(ds2.Tables(0).Rows(0).Item("CURR").ToString()) / CDbl(ds2.Tables(0).Rows(0).Item("convarea").ToString())
                                ElseIf CDbl(ds2.Tables(0).Rows(0).Item("finvolmunits").ToString()) > 0 Then

...
Partial Class Pages_Distribution_IntResults_ExtrusrionOut
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "EDistribution - Material and Structure Results"
    End Sub
        ...
        Try
            ...
            For i = 1 To 5
                ...
                Select Case i
                    ...
                    Case 5
                        InnerTdSetting(tdInner, "", "Right")
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTPURZ").ToString(), 0) + " </b> </span>"
                        trInner.Controls.Add(tdInner)

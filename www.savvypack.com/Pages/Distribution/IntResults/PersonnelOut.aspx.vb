...
Partial Class Pages_Distribution_IntResults_PersonnelOut
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Personnel Plan ,Payroll, and Department Breakdown')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "EDistribution - Personnel Plan ,Payroll, and Department Breakdown"
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetPersonnelOutDetails(CaseId)
            For i = 1 To 4
                ...
                Select Case i
                    Case 1
                        HeaderTdSetting(tdHeader, "80px", "Position", "1")
                        HeaderTdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 2
                        HeaderTdSetting(tdHeader, "200px", "Position Description", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 3
                        HeaderTdSetting(tdHeader, "150px", "Number of Workers", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 4
                        HeaderTdSetting(tdHeader, "150px", "Payroll", "1")
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            If i = 31 Then
                                lbl.Text = ""
                            Else
                                lbl.Text = ds.Tables(0).Rows(0).Item("PERSDES" + i.ToString() + "").ToString()
                            End If
                        ...
                        Case 3
                            ...
                            lbl = New Label()
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("N" + i.ToString() + "").ToString(), 2)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 4
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label()
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("P" + i.ToString() + "").ToString(), 0)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case Else
                    End Select

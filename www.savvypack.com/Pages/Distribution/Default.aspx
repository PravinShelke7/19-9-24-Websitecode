<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_Distribution_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Edist-Global Manager</title>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif"
                                            runat="server" ToolTip="Log Off" Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=DIST" />
                                    </td>
                                    <td>
                        ...
                        <div id="PageSection1" style="text-align: left;">
                            ...
                            <table width="80%">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlBaseCases" CssClass="DropDown" Width="80%" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr class="AlterNateColor1">
                                    <td>
                                        ...
                                        <asp:Button ID="btnBCaseSearch" runat="server" Text="Case Search" CssClass="Button"
                                            OnClientClick="return ShowPopWindow('PopUp/CaseSearch.aspx?Id=ddlBaseCases');"></asp:Button>
                                    </td>
                                </tr>
                                <tr class="AlterNateColor1">
                                    <td>
                            ...
                            <table width="80%">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlPCase" CssClass="DropDown" Width="80%" runat="server">
                                        </asp:DropDownList>
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:Button ID="btnPCase" runat="server" CssClass="Button" Text="Start a Proprietary Case"
                                            Style="margin-left: 0px;" />
                                        <asp:Button ID="btRename" runat="server" Text="Rename" CssClass="Button" OnClientClick="return MakeVisible('divRename')">
                                        </asp:Button>
                                        <asp:Button ID="btSerach" runat="server" Text="Case Search" CssClass="Button" OnClientClick="return ShowPopWindow('PopUp/CaseSearch.aspx?Id=ddlPCase');">
                                        </asp:Button>
                                    </td>
                                </tr>
                                <tr class="AlterNateColor1">
                                    <td>
                                        <div style="margin-left: 20px; display: none" id="divRename">
                                            <table width="80%" style="padding-left: 20px">
                                                ...
                                                <tr align="left">
                                                    <td>
                                                        <asp:TextBox ID="txtCaseDe1" runat="server" CssClass="SmallTextBox" Style="text-align: left;
                                                            width: 150px" MaxLength="25"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                        <asp:TextBox ID="txtCaseDe2" runat="server" CssClass="SmallTextBox" Style="text-align: left;
                                                            width: 150px" MaxLength="25"></asp:TextBox>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <asp:Button ID="Button1" runat="server" Text="Cancel" CssClass="Button" OnClientClick="return MakeInVisible('divRename')"
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:Button ID="btnToolBox" runat="server" CssClass="Button" Text="Go To Toolbox"
                                            Style="margin-left: 0px;" Visible="true" />
                                    </td>
                                </tr>
                                <tr class="AlterNateColor1">
                                    <td>

...
Partial Class Pages_Distribution_Default
...
#End Region
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("DistUserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("DistServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("DistUserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("DistToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("DistMaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
        Catch ex As Exception
    ...
    Protected Sub SetToolButton()
        Try
            If Session("DistServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("DistCaseId") = ddlBaseCases.SelectedValue.ToString()
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("DistCaseId") = ddlPCase.SelectedValue.ToString()
            If Not objRefresh.IsRefresh Then

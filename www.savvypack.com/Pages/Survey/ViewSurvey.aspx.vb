Imports System
Imports System.Data
Imports SurveyGetData
Imports System.Net
Imports System.Net.Mail
Partial Class Survey_Pages_PopUp_ViewSurvey
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Response.AppendHeader("Pragma", "no-cache")
            ...
            SurveyId = obj.Decrypt(Request.QueryString.Item("SurveyId").ToString())
    ...
    Protected Sub GetSurveyName()
        ...
        Dim objGetData As New SurveyGetData
        Try
    ...
    Protected Sub GetUserDetails()
        Try
            Dim objGet As New SurveyGetData
    ...
    Protected Sub btnsend_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsend.Click
        ...
        Try
            ...
            Next
            objUpIns.AddSurveyAnswer(UserId, SurveyId, Ques, ans, comAns, QFCount, BlastId)
            objUpIns.AddResponseDate(UserId, SurveyId, BlastId)

            'Send Email to allied contact
            dsEmail = objGetData.GetEmailConfigDetails("Y")
            dsUser = objGet.GetUserName(UserId)
            dsSurvey = objGet.GetSurveyName(SurveyId)

            If dsEmail.Tables(0).Rows.Count > 0 Then
                strLink = dsEmail.Tables(0).Rows(0).Item("URL").ToString()
                strBody = GetEmailBodyDataNotify(strLink, dsUser.Tables(0).Rows(0).Item("USERNAME").ToString(), dsSurvey.Tables(0).Rows(0).Item("NAME").ToString())
...
#Region "Email"
    ...
    Protected Function GetEmailBodyDataNotify(ByVal link As String, ByVal Username As String, ByVal SurveyNm As String) As String
        ...
        Try
            ...
            StrSqlBdy = StrSqlBdy + "<table style='font-family:Verdana;width:650px;font-size:12px;border-collapse:collapse' border='1' bordercolor='black' cellpadding='0' cellspacing='0'><tr style='font-weight:bold;text-align:center'><td>User Name</td><td>Survey Name</td></tr> "
            StrSqlBdy = StrSqlBdy + "<tr><td>" + Username + "</td><td>" + SurveyNm + "</td></tr> "
            StrSqlBdy = StrSqlBdy + "</table> "
            StrSqlBdy = StrSqlBdy + "<br /> "

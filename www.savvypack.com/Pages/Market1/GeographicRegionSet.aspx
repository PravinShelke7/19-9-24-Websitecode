...
<div>
                   <asp:GridView CssClass="GrdUsers" runat="server" ID="grdRegionSet" PageSize="30" 
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="RegionSet Name" HeaderStyle-HorizontalAlign="center" SortExpression="REGIONSETNAME" ItemStyle-HorizontalAlign="Left" >
                            <ItemTemplate>                             
                               ...
                               AutoPostBack="false"  
                               NavigateUrl='<%# "~/Pages/Market1/RegionSetsDetails.aspx?RegionSetId="+  Eval("REGIONSETID").toString()%>'>
                               </asp:HyperLink>
                            </ItemTemplate>

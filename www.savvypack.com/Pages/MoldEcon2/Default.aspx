<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_MoldEcon2_Default" %>
                ...
                <div id="ContentPagemargin" runat="server">
                    <div id="PageSection1" style="text-align: left;">
                        ...
                        <table width="90%">
                            ...
                            <tr class="AlterNateColor1">
                                <td>
                                    <asp:DropDownList ID="ddlPCase" CssClass="DropDown" Width="98%" runat="server">
                                    </asp:DropDownList>
                            ...
                            <tr class="AlterNateColor1">
                                <td>
                                    <asp:Button ID="btnToolBox" runat="server" CssClass="Button" Text="Go To Toolbox"
                                        Style="margin-left: 0px;" ToolTip="Manage Groups and Cases" />
                                </td>
                            </tr>
                            <tr class="AlterNateColor1">
                                <td>

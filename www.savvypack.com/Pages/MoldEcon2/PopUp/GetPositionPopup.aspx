<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetPositionPopup.aspx.vb"
    Inherits="Pages_MoldEcon2_PopUp_GetPersonnelINPopup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E2 Mold-Get Postion Description</title>
                ...
                <asp:GridView Width="400px" runat="server" ID="grdPos" DataKeyNames="persid" AutoGenerateSelectButton="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Pos Des1" SortExpression="palletde1">
                            <ItemTemplate>
                                <a href="#" onclick="PositionDet('<%#Container.DataItem("persde1")%>','<%#Container.DataItem("persid")%>')"
                                    class="Link">
                        ...
                        <asp:BoundField DataField="persde2" HeaderText="Position Des2" SortExpression="persde2"
                            Visible="true">

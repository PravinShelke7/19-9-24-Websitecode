...
Partial Class Pages_MoldEcon2_PopUp_CasesSearch
            ...
            If hidCaseid.Value = "hidPropCase" Or hidCaseid.Value = "hidTargetApp" Or hidCaseid.Value = "hidTargetProp" Then
                If Session("MoldE2LicAdmin") = "N" Then
                    If Request.QueryString("GrpID") <> "0" Then
                        ds = objGetData.GetGroupPCases(Session("MoldE2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Request.QueryString("GrpID").ToString())
                    Else
                        ds = objGetData.GetPropCases(Session("MoldE2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                    End If

                Else
                    ds = objGetData.GetPropCasesByLicense(Session("MoldE2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If
            Else
                If Session("MoldE2LicAdmin") = "N" Then
                    ds = objGetData.GetApprovedCases(Session("MoldE2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                Else
                    ds = objGetData.GetAppCasesByLicense(Session("MoldE2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If

...
Partial Class Pages_MoldEcon2_PopUp_CaseSearch
        ...
        Try
            If hidCaseid.Value = "ddlPCase" Then
                If Session("MoldE2LicAdmin") = "N" Then
                    ...
                    End If
                Else
                    ds = objGetData.GetCasesByLicense(Session("MoldE2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If
            Else

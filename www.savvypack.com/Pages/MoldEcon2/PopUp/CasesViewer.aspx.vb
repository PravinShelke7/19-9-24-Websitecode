...
Partial Class Pages_MoldEcon2_PopUp_CasesViewer
            ...
            If Session("E2LicAdmin") = "N" Then
                If Request.QueryString("CTYPE") <> "AP" Then
                    If Request.QueryString("GrpID") <> "0" Then
                        ds = objGetData.GetGroupPCases(Session("MoldE2UserName"), CaseDe1, CaseDe2, Request.QueryString("GrpID").ToString())
                    Else
                        ds = objGetData.GetPropCases(Session("MoldE2UserName"), CaseDe1, CaseDe2)
                    End If

                Else
                    ds = objGetData.GetApprovedCases(Session("MoldE2UserName"), CaseDe1, CaseDe2)
                End If

            Else
                ds = objGetData.GetCasesByLicense(Session("MoldE2UserName"), CaseDe1, CaseDe2)
            End If

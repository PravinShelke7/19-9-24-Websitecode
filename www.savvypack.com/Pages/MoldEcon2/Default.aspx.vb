...
Partial Class Pages_MoldEcon2_Default
...
#End Region
    ...
    Protected Sub GetPCaseDetails()
        ...
        Dim ds As New DataSet()
        Try
            'ds = objGetData.GetPCaseDetails(Session("E2UserName").ToString())
            ...
            Else
                If Session("MoldE2LicAdmin") = "N" Then
                    ds = objGetData.GetPCaseDetails(Session("UserId").ToString())
                Else
                    ds = objGetData.GetPCaseDetailsByLicense(Session("MoldE2UserName").ToString())
                End If
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("MoldE2CaseId") = ddlBaseCases.SelectedValue.ToString()
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("MoldE2CaseId") = ddlPCase.SelectedValue.ToString()
            If Not objRefresh.IsRefresh Then

...
Imports System.Net
Partial Class Pages_MoldEcon2_Default2
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_DEFAULT")
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            SetToolButton()
            If Session("MoldE2LicAdmin") = "Y" Then
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("MoldE2UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("MoldE2ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("MoldE2UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("MoldE2ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("MoldE2MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
            'Set for License Administrator
            Session("MoldE2LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("MoldE2LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
    ...
    Protected Sub GetPCaseGroupDetails()
        ...
        Try
            ...
            'Dts = objGetData.GetSavedCaseAsperUser(Session("E2UserName").ToString(), "-1")
    ...
    Protected Sub SetToolButton()
        Try
            If Session("MoldE2ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            ...
            Else
                ...
                Session("MoldE2CaseId") = hidApprovedCase.Value
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        ...
        Try
            ...
            Else
                Session("MoldE2CaseId") = hidPropCase.Value ' ddlPCase.SelectedValue.ToString()
                lnkPropCase.Text = hidPropCaseD.Value
                lnkCaseGroup.Text = hidGroupCaseD.Value
                Session("CaseType") = "Prop"

                CaseId = Session("MoldE2CaseId")
                User = Session("MoldE2UserName")
                dsSt = objgetdata.GetStatusForSister("MoldE2", CaseId, User)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldE2ConnectionString")
            'GetPCaseDetails()
            lnkPropCase.Text = "Select Case"
            hidPropCase.Value = "0"

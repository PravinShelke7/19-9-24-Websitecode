...
Imports ToolCCS
Partial Class Pages_MoldEcon2_Tools_Tool
    Inherits System.Web.UI.Page
#Region "Browser Refresh Check"
    Dim objRefresh As zCon.Net.Refresh

    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_TOOLS_TOOL")
    End Sub
...
#End Region
    ...
    Protected Sub GetBCaseDetails()
        Dim objGetData As New MoldE2GetData.Selectdata() 'change made E1GetData by E2GetData
    ...
    Protected Sub GetUserDetails()
        Dim objGetData As New MoldE2GetData.Selectdata() 'change made E1GetData by MoldE2GetData
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetUserCompanyUsers(Session("MoldE2UserName").ToString()) 'Replace E1UserName
            With ddlUsers
                .DataSource = ds
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                CaseId = ddlPCases.SelectedValue.ToString()
                obj.CaseRename(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldE2ConnectionString")
                GetPCaseDetails()

...
Imports ToolCCS
Partial Class Pages_MoldEcon2_Tools_AdminTool
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.BaseCaseSynch(SCaseId, TCaseId, "SUSTAIN2MOLD", "ECON2MOLD", "MoldE2ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            ...
            obj.CaseRenameBase(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldE2ConnectionString")
            GetBCaseDetails()

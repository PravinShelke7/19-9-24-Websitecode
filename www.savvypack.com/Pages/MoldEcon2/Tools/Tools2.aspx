<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tools2.aspx.vb" Inherits="Pages_MoldEcon2_Tools_Tools2" %>
...
if(CaseId=="0")
         ...
         else
         {
            ...
            if (Flag == 'SYN') {
                ...
                var msg = "You are going to synchronize case " + CaseId + " from Sustain2 Mold to Econ2 Mold. Do you want to proceed?"
            }
             if (Flag == 'RENAME') 
             {
              return true;
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                        Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/MoldEcon2/Default2.aspx"
                            ...
                            <tr class="AlterNateColor1" style="height: 30px">
                                <td>
                                    ...
                                    <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                        OnClientClick="return SyncMessage('Prop', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Sustain2 Mold to Econ2 Mold')"
                                        onmouseout="UnTip()" Style="margin-left: 10px" />

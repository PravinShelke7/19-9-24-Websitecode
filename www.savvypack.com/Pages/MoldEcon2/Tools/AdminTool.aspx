<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdminTool.aspx.vb" Inherits="Pages_MoldEcon2_Tools_AdminTool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E2 Mold-Admin Tools</title>
...
<body style="margin-top: 0px;">
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width: 845px">
        <tr style="height: 20px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Econ2 Mold - Admin Tools')"
                    onmouseout="UnTip()" style="width: 840px;">
                    Econ2 Mold - Admin Tools
                </div>
            </td>
        </tr>
        <tr style="height: 20px">

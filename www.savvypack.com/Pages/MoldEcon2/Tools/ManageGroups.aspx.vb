...
Partial Class Pages_MoldEcon2_Tools_ManageGroups
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            If Session("SavvyModType") <> "1" Then
                ds = objGetData.GetPCaseGrpDetailsBem(Session("MoldE2UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim())
            Else
                ds = objGetData.GetPCaseGrpDetails(Session("MoldE2UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim())
            End If

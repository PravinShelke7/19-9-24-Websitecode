<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_MoldEcon2_Tools_Tool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E2 Mold-Tools</title>
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from Sustain2 Mold to Econ2 Mold. Do you want to proceed?"
            }
 ...
 function ShareMessageNew(Case, User, Flag) 
         ...
         function CreateMessage(Case, Flag) 
        {
          ...
          var MaxCount="<%=Session("MoldE2MaxCaseCount")%>";       
...
<body style="margin-top: 0px;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                        Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/MoldEcon2/Default.aspx"
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width: 845px">
        <tr style="height: 20px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Econ2 Mold-Tools')"
                            ...
                            <tr class="AlterNateColor1" style="height: 30px">
                                <td>
                                    ...
                                    <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                        OnClientClick="return ShareMessage('ddlPCases', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Sustain2 Mold to Econ2 Mold')"
                                        onmouseout="UnTip()" Style="margin-left: 10px" />
                                ...
                                <tr class="AlterNateColor1">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCaseDe3" onKeyUp="javascript:Count(this);" onChange="javascript:Count(this);"
                                            runat="server" CssClass="MediumTextBox" Style="text-align: left; width: 255px;"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CResultCost2.aspx.vb" Inherits="Pages_MoldEcon2_Results_CResultCost2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E2 Mold-Customer Cost Comparison</title>
            ...
            <tr>
                <td>
                    <div class="PageHeading" id="divMainHeading" style="width: 840px;">
                        Econ2 Mold - Customer Cost Comparison
                    </div>
                </td>
            </tr>

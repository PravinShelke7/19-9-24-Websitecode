...
Partial Class Pages_MoldEcon2_Results_CResultCost2
...
#End Region
    ...
    Protected Sub GetByTotal(ByVal ds1 As DataSet, ByVal ds2 As DataSet)
        ...
        Dim newVal1 As Decimal
        Dim newVal2 As Decimal
        ...
        Try
            ...
            customerSaleValue1 = FormatNumber(CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()), 0)
            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                customerSaleValue2 = FormatNumber(CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME1").ToString()) * CDbl(ds2.Tables(0).Rows(0).Item("CONVWT").ToString()), 0)
            Else
                customerSaleValue2 = FormatNumber(CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME1").ToString()), 0)
            End If
                    ...
                    For j = 1 To 5
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                    If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0 Then
                                        newVal1 = CDbl(ds1.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString() * CDbl(ds1.Tables(0).Rows(0).Item("CURR").ToString())) * customerSaleValue1 / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString())
                                        'CustValue = CDbl(ds1.Tables(0).Rows(0).Item("PL24").ToString() * CDbl(ds1.Tables(0).Rows(0).Item("CURR").ToString())) * customerSaleValue / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString())
                                    End If
                                Else
                                    If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                        newVal1 = CDbl(ds1.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) * CDbl(ds1.Tables(0).Rows(0).Item("CURR").ToString()) * customerSaleValue1 / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString())
                                        'CustValue = CDbl(ds.Tables(0).Rows(0).Item("PL24").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString()) * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString())
                                    End If
                                End If
                                lbl.Text = FormatNumber(newVal1, 0)
                            ...
                            Case 3
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                    If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0 Then
                                        newVal2 = CDbl(ds2.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString() * CDbl(ds2.Tables(0).Rows(0).Item("CURR").ToString())) * customerSaleValue2 / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString())
                                        'CustValue = CDbl(ds1.Tables(0).Rows(0).Item("PL24").ToString() * CDbl(ds1.Tables(0).Rows(0).Item("CURR").ToString())) * customerSaleValue / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString())
                                    End If
                                Else
                                    If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                        newVal2 = CDbl(ds2.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) * CDbl(ds2.Tables(0).Rows(0).Item("CURR").ToString()) * customerSaleValue2 / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString())
                                        'CustValue = CDbl(ds.Tables(0).Rows(0).Item("PL24").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString()) * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString())
                                    End If
                                End If
                                lbl.Text = FormatNumber(newVal2, 0)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Case 4
                                InnerTdSetting(tdInner, "", "Right")
                                ...
                                If newVal1 <> 0 Then
                                    ...
                                    Comp = FormatNumber(((newVal1 - newVal2) / newVal1) * 100, 1)
                                    lbl.Text = FormatNumber(Comp, 1)
                                Else
                                    lbl.Text = "na"
                                End If
                                tdInner.Controls.Add(lbl)
                            ...
                            Case 5
                                ...
                                If CDbl(newVal1) <> CDbl(0) Then
                                    Comp = FormatNumber((newVal2 / newVal1) * 100, 1)
                                Else
                                    Comp = "na"
                                End If
                                lbl.Text = Comp
    ...
    Protected Sub GetByWeight(ByVal ds1 As DataSet, ByVal ds2 As DataSet)
        ...
        Try
            customerSaleValue1 = FormatNumber(CDbl(((CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString())))), 0)
            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                customerSaleValue2 = FormatNumber(CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME1").ToString()) * CDbl(ds2.Tables(0).Rows(0).Item("CONVWT").ToString()), 0)
            Else
                customerSaleValue2 = FormatNumber(CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME1").ToString()), 0)
                            ...
                            Case 2
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) <> 0 Then
                                    If CDbl(customerSaleValue1 * UnitTolb1) <> 0 Then
                                        perwt1 = CDbl(newVal1) / CDbl(customerSaleValue1 * UnitTolb1)
                                ...
                                Else
                                    If CDbl(customerSaleValue1) <> 0 Then
                                        perwt1 = CDbl(newVal1) / CDbl(customerSaleValue1)
                                        lbl.Text = FormatNumber(perwt1, 3)
                                    Else
                                        lbl.Text = "na"
                                    End If
                            ...
                            Case 3
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) <> 0 Then
                                    If CDbl(customerSaleValue2 * UnitTolb2) <> 0 Then
                                        perwt2 = CDbl(newVal2) / CDbl(customerSaleValue2 * UnitTolb2)
                                ...
                                Else
                                    If CDbl(customerSaleValue2) <> 0 Then
                                        perwt2 = CDbl(newVal2) / CDbl(customerSaleValue2)
                                        lbl.Text = FormatNumber(perwt2, 3)
                                    Else
                                        lbl.Text = "na"
                                    End If
            ...
            For i = 1 To 5
                ...
                Select Case i
                    ...
                    Case 3
                        ...
                        Header2TdSetting(tdHeader3, "", "", "1")
                        GetCaseDetails(tdHeader2, tdHeader3, ds2.Tables(0).Rows(0).Item("CaseId").ToString())
                        If CDbl(ds2.Tables(0).Rows(0).Item("finvolmunits").ToString()) > 0 Then
                            ...
                            Case 2
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                    If CDbl(customerSaleValue1 * lbToUnit1) <> 0 Then
                                        perunit1 = (CDbl(newVal1) / CDbl(customerSaleValue1 * lbToUnit1)) * 100
                                        lbl.Text = FormatNumber(perunit1, 4)
                                    Else
                                        lbl.Text = "na"
                                    End If
                                Else
                                    If CDbl(customerSaleValue1) <> 0 Then
                                        perunit1 = (CDbl(newVal1) / CDbl(customerSaleValue1)) * 100
                                        lbl.Text = FormatNumber(perunit1, 4)
                                    Else
                                        lbl.Text = "na"
                                    End If
                            ...
                            Case 3
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                    If CDbl(customerSaleValue2 * lbToUnit2) <> 0 Then
                                        perunit2 = (CDbl(newVal2) / CDbl(customerSaleValue2 * lbToUnit2)) * 100
                                        lbl.Text = FormatNumber(perunit2, 4)
                                    Else
                                        lbl.Text = "na"
                                    End If
                                Else
                                    If CDbl(customerSaleValue2) <> 0 Then
                                        perunit2 = (CDbl(newVal2) / CDbl(customerSaleValue2)) * 100
                                        lbl.Text = FormatNumber(perunit2, 4)
                                    Else
                                        lbl.Text = "na"
                                    End If

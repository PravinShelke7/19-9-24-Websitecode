<%@ Page Title="E2 Mold-Print Case Summary" Language="VB" MasterPageFile="~/Masters/MoldEcon2.master"
    AutoEventWireup="false" CodeFile="PrintCaseSummary.aspx.vb" Inherits="Pages_MoldEcon2_Results_PrintCaseSummary" %>
    ...
    <div id="ContentPagemargin" runat="server">
        <div id="PageSection1" style="text-align: left">
            ...
            <div id="divSalesVol" class="PrintCaseSummaryPrint">
                ...
                <asp:Table ID="tblSalesVol" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divProfitAndLoss" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Profit and Loss Results</div>
                <asp:Table ID="tblPandL" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divMaterilInput" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Material Assumptions</div>
                <asp:Table ID="tblMatInput" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divMatRes" class="PrintCaseSummaryPrint">
                ...
                <asp:Table ID="tblMatResults" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divEquipment" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Equipment Assumptions</div>
                <asp:Table ID="tblEquipment" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divOperations" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Operating Assumptions</div>
                <asp:Table ID="tblOperations" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divPersonnel" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Personnel Assumptions</div>
                <asp:Table ID="tblPersonnel" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divFixCost" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Fixed Cost Assumptions</div>
                <asp:Table ID="tblFixCost" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
        </div>

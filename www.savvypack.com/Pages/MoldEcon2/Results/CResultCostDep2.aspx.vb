...
Partial Class Pages_MoldEcon2_Results_CResultCostDep2
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            ds1 = objGetData.GetCostDetailsWithDep(CaseId1, True)
            ds2 = objGetData.GetCostDetailsWithDep(CaseId2, True)
                    ...
                    Select Case j
                        Case 1
                            ...
                            If i = 6 Or i = 24 Or i = 25 Then
                                tdInner.Text = "<b>" + ds1.Tables(0).Rows(0).Item("DES" + i.ToString() + "").ToString() + "</b>"
                            Else
                        ...
                        Case 5
                            ...
                            If CDbl(newVal1) <> CDbl(0) Then
                                lbl.Text = FormatNumber((newVal2 / newVal1) * 100, 1)
                            Else
                                lbl.Text = "na"
                            End If
                            tdInner.Controls.Add(lbl)

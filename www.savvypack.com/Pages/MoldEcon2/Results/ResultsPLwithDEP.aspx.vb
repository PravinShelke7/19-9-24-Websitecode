...
Partial Class Pages_MoldEcon2_Results_ResultsPLwithDEP
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Profit and Loss Statement with Depreciation"
    End Sub
            ...
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 6
                        ...
                        Header2TdSetting(tdHeader2, "85px", "Suggested", "1")
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                UnitPrice = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$UNITPP").Replace(",", "")
                UnitType = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$UNITTYPE")
                'Check For IsNumric

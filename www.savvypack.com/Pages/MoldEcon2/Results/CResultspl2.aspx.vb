...
Partial Class Pages_MoldEcon2_Results_CResultspl2
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            ds1 = objGetData.GetProfitAndLossDetails(CaseId1, False)
            ds2 = objGetData.GetProfitAndLossDetails(CaseId2, False)
                    ...
                    For j = 1 To 7
                        ...
                        Select Case j
                            ...
                            Case 5
                                InnerTdSetting(tdInner, "", "Right")
                                lbl = New Label()
                                If (CDbl(newVal1)) <> 0 Then
                                    lbl.Text = FormatNumber(CDbl(newVal2 / newVal1) * 100, 1)
                                Else
                                    lbl.Text = "na"
                                End If
                                tdInner.Controls.Add(lbl)
                            ...
                            Case 2
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) <> 0 Then
                                    If CDbl(customerSaleValue1 * UnitTolb1) <> 0 Then
                                        ...
                                        lbl.Text = FormatNumber(perwt1, 4)
                                    Else
                                        lbl.Text = "na"
                                    End If
                                Else
                            ...
                            Case 3
                                ...
                                If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) <> 0 Then
                                    If CDbl(customerSaleValue2 * UnitTolb2) <> 0 Then
                                        ...
                                        lbl.Text = FormatNumber(perwt2, 4)
                                    Else
                                        lbl.Text = "na"
                                    End If
                                Else

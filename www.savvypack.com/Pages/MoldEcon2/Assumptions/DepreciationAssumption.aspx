<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DepreciationAssumption.aspx.vb"
    Inherits="Pages_MoldEcon2_Assumptions_DepreciationAssumption" MasterPageFile="~/Masters/MoldEcon2.master"
    Title="E2 Mold-Depreciation Assumption" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MoldEcon2ContentPlaceHolder" runat="Server">
    ...
    <div id="ContentPagemargin" runat="server">
        ...
        <asp:HiddenField ID="hidRvalue" runat="server" />
    </div>
</asp:Content>

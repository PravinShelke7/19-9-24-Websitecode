...
Partial Class Pages_MoldEcon2_Assumptions_FixedCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Fixed Cost Guidelines"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    FixedCostVal(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$FIXCOST" + i.ToString() + "").Replace(",", "")
                    FixedCostPref(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$FCPREF" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidFCDepid" + i.ToString() + "")

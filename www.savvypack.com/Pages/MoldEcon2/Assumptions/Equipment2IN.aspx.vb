...
Partial Class Pages_MoldEcon2_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Support Equipment Assumptions"
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    HRS(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$HRS" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidCosId" + i.ToString() + "")

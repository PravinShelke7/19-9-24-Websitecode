...
Partial Class Pages_MoldEcon2_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Equipment Assumptions"
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    hidAssetId(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    AP(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$AP" + i.ToString() + "")
                    PAP(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$PAP" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$ECP" + i.ToString() + "")
                    NGP(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$NGP" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidEqDepid" + i.ToString() + "")

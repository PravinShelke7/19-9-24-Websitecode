<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MaterialViewer.aspx.vb"
    Inherits="Pages_MoldEcon2_PopUp_MaterialViewer" %>
            ...
            <div style="margin-left: 10px; width: 600px;">
                ...
                <table width="90%">
                    ...
                    <tr class="AlterNateColor1">
                        <td>
                            <asp:DropDownList ID="ddlMat" CssClass="DropDown" Width="80%" runat="Server">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr class="AlterNateColor1">

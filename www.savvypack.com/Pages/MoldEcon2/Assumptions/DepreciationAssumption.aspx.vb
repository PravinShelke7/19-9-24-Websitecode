...
Partial Class Pages_MoldEcon2_Assumptions_DepreciationAssumption
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Depreciation Assumption"
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                hidcnt.Value = "0"
                hidDeprettl.Value = "0"
                Session("EQE2_ICOST") = Nothing
                Session("SEQE12_ICOST") = Nothing
                GetPageDetails()
            End If
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            Session("EQE2_ICOST") = ds
            Session("SEQE12_ICOST") = dsSE
            ...
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 6
                        ...
                        trHeader2.Controls.Add(tdHeader2)
                    Case 7
                        Dim Title1 As String = "A special function provides the capability to make depreciation zero by inputting a zero in the " + """" + "Depreciation Period" + """" + " column text boxes."
                        HeaderTdSetting(tdHeader, "100px", "Depreciation Period", "1")
                        Header2TdSetting(tdHeader1, "0", "", "1")
                        Header2TdSetting(tdHeader2, "", "(years)", "1")
                        tdHeader.Attributes.Add("onmouseover", "Tip('" + Title1 + "')")
                ...
                If k <> 0 Then
                    ...
                    Select Case k
                        ...
                        Case 4
                            ...
                            depC = lbl.Text.Replace("<b>", "").Replace("</b>", "")
                            tdInner1.Controls.Add(lbl)
                            trInner1.Controls.Add(tdInner1)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Dim cnt = hidcnt.Value
        Dim dsEq, dsSEQ As New DataSet
        Try
            dsEq = CType(Session("EQE2_ICOST"), DataSet)
            dsSEQ = CType(Session("SEQE12_ICOST"), DataSet)

            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    DEPRE(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$DEPRE" + i.ToString() + "")
                    DEPRESE(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$DEPRES" + i.ToString() + "")
                    ...
                    End If
                Next
                ObjUpIns.DepreciationUpdate(CaseId, DEPRE, cnt, DEPRESE)
                Calculate()
                'Update Server Date

...
Partial Class Pages_MoldEcon2_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Material Assumption"
    End Sub
            ...
            For i = 1 To 13
                ...
                Select Case i
                    ...
                    Case 8
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 9
                        HeaderTdSetting(tdHeader, "105px", "Econ1 Mold Cases", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Price(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$PRICE" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$REC" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$EP" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidDepid" + i.ToString() + "")
                    E1Cases(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Quant(i - 1) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$MoldEcon2ContentPlaceHolder$PCOMP" + i.ToString() + "") <> "" Then
                        PC(i - 1) = 1
                    Else
                        PC(i - 1) = 0
                    End If
                ...
                Next
                plate = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$radPlate")

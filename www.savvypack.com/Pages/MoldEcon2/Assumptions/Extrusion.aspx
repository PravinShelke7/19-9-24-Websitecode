<%@ Page Language="VB" MasterPageFile="~/Masters/MoldEcon2.master" AutoEventWireup="false"
    CodeFile="Extrusion.aspx.vb" Inherits="Pages_MoldEcon2_Assumptions_Extrusion" Title="E2 Mold-Material And Structure" %>
            ...
            <table cellspacing="5">
                <tr>
                    <td style="padding-left: 5px" valign="middle" colspan="2">
                        <a href="MaterialViewer.aspx" class="Link" target="_blank" style="font-weight: bold;
                            display: none">Material Viewer</a>
                    </td>
                </tr>
                <tr>

<%@ Page Language="VB" MasterPageFile="~/Masters/MoldEcon2.master" AutoEventWireup="false"
    CodeFile="FixedCost.aspx.vb" Inherits="Pages_MoldEcon2_Assumptions_FixedCost" Title="E2 Mold-Fixed Cost Guidelines " %>
    ...
    <div id="ContentPagemargin" runat="server">
        <div id="PageSection1" style="text-align: left">
            ...
            <div style="margin-left: 380px;">
                <asp:Table ID="tblComparision" runat="server" CellPadding="0" CellSpacing="2" Visible="false">
                </asp:Table>
            </div>

...
Partial Class Pages_MoldEcon2_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Customer Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$PRODPUR").Replace(",", "")
                SHIPDIST = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$SHIPDIST").Replace(",", "")
                MILCOST = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$MILCOST").Replace(",", "")
                'Check For IsNumric

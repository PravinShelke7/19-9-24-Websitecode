<%@ Page Language="VB" MasterPageFile="~/Masters/MoldEcon2.master" AutoEventWireup="false"
    CodeFile="PlantConfig.aspx.vb" Inherits="Pages_MoldEcon2_Assumptions_PlantConfig"
    Title="E2 Mold-Plant Configuration" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 830px">
                <tr>
                    <td valign="top" style="width: 10%">
                        <asp:Table ID="tblComparisionFix" runat="server" CellPadding="0" CellSpacing="1">
                        </asp:Table>
                    </td>

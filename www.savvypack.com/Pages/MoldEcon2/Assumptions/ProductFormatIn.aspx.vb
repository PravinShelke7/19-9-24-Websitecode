...
Partial Class Pages_MoldEcon2_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 Mold - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Econ2_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
            ...
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 7
                        ...
                        HeaderTdSetting(tdHeader, "100px", " Packaging Weight", "1")
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("MoldE2ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$MoldEcon2ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

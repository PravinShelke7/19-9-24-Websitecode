<%@ Page Language="VB" MasterPageFile="~/Masters/PackProdPopUp.master" AutoEventWireup="false" CodeFile="GetCountries.aspx.vb" Inherits="Pages_PackProd_Popup_GetCountries" title="Pack. Prod.-Get Countries" %>
...
<script type="text/JavaScript">
        function SearchItem(itemId) 
         {            
             ...
             window.opener.document.getElementById('ctl00$PackProdContentPlaceHolder$btnState').click();  
             window.close();
         }
     </script> 

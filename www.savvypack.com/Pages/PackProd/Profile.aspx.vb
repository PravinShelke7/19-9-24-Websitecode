...
Partial Class Pages_PackProd_Profile
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Packaging Producer - Keyword Search Results "
    End Sub
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            If dsCat.Tables(0).Rows(i).Item("ISDETAILS").ToString() = "Y" And dsCat.Tables(0).Rows(i).Item("ISCOMMENTS").ToString() = "Y" Then
                                ...
                                If dsProfDet.Tables(0).Rows.Count > 0 Then
                                    divDetails.InnerHtml = dsProfDet.Tables(0).Rows(0).Item("DETAILS").ToString() + "<br/><br/>"
                                End If
                                divComments.InnerHtml = "<b>Comments: </b>" + dsProfComm.Tables(0).Rows(0).Item("COMMENTS").ToString() + ""
                            ...
                            If dsCat.Tables(0).Rows(i).Item("ISDETAILS").ToString() = "N" And dsCat.Tables(0).Rows(i).Item("ISCOMMENTS").ToString() = "Y" Then
                                ...
                                divDetails.InnerHtml = dsProfDet.Tables(0).Rows(0).Item("COMMENTS").ToString() + ""
                                tdInner.Controls.Add(divDetails)
                                trInner.Controls.Add(tdInner)
                                tdInner.RowSpan = 2
                                tdSInner.RowSpan = 2
                        ...
                        Case 3
                            ...
                            If dsCat.Tables(0).Rows(i).Item("ISDETAILS").ToString() = "N" And dsCat.Tables(0).Rows(i).Item("ISCOMMENTS").ToString() = "Y" Then
                                dsProfComm = objGetdata.GetUserCategoryComments(dsCat.Tables(0).Rows(i).Item("CATEGORYID").ToString(), CompanyId, Session("UserId"))
                                If dsProfComm.Tables(0).Rows.Count > 0 Then
                                    divComments.InnerHtml = dsProfComm.Tables(0).Rows(0).Item("COMMENTS").ToString() + ""
                                End If

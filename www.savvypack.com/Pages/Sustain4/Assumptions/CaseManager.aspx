<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_Sustain4_Assumptions_CaseManager" title="S4-Case Manager" %>
        ...
        <br />
            <table width="98%" style="text-align:left;">
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft"> 
                      <%--  <a href="../Graphs/GhgComp.aspx" class="Link" target="_blank"> GHG Charts</a>--%>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="height: 22px"> 
                        <a href="../../../Charts/S4Charts/CErgyGhg.aspx" class="Link" target="_blank">Graphic Tool</a> 
                    </td>
                </tr>

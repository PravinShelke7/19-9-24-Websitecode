...
Partial Class Pages_Sustain4_Assumptions_PalletIn
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            For k = 0 To DataCnt
                                ...
                                'TextBoxSetting(txt, "NormalTextBox")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("NU" + i.ToString() + "").ToString(), 2)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(txt)
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, DWidth, "Right")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("ES" + i.ToString() + "").ToString(), 3)
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 8
                            ...
                            For k = 0 To DataCnt
                                'Energy Preff
                                tdInner = New TableCell
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("EP" + i.ToString() + "").ToString(), 3)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(txt)
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 13
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, DWidth, "Right")
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("SS" + i.ToString() + "").ToString(), 0)
                                trInner.Controls.Add(tdInner)
                        ...
                        Case 14
                            ...
                            For k = 0 To DataCnt
                                'Ship Distance Preff
                                tdInner = New TableCell
                                tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("SP" + i.ToString() + "").ToString(), 2)
                                InnerTdSetting(tdInner, DWidth, "Right")
                                'tdInner.Controls.Add(txt)
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 18
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, DWidth, "Right")
                                tdInner.Text = dstbl.Tables(k).Rows(0).Item("SMS" + i.ToString() + "").ToString()
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 19
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                If dstbl.Tables(k).Rows(0).Item("SMP" + i.ToString() + "").ToString() <> "" Then
                                    tdInner.Text = dstbl.Tables(k).Rows(0).Item("SMP" + i.ToString() + "").ToString()
                                Else

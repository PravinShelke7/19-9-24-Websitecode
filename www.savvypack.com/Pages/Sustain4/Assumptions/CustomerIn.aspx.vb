...
Partial Class Pages_Sustain4_Assumptions_CustomerIn
                ...
                For j = 1 To 13
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            tdInner = New TableCell
                            Title = "(MJ/" + dstbl.Tables(0).Rows(0).Item("TITLE10").ToString() + ")"
                        ...
                        Case 5
                            tdInner = New TableCell
                            Title = "(CO2 " + dstbl.Tables(0).Rows(0).Item("Title8").ToString() + "/" + dstbl.Tables(0).Rows(0).Item("TITLE10").ToString() + ")"
                        ...
                        Case 9
                            tdInner = New TableCell
                            Title = "(" + dstbl.Tables(0).Rows(0).Item("Title4").ToString() + "/" + dstbl.Tables(0).Rows(0).Item("TITLE10").ToString() + ")"

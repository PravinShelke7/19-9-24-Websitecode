<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="PlantConfig2.aspx.vb" 
Inherits="Pages_Sustain4_Assumptions_PlantConfig2" title="S4-Plant Space Requirements" %>
                 ...
                 <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                   <b>Space Type</b>
                        <div style="margin-left:7px;margin-bottom:5px">
                              <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_P" checked="checked"   onclick="showhideALL1('ctl00_Sustain4ContentPlaceHolder_P'); " />Production
                              <br />
                              <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_W" checked="checked"   onclick="showhideALL1('ctl00_Sustain4ContentPlaceHolder_W'); " />Warehouse
                              <br />
                               <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_O" checked="checked"   onclick="showhideALL1('ctl00_Sustain4ContentPlaceHolder_O'); " />Office
                              <br />
                               <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_S" checked="checked"   onclick="showhideALL1('ctl00_Sustain4ContentPlaceHolder_S'); " />Support
                              <br />
                                <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_T" checked="checked"   onclick="showhideALL1('ctl00_Sustain4ContentPlaceHolder_T'); " />Total

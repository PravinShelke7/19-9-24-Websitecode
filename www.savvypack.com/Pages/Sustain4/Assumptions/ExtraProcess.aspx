...
CodeFile="ExtraProcess.aspx.vb" Inherits="Pages_Sustain4_Assumptions_ExtraProcess" title="S4-Extra-process Waste" %>
        ...
        <tr>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_VA"   checked="checked"    onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_VA',3); " />Extra-process Waste Value
                            <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_RUL"  checked="checked"   onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_RUL',3); " />Extra-process Waste Rule
                            <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_SUG"  checked="checked"   onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_SUG',3); " />Suggested
                            <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_PREF" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_PREF',3); " />Preferred
                            <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_DEPT" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_DEPT',3); " />Mfg. Dept.

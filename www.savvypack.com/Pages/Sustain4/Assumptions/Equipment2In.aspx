<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="Equipment2In.aspx.vb" 
Inherits="Pages_Sustain4_Assumptions_Equipment2In" title="S4-Support Equipment" %>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <br />
                           <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_ES" checked="checked"   onclick="showhideALL2('ctl00_Sustain4ContentPlaceHolder_ES'); " />Maximum Annual Run Hours
                         <%-- <br />--%>
                          ...
                          <%-- <br />--%>
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_NCS" checked="checked"  onclick="showhideALL2('ctl00_Sustain4ContentPlaceHolder_NCS'); " />Natural Gas Consumption Sugg.
                             <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_NCP" checked="checked"  onclick="showhideALL2('ctl00_Sustain4ContentPlaceHolder_NCP'); " />Natural Gas Consumption Pref.
                             <br />

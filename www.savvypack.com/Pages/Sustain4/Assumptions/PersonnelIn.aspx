<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="PersonnelIn.aspx.vb" 
Inherits="Pages_Sustain4_Assumptions_PersonnelIn" title="S4-Personnel" %>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_PD" checked="checked"   onclick="showhideALL2('ctl00_Sustain4ContentPlaceHolder_PD'); " />Position Description
                          <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_NOW" checked="checked"  onclick="showhideALL2('ctl00_Sustain4ContentPlaceHolder_NOW'); " />Number of Workers
                             <br />

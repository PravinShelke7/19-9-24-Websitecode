...
Partial Class Pages_Sustain4_Assumptions_Effciency
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            For k = 0 To DataCnt
                                ...
                                lbl = New Label
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("A" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 4
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("B" + i.ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 5
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("C" + i.ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 6
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("D" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("E" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 8
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("F" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 9
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("G" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 10
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("H" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 11
                            ...
                            For k = 0 To DataCnt    'Dept9
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("I" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If
                        ...
                        Case 12
                            ...
                            tdInner = New TableCell
                            LeftTdSetting(tdInner, "Deparment Name 10", trInner, "AlterNateColor1")
                            ...
                            For k = 0 To DataCnt
                                ...
                                InnerTdSetting(tdInner, DWidth, "Left")
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("DEP" + (j - 2).ToString() + "").ToString()
                                If Convert.ToInt32(dstbl.Tables(k).Rows(0).Item("J" + (i).ToString() + "").ToString()) = 1 Then
                                    chk.Checked = True
                                Else
                                    chk.Checked = False
                                End If

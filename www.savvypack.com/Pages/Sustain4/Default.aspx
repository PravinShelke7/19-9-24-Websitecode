<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_Sustain4_Default" title="S4-Assumption Comparision" %>
  ...
  function Message() 
        {
         var modType="<%=Session("SavvyModType")%>"; 
                ...
                if(modType=="2")
                {
                               var SisterCases="<%=Session("S4SisterCases")%>"; 
                               var sisCases="";
                               var sisStatus="";
                               var statusId=SisterCases.split(',');
                              // alert(statusId[0]);
                             // alert(SisterCases);
                                var x = document.getElementById("ctl00_Sustain4ContentPlaceHolder_CaseComp");
     ...
     function confirmMessage(msg) {
       ...
       function MakeVisible(id) 
      {
        ...
        function valList() {
            ...
            var selCount = 0;
            var namelength = document.getElementById("ctl00$Sustain4ContentPlaceHolder$ComparisonName").value
            for (var i = 0; i < document.getElementById("ctl00$Sustain4ContentPlaceHolder$CaseComp").length; i++) {
                if (document.getElementById("ctl00$Sustain4ContentPlaceHolder$CaseComp")[i].selected) {
                    selCount += 1;
                }
            ...
            //alert(document.getElementById("ctl00$Econ4ContentPlaceHolder$ComparisonName").value);
            return true;
    ...
    <div id="ContentPagemargin" style="width: 830px;">
        ...
        <table class="Comparison" cellpadding="0" cellspacing="0" border="0" style="padding-left: 10px;">
            <tr>
                <td class="PageHeading" style="padding-left: 10px;">
                    Existing Comparisons</td>
            </tr>
            <tr>
        ...
        <table class="Comparison" cellpadding="0" cellspacing="0" border="0" style="width: 648px;
            padding-left: 10px;">
            <tr>
                <td style="width: 600px; padding-top: 5px;" class="PageHeading">
                    Create a New Comparison</td>
            </tr>
            <tr>
                <td style="width: 600px; padding-left: 15px;">
                    Hold control key to select multiple cases.
                    <br />
                ...
                <td>
                    <div id="newcomparisiondiv" style="display: none">
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td>
                                    <asp:TextBox ID="ComparisonName" runat="server" CssClass="Button"></asp:TextBox>
                                    <br />
                                </td>
                                <td>
        ...
        <table class="Comparison" cellpadding="0" cellspacing="0" border="0" style="width: 648px;
            padding-left: 10px;">
            <tr>
                <td style="padding-left: 10px;" class="PageHeading">
                    Share an Existing Comparison</td>
            </tr>
            ...
            <tr id="headingtr2" runat="server">
                <td style="font-size: 15px">
                    &nbsp;&nbsp;Coworker with whom to share:</td>
            </tr>

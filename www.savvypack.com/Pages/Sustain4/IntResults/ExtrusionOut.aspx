<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="ExtrusionOut.aspx.vb" 
Inherits="Pages_Sustain4_IntResults_ExtrusionOut" title="S4-Material and Structure Results" %>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                           ...
                           <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_M" checked="checked"   onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_M',10); " />Material
                          <br />    
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_WT" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_WT',10); " />Weight 
                              <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_P" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_P',10); " />Purchases 
                             <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_E" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_E',10); " />Energy 
                             <br />
                          <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_G" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_G',10); " />CO2 Eqivalents
                             <br />
                               <input type="checkbox" id="ctl00_Sustain4ContentPlaceHolder_W" checked="checked"  onclick="showhideALLCnt('ctl00_Sustain4ContentPlaceHolder_W',10); " />Water

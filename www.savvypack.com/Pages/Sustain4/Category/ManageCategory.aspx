...
CodeFile="ManageCategory.aspx.vb" Inherits="Pages_Sustain4_Category_ManageCategory" title="S4-Manage Category" %>
...

{
   ...
   return IsNumber;
     ...
     function checkDeletedDrop()
    {
      ...
      {       
        var txtCount=document.getElementById("<%=txtCatCount.ClientId%>").value;
        //var PrevCount=document.getElementById("ctl00$Sustain4ContentPlaceHolder$hdnPrevCount").value;
      ...
      function CheckCategory()
      {
           ...
           {
             var txtCat=document.getElementById("ctl00_Sustain4ContentPlaceHolder_CATNAME"+i).value;
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width: 820px">
        <tr style="height: 20px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('S4 - Manage Category Set')"
                    onmouseout="UnTip()" style="width: 820px;">
                    Sustain4 - Manage Category Set
                </div>
                <div style="text-align: right">
                    <asp:HyperLink ID="HyperLink1" runat="server" Text="Go to Charts" CssClass="Link"
                        Style="font-size: 15px;" Font-Bold="true" NavigateUrl="~/Charts/S4Charts/CErgyGhg.aspx"></asp:HyperLink>
                </div>
            </td>
        </tr>
        <tr>

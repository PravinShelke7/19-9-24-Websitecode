...
Imports S4GetData
Imports S4UpInsData
Partial Class Pages_Sustain4_Category_AddEditCategory
    ...
    Protected Sub bindDetails()
        Dim objGetData As New S4GetData.Selectdata
        Dim objUpdateData As New S4UpInsData.UpdateInsert
    ...
    Protected Sub Transfer1(ByVal Fromlst As ListBox, ByVal Tolst As ListBox, ByVal IsAll As Boolean)
        ...
        Try
            ...
            Dim cntVal As String = Request.Form("ctl00$Sustain4ContentPlaceHolder$lstRegion1")
    ...
    Protected Sub Transfer2(ByVal Fromlst As ListBox, ByVal Tolst As ListBox, ByVal IsAll As Boolean)
        ...
        Try
            ...
            Dim cnt As Integer = 0
            Dim cntVal As String = Request.Form("ctl00$Sustain4ContentPlaceHolder$lstRegion2")
            Dim strCount() As String = Regex.Split(cntVal, ",")

<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="AddEditCategory.aspx.vb" 
Inherits="Pages_Sustain4_Category_AddEditCategory" title="S4-Add/Edit Category Item" %>
...
<script language="javascript" type="text/javascript">
 ...
 <table class="ContentPage" id="ContentPage" runat="server" style="width: 840px">
        <tr style="height: 20px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('S4 - Add/Edit Category Items')"
                    onmouseout="UnTip()" style="width: 800px;">
                    Sustain4 - Add/Edit Category Items
                </div>
                <div style="text-align: right">
                    <asp:HyperLink ID="lnkEditCategory" runat="server" Text="Go to Charts" CssClass="Link"
                        Style="font-size: 13px;" Font-Bold="true" NavigateUrl="~/Charts/S4Charts/CErgyGhg.aspx"></asp:HyperLink>
                    <asp:HyperLink ID="lnkPrev" runat="server" Text="Go to Prev. Page" CssClass="Link"
                        Style="font-size: 13px; margin-left: 10px;" Font-Bold="true" NavigateUrl="~/Pages/Sustain4/Category/ManageCategory.aspx"></asp:HyperLink>
                </div>
            </td>
        </tr>
        <tr>
                    ...
                    <div id="PageSection1" style="text-align: left; margin-left: 0px;">
                        <table width="810px">
                            ...
                            <tr class="AlterNateColor1">
                                ...
                                <td>
                                    <asp:Button ID="btnAdd" runat="server" Text="Add Items" CssClass="ButtonWMarigin"
                                        Style="width: 80px;" OnClientClick="return ValidateData();" onmouseover="Tip('Add Items')"
                                        onmouseout="UnTip()" />
                                    <asp:Button ID="btnRename" runat="server" Text="Rename Category" OnClientClick="return renameCheck('divRename')"
                                        CssClass="ButtonWMarigin" Style="width: 120px;" onmouseover="Tip('Rename Category')"
                                        onmouseout="UnTip()" />
                                    <asp:Button ID="btnDelete" runat="server" Text="Delete Category" CssClass="ButtonWMarigin"
                                        Style="width: 120px;" onmouseover="Tip('Delete Category')" onmouseout="UnTip()" OnClientClick="return checkDeletedDrop();" />
                                </td>
                            </tr>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td valign="middle" style="padding-left: 10px; padding-right: 10px;">
                                                ...
                                                <br />
                                                <br />
                                                <asp:ImageButton ID="btnOk" runat="server" ImageUrl="~/Images/button_ok.png" Style="margin-left: 5px;"
                                                    Width="32px" Height="20px" ToolTip="Ok" />
                                            </td>
                                            <td valign="middle">

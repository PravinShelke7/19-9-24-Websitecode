<%@ Page Language="VB" MasterPageFile="~/Masters/Sustain4.master" AutoEventWireup="false" CodeFile="EditComparision.aspx.vb" Inherits="Pages_Sustain4_Tools_EditComparision" title="S4-Edit Comparison" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Sustain4ContentPlaceHolder" Runat="Server">
  <script type="text/JavaScript" src="../../../JavaScripts/collapseableDIV.js"></script>
    ...
    <table width="840px">
        <tr align="left">
            <td style="width: 43%" class="PageHeading" onmouseover="Tip('S4-Edit Comparison')"
                onmouseout="UnTip()">
                Sustain4 - Edit Comparison
            </td>
        </tr>
    </table>
    <br />

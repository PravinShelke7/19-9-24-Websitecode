...
Imports S4GetData
Imports S4UpInsData
Partial Class Pages_Sustain4_Tools_EditComparision
    ...
    Protected Sub bindDetails()
        Try
            ...
            If Session("SavvyModType") <> "1" Then
                Dts1 = GetData.GetEditCasesS4(Session("USERID").ToString(), AssumptionId, "true", Session("S4LicAdmin"))
                Dts2 = GetData.GetEditCasesS4(Session("USERID").ToString(), AssumptionId, "false", Session("S4LicAdmin"))
            Else

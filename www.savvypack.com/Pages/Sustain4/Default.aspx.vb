...
Imports S4GetData
Imports S4UpInsData
Partial Class Pages_Sustain4_Default
    Inherits System.Web.UI.Page
    Dim GetData As New S4GetData.Selectdata()
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetLogoffBtn()
        ...
        LogOffbtn.PostBackUrl = "~/Universal_loginN/Pages/ULogOff.aspx?Type=S4"
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Catch ex As Exception
            Response.Write("Assumptions Comparisons.Page_Load.Error" + ex.Message.ToString())
        End Try
    End Sub
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("S4LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
    ...
    Protected Sub StartComp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles StartComp.Click
        Try
            ...
            If Name.Length <> 0 Then
                ...
                Caseid = Request.Form("ctl00$Sustain4ContentPlaceHolder$CaseComp")
    ...
    Private Function CheckAnyDelCases1(ByVal flag As String) As Boolean
    ...
    Private Function CheckAnyDelCases(ByVal flag As String) As Boolean
        ...
        Try
            ...
            For i = 0 To AllCases.Length - 1
                ...
                If Session("SavvyModType") <> "1" Then
                    DelCase = GetData.GetDelCasesS4(AllCases(i), Session("USERID").ToString(), Session("S4LicAdmin"))
                Else
                    DelCase = GetData.GetDelCases(AllCases(i), Session("USERID").ToString())
                End If
                If (DelCase <> "") Then
    ...
    Protected Sub SavedButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SavedButton.Click
        ...
        Try
            ...
            If DelCases <> "" Then
                ...
                ElseIf flag = "Edit" Then
                    message = "---------------------------------------------------------------------------"
                    If PropCase <> "" Then
                        message = message + "Case(s) " + DelCases + " in this comparison have been deleted, so \n comparison " + SavedComp.SelectedValue + " will no longer editable. We recommend you close \n this window and delete comparison " + SavedComp.SelectedValue + " \n ------------------------------------------------------------------------------\n"
                    End If
                    If SisCase <> "" Then
    ...
    Protected Sub SharedButton_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles SharedButton.Click
        ...
        Try
            ...
            If Session("SavvyModType") <> "1" Then
                ds = GetData.GetAllPermissionCasesS4(ID, "N")
            Else
                ds = GetData.GetAllPermissionCases(ID)
            End If

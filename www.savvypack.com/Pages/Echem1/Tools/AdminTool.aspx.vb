...
Imports ToolCCS
Partial Class Pages_Echem1_Tools_AdminTool
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.BaseCaseSynch(SCaseId, TCaseId, "SCHEM1", "ECHEM1", "Echem1ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            GetBCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from Schem1 to Econ1');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            ...
            obj.CaseRenameBase(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim().Replace("'", "''").ToString(), txtCaseDe2.Text.Trim().Replace("'", "''").ToString(), txtCaseDe3.Text.Trim().Replace("'", "''").ToString(), "Echem1ConnectionString")
            GetBCaseDetails()
...
#Region "Delete Case"
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            obj.CaseBaseDelete(Session("UserId").ToString(), CaseId.ToString(), "Echem1ConnectionString")
            obj.CaseBaseDelete(Session("UserId").ToString(), CaseId.ToString(), "Schem1ConnectionString")
            GetBCaseDetails()
...
#Region "Tools Function"
    Protected Function CreateCase() As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateBaseCase("Echem1ConnectionString", "Echem1", 0)
            obj.CreateBaseCase("Schem1ConnectionString", "Echem1", CaseId)
            Return CaseId
        Catch ex As Exception

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageGroups.aspx.vb" Inherits="Pages_Echem1_Tools_ManageGroups" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>EChem1-Manage Groups</title>
                        ...
                        <table width="1215px">
                            ...
                            <tr class="AlterNateColor2">
                                <td style="width: 900px; padding-left: 5px; margin-right: 0px;" align="left" colspan="3">
                                    ...
                                    <asp:Label ID="lblCF" runat="server" Text="5" ForeColor="Red" Font-Bold="true" Width="60"></asp:Label>

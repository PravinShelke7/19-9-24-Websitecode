...
Partial Class Pages_Echem1_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Echem1 - Material Assumption"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("PAGES_ECHEM1_ASSUMPTIONS_EXTRUSION")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            dsEcon1 = objGetData.GetEcon1Cases("-1", CaseId, "", "", Session("USERID").ToString())
            ...
            For i = 1 To 15
                ...
                Select Case i
                    ...
                    Case 7
                        'Weight Distribution
                        Title = "(%)"
                        HeaderTdSetting(tdHeader, "", "Cost Distribution", "1")
                        Header2TdSetting(tdHeader2, "", Title, "1")
                        Header2TdSetting(tdHeader1, "70px", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    ...
                    Case 10
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 11
                        HeaderTdSetting(tdHeader, "105px", "Econ1 Cases", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                ...
                For j = 1 To 15
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 130
                            Link.CssClass = "Link"
                            GetMaterialDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), ds1)
                        ...
                        Case 7
                            ...
                            txt.CssClass = "SmallTextBox"
                            txt.Width = 50
                            txt.ID = "CD" + i.ToString()
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("CD" + i.ToString() + "").ToString(), 1)
                            txt.MaxLength = 6
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 8
                        ...
                        Case 11
                            ...
                            Link.Width = 105
                            Link.CssClass = "Link"
                            GetEcon1Details(Link, hid, CInt(ds.Tables(0).Rows(0).Item("C" + i.ToString() + "").ToString()), dsEcon1)
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
                        Case 12
            ...
            For i = 1 To 15
                ...
                Select Case i
                    ...
                    Case 7
                        InnerTdSetting(tdInner, "", "Center")
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTCOSTDIS").ToString(), 1) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 14
                        InnerTdSetting(tdInner, "", "Right")
    ...
    Protected Sub GetMaterialDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal MatId As Integer, ByVal ds1 As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New Echem1GetData.Selectdata()
    ...
    Protected Sub GetEcon1Details(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal CaseIdE1 As Integer, ByVal dsEcon1 As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New Echem1GetData.Selectdata()
        Dim hidval As New HiddenField
        Dim Path As String = String.Empty
        ...
        Try
            ...
            dvEcon1 = dsEcon1.Tables(0).DefaultView
            ...
            If dtEcon1.Rows.Count = 0 Then
                ...
                LinkMat.Attributes.Add("text-decoration", "none")
            Else
                LinkMat.Text = dtEcon1.Rows(0).Item("CASDES").ToString()
                LinkMat.ToolTip = dtEcon1.Rows(0).Item("CASDES").ToString()
                LinkMat.Attributes.Add("text-decoration", "none")
            End If
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    WeightDis(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$WD" + i.ToString() + "")
                    CostDis(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$CD" + i.ToString() + "")
                    Price(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$PRICE" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$REC" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$EP" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidDepid" + i.ToString() + "")
                    E1Cases(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Quant(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$Echem1ContentPlaceHolder$PCOMP" + i.ToString() + "") <> "" Then
                        PC(i - 1) = 1
                    Else
                        PC(i - 1) = 0
                    End If
                ...
                Next
                plate = Request.Form("ctl00$Echem1ContentPlaceHolder$radPlate")
                ObjUpIns.ExtrusionUpdate(CaseId, Material, Weight, Price, Recycle, Extra, PC, Dept, E1Cases, plate, Quant, WeightDis, CostDis, True)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

<%@ Page Language="VB" MasterPageFile="~/Masters/Echem1.master" AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_Echem1_Assumptions_CaseManager"  Title="Echem1-Case Manager"  %>
       ...
       <div id="PageSection1" style="text-align:left" >
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft"> 
                         <a href="../Results/ResultsplProd.aspx" class="Link" target="_blank">Profit And 
                         Loss Product</a></td>
                </tr>
                 ...
                 <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                    <td class="StaticTdLeft"> 
                         <a href="../Results/ResultsPLwithDEPProd.aspx" class="Link" target="_blank">Profit And 
                         Loss With Depreciation Product</a></td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                      ...
                      <td class="StaticTdLeft"> 
                          <a href="../Results/ResultcostProd.aspx" class="Link" target="_blank">Cost Product </a></td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft"> 
                          <a href="../Results/ResultcostWithDepProd.aspx" class="Link" target="_blank">Cost With Depreciation Product</a></td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                    <td class="StaticTdLeft"> 
                         <a href="../Results/PrintCaseSummaryProd.aspx" class="Link" target="_blank">Print Case Summary Product</a></td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                  <td class="StaticTdLeft"> 
                         <a href="../Results/ResultsPLwithDEP.aspx" class="Link" target="_blank">Profit And 

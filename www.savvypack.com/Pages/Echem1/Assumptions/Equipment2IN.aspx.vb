...
Partial Class Pages_Echem1_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Echem1 - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
...
#End Region
    ...
    Protected Sub GetSupportEquipmentInDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal EqId As Integer, ByVal dSEquip As DataSet)
        ...
        Try
            ...
            dvSEquip = dSEquip.Tables(0).DefaultView
            dvSEquip.RowFilter = "EQUIPID= " + EqId.ToString()
            dtSEquip = dvSEquip.ToTable()


            LinkMat.Text = dtSEquip.Rows(0).Item("equipDES").ToString()
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    hidAssetId(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    AP(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$AP" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$ECP" + i.ToString() + "")
                    NGP(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$NGP" + i.ToString() + "")
                    HRS(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$HRS" + i.ToString() + "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidCosId" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    ...
                    '        Response.Redirect("../Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE107").Replace("+", "!Plus!").Replace("#", "!Hash!").Replace("&", "!And!") + "")
                    '    End If
                    'End If

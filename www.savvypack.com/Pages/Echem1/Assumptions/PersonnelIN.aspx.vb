...
Partial Class Pages_Echem1_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Echem1 - Personnel Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_ASSUMPTIONS_PERSONNELIN")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            dsPer = objGetData.GetPersonnelInfo("-1", "", "", dsEffCountry.Tables(0).Rows(0).Item("COUNTRY").ToString())
                ...
                For j = 1 To 7
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetPersonnelDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("PERSPOS" + i.ToString() + "").ToString()), dsEffCountry.Tables(0).Rows(0).Item("COUNTRY").ToString(), dsPer)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidPosId" + i.ToString() + "").Replace(",", "")
                    NoWorker(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$NOWORKER" + i.ToString() + "").Replace(",", "")
                    PrefSal(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$SALPREF" + i.ToString() + "").Replace(",", "")
                    CostType(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidCosId" + i.ToString() + "").Replace(",", "")
                    DeptId(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidPerDepid" + i.ToString() + "").Replace(",", "")

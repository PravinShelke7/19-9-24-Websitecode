...
Partial Class Pages_Echem1_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Echem1 - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("Echem1ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$Echem1ContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$Echem1ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

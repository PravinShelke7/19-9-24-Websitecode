...
Partial Class Pages_Echem1_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Echem1 - Customer Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_ASSUMPTIONS_CUSTOMERIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$Echem1ContentPlaceHolder$PRODPUR").Replace(",", "")
                SHIPDIST = Request.Form("ctl00$Echem1ContentPlaceHolder$SHIPDIST").Replace(",", "")
                MILCOST = Request.Form("ctl00$Echem1ContentPlaceHolder$MILCOST").Replace(",", "")
                'Check For IsNumric

...
Partial Class Pages_Echem1_Assumptions_PalletIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Echem1 - Pallet Packaging Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_ASSUMPTIONS_PALLETIN")
    End Sub
                ...
                For j = 1 To 9
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetPalletDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), dsPallet)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Pallet(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                    Number(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                    NoOfUses(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$NOFUSE" + i.ToString() + "").Replace(",", "")
                    PrefWeight(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$W" + i.ToString() + "").Replace(",", "")
                    PrefPrice(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$Echem1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")

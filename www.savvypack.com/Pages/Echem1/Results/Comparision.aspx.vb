...
Partial Class Pages_Echem1_Results_Comparision
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Type = "PL" Then
                lblTitle.Text = "Echem1 - Profit and Loss Comparison Selector"
                Page.Title = "Echem1-Profit and Loss Comparison Selector"
            ElseIf Type = "PLDEP" Then
                lblTitle.Text = "Echem1 - Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "Echem1-Profit and Loss With Depreciation Comparison Selector"
            ElseIf Type = "CST" Then
                lblTitle.Text = "Echem1 - Cost Comparison Selector"
                Page.Title = "Echem1-Cost Comparison Selector"
            ElseIf Type = "CSTDEP" Then
                lblTitle.Text = "Echem1 - Cost Comparison With Depreciation Selector"
                Page.Title = "Echem1-Cost Comparison With Depreciation Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            ...
            lblSessionCaseId.Text = Session("Echem1CaseId")
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        Try
            ...
            URL = "../../../Charts/Echem1Charts/CPrftCost.aspx?CaseId=" + CaseId + "&PrftCost=" + objCryptoHelper.Encrypt(PrftCost) + "&ChartType=" + ChType + "&IsDep=" + objCryptoHelper.Encrypt(IsDep) + ""

...
Partial Class Pages_Echem1_Results_ResultsplProd
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Profit and Loss Statement Product')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Echem1 - Profit and Loss Statement Product"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_RESULTS_RESULTSPLPROD")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetProfitAndLossDetailsProd(CaseId, False)
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 6
                        ...
                        Header2TdSetting(tdHeader2, "80px", "Suggested", "1")

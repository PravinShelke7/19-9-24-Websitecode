...
Partial Class Pages_Echem1_Results_ResultcostProd
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Packaging Cost')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Echem1 - Packaging Cost Product"
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetCostDetailsProd(CaseId, False)
            For i = 1 To 7
                ...
                For j = 1 To 7
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label()
                            If CDbl(ds.Tables(0).Rows(0).Item("PL24").ToString()) > 0 Then
                                percentage = CDbl(ds.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(ds.Tables(0).Rows(0).Item("PL24").ToString()) * 100

...
Partial Class Pages_Echem1_Results_ResultsPLwithDEPProd
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Profit and Loss Statement with Depreciation Product')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Echem1 - Profit and Loss Statement with Depreciation Product"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_RESULTS_RESULTSPLWITHDEPPROD")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetProfitAndLossDetailsWithDepProd(CaseId, False)
            For i = 1 To 8
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                If hdnVolume.Value <> "0" Then
                    ObjUpIns.ResultsPlProd(CaseId.ToString(), UnitPrice, UnitType)
                End If
                Calculate()
            End If
            GetPageDetails()

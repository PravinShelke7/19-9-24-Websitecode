...
Partial Class Pages_Echem1_Results_ResultcostWithDepProd
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("CSTDEP") + "') "  'obj.Encrypt("CST") CSTDEP
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Packaging Cost with depreciation Product')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Echem1 - Packaging Cost with depreciation Product"
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetCostDetailsWithDepProd(CaseId, False)
            For i = 1 To 7

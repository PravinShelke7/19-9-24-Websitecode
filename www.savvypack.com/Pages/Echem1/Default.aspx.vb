...
Partial Class Pages_Echem1_Default
    Inherits System.Web.UI.Page
#Region "Browser Refresh Check"
    Dim objRefresh As zCon.Net.Refresh

    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECHEM1_DEFAULT")
    End Sub
...
#End Region
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("Echem1UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("Echem1ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("Echem1UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("Echem1ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("Echem1MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()

            'Set for License Administrator
            Session("Echem1LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("Echem1LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
        Catch ex As Exception
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            Else
                If Session("Echem1LicAdmin") = "N" Then
    ...
    Protected Sub SetToolButton()
        Try
            If Session("Echem1ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("Echem1CaseId") = ddlBaseCases.SelectedValue.ToString()
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("Echem1CaseId") = ddlPCase.SelectedValue.ToString()
            If Not objRefresh.IsRefresh Then

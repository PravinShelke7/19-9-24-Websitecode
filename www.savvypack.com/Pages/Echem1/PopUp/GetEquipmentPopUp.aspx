<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetEquipmentPopUp.aspx.vb" Inherits="Pages_Echem1_PopUp_GetEquipmentPopUp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Echem1-Get Equipment</title>
...
//             window.close();
         ...
         function EquipmentDet(EquipDes, EquipId, EQUIPDES3) {
             ...
             if (document.getElementById('<%= hidMod.ClientID%>').value == 'EC1') {
                 if (EquipId == "0") {

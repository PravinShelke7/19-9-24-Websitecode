...
Partial Class Pages_Echem1_PopUp_GetE1CasePopup
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            ds = objGetData.GetEcon1Cases(-1, Session("Echem1CaseId").ToString(), txtCaseDe1.Text.Trim.ToString(), txtCaseDe2.Text.Trim.ToString(), Session("USERID").ToString())

<%@ Page Language="VB" MasterPageFile="~/Masters/MoldSustain1.master" AutoEventWireup="false"
    CodeFile="PrintCaseSummary.aspx.vb" Inherits="Pages_MoldSustain1_Results_PrintCaseSummary"
    Title="S1 Mold-Print Case Summary" %>
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <div id="divEnergy" class="PrintCaseSummaryPrint">
                <div class="PageHeading">
                    Energy Statement</div>
                <asp:Table ID="tblEnergy" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divGHG" class="PrintCaseSummaryPrint">
                ...
                <asp:Table ID="tblGHG" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            <div id="divWater" class="PrintCaseSummaryPrint">
                ...
                <asp:Table ID="tblWater" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
            ...
            <div id="divPersonnel" class="PrintCaseSummaryPrint">
                ...
                <asp:Table ID="tblPersonal" runat="server" CellPadding="0" CellSpacing="2">
                </asp:Table>
                <br />
            </div>
        </div>

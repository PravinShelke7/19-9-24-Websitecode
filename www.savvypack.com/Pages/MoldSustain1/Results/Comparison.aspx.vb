...
Partial Class Pages_MoldSustain1_Results_Comparison
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            If Type = "ERGY" Then
                lblTitle.Text = "Sustain1 Mold - Energy Comparison Selector"
                Page.Title = "S1 Mold-Energy Comparison Selector"
            ElseIf Type = "CERGY" Then
                lblTitle.Text = "Sustain1 Mold - Customer Energy Comparison Selector"
                Page.Title = "S1 Mold-Customer Customer Energy Comparison Selector"
            ElseIf Type = "GHG" Then
                lblTitle.Text = "Sustain1 Mold - GHG Comparison Selector"
                Page.Title = "S1 Mold-GHG Comparison Selector"
            ElseIf Type = "CGHG" Then
                lblTitle.Text = "Sustain1 Mold - Customer GHG Comparison Selector"
                Page.Title = "S1 Mold-Customer GHG Comparison Selector"
            ElseIf Type = "CGHG" Then
                lblTitle.Text = "Sustain1 Mold - Customer GHG Comparison Selector"
                Page.Title = "S1 Mold-Customer GHG Comparison Selector"
            ElseIf Type = "WATER" Then
                lblTitle.Text = "Sustain1 Mold - Water Comparison Selector"
                Page.Title = "S1 Mold-Water Comparison Selector"
            ElseIf Type = "CWATER" Then
                lblTitle.Text = "Sustain1 Mold - Water Comparison Selector"
                Page.Title = "S1 Mold-Water Comparison Selector"
            ElseIf Type = "CEOL" Then
                lblTitle.Text = "Sustain1 Mold - Customer End Of Life Comparison Selector"
                Page.Title = "S1 Mold-Customer End Of Life Comparison Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            lblSessionCaseId.Text = Session("MoldS1CaseId")
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            If Session("MoldS1LicAdmin") = "N" Then
                If Session("Service") = "COMPS1" Then
            ...
            Else
                If Session("Service") = "COMPS1" Then
                    ds = objGetData.GetCompPCaseDetailsByLicense(Session("USERID").ToString(), Session("MoldS1ServiceId").ToString())
                Else
            ...
            'ds = objGetData.GetPCaseDetails(Session("S1UserName").ToString())
            With ddlPCases
                .DataSource = ds
    ...
    Protected Sub btnType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnType.Click
        ...
        Try
            ...
            ds = objGetData.GetProductFormtByID(Session("MoldS1CaseId"), ddlPCases.SelectedValue)
            ...
            Else
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('These cases are not comparable because Case " + Session("MoldS1CaseId").ToString() + " is in " + Units1 + " and Case " + ddlPCases.SelectedValue + " is in " + Units2 + ".');", True)
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        ...
        Try
            ...
            URL = "../../../Charts/MoldS1Charts/CErgyGhgWat.aspx?CaseId=" + CaseId + "&ErgyGHG=" + objCryptoHelper.Encrypt(Type) + "&ChartType=" + objCryptoHelper.Encrypt(TypeDes) + ""

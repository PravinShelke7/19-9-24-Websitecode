<%@ Page Title="S1 Mold-Customer Material End-of-life Results Statement" Language="VB"
    MasterPageFile="~/Masters/MoldSustain1.master" AutoEventWireup="false" CodeFile="ResultsEOL2.aspx.vb"
    Inherits="Pages_MoldSustain1_Results_ResultsEOL2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MoldSustain1ContentPlaceHolder"
    ...
    <div id="ContentPagemargin" runat="server">
        <div id="PageSection1" style="text-align: left">
            <table cellspacing="2" style="width: 800px">
                <tr>
                            ...
                            <tr>
                                ...
                                <td valign="bottom">
                                    <asp:Label ID="lblNewSalesValue" runat="server" Style="font-family: Optima; font-size: 12px;
                                        ...
                                        margin-left: 0px; text-align: right; font-weight: bold"></asp:Label>

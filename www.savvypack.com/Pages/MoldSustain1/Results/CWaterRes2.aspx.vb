...
Imports System.Math
Partial Class Pages_MoldSustain1_Results_CWaterRes2
            ...
            For i = 1 To 5
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        Title = "(" + ds1.Tables(0).Rows(0).Item("TITLE10").ToString() + ")"
                    ...
                    Case 3
                        ...
                        Title = "(" + ds2.Tables(0).Rows(0).Item("TITLE10").ToString() + ")"
                        Header2TdSetting(tdHeader4, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                        trHeader2.Controls.Add(tdHeader2)
                ...
                For j = 1 To 5
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(ds1.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                    percentage = CDbl(ds1.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue1 / CDbl(ds1.Tables(0).Rows(0).Item("SVOLUME").ToString())
                                End If
                            Else
                                If CDbl(ds1.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                    percentage = CDbl(ds1.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue1 / CDbl(ds1.Tables(0).Rows(0).Item("SUNITVAL").ToString())
                                End If
                            End If
                        ...
                        Case 3
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(ds2.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                    percentage = CDbl(ds2.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue2 / CDbl(ds2.Tables(0).Rows(0).Item("SVOLUME").ToString())
                                End If
                            Else
                                If CDbl(ds2.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                    percentage = CDbl(ds2.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue2 / CDbl(ds2.Tables(0).Rows(0).Item("SUNITVAL").ToString())
                                End If
                            End If
                            lbl.Text = FormatNumber(percentage, 0)
                            tdInner.Controls.Add(lbl)
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(ds1.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                    percentage1 = CDbl(ds1.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue1 / CDbl(ds1.Tables(0).Rows(0).Item("SVOLUME").ToString())
                                End If
                            Else
                                If CDbl(ds1.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                    percentage1 = CDbl(ds1.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue1 / CDbl(ds1.Tables(0).Rows(0).Item("SUNITVAL").ToString())
                                End If
                            End If
                            'Second Case
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(ds2.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                    percentage2 = CDbl(ds2.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue2 / CDbl(ds2.Tables(0).Rows(0).Item("SVOLUME").ToString())
                                End If
                            Else
                                If CDbl(ds2.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                    percentage2 = CDbl(ds2.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) * customerSaleValue2 / CDbl(ds2.Tables(0).Rows(0).Item("SUNITVAL").ToString())
                                End If
                            End If
                ...
                For j = 1 To 5
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(customerSaleValue1) <> 0 And CDbl(lbToUnit1) > 0 Then
                                    perUnit = (CDbl(percentage) / CDbl(customerSaleValue1 * lbToUnit1))
                            ...
                            Else
                                If CDbl(customerSaleValue1) <> 0 Then
                                    perUnit = (CDbl(percentage) / CDbl(customerSaleValue1))
                                    lbl.Text = FormatNumber(perUnit, 3)
                                Else
                                    lbl.Text = "na"
                                End If
                        ...
                        Case 3
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(customerSaleValue2) <> 0 And CDbl(lbToUnit2) > 0 Then
                                    perUnit = (CDbl(percentage) / CDbl(customerSaleValue2 * lbToUnit2))
                                    lbl.Text = FormatNumber(perUnit, 3)
                                Else
                                    lbl.Text = "na"
                                End If
                            ...
                            Else
                                If CDbl(customerSaleValue2) <> 0 Then
                                    perUnit = (CDbl(percentage) / CDbl(customerSaleValue2))
                                    lbl.Text = FormatNumber(perUnit, 3)
                                Else
                                    lbl.Text = "na"
                                End If
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(customerSaleValue1) <> 0 And CDbl(lbToUnit1) > 0 Then
                                    perUnit1 = (CDbl(percentage1) / CDbl(customerSaleValue1 * lbToUnit1))
                                Else
                                    perUnit1 = ""
                                End If
                            ...
                            Else
                                If CDbl(customerSaleValue1) <> 0 Then
                                    perUnit1 = (CDbl(percentage1) / CDbl(customerSaleValue1))
                                Else
                                    perUnit1 = ""
                                End If
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(customerSaleValue2) <> 0 And CDbl(lbToUnit2) > 0 Then
                                    perUnit2 = (CDbl(percentage2) / CDbl(customerSaleValue2 * lbToUnit2))
                                Else
                                    perUnit2 = ""
                                End If
                            ...
                            Else
                                If CDbl(customerSaleValue2) <> 0 Then
                                    perUnit2 = (CDbl(percentage2) / CDbl(customerSaleValue2))
                                Else
                                    perUnit2 = ""
                                End If

...
Partial Class Pages_MoldSustain1_Results_ResultsEOL2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparison.aspx?Type=" + obj.Encrypt("CEOL") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Customer Material End-of-life Results Statement "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_RESULTS_RESULTSEOL2")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            'Getting Customer Sales Volume
            If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                customerSaleValue = FormatNumber(CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CONVWT").ToString()), 0)
            Else
                If CDbl(ds.Tables(0).Rows(0).Item("FINVOLMSI").ToString()) > 0 Then
                    customerSaleValue = FormatNumber(CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CONVAREA").ToString()), 0)
                ElseIf CDbl(ds.Tables(0).Rows(0).Item("FINVOLMUNITS").ToString()) > 0 Then
                    customerSaleValue = FormatNumber(CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()), 0)
                End If

            End If

            txtNewSaleValue.Text = FormatNumber(customerSaleValue, 0).ToString()
                                ...
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATB" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATB" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()), 0)
                                        End If
                                    End If
                                Else
                                    lbl.Text = "0"
                        ...
                        Case 3
                            ...
                            Else
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATRE" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATRE" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()), 0)
                                        End If
                                    End If
                                Else
                                    lbl.Text = "0"
                        ...
                        Case 4
                            ...
                            Else
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATIN" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATIN" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()), 0)
                                        End If
                                    End If
                                Else
                                    lbl.Text = "0"
                        ...
                        Case 5
                            ...
                            Else
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATCM" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATCM" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()), 0)
                                        End If
                                    End If
                                Else
                                    lbl.Text = "0"
                        ...
                        Case 6
                            ...
                            Else
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATLF" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATLF" + i.ToString() + "").ToString() * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()), 0)
                                        End If
                                    End If
                                Else
                                    lbl.Text = "0"
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                cusSalesVolume = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$txtNewSaleValue")

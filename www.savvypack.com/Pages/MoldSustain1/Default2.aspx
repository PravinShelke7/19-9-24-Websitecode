<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default2.aspx.vb" Inherits="Pages_MoldSustain1_Default2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S1 Mold-Global Manager</title>
...
<body>
    ...
    <div id="MasterContent">
        ...
        <div>
            <table class="S1MoldModule" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
                <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif"
                                        runat="server" ToolTip="Log Off" Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=MoldS1" />
                                </td>
                                <td>
                    ...
                    <div id="PageSection1" style="text-align: left;">
                        ...
                        <table width="90%">
                            ...
                            <tr class="AlterNateColor1">
                                <td>
                                    <asp:DropDownList ID="ddlBaseCases" CssClass="DropDown" Width="98%" runat="server"
                                        Visible="false">
                                    </asp:DropDownList>
                            ...
                            <tr class="AlterNateColor1">
                                <td>
                                    <asp:Button ID="btnBCase" runat="server" CssClass="Button" Text="Start an Approved Case"
                                        Style="margin-left: 0px;" />
                                    <asp:Button ID="btnBCaseSearch" runat="server" Text="Case Search" Visible="false"
                                        CssClass="Button" OnClientClick="return ShowPopWindow('PopUp/CaseSearch.aspx?Id=ddlBaseCases');">
                                    </asp:Button>
                                </td>
                            </tr>
                            <tr class="AlterNateColor1">
                        ...
                        <table width="90%">
                            ...
                            <tr class="AlterNateColor1">
                                <td>
                                    <asp:DropDownList ID="ddlCaseGroup" CssClass="DropDown" Visible="false" Width="98%"
                                        runat="server" AutoPostBack="true">
                                    </asp:DropDownList>
                                    <asp:LinkButton ID="lnkCaseGroup" Style="font-size: 14px; padding-left: 10px" runat="server"
                                        CssClass="Link" Width="500px" OnClientClick="return ShowPopWindow('PopUp/CaseGroup.aspx?Des=lnkCaseGroup&Id=hidGroupId&IdD=hidGroupCaseD','PRP');">All Groups and All Cases</asp:LinkButton>
                                </td>
                            </tr>
        </tr>
        <tr>
                        ...
                        <tr>
                            <td>
                                <asp:Button ID="btnPCase" runat="server" CssClass="Button" Text="Start a Proprietary Case"
                                    Style="margin-left: 0px;" OnClientClick="return PropCaseCheck();" Width="159px" />
                            </td>
                            <td>
                                <asp:Button ID="btRename" runat="server" Text="Rename" CssClass="Button" OnClientClick="return PropCaseCheck();"
                                    Width="65px"></asp:Button>
                            </td>
                            <td>
                                <asp:Button ID="btnAdminSubmit" runat="server" Style="display: none" Text="Submit"
                                    OnClientClick="return Check();" ToolTip="Submit for approval for addition to Approved cases"
                                    CssClass="Button"></asp:Button>
                            </td>
                            <td>
                                <asp:Button ID="btSerach" runat="server" Text="Case Search" Visible="false" OnClientClick="return PropCaseCheck();"
                                    CssClass="Button" Width="86px"></asp:Button>
                            </td>
                            <td>
                                <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClientClick="return Message();"
                                    ToolTip="Submitted for approval for addition to Approved cases" CssClass="Button">
                                </asp:Button>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div style="margin-left: 20px; display: none" id="divRename" runat="server">
                        <table width="90%" style="padding-left: 20px">
                            ...
                            <tr class="AlterNateColor1">
                                ...
                                <td>
                                    <asp:TextBox ID="txtCaseDe3" runat="server" onKeyUp="javascript:Count(this);" onChange="javascript:Count(this);"
                                        CssClass="MediumTextBox" Style="text-align: left; font-size: 11px;" TextMode="MultiLine"
    ...
    <table width="90%">
        ...
        <tr class="AlterNateColor1">
            <td>
                <asp:Button ID="btnToolBox" ToolTip="Manage Groups and Cases" runat="server" CssClass="Button"
                    Text="Go To Toolbox" Style="margin-left: 0px;" Visible="true" />
            </td>
        </tr>
        <tr class="AlterNateColor1">
            <td>

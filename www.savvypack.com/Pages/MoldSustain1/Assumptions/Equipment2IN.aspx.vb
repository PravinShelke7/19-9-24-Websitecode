...
Partial Class Pages_MoldSustain1_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Support Equipment Assumptions"
    End Sub
                    ...
                    Select Case j
                        ...
                        Case 3 'Bug# 375
                            ...
                            If ViewState("IsFirstLoad") = "N" Then
                                txt.Text = FormatNumber(Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ASSETNUM" + i.ToString() + "").Replace(",", ""), 0)
                            Else
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    ECP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ECP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$NGCP" + i.ToString() + "").Replace(",", "")
                    WATERP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                    HRS(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$HRS" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ASSETNUM" + i.ToString() + "") 'Bug #375

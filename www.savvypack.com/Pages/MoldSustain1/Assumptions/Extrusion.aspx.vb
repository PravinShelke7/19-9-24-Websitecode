...
Partial Class Pages_MoldSustain1_Assumptions_Extrusion
    Inherits System.Web.UI.Page
    Public CaseDes As String = String.Empty
    Shared objCalb As New MoldS1BarrierGetData.Calculations
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Material and Structure Assumptions"
    End Sub
...
#End Region
                ...
                For j = 1 To 24
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            'GetMaterialDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), Nothing)
                        ...
                        Case 3
                            ...
                            Link.Width = 100
                            Link.CssClass = "Link"
                            GetGrades(Link, hid, "hidMatid" + i.ToString(), CInt(dsPref.Tables(0).Rows(0).Item("GRADE" + i.ToString() + "").ToString()), "SGP" + i.ToString())
                        ...
                        Case 23
                            ...
                            Link.Width = 50
                            Link.CssClass = "Link"
                            GetShipSelectorDetails(Link, hid, dsPref.Tables(0).Rows(0).Item("SS" + i.ToString() + "").ToString())
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
                ...
                For j = 1 To 8
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            lbl = New Label
                            lbl.Width = 180
                            GetMaterialDetails(Nothing, Nothing, CInt(dsPref.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), lbl)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
    ...
    Protected Sub GetShipSelectorDetails(ByRef LinkShip As HyperLink, ByVal hid As HiddenField, ByVal ShipId As Integer)
        Dim Ds As New DataSet
        Dim ObjGetdata As New MoldS1GetData.Selectdata()
        Dim Path As String = String.Empty
        Try
            ...
            LinkShip.Text = Ds.Tables(0).Rows(0).Item("shipdes").ToString()
    ...
    Protected Sub UpdatePage()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        Material(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidMatid" + i.ToString() + "")
                        Thickness(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$THICK" + i.ToString() + "")
                        Recycle(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$REC" + i.ToString() + "")
                        ERGYP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ERGYP" + i.ToString() + "")
                        CO2P(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$CO2P" + i.ToString() + "")
                        SHIPP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$SHIPP" + i.ToString() + "")
                        EP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$EP" + i.ToString() + "")
                        SGP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$SGP" + i.ToString() + "")
                        SHIPU(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$SHIPU" + i.ToString() + "")
                        SHIPS(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidShipSId" + i.ToString() + "")
                        Dept(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidDepid" + i.ToString() + "")
                        WATER(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$WATERP" + i.ToString() + "")

                        OTR(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$OTR" + i.ToString() + "")
                        WVTR(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$WVTR" + i.ToString() + "")
                        GRADE(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidGradeId" + i.ToString() + "")
                    ...
                    For i = 1 To 3
                        ...
                        MaterialDis(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidDisMatid" + i.ToString() + "")
                        WeightDis(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$DISW" + i.ToString() + "")
                        ErgyDis(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$DISERGY" + i.ToString() + "")
                        CO2Dis(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$DISCO" + i.ToString() + "")
                        WaterDis(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$DISWATER" + i.ToString() + "")
                        ...
                        If Request.Form("ctl00$MoldSustain1ContentPlaceHolder$DISW" + i.ToString() + "") <> 0 Then
                    ...
                    plate = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$radPlate")

                    raddiscmatyn = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$raddiscmatyn")
                ...
                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        RECOP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$RECOP" + i.ToString() + "")
                        SUSMat(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                        PCRECP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$PCRECP" + i.ToString() + "")

...
Partial Class Pages_MoldSustain1_Assumptions_PalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Pallet Configuration Assumptions "
    End Sub
    ...
    Protected Sub UpdatePage()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        Pallet(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                        Number(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                        NoOfUses(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$NOUSE" + i.ToString() + "").Replace(",", "")
                        PrefWeight(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$WP" + i.ToString() + "").Replace(",", "")
                        PrefErgy(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                        PrefCO2(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$GHGP" + i.ToString() + "").Replace(",", "")
                        PrefSHIPD(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$SDP" + i.ToString() + "").Replace(",", "")
                        Dept(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")
                        PrefWater(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                ...
                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        PrefRECOV(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$RECP" + i.ToString() + "").Replace(",", "")
                        PrefSUSM(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                        PrefPCREC(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$PCRECP" + i.ToString() + "").Replace(",", "")
                        'Check Numeric

...
Partial Class Pages_MoldSustain1_Assumptions_RwMatPack
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Raw Material Packaging Assumptions"
    End Sub
...
#End Region
    ...
    Protected Sub UpdatePage()
        Try
            ...
            Col = Chr(64 + Convert.ToInt32(ViewState("TabId"))).ToString()
            For i = 1 To 10
                Pallet(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                Number(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$NUM" + i.ToString() + "")
                Ergy(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ERGY" + i.ToString() + "")
                Ghg(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$GHG" + i.ToString() + "")
                Water(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$Water" + i.ToString() + "")
                Recycle(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$RECYCLE" + i.ToString() + "")
                Reco(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$RECO" + i.ToString() + "")
                Osha(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                Pc(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$PC" + i.ToString() + "")
                Sd(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$SHIP" + i.ToString() + "")
            ...
            Next
            Tuc = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$Tuc")
            'Check for isNumeric

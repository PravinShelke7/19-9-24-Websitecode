...
Partial Class Pages_MoldSustain1_Assumptions_PlantConfig2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("onclick", "return CheckForPlantSpace()")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Plant Space Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_PLANTCONFIG2")
    End Sub
        ...
        Try
            ...
            For i = 1 To 2
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        HeaderTdSetting(tdHeader, "70px", "Area", "1")
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            If i = 1 Then
                                ...
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("AREA" + i.ToString() + "").ToString(), 0)
                            ...
                            Else
                                ...
                                txt.Width = 70
                                txt.ID = "AREA" + (i).ToString()
                                txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("AREA" + (i).ToString() + "").ToString(), 0)
                                txt.MaxLength = 12
            ...
            For i = 1 To 2
                ...
                Select Case i
                    ...
                    Case 2
                        InnerTdSetting(tdInner, "", "Right")
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTALAREA").ToString(), 0) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                End Select
            Next
            trInner.Height = 30
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 3
                    AREA(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$AREA" + (i + 1).ToString() + "")
                    'Check For IsNumric
                    If Not IsNumeric(AREA(i - 1)) Then
                        Response.Redirect("../Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE113").Replace("+", "!Plus!").Replace("#", "!Hash!").Replace("&", "!And!") + "")
                    End If
                Next


                ObjUpIns.PlantConfig2Update(CaseId, AREA)
                Calculate()
                'Update Server Date

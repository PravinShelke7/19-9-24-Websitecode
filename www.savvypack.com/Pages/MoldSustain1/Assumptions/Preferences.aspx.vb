...
Partial Class Pages_MoldSustain1_Assumptions_Preferences
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Preferences"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_PREFERENCES")
    End Sub
...
#End Region
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            ObjUpIns.PrefrencesUpdate(CaseId, LCI, Unit, Effdate, IsDsctNew, Type)
            Calculate()
            'Update Server Date

...
Partial Class Pages_MoldSustain1_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("onclick", "return CheckForCustomerIn()")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Transportation Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Sustain1_ASSUMPTIONS_CUSTOMERIN")
    End Sub
            ...
            For i = 1 To 8
                ...
                Select Case i
                    Case 1
                        ...
                        HeaderTdSetting(tdHeader, "160px", "Transportation Assumptions", "1")
                    ...
                    Case 2
                        ...
                        Header2TdSetting(tdHeader2, "", "Diesel energy", "1")
                        Header2TdSetting(tdHeader1, "0", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 3
                        ...
                        Header2TdSetting(tdHeader2, "", "Diesel CO2", "1")
                        Header2TdSetting(tdHeader1, "0", Title, "1")
                        trHeader2.Controls.Add(tdHeader2)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 4
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                SD = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$SD").Replace(",", "")
                TruckEffPre = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$TFUELEFFP").Replace(",", "")
                RailEffPre = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$RFUELEFFP").Replace(",", "")
                'Check For IsNumric

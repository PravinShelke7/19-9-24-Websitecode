...
Partial Class Pages_MoldSustain1_Assumptions_ProductFormatIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Product Format Assumptions"
    End Sub
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PwtPref = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$PWT").ToString()
                If Session("MoldS1ServiceRole") <> "ReadOnly" Then
                    UpdateFlag = 0
                    ds = ObjGetdata.GetDiscretedMaterialTotal(CaseId)
                    DiscTotal = CDbl(ds.Tables(0).Rows(0).Item("DISCRETEWT").ToString())
                    M1 = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidProductid")
                    ...
                    If UpdateFlag = CDbl(0) Then
                        For i = 2 To 6
                            Input(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                            'Check For IsNumric

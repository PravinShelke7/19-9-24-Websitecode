<%@ Page Title="S1 Mold-Case Manager" Language="VB" MasterPageFile="~/Masters/MoldSustain1.master"
    AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_MoldSustain1_Assumptions_CaseManager" %>
            ...
            <table width="98%" style="text-align: left;">
                ...
                <tr class="AlterNateColor1">
                    ...
                    <td class="StaticTdLeft">
                        <a href="../IntResults/ExtrusionOut.aspx" class="Link" target="_blank">Material and
                            Structure</a>
                    </td>
                    <td class="StaticTdLeft">
                ...
                <tr class="AlterNateColor2">
                    ...
                    <td class="StaticTdLeft">
                        <a href="../IntResults/PalletInNewOut.aspx" class="Link" target="_blank">Raw Material
                            Packaging</a>
                    </td>
                    <td class="StaticTdLeft">

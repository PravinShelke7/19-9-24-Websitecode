...
Partial Class Pages_MoldSustain1_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Personnel Assumptions"
    End Sub
                ...
                For j = 1 To 4
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            Link.Width = 120
                            Link.CssClass = "Link"
                            GetDeptDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("DEPARTMENT" + i.ToString() + "").ToString()))
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    NoWorker(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$NUMBER" + i.ToString() + "").Replace(",", "")
                    DeptId(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidPerDepid" + i.ToString() + "")

...
Partial Class Pages_MoldSustain1_Assumptions_ExtraProcess
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Extra-process Waste"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_EXTRAPROCESS")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 3
                    extraProcess(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$EP" + i.ToString() + "").Replace(",", "")
                    Preffered(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$PREF" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

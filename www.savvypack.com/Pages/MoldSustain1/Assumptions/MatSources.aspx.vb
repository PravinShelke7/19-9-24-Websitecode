...
Partial Class Pages_MoldSustain1_Assumptions_MatSources
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Materials And Sources')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Sustain1 Mold - Materials And Sources"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_MATSOURCES")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetMaterialsSource(CaseId)
            ...
            For i = 1 To 2
                ...
                Select Case i
                    ...
                    Case 1
                        HeaderTdSetting(tdHeader, "300px", "Materials", "1")
                        trHeader.Controls.Add(tdHeader)

                    Case 2
                        HeaderTdSetting(tdHeader, "300px", "Source", "1")
                        trHeader.Controls.Add(tdHeader)
                ...
                For j = 1 To 2
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            lbl = New Label
                            'lbl.Width = 200
                            lbl.Text = ds.Tables(0).Rows(0).Item("MATSOURCE" + i.ToString() + "").ToString()
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                    End Select
                Next

...
Partial Class Pages_MoldSustain1_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_EQUIPMENTIN")
    End Sub
                ...
                For j = 1 To 13
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 170
                            Link.CssClass = "Link"
                            GetEquipmentInDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()))
                        ...
                        Case 4
                            ...
                            lbl = New Label
                            lbl.Width = 100
                            lbl.Text = ds.Tables(0).Rows(0).Item("AREATYPE" + i.ToString() + "").ToString()
                        ...
                        Case 6
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("PLANTAREAP" + i.ToString() + "").ToString(), 0)
                            txt.MaxLength = 12
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 7
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    hidAssetId(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    PARP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$PLANTAREAP" + i.ToString() + "").Replace(",", "")
                    ECP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$NTGP" + i.ToString() + "").Replace(",", "")
                    WATERP(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    'Check For IsNumric
                    ...
                    If CDbl(hidAssetId(i - 1)) <> 0 Then
                        If CDbl(ASSETNUM(i - 1)) <= CDbl(0.0) Then 'ADDED CONDITION FOR BUG#210
                            Response.Redirect("../Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE115").Replace("+", "!Plus!").Replace("#", "!Hash!").Replace("&", "!And!") + "")
                        End If
                    End If
                Next

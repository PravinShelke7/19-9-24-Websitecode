...
Partial Class Pages_MoldSustain1_Assumptions_TruckPalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("onclick", "return CheckTrukAndPallet();")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold- Pallet and Truck Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_TRUCKPALLETIN")
    End Sub
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            For i = 1 To 5
                ...
                txt.Width = 80
                txt.ID = "P" + i.ToString()
                txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("P" + i.ToString() + "").ToString(), 0)
                If i = 5 Then
                    txt.MaxLength = 10
                Else
                    txt.MaxLength = 6
            ...
            lbl = New Label
            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("CALCULATEDWEIGHT").ToString(), 0)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 5
                    Pallet(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Truck(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$T" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

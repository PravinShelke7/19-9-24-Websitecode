<%@ Page Language="VB" MasterPageFile="~/Masters/MoldSustain1.master" AutoEventWireup="false"
    CodeFile="Extrusion.aspx.vb" Inherits="Pages_MoldSustain1_Assumptions_Extrusion"
    Title="S1 Mold-Material Assumptions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MoldSustain1ContentPlaceHolder"
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/MoldS1Barr.js"></script>
    <style type="text/css">
        a.LinkMatNew:link
        {
            color: White;
    ...
    <script type="text/javascript">
        function CallBackBarrier() {
            ...
            if (document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_hidBarrier").value == "0") {
                document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_hidBarrier").value = "1";
                document.getElementById('ctl00_imgBarProp').title = "Hide Barrier Properties";

                showDisplay();

                msgBarr = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_hidMessageBarr").value;
                ...
                document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_hidBarrier").value = "0";
        ...
        function showhide() {
            ...
            var obj4;
            //Grade
            obj1 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_GradeHeader");
            obj2 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_GradeHeader2");
            obj3 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_GradeHeader1");
            ...
            var i;
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_GradeVal" + i);
                objDep.style.display = "none";
            }

            //OTR
            obj1 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_OTRHeader");
            obj2 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_OTRHeader2");
            obj3 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_OTRSHeader1");
            obj4 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_OTRPHeader1");
            ...
            var i;
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_OTRSVal" + i);
                objDep.style.display = "none";
            }
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_OTRPVal" + i);
                objDep.style.display = "none";
            }

            //WVTR
            obj1 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_WVTRHeader");
            obj2 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_WVTRHeader2");
            obj3 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_WVTRSHeader1");
            obj4 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_WVTRPHeader1");
            ...
            var i;
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_WVTRSVal" + i);
                objDep.style.display = "none";
            }
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_WVTRPVal" + i);
                objDep.style.display = "none";
            }

            //OTR/WVTR TEMP and HUMIDITY  
            obj1 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_tblBarrier");
            obj1.style.display = "none";

            //Total
            obj1 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_Total5");
            obj2 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_Total7");
            obj3 = document.getElementById("ctl00_MoldSustain1ContentPlaceHolder_Total3");

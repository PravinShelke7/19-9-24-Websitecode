...
Imports System.Net
Partial Class Pages_MoldSustain1_Tools_Tools2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            If Session("MoldS1UserRole") = "AADMIN" Then
    ...
    Protected Sub GetUserDetails()
        ...
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetUserCompanyUsers(Session("MoldS1UserName").ToString())
            With ddlUsers
                .DataSource = ds
    ...
    Protected Sub GetTotalCaseCount()
        ...
        Try
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(ddlUsers.SelectedItem.Text, "MOLDS1")
...
#Region "Copy A Case"
    Protected Sub btnCopyBcase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCopyBcase.Click
        ...
        Try
            ...
            TCaseId = CreateCase(Session("MoldS1ToolUserName"))
...
#Region "Share Access"
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(hidUserSA.Value, "MOLDS1")
            If dsShareUserMaxCount.Tables(0).Rows.Count > 0 Then
                hidShareUserMaxCaseCount.Value = CInt(dsShareUserMaxCount.Tables(0).Rows(0).Item("MAXCASECOUNT")).ToString()
                hidTotalShareCount.Value = CInt(dsShareUserCount.Tables(0).Rows(0).Item("TOTALCOUNT")).ToString()
            Else
...
#Region "Share A Copy"
    Protected Sub btnShareCopy_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareCopy.Click
        ...
        Try
            ...
            'Getting details for selected user for share Copy
            dsSUserMaxCountS1 = objGetData.GetSelectedUserDetails(hidUserSC.Value, "MOLDS1")
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.CaseSynch(SCaseId, TCaseId, "ECON1MOLD", "SUSTAIN1MOLD", "MoldS1ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            ...
            lnkPropCase.Text = hidPropCaseD.Value
            GetPCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from Econ1 Mold to Sustain1 Mold');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            CaseId = hidPropCase.Value
            obj.CaseRename(CaseId, txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldS1ConnectionString")
            GetPCaseDetails()
...
#Region "Delete Case"
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            CaseId = hidPropCase.Value
            obj.CaseDelete(Session("MoldS1ToolUserName").ToString(), CaseId.ToString(), "MoldE1ConnectionString")
            obj.CaseDelete(Session("MoldS1ToolUserName").ToString(), CaseId.ToString(), "MoldS1ConnectionString")
...
#Region "Create Case"
    Protected Sub btnCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        Try
            Dim CaseId As New Integer
            CaseId = CreateCase(Session("MoldS1ToolUserName"))
            GetPCaseDetails()
            GetTotalCaseCount()
            hidPropCase.Value = "0"
...
#Region "Tools Function"
    Protected Function CreateCase(ByVal UserName As String) As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateCase(UserName, "MoldE1ConnectionString", "MoldE1", 0)
            obj.CreateCase(UserName, "MoldS1ConnectionString", "MoldE1", CaseId)
            Return CaseId
        Catch ex As Exception
...
#End Region
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            Dim objUpdateData As New MoldS1UpInsData.UpdateInsert()
            Dim objGetData As New MoldS1GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            Else
                ...
                ds = objGetData.GetPropCasesById(Session("UserName"), hidPropCase.Value)
                If ds.Tables(0).Rows.Count > 0 Then
    ...
    Protected Sub SendEmailStatus(ByVal CaseId As String)
        Try
            ...
            Dim objS1GetData As New MoldS1GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            dsUserData = objS1GetData.GetPermissionStatus(CaseId, Session("MoldS1UserName").ToString())
            If ds.Tables(0).Rows.Count > 0 Then
    ...
    Public Function GetEmailBodyData(ByVal link As String, ByVal ds As DataSet) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<td>Sustain1 Mold</b></td> "

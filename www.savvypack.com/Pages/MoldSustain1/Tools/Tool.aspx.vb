...
Imports ToolCCS
Partial Class Pages_MoldSustain1_Tools_Tool
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetPCaseCompDetails(Session("USERID").ToString(), Session("MoldS1ServiceId").ToString())
            Else
    ...
    Protected Sub GetUserDetails()
        ...
        Try
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetCompUserCompanyUsers(Session("MoldS1UserName").ToString(), Session("MoldS1ServiceID").ToString())
            Else
    ...
    Protected Sub GetTotalCaseCount()
        ...
        Try
            ...
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetCompTotalCaseCount(Session("USERID").ToString(), Session("MoldS1ServiceId").ToString())
            Else
            ...
            If Session("Service") = "COMPS1" Then
                dsSUserCount = objGetData.GetCompTotalCaseCount(ddlUser2.SelectedItem.Value, Session("MoldS1ServiceId").ToString())
            Else
            ...
            If Session("Service") = "COMPS1" Then
                dsShareUserCount = objGetData.GetCompTotalCaseCount(ddlUsers.SelectedItem.Value, Session("MoldS1ServiceId").ToString())
...
#Region "Tools Function"
    Protected Function CreateCase(ByVal USERID As String) As Integer
        ...
        Dim objData As New MoldS1UpInsData.UpdateInsert()
        Try
            CaseId = obj.CreateCase(USERID, "MoldE1ConnectionString", "MoldE1", 0)
            obj.CreateCase(USERID, "MoldS1ConnectionString", "MoldE1", CaseId)
            If Session("Service") = "COMPS1" Then
                objData.UpdateSustainServiceId(CaseId, Session("ServiceMoldE1"), Session("ServiceMoldS1"), USERID)
            End If
            Return CaseId
        Catch ex As Exception
...
#Region "Share Access"
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            ...
            obj.CaseAccess(USERID, CaseId, "MoldE1ConnectionString")
            obj.CaseAccess(USERID, CaseId, "MoldS1ConnectionString")
            If Session("Service") = "COMPS1" Then
                objData.UpdateSustainServiceId(CaseId, Session("ServiceMoldE1"), Session("ServiceMoldS1"), USERID)
            End If
            Flag = True
...
#Region "Rename Case"
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            CaseId = ddlPCases.SelectedValue.ToString()
            obj.CaseRename(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldS1ConnectionString")
            GetPCaseDetails()

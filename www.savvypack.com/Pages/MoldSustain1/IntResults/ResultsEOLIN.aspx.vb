...
Partial Class Pages_MoldSustain1_IntResults_ResultsEOLIN
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 8
                    MALRE(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$MALRE" + (i + 1).ToString() + "")
                    MALIN(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$MALIN" + (i + 1).ToString() + "")
                    MALCM(i) = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$MALCM" + (i + 1).ToString() + "")
                    'Check For IsNumric

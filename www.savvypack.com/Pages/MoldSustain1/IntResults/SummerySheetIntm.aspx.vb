...
Partial Class Pages_MoldSustain1_IntResults_SummerySheetIntm
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 Mold - Scorecard Intermediate"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                M5 = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$M5").Replace(",", "")
                M6 = Request.Form("ctl00$MoldSustain1ContentPlaceHolder$M6").Replace(",", "")
                'Check For IsNumric

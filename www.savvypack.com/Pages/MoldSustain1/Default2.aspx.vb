...
Imports System.Net
Partial Class Pages_MoldSustain1_Default2
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Session("MoldS1LicAdmin") = "Y" Then
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("MoldS1UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("MoldS1ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("MoldS1UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("MoldS1ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("MoldS1MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
            'Set for License Administrator
            Session("MoldS1LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("MoldS1LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
    ...
    Protected Sub GetPCaseGroupDetails()
        ...
        Try
            ...
            'Dts = objGetData.GetSavedCaseAsperUser(Session("S1UserName").ToString(), "-1")
    ...
    Protected Sub SetToolButton()
        Try
            If Session("MoldS1ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            ...
            Else
                ...
                Session("MoldS1CaseId") = hidApprovedCase.Value
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        ...
        Try
            ...
            Else
                Session("MoldS1CaseId") = hidPropCase.Value ' ddlPCase.SelectedValue.ToString()
                lnkPropCase.Text = hidPropCaseD.Value
                Session("CaseType") = "Prop"

                CaseId = Session("MoldS1CaseId")
                User = Session("MoldS1UserName")
                dsSt = objgetdata.GetStatusForSister("MoldS1", CaseId, User)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldS1ConnectionString")
            hidPropCase.Value = "0"
    ...
    Public Function GetEmailBodyData(ByVal link As String, ByVal ds As DataSet) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<td>Sustain1</b></td> "

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_MoldSustain1_Default" %>
            ...
            <td>
                <div id="ContentPagemargin" runat="server">
                    <div id="PageSection1" style="text-align: left;">
                        <br />
                        <div class="PageHeading" style="width: 90%">
                            <center>
                                            ...
                                            <tr class="AlterNateColor1">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCaseDe3" onKeyUp="javascript:Count(this);" onChange="javascript:Count(this);"
                                                        runat="server" CssClass="MediumTextBox" Style="text-align: left; font-size: 11px;"

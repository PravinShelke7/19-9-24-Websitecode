<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GroupDetails.aspx.vb" Inherits="Pages_MoldSustain1_PopUp_GroupDetails" %>
                ...
                <asp:GridView Width="800px" runat="server" ID="grdGrpCases" DataKeyNames="GROUPID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                            ...
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkGrpId" runat="server" Width="150px" Style="color: Black; font-family: Verdana;
                                    font-size: 11px;" Text='<%# bind("CDES1")%>' OnClick="lnkGrpId_Click"></asp:LinkButton>
                            </ItemTemplate>

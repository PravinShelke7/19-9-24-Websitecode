<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CasesSearch.aspx.vb" Inherits="Pages_MoldSustain1_PopUp_CasesSearch" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S1 Mold-CaseDetails</title>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left">
            ...
            <div style="width: 750px; height: 280px; overflow: auto;">
                <asp:GridView Width="700px" runat="server" ID="grdCaseSearch" DataKeyNames="CaseId"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="PACKAGE FORMAT" SortExpression="CaseDe1">
                            <ItemTemplate>
                                <a href="#" onclick="CaseSearch('<%#Container.DataItem("CaseId")%>:<%#Container.DataItem("CaseDES")%>','<%#Container.DataItem("CaseId")%>','<%#Container.DataItem("STATUSID")%>','<%#Container.DataItem("STATUS")%>')"
                                    class="Link">
                        ...
                        <asp:BoundField DataField="CaseOwner" HeaderText="Owner" SortExpression="CaseOwner"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="30%" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="STATUS" SortExpression="STATUS">
                            <ItemTemplate>
                                <a href="#" onclick="CaseStatus('<%#Container.DataItem("CaseId")%>','<%#Container.DataItem("CaseOwner")%>')"
                                    class="Link">

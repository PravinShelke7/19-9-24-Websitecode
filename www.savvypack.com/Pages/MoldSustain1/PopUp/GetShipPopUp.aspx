<%@ Page Language="VB" MasterPageFile="~/Masters/MoldS1PopUp.master" AutoEventWireup="false"
    CodeFile="GetShipPopUp.aspx.vb" Inherits="Pages_MoldSustain1_PopUp_GetShipPopUp"
    Title="S1 Mold-Get Shiping Selector" %>
                ...
                <asp:GridView Width="400px" runat="server" ID="grdShip" DataKeyNames="shipId" AutoGenerateSelectButton="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Ship Des1" SortExpression="matDISde1">
                            <ItemTemplate>
                                <a href="#" onclick="ShipDet('<%#Container.DataItem("shipDes")%>','<%#Container.DataItem("shipId")%>')"
                                    class="Link">
                                    <%#Container.DataItem("shipId")%>:<%#Container.DataItem("shipDes")%></a>
                            </ItemTemplate>

...
Partial Class Pages_MoldSustain1_PopUp_CasesViewer
    ...
    Protected Sub GetPCaseDetails()
        Dim objGetData As New MoldS1GetData.Selectdata()
        Dim ds As New DataSet()
        'Session("S1UserName") = "ADMINISTRATOR2"
        Try

            ' ds = objGetData.GetCases(Session("S1UserName"), CaseDe1, CaseDe2)
            If Session("MoldS1LicAdmin") = "N" Then
                ...
                Else
                    ds = objGetData.GetApprovedCases(Session("MoldS1UserName"), CaseDe1, CaseDe2)
                End If

...
Partial Class Pages_MoldSustain1_PopUp_CaseViewer
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            If Session("MoldS1LicAdmin") = "N" Then
                ...
                Else
                    If Session("Service") = "COMPS1" Then
                        ds = objGetData.GetCompCases(Session("USERID"), CaseDe1, CaseDe2, Session("MoldS1ServiceId"))
                    Else
            ...
            Else
                If Session("Service") = "COMPS1" Then
                    ds = objGetData.GetCompCasesByLicense(Session("USERID"), CaseDe1, CaseDe2, Session("MoldS1ServiceId"))
                Else

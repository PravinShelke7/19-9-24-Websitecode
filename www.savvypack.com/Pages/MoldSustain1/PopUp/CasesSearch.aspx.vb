...
Partial Class Pages_MoldSustain1_PopUp_CasesSearch
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            Else
                If Session("MoldS1LicAdmin") = "N" Then
                    ds = objGetData.GetApprovedCases(Session("MoldS1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                Else
                    ds = objGetData.GetAppCasesByLicense(Session("MoldS1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If

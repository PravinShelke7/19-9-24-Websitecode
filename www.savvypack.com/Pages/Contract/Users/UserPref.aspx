<%@ Page Language="VB" MasterPageFile="~/Masters/Contract.master" AutoEventWireup="false"
    CodeFile="UserPref.aspx.vb" Inherits="Pages_Contract_Users_UserPref" Title="Contract-User Intelligence" %>
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <table width="75%" cellpadding="0px" cellspacing="0px">
                ...
                <tr class="AlterNateColor1" id="trCatDropdown" runat="server" visible="false">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCat" runat="server" CssClass="DropDown" Width="200px" Enabled="false">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr class="AlterNateColor2">
                    <td colspan="2" style="padding-left: 5px">
                        <div id="divCatDetails" runat="server" style="margin-bottom: 15px; font-weight: bold;
                            ...
                            <fieldset>
                                ...
                                <table style="width: 600px">
                                    <tr style="height: 20px; text-align: center">
                                        <td class="TdHeading" style="width: 5%" onmouseover="Tip('SavvyPack Corporation Intelligence ')"
                                            onmouseout="UnTip()">
                                            AI
                                        </td>
                                        <td class="TdHeading" style="text-align: left; padding-left: 5px;" onmouseover="Tip('User Intelligence ')"
                                            onmouseout="UnTip()">
                                            User Intelligence
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor3">
                                        <td valign="top">
                                            <asp:CheckBoxList Enabled="false" Style="font-weight: normal; border: solid 1 black"
                                                ID="chkDetailsSugg" runat="server" RepeatColumns="1" RepeatDirection="Horizontal">
                                            </asp:CheckBoxList>
                                        </td>
                                        <td valign="top">
                                            <asp:CheckBoxList Style="font-weight: normal; border: solid 1 black" ID="chkDetails"
                        ...
                        <div id="divCatComments" runat="server" style="font-weight: bold" visible="false">
                            <fieldset>
                                ...
                                <table style="width: 600px">
                                    <tr style="height: 20px; text-align: center">
                                        <td class="TdHeading" style="width: 50%" onmouseover="Tip('SavvyPack Corporation Intelligence ')"
                                            onmouseout="UnTip()">
                                    ...
                                    <tr class="AlterNateColor3">
                                        <td valign="top" style="height: 104px">
                                            <asp:TextBox TextMode="MultiLine" Rows="10" Height="100px" Width="300px" ID="txtCommSugg"
                                                runat="server" Enabled="false"></asp:TextBox>
                                        </td>
                                        <td valign="top" style="height: 104px">
                                            <asp:TextBox TextMode="MultiLine" Rows="10" Height="100px" Width="300px" ID="txtComm"

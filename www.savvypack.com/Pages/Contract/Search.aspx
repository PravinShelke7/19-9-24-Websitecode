<%@ Page Language="VB" MasterPageFile="~/Masters/Contract.master" AutoEventWireup="false" CodeFile="Search.aspx.vb" Inherits="Pages_Contract_Search" title="Search Manager" %>
...
<script type="text/JavaScript">
      ...
      function OpenNewWindow(Page,Title) {
        ...
        function ShowPopWindowComp(Page) {
            //window.open('ItemSearch.aspx', 'ItemSearch', 'status=0,toolbar=0,location=0,menubar=0,directories=0,resizable=0,scrollbars=0,height=400,width=600');  
            var width = 550;
            var height = 350;
            var left = (screen.width - width) / 2;
              ...
              <div class="PageHeading" id="divMainHeading">
                       <table>
                          <tr>
                            ...
                            <td>
                                <asp:Button ID="btnSearch" runat="server" CssClass="ButtonWMarigin" ToolTip="The keyword search always searches the entire database" Text="Keyword Search" style="height:22px;"  /> 
                            </td>
                          </tr>
                       </table>
               </div>
					  ...
					  <tr>
                         <td align="right">
                             <div id="ManageUser" runat="server" visible="false">
                              <asp:HyperLink ID="hypConUSRM" runat="server" style="color:#cc0000;font-size:14px;" Text="Manage Contract Packager Users " CssClass="Link"
                                                    Font-Bold="true" NavigateUrl="~/Pages/Contract/ContractUsers.aspx" Target="_blank"></asp:HyperLink>
                             </div> 
                        ...
                        <tr>
                            <td>
                                <table width="750px" cellpadding="1px" cellspacing ="1px">
                                ...
                                <tr class="AlterNateColor4" >
                                    ...
                                    <tr class="AlterNateColor1" style="width:100%">
                                        ...
                                        <td style="width:45%;text-align:left; height: 20px;">
                                            ...
                                            <asp:ImageButton ID="btnCompSearch" runat="Server"  ImageUrl="~/Images/search_icon.png" ToolTip="Search Company" Height="19px" OnClientClick="return ShowPopWindowComp('PopUp/GetCompany.aspx?Id=ddlCompany');" />
                                        </td>

...
Partial Class Pages_Retail_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Material Assumption"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("PAGES_Retail_ASSUMPTIONS_EXTRUSION")
    End Sub
...
#End Region
    ...
    Protected Sub GetEcon1Details(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal CaseIdE1 As Integer)
        ...
        Try
            ...
            Ds = ObjGetdata.GetEcon1Cases(CaseIdE1, CaseId, "", "", Session("RetlUserName").ToString())
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Price(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$PRICE" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$REC" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$EP" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepid" + i.ToString() + "")
                    E1Cases(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    If Request.Form("ctl00$RetailContentPlaceHolder$PCOMP" + i.ToString() + "") <> "" Then
                        PC(i - 1) = 1
                    Else
                        PC(i - 1) = 0
                    End If
                ...
                Next
                plate = Request.Form("ctl00$RetailContentPlaceHolder$radPlate")
                ObjUpIns.ExtrusionUpdate(CaseId, Material, Weight, Price, Recycle, Extra, PC, Dept, E1Cases, plate, True)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

...
Partial Class Pages_Retail_Assumptions_PlantConfig
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Plant Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_PLANTCONFIG")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P1")
                    DEPTB(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P2")
                    DEPTC(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P3")
                    DEPTD(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P4")
                    DEPTE(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P5")
                    DEPTF(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P6")
                    DEPTG(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P7")
                    DEPTH(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P8")
                    DEPTI(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P9")
                    DEPTJ(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidDepD" + i.ToString() + "P10")
                Next

...
Partial Class Pages_Retail_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("onclick", "return CheckForEquipmentIn('" + ctlContentPlaceHolder.ClientID + "','hidAssetId','hidEqDepid','hypEqDep')")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_EQUIPMENTIN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    hidAssetId(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    AP(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$AP" + i.ToString() + "")
                    PAP(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$PAP" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$ECP" + i.ToString() + "")
                    NGP(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$NGP" + i.ToString() + "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                ...
                Next
                ObjUpIns.EquipmentUpdate(CaseId, hidAssetId, AP, PAP, ECP, NGP, hidAssetDep)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

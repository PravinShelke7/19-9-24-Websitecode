...
Partial Class Pages_Retail_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Customer Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_CUSTOMERIN")
    End Sub
            ...
            For p = 1 To 4
                ...
                Select Case p
                    ...
                    Case 3
                        ...
                        trHeader2.Controls.Add(tdHeader2)
                    Case 4
                        Title = "(" + ds.Tables(0).Rows(0).Item("PREFT2").ToString() + ")"
                        HeaderTdSetting(tdHeader, "", "Promotion Payment", "1")
                        Header2TdSetting(tdHeader2, "120px", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
            ...
            For q = 1 To 4
                ...
                Select Case q
                    ...
                    Case 4
                        ...
                        txt.Width = 70
                        txt.ID = "MFGPRMO"
                        txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MFGPRMO").ToString(), 3)
                        txt.MaxLength = 12
                        tdInner.Controls.Add(txt)
                        trInner.Controls.Add(tdInner)
                End Select
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$RetailContentPlaceHolder$PRODPUR").Replace(",", "")
                SHIPDIST = Request.Form("ctl00$RetailContentPlaceHolder$SHIPDIST").Replace(",", "")
                MILCOST = Request.Form("ctl00$RetailContentPlaceHolder$MILCOST").Replace(",", "")
                MFGPRMO = Request.Form("ctl00$RetailContentPlaceHolder$MFGPRMO").Replace(",", "")
                'Check For IsNumric
                ...
                If Not IsNumeric(MFGPRMO) Then
                    Response.Redirect("../Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE111").Replace("+", "!Plus!").Replace("#", "!Hash!").Replace("&", "!And!") + "")
                End If



                ObjUpIns.CustomerInUpdate(CaseId, PRODPUR, SHIPDIST, MILCOST, MFGPRMO)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

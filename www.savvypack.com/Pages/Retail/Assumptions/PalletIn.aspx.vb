...
Partial Class Pages_Retail_Assumptions_PalletIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Pallet Packaging Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_PALLETIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Pallet(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidPalid" + i.ToString() + "")
                    Number(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                    NoOfUses(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$NOFUSE" + i.ToString() + "").Replace(",", "")
                    PrefWeight(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$W" + i.ToString() + "").Replace(",", "")
                    PrefPrice(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$hidPalletDepid" + i.ToString() + "")

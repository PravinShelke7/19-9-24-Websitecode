...
Partial Class Pages_Retail_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("RetlServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$RetailContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$RetailContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

...
Partial Class Pages_Retail_Assumptions_PlantConfig2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Plant Space Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_PLANTCONFIG2")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 2 To 4
                    AREA(i - 2) = Request.Form("ctl00$RetailContentPlaceHolder$AR" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric
                ...
                For i = 0 To 5
                    PrefLease(i) = Request.Form("ctl00$RetailContentPlaceHolder$PREF" + (i + 1).ToString() + "").Replace(",", "")
                    'Check For IsNumric

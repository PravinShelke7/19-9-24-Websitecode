...
Partial Class Pages_Retail_Assumptions_OperationsIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Operating Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_ASSUMPTIONS_OPERATIONSIN")
    End Sub
        ...
        Try
            ...
            For i = 1 To 7
                ...
                Select Case i
                    ...
                    Case 3
                        HeaderTdSetting(tdHeader, "140px", "Selling Hours", "1")
                        Header2TdSetting(tdHeader2, "", "(hr/year)", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)

                    Case 4
                        HeaderTdSetting(tdHeader, "90px", "Product Sold", "1")
                        Header2TdSetting(tdHeader2, "", "(unit/hr)", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)

                    Case 5
                        HeaderTdSetting(tdHeader, "90px", "Product Sold", "1")
                        Header2TdSetting(tdHeader2, "", "(unit/year)", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    Case 6
                        ...
                        trHeader2.Controls.Add(tdHeader2)
                    Case 7
                        HeaderTdSetting(tdHeader, "80px", "Shrinkage", "1")
                        Header2TdSetting(tdHeader2, "", "(%)", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                ...
                For j = 1 To 7
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            Dim cal As Double
                            cal = CDbl(ds.Tables(0).Rows(0).Item("OPINSTGRSRATE" + i.ToString() + ""))
                        ...
                        Case 5
                            InnerTdSetting(tdInner, "", "Center")
                            lbl = New Label
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("PRODSOLD" + i.ToString() + "").ToString(), 0)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 6
                            InnerTdSetting(tdInner, "", "Center")
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    OMAXRH(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$MAXHOUR" + i.ToString() + "").Replace(",", "")
                    OPINSTR(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$INSTANTANEOUSRATE" + i.ToString() + "").Replace(",", "")
                    DT(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$DOWNTIME" + i.ToString() + "").Replace(",", "")
                    OPWASTE(i - 1) = Request.Form("ctl00$RetailContentPlaceHolder$OPWASTE" + i.ToString() + "").Replace(",", "")

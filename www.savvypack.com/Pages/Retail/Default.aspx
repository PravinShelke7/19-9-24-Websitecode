<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_Retail_Default"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Retail-Global Manager</title>
    ...
    <script type="text/JavaScript">
        ...
        function Help() {
            ...
            params += ', status=yes';
            params += ', toolbar=yes';
            URL = "../Retail/help/SavvyPackInstructions1.htm"
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif" runat="server"  ToolTip="Log Off"  Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=Retl"/>  
                            ...
                            <br />
                             <table width="80%">
                                <tr class="AlterNateColor4">
                                 ...
                                 <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlPCase" CssClass="DropDown" Width="80%" runat="server"></asp:DropDownList>
                                 ...
                                 <tr class="AlterNateColor1">
                                    <td>  
                                         ...
                                         <asp:Button  ID="btSerach" runat="server" Text="Case Search" CssClass="Button" OnClientClick="return ShowPopWindow('PopUp/CaseSearch.aspx?Id=ddlPCase');"></asp:Button>
                                    </td>
                                 </tr>
                                  <tr class="AlterNateColor1">
                                    <td>
                                         <div style="margin-left:20px;display:none" id="divRename">
				                            ...
				                            <tr align="left">
				                               ...
				                               <tr align="left">
				                                <td>
				                                    <asp:TextBox ID="txtCaseDe1" runat="server" CssClass="SmallTextBox" style="text-align:left;width:150px" MaxLength="25"></asp:TextBox>
				                                </td>
				                                 <td>
				                                    <asp:TextBox ID="txtCaseDe2" runat="server" CssClass="SmallTextBox" style="text-align:left;width:150px" MaxLength="25"></asp:TextBox>
				                                </td>
				                                <td>

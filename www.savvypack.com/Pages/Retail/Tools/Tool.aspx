<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_Retail_Tools_Tool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Retail-Tools</title>
...
'.google-analytics.com/ga.js';
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from Sustain2 to Retail. Do you want to proceed?"
            }
 ...
 function ShareMessageNew(Case, User, Flag) 
        {
           ...
           if(TotalCount != "" || MaxCount != "")
          {
                  ...
                  {
                          var Name = document.getElementById(User)
                          var msg = "You are trying to share a access with user " + Name.value + ".  " + Name.value + " has reached their limit of "+MaxCount+" cases.  Please contact SavvyPack Corporation (952-405-7500) to purchase more cases.";
                          alert(msg);
                          return false;
                  }
            }
		  ...
		  function ShareCopyMessageNew(Case, User, Flag) 
        {
          ...
          if(TotalCount != "" || MaxCount != "")
          {
                  ...
                  {
                          var Name = document.getElementById(User)
                          var msg = "You are trying to share a copy with user " + Name.value + ".  " + Name.value + " has reached their limit of "+MaxCount+" cases.  Please contact SavvyPack Corporation (952-405-7500) to purchase more cases.";
                          alert(msg);
                          return false;
                  }
            }
        ...
        {
          var MaxCount="<%=Session("RetlMaxCaseCount")%>";       
...
<body style="margin-top:0px;">
 <%-- <center>--%>
   ...
   <div id="AlliedLogo">
      ...
      <div>
        <table class="RetModule" cellpadding="0" cellspacing="0"  style="border-collapse:collapse">
            <tr>
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"  Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Retail/Default.aspx" 
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Retail-Tools')" onmouseout="UnTip()" style="width:840px;">
                     Retail - Tools
             ...
             <br />
                        <table width="820px">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlBCases" CssClass="DropDown" Width="600px" runat="server"></asp:DropDownList>
                ...
                <table width="820px">
                                 ...
                                 <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlPCases" CssClass="DropDown" Width="600px" runat="server"></asp:DropDownList>
                                    ...
                                    <td>
                                           ...
                                           <asp:Button ID="btnCopyPcase" runat="server" Text="Copy" CssClass="ButtonWMarigin" OnClientClick="return CreateMessage('ddlPCases','NCC');"
                                            ...
                                            <asp:Button ID="btnPShareCase" runat="server" Text="Share Access" CssClass="ButtonWMarigin" OnClientClick="return MakeVisible('divshareAccess');"
                                             ...
                                             onmouseover="Tip('Synchronize this Case from Sustain2 to Retail')" onmouseout="UnTip()" style="margin-left:10px" Enabled="false"  />
                            ...
                            <div style="display:none;margin-top:40px;" id="divBCopy">
                                <table width="700px">
                                    <tr class="AlterNateColor4">
                                     ...
                                     <tr class="AlterNateColor1">
                                        <td>
                                            <asp:DropDownList ID="ddlTarget" CssClass="DropDown" Width="600px" runat="server"></asp:DropDownList>
                                        </td>
                                     </tr> 
                                     <tr class="AlterNateColor1">
                                        <td>
                            ...
                            <div style="display:none;margin-top:40px;" id="divCopy">
                                <table width="700px">
                                    <tr class="AlterNateColor4">
                                     ...
                                     <tr class="AlterNateColor1">
                                        <td>
                                            <asp:DropDownList ID="ddlTarget1" CssClass="DropDown" Width="600px" runat="server"></asp:DropDownList>
                                        </td>
                                     </tr> 
                                     <tr class="AlterNateColor1">
                                        <td>
                                ...
                                <table width="700px">
                                    <tr class="AlterNateColor4">
                                     ...
                                     <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:TextBox id="txtCaseDe1" runat="server" CssClass="LongTextBox" Style="text-align:left;" MaxLength="25"></asp:TextBox>
                                        </td>
                                      </tr>
                                      <tr class="AlterNateColor1">
                                         <td align="right">
                                        ...
                                        <td>
                                            <asp:TextBox id="txtCaseDe2" runat="server" CssClass="LongTextBox" Style="text-align:left;" MaxLength="25"></asp:TextBox>
                                        </td>
                                       </tr>
                                        <tr class="AlterNateColor1">
                                         <td align="right">
                                        ...
                                        <td>
                                            <asp:TextBox id="txtCaseDe3" runat="server" CssClass="NormalTextBox" Style="text-align:left;"

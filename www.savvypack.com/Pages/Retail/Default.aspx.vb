...
Partial Class Pages_Retail_Default
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_RETAIL_DEFAULT")
    End Sub
...
#End Region
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("RetlUserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("RetlServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("RetlUserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("RetlToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("RetlMaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
        Catch ex As Exception
    ...
    Protected Sub SetToolButton()
        Try
            If Session("RetlServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("RetlCaseId") = ddlBaseCases.SelectedValue.ToString()
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("RetlCaseId") = ddlPCase.SelectedValue.ToString()
            If Not objRefresh.IsRefresh Then
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Dim ds As New DataSet()
        Try
            objUpIns.CaseDesUpdate(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString(), txtCaseDe2.Text.Trim().ToString())
            GetPCaseDetails()
        Catch ex As Exception

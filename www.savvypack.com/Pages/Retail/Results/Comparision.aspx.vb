...
Partial Class Pages_Retail_Results_Comparision
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Type = "PL" Then
                lblTitle.Text = "Retail - Profit and Loss Comparison Selector"
                Page.Title = "Retail-Profit and Loss Comparison Selector"
            ElseIf Type = "PLDEP" Then
                lblTitle.Text = "Retail - Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "Retail-Profit and Loss With Depreciation Comparison Selector"
            ElseIf Type = "CST" Then
                lblTitle.Text = "Retail - Cost Comparison Selector"
                Page.Title = "Retail-Cost Comparison Selector"
            ElseIf Type = "CSTDEP" Then
                lblTitle.Text = "Retail - Cost Comparison With Depreciation Selector"
                Page.Title = "Retail-Cost Comparison With Depreciation Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            ...
            lblSessionCaseId.Text = Session("RetlCaseId")
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ds = objGetData.GetPCaseDetails(Session("RetlUserName").ToString())
            With ddlPCases
                .DataSource = ds
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        Try
            ...
            URL = "../../../Charts/RetailCharts/CPrftCost.aspx?CaseId=" + CaseId + "&PrftCost=" + objCryptoHelper.Encrypt(PrftCost) + "&ChartType=" + ChType + "&IsDep=" + objCryptoHelper.Encrypt(IsDep) + ""

...
Partial Class Pages_Retail_Results_PrintCaseSummary
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Retail - Print Case Summary"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Retail_RESULTS_PRINTCASESUMMARY")
    End Sub
            ...
            For i = 1 To 4
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE2").ToString() + ")" 'TITLE8 Replaced by TITLRetl
                        Header2TdSetting(tdHeader1, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)

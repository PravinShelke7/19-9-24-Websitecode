...
Partial Class Pages_Retail_PopUp_GetE1CasePopup
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            ds = objGetData.GetEcon1Cases(-1, Session("RetlCaseId").ToString(), txtCaseDe1.Text.Trim.ToString(), txtCaseDe2.Text.Trim.ToString(), Session("RetlUserName").ToString())

...
Partial Class Pages_Retail_PopUp_CaseViewer
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        CaseDe1 = Request.QueryString("CASEDE1")
        CaseDe2 = Request.QueryString("CASEDE2")
        Try
    ...
    Protected Sub GetPCaseDetails()
        ...
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetCases(Session("RetlUserName"), CaseDe1, CaseDe2)
            With ddlCases
                .DataSource = ds
                .DataTextField = "CASEDE"
                .DataValueField = "CASEID"

...
Partial Class Pages_MoldSustain2_Results_CEndOfLife
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0.0 Then
                                            lbl.Text = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATLF" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0.0 Then
                                            lbl.Text = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATLF" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 And CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0.0 Then
                                            cTotal1 = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATLF" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If

                                    If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATLF" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATLF" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            lbl.Text = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATCM" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                        ...
                        Case 3
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0.0 Then
                                            lbl.Text = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATCM" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 And CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            cTotal1 = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATCM" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                    ...
                                    If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATCM" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)

                                        End If
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATCM" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                        ...
                        Case 2
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            lbl.Text = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATIN" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            lbl.Text = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATIN" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 And CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            cTotal1 = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATIN" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If

                                    If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) > 0 Then
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATIN" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATIN" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If
                        ...
                        Case 2
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            lbl.Text = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATRE" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                        ...
                        Case 3
                            ...
                            Else
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            lbl.Text = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATRE" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        Else
                                            lbl.Text = "na"
                                        End If
                                    End If
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 And CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal1 = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATRE" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If

                                    If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATRE" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATRE" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Else
                                ...
                                Else
                                    If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                        lbl.Text = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATB" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                    Else
                                        lbl.Text = "na"
                                    End If
                                End If
                        ...
                        Case 3
                            ...
                            Else
                                ...
                                Else
                                    If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                        lbl.Text = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATB" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                    Else
                                        lbl.Text = "na"
                                    End If
                                End If
                        ...
                        Case 4
                            ...
                            If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 And CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                ...
                                Else
                                    ...
                                    Else
                                        If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal1 = FormatNumber((CDbl(ds1.Tables(0).Rows(0).Item("MATB" + count1.ToString() + "").ToString()) * customerSaleValue1) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If

                                    If CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATB" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)
                                        End If
                                    Else
                                        If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                            cTotal2 = FormatNumber((CDbl(ds2.Tables(0).Rows(0).Item("MATB" + count2.ToString() + "").ToString()) * customerSaleValue2) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()), 0)
                                        End If
                                    End If

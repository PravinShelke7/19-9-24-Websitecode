...
Partial Class Pages_MoldSustain2_Results_Comparison
...
#End Region
    ...
    Protected Sub GetSessionDetails()
        Try
            lblSessionCaseId.Text = Session("MoldS2CaseId")
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        ...
        Try
            ...
            If Type = "ERGY" Or Type = "GHG" Or Type = "WATER" Then
                URL = "../../../Charts/MoldS2Charts/CErgyGhgWAT.aspx?CaseId=" + CaseId + "&ErgyGHG=" + objCryptoHelper.Encrypt(Type) + "&ChartType=" + objCryptoHelper.Encrypt(TypeDes) + ""
            ElseIf Type = "CERGY" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/MoldS2Charts/CEnergyCharts2.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/MoldS2Charts/CStackErgyChart2.aspx?&CaseId=" + CaseId + ""
                End If
            ElseIf Type = "CustomerGHG" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/MoldS2Charts/CGHGCharts2.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/MoldS2Charts/CStackGHGChart2.aspx?&CaseId=" + CaseId + ""
                End If
            ElseIf Type = "CWATER" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/MoldS2Charts/CWATERCharts2.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/MoldS2Charts/CStackWATERChart2.aspx?&CaseId=" + CaseId + ""
                End If
            ElseIf Type = "CustomerEOL" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/MoldS2Charts/CEolCharts.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/MoldS2Charts/CStackGHGChart2.aspx?&CaseId=" + CaseId + ""
                End If

<%@ Page Language="VB" MasterPageFile="~/Masters/MoldS2PopUp.master" AutoEventWireup="false"
    CodeFile="GetSusMatPopUp.aspx.vb" Inherits="Pages_MoldSustain2_PopUp_GetSusMatPopUp"
    Title="S2 Mold-Get Sustainable Material" %>
                ...
                <asp:GridView Width="400px" runat="server" ID="grdMat" DataKeyNames="TYPEID" AutoGenerateSelectButton="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Sustainable Material Des1" SortExpression="TYPE">
                            <ItemTemplate>
                                <a href="#" onclick="MaterialDet('<%#Container.DataItem("TYPE")%>','<%#Container.DataItem("TYPEID")%>')"
                                    class="Link">
                                    <%#Container.DataItem("TYPEID")%>:<%#Container.DataItem("TYPE")%></a>
                            </ItemTemplate>

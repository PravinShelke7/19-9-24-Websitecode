<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LicenseUser.aspx.vb" Inherits="Pages_MoldSustain2_PopUp_LicenseUser" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S2 Mold-User Details</title>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left">
            ...
            <div style="width: 350px; height: 300px; overflow: auto;">
                <asp:GridView Width="300px" runat="server" ID="grdCaseSearch" DataKeyNames="USERID"

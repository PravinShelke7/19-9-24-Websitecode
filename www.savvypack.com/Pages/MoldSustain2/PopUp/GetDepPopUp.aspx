<%@ Page Language="VB" MasterPageFile="~/Masters/MoldS2PopUp.master" AutoEventWireup="false"
    CodeFile="GetDepPopUp.aspx.vb" Inherits="Pages_MoldSustain2_PopUp_GetDepPopUp"
    Title="S2 Mold-Get Department" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MoldContentPlaceHolder1" runat="Server">
    <script type="text/JavaScript">
        function DeptDet(DepDes, DepId) {
            ...
            window.opener.document.getElementById(hidDepdes).style.color = 'black';
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <table cellpadding="0" cellspacing="2">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDepDe2" runat="server" CssClass="SearchTextBox" Width="200px"
            ...
            <div style="width: 450px; height: 230px; overflow: auto;">
                <asp:GridView Width="400px" runat="server" ID="grdDepartment" DataKeyNames="PROCID"
                    ...
                    <Columns>
                        <asp:BoundField DataField="PROCID" HeaderText="PROCID" SortExpression="PROCID" Visible="false">
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Dept. Des1" SortExpression="PROCDE1">
                            <ItemTemplate>
                                <a href="#" onclick="DeptDet('<%#Container.DataItem("PROCDE")%>','<%#Container.DataItem("PROCID")%>')"
                                    class="Link">
                                    <%#Container.DataItem("PROCDE1")%></a>
                            </ItemTemplate>

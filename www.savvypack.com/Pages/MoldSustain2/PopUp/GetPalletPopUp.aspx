<%@ Page Language="VB" MasterPageFile="~/Masters/MoldS2PopUp.master" AutoEventWireup="false"
    CodeFile="GetPalletPopUp.aspx.vb" Inherits="Pages_MoldSustain2_PopUp_GetPalletPopUp"
    Title="S2 Mold-Get Pallets" %>
                ...
                <asp:GridView Width="400px" runat="server" ID="grdPallets" DataKeyNames="PALLETID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Pallet Des1" SortExpression="palletde1">
                            <ItemTemplate>
                                <a href="#" onclick="PalletDet('<%#Container.DataItem("PALLETDES1")%>','<%#Container.DataItem("PALLETID")%>')"
                                    class="Link">

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StatusDetails.aspx.vb" Inherits="Pages_MoldSustain2_PopUp_StatusDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S2 Mold-Case Status Details</title>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left">
            ...
            <div style="width: 750px; height: 140px; overflow: auto;">
                <asp:GridView Width="750px" runat="server" ID="grdCaseStatus" DataKeyNames="CaseId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ACTIONBY" HeaderText="Action By" SortExpression="ACTIONBY"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="25%" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>

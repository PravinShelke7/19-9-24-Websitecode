...
Partial Class Pages_MoldSustain2_Assumptions_EnergyIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Energy Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN2_ASSUMPTIONS_ENERGYIN")
    End Sub
                ...
                For j = 1 To 3
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            lbl = New Label
                            lbl.Width = 70
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("ERS" + i.ToString() + "").ToString(), 3)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        ...
                        Case 3
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("ERP" + i.ToString() + "").ToString(), 3)
                            txt.MaxLength = 6
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 1
                    ERGPPREF(i) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$ERGPPREF" + (i + 1).ToString() + "")
                    'Check For IsNumric
                    ...
                    End If
                Next
                CFACTORPREF(0) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$CFACTORPREF1")
                CFACTORPREF(1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$CFACTORPREF2")

...
Partial Class Pages_MoldSustain2_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Support Equipment Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    hidAssetId(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$ECP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$NGCP" + i.ToString() + "").Replace(",", "")
                    WATERP(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                    HRS(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$HRS" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$ASSETNUM" + i.ToString() + "")

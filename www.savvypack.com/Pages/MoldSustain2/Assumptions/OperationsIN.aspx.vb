...
Partial Class Pages_MoldSustain2_Assumptions_OperationsIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Operating Assumptions"
    End Sub
                ...
                For j = 1 To 8
                    ...
                    Select Case j
                        ...
                        Case 5
                            ...
                            txt.Text = FormatNumber(cal.ToString(), 6)
                            txt.MaxLength = 12
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        ...
                        Case 6
                            ...
                            If ds.Tables(0).Rows(0).Item("UNITS" + i.ToString() + "").ToString().ToLower() = "cpm" Then
                                ...
                                Else
                                    cal = 0
                                End If
                                lbl.Text = FormatNumber(cal, 6).ToString() + ds.Tables(0).Rows(0).Item("UNITS" + i.ToString() + "").ToString()
                            ElseIf ds.Tables(0).Rows(0).Item("UNITS" + i.ToString() + "").ToString().ToLower() = "fpm" Then
                                If ARRpercent(i) = 0 Then
                                    ...
                                    If CInt(ds.Tables(0).Rows(0).Item("UNITS")) = 0 Then
                                        lbl.Text = FormatNumber(cal, 6).ToString() + ds.Tables(0).Rows(0).Item("UNITS" + i.ToString() + "").ToString()
                                    Else
                                        lbl.Text = FormatNumber(cal, 6).ToString() + ds.Tables(0).Rows(0).Item("UNITST" + i.ToString() + "").ToString()
                                    End If
                                Else
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    OMAXRH(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MAXHOUR" + i.ToString() + "").Replace(",", "")
                    OPINSTR(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$INSTANTANEOUSRATE" + i.ToString() + "").Replace(",", "")
                    DT(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$DOWNTIME" + i.ToString() + "").Replace(",", "")
                    OPWASTE(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$OPWASTE" + i.ToString() + "").Replace(",", "")

...
Partial Class Pages_MoldSustain2_Assumptions_Efficiency
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Efficiency Table Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN2_ASSUMPTIONS_EFFICIENCY")
    End Sub
            ...
            For i = 1 To 12
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        trHeader.Controls.Add(tdHeader)
                    Case 3
                        Title = ds.Tables(0).Rows(0).Item("DEP1").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 4
                        Title = ds.Tables(0).Rows(0).Item("DEP2").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 5
                        Title = ds.Tables(0).Rows(0).Item("DEP3").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 6
                        Title = ds.Tables(0).Rows(0).Item("DEP4").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 7
                        Title = ds.Tables(0).Rows(0).Item("DEP5").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 8
                        Title = ds.Tables(0).Rows(0).Item("DEP6").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 9
                        Title = ds.Tables(0).Rows(0).Item("DEP7").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 10
                        Title = ds.Tables(0).Rows(0).Item("DEP8").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 11
                        Title = ds.Tables(0).Rows(0).Item("DEP9").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 12
                        Title = ds.Tables(0).Rows(0).Item("DEP10").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                ...
                For j = 1 To 12
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            If ds.Tables(0).Rows(0).Item("A" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 4
                            ...
                            If ds.Tables(0).Rows(0).Item("B" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 5
                            ...
                            If ds.Tables(0).Rows(0).Item("C" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 6
                            ...
                            If ds.Tables(0).Rows(0).Item("D" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 7
                            ...
                            If ds.Tables(0).Rows(0).Item("E" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 8
                            ...
                            If ds.Tables(0).Rows(0).Item("F" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 9
                            ...
                            If ds.Tables(0).Rows(0).Item("G" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 10
                            ...
                            If ds.Tables(0).Rows(0).Item("H" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 11
                            ...
                            If ds.Tables(0).Rows(0).Item("I" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 12
                            ...
                            If ds.Tables(0).Rows(0).Item("J" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATA" + i.ToString() + "") <> "" Then
                        MATA(i - 1) = 1
                    Else
                        MATA(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATB" + i.ToString() + "") <> "" Then
                        MATB(i - 1) = 1
                    Else
                        MATB(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATC" + i.ToString() + "") <> "" Then
                        MATC(i - 1) = 1
                    Else
                        MATC(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATD" + i.ToString() + "") <> "" Then
                        MATD(i - 1) = 1
                    Else
                        MATD(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATE" + i.ToString() + "") <> "" Then
                        MATE(i - 1) = 1
                    Else
                        MATE(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATF" + i.ToString() + "") <> "" Then
                        MATF(i - 1) = 1
                    Else
                        MATF(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATG" + i.ToString() + "") <> "" Then
                        MATG(i - 1) = 1
                    Else
                        MATG(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATH" + i.ToString() + "") <> "" Then
                        MATH(i - 1) = 1
                    Else
                        MATH(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATI" + i.ToString() + "") <> "" Then
                        MATI(i - 1) = 1
                    Else
                        MATI(i - 1) = 0
                    End If

                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$MATJ" + i.ToString() + "") <> "" Then
                        MATJ(i - 1) = 1
                    Else
                        MATJ(i - 1) = 0
                    End If

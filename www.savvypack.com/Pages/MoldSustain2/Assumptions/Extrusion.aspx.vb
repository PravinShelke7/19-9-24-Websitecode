...
Partial Class Pages_MoldSustain2_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Material Assumptions"
    End Sub
            ...
            For i = 1 To 11
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 5
                        HeaderTdSetting(tdHeader, "120px", "Sustain1 Mold Cases", "1")
                        Header2TdSetting(tdHeader2, "", "(%)", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Qty(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$MoldSustain2ContentPlaceHolder$IC" + i.ToString() + "") <> "" Then
                        PComp(i - 1) = 1
                    Else
                        PComp(i - 1) = 0
                    End If
                    SCase(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$R" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$E" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepid" + i.ToString() + "")
                    'Check For IsNumric
                ...
                Next
                plate = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$radPlate")

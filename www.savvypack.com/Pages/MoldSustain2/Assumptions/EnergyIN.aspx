<%@ Page Language="VB" MasterPageFile="~/Masters/MoldSustain2.master" AutoEventWireup="false"
    CodeFile="EnergyIN.aspx.vb" Inherits="Pages_MoldSustain2_Assumptions_EnergyIN" Title="S2 Mold-Energy Assumptions" %>
    ...
    <div id="ContentPagemargin" runat="server">
        <div id="PageSection1" style="text-align: left">
            <table cellspacing="10">
                ...
                <tr>
                    <td style="width: 30%" valign="top" colspan="2">
                        <asp:Table ID="tblComparision4" runat="server" CellPadding="0" CellSpacing="2">
                        </asp:Table>
                    </td>
                </tr>
            </table>

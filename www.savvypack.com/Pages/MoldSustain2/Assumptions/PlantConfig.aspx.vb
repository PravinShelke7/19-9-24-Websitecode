...
Partial Class PAGES_MoldSUSTAIN2_ASSUMPTIONS_PLANTCONFIG
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Plant Configuration"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDA" + i.ToString())
                    DEPTB(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDB" + i.ToString())
                    DEPTC(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDC" + i.ToString())
                    DEPTD(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDD" + i.ToString())
                    DEPTE(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDE" + i.ToString())
                    DEPTF(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDF" + i.ToString())
                    DEPTG(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDG" + i.ToString())
                    DEPTH(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDH" + i.ToString())
                    DEPTI(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDI" + i.ToString())
                    DEPTJ(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidDepDJ" + i.ToString())

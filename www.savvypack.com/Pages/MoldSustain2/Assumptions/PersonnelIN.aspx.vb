...
Partial Class Pages_MoldSustain2_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Personnel Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    NoWorker(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$NUMBER" + i.ToString() + "").Replace(",", "")
                    DeptId(i - 1) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$hidPerDepid" + i.ToString() + "")

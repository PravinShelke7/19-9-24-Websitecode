...
Partial Class Pages_MoldSustain2_Assumptions_AdditionalEnergyInfo
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Additional Energy Info"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN2_ASSUMPTIONS_ADDITIONALENERGYINFO")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 2
                    EnergyConsum1(i) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$ENERGYCONSUMAP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric
                ...
                For i = 0 To 3
                    EnergyConsum2(i) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$ENERGYCONSUMBP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric
                ...
                For i = 0 To 3
                    EnergyConsum3(i) = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$ENERGYCONSUMCP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric

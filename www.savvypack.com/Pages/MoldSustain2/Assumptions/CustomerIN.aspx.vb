...
Partial Class Pages_MoldSustain2_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 Mold - Transportation Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_Sustain2_ASSUMPTIONS_CUSTOMERIN")
    End Sub
            ...
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        Header2TdSetting(tdHeader2, "110px", "Diesel Water", "1")
                        Header2TdSetting(tdHeader1, "0", Title, "1")
                        trHeader2.Controls.Add(tdHeader2)
                        trHeader1.Controls.Add(tdHeader1)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                SD = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$SD").Replace(",", "")
                TruckEffPre = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$TFUELEFFP").Replace(",", "")
                RailEffPre = Request.Form("ctl00$MoldSustain2ContentPlaceHolder$RFUELEFFP").Replace(",", "")
                'Check For IsNumric

...
Imports System.Net
Partial Class Pages_MoldSustain2_Default2
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN2_DEFAULT")
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Session("MoldS2LicAdmin") = "Y" Then
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("MoldS2UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("MoldS2ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("MoldS2UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("MoldS2ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("MoldS2MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
            'Set for License Administrator
            Session("MoldS2LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("MoldS2LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
    ...
    Protected Sub GetPCaseGroupDetails()
        ...
        Try
            ...
            'Dts = objGetData.GetSavedCaseAsperUser(Session("S2UserName").ToString(), "-1")
    ...
    Protected Sub SetToolButton()
        Try
            If Session("MoldS2ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            ...
            Else
                ...
                Session("MoldS2CaseId") = hidApprovedCase.Value
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        ...
        Try
            ...
            Else
                Session("MoldS2CaseId") = hidPropCase.Value ' ddlPCase.SelectedValue.ToString()
                lnkPropCase.Text = hidPropCaseD.Value
                Session("CaseType") = "Prop"

                CaseId = Session("MoldS2CaseId")
                User = Session("MoldS2UserName")
                dsSt = objgetdata.GetStatusForSister("MoldS2", CaseId, User)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldS2ConnectionString")
            hidPropCase.Value = "0"
    ...
    Public Function GetEmailBodyData(ByVal link As String, ByVal ds As DataSet) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<td>Sustain2</b></td> "

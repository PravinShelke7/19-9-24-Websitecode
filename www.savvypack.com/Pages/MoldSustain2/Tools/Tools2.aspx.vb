...
Imports System.Net
Partial Class Pages_MoldSustain2_Tools_Tools2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            If Session("MoldS2UserRole") = "AADMIN" Then
    ...
    Protected Sub GetUserDetails()
        ...
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetUserCompanyUsers(Session("MoldS2UserName").ToString())
            With ddlUsers
                .DataSource = ds
    ...
    Protected Sub GetTotalCaseCount()
        ...
        Try
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(ddlUsers.SelectedItem.Text, "MOLDS2")
...
#Region "Share Access"
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(hidUserSA.Value, "MOLDS2")
            If dsShareUserMaxCount.Tables(0).Rows.Count > 0 Then
                hidShareUserMaxCaseCount.Value = CInt(dsShareUserMaxCount.Tables(0).Rows(0).Item("MAXCASECOUNT")).ToString()
                hidTotalShareCount.Value = CInt(dsShareUserCount.Tables(0).Rows(0).Item("TOTALCOUNT")).ToString()
            Else
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.CaseSynch(SCaseId, TCaseId, "ECON2MOLD", "SUSTAIN2MOLD", "MoldS2ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            ...
            lnkPropCase.Text = hidPropCaseD.Value
            GetPCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from Econ2 Mold to Sustain2 Mold');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            CaseId = hidPropCase.Value
            obj.CaseRename(CaseId, txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MoldS2ConnectionString")
            GetPCaseDetails()
...
#Region "Tools Function"
    Protected Function CreateCase(ByVal UserName As String) As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateCase(UserName, "MoldE2ConnectionString", "MoldE2", 0)
            obj.CreateCase(UserName, "MoldS2ConnectionString", "MoldE2", CaseId)
            Return CaseId
        Catch ex As Exception
...
#End Region
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            Dim objUpdateData As New MoldS2UpInsData.UpdateInsert()
            Dim objGetData As New MoldS2GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            If hidPropCase.Value = "0" Then
                ...
                lnkPropCase.Text = "Select case"
            Else
                objUpdateData.PermissionStatusUpdate(hidPropCase.Value, Session("USERID").ToString())
    ...
    Protected Sub SendEmailStatus(ByVal CaseId As String)
        Try
            ...
            Dim objS2GetData As New MoldS2GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            dsUserData = objS2GetData.GetPermissionStatus(CaseId, Session("MoldS2UserName").ToString())
            If ds.Tables(0).Rows.Count > 0 Then
    ...
    Public Function GetEmailBodyData(ByVal link As String, ByVal ds As DataSet) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<td>Sustain2 Mold</b></td> "

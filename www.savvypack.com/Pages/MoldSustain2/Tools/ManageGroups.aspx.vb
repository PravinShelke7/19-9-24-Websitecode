...
Partial Class Pages_MoldSustain2_Tools_ManageGroups
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            If Session("SavvyModType") <> "1" Then
                ds = objGetData.GetPCaseGrpDetailsBem(Session("MoldS2UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim())
            Else
                ds = objGetData.GetPCaseGrpDetails(Session("MoldS2UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim())
            End If
    ...
    Protected Sub btnGlobalManager_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles btnGlobalManager.Click
        Try
            Session("MoldS2GroupID") = Nothing
            'Response.Redirect("~/Pages/Sustain2/Default.aspx")
            If Session("SavvyModType") <> "1" Then
                Response.Redirect("~/Pages/MoldSustain2/Default2.aspx")
            Else

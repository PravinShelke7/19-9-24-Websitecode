<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_MedSustain2_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SMed2-Global Manager</title>
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif" runat="server"  ToolTip="Log Off"  Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=SMED2"/>  
                                            ...
                                            <tr class="AlterNateColor1">
                                                ...
                                                <td>
                                                    <asp:TextBox ID="txtCaseDe3" runat="server" CssClass="MediumTextBox" Style="text-align: left;
                                                        font-size: 11px;" onKeyUp="javascript:Count(this);" onChange="javascript:Count(this);"
                            ...
                            <div class="PageHeading" style="width:80%"><center>Case Modification Tools</center></div>
                               <table width="90%">
                                <tr class="AlterNateColor4">
                                  ...
                                  <tr class="AlterNateColor1">
                                    <td>  
                                        <asp:Button ID="btnToolBox" runat="server" ToolTip="Manage Groups and Cases"  CssClass="Button" Text="Go To Toolbox" style="margin-left:0px;" />                                        
                                    </td>
                                 </tr>   
                                  <tr class="AlterNateColor1">
                                    <td>  

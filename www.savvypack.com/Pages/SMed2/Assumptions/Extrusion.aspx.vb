...
Partial Class Pages_MedSustain2_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed2 - Material Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN2_ASSUMPTIONS_EXTRUSION")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Qty(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$SMed2ContentPlaceHolder$IC" + i.ToString() + "") <> "" Then
                        PComp(i - 1) = 1
                    Else
                        PComp(i - 1) = 0
                    End If
                    SCase(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$R" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$E" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepid" + i.ToString() + "")
                    'Check For IsNumric
                ...
                Next
                plate = Request.Form("ctl00$SMed2ContentPlaceHolder$radPlate")

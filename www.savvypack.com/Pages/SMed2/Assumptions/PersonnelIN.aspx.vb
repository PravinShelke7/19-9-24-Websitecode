...
Partial Class Pages_MedSustain2_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed2 - Personnel Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN2_ASSUMPTIONS_PERSONNELIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    NoWorker(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$NUMBER" + i.ToString() + "").Replace(",", "")
                    DeptId(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidPerDepid" + i.ToString() + "")

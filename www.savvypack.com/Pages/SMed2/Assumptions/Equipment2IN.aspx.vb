...
Partial Class Pages_MedSustain2_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed2 - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN2_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    hidAssetId(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$ECP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$NGCP" + i.ToString() + "").Replace(",", "")
                    WATERP(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                    HRS(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$HRS" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$ASSETNUM" + i.ToString() + "")

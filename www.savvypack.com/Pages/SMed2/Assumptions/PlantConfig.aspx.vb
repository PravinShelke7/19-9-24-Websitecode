...
Partial Class PAGES_MedSUSTAIN2_ASSUMPTIONS_PLANTCONFIG
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed2 - Plant Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN2_ASSUMPTIONS_PLANTCONFIG")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDA" + i.ToString())
                    DEPTB(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDB" + i.ToString())
                    DEPTC(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDC" + i.ToString())
                    DEPTD(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDD" + i.ToString())
                    DEPTE(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDE" + i.ToString())
                    DEPTF(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDF" + i.ToString())
                    DEPTG(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDG" + i.ToString())
                    DEPTH(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDH" + i.ToString())
                    DEPTI(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDI" + i.ToString())
                    DEPTJ(i - 1) = Request.Form("ctl00$SMed2ContentPlaceHolder$hidDepDJ" + i.ToString())

...
Partial Class Pages_MedSustain2_IntResults_ResultsEOLIN
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN2_INTRESULTS_RESULTSEOLIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 8
                    MALRE(i) = Request.Form("ctl00$SMed2ContentPlaceHolder$MALRE" + (i + 1).ToString() + "")
                    MALIN(i) = Request.Form("ctl00$SMed2ContentPlaceHolder$MALIN" + (i + 1).ToString() + "")
                    MALCM(i) = Request.Form("ctl00$SMed2ContentPlaceHolder$MALCM" + (i + 1).ToString() + "")
                    'Check For IsNumric

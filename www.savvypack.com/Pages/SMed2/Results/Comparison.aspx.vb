...
Partial Class Pages_MedSustain2_Results_Comparison
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            If Type = "ERGY" Then
                lblTitle.Text = "SMed2 - Energy Comparison Selector"
                Page.Title = "SMed2-Energy Comparison Selector"
            ElseIf Type = "CERGY" Then
                lblTitle.Text = "SMed2 - Customer Energy Comparison Selector"
                Page.Title = "SMed2-Customer Energy Comparison Selector"
            ElseIf Type = "CustomerGHG" Then
                lblTitle.Text = "SMed2 - Customer GHG Comparison Selector"
                Page.Title = "SMed2-Customer GHG Comparison Selector"
            ElseIf Type = "CustomerEOL" Then
                lblTitle.Text = "SMed2 - Customer End Of Life Comparison Selector"
                Page.Title = "SMed2-Customer End Of Life Comparison Selector"
            ElseIf Type = "WATER" Then
                lblTitle.Text = "SMed2 - Water Comparison Selector"
                Page.Title = "SMed2-Water Comparison Selector"
            ElseIf Type = "CWATER" Then
                lblTitle.Text = "SMed2 - Customer Water Comparison Selector"
                Page.Title = "SMed2-Customer Water Comparison Selector"
            ElseIf Type = "" Then
    ...
    Protected Sub GetSessionDetails()
        Try
            lblSessionCaseId.Text = Session("SMed2CaseId")
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        ...
        Try
            ...
            If Type = "ERGY" Or Type = "GHG" Or Type = "WATER" Then
                URL = "../../../Charts/SMed2Charts/CErgyGhgWAT.aspx?CaseId=" + CaseId + "&ErgyGHG=" + objCryptoHelper.Encrypt(Type) + "&ChartType=" + objCryptoHelper.Encrypt(TypeDes) + ""
            ElseIf Type = "CERGY" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/SMed2Charts/CEnergyCharts2.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/SMed2Charts/CStackErgyChart2.aspx?&CaseId=" + CaseId + ""
                End If
            ElseIf Type = "CustomerGHG" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/SMed2Charts/CGHGCharts2.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/SMed2Charts/CStackGHGChart2.aspx?&CaseId=" + CaseId + ""
                End If
            ElseIf Type = "CWATER" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/SMed2Charts/CWATERCharts2.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/SMed2Charts/CStackWATERChart2.aspx?&CaseId=" + CaseId + ""
                End If
            ElseIf Type = "CustomerEOL" Then
                If TypeDes = "RBC" Then
                    URL = "../../../Charts/SMed2Charts/CEolCharts.aspx?&CaseId=" + CaseId + ""
                ElseIf TypeDes = "SBC" Then
                    URL = "../../../Charts/SMed2Charts/CStackGHGChart2.aspx?&CaseId=" + CaseId + ""
                End If

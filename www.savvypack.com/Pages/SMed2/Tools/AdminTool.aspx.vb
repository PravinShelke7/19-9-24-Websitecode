...
Imports ToolCCS
Partial Class Pages_MedSustain2_Tools_AdminTool
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.BaseCaseSynch(SCaseId, TCaseId, "MED2", "SMED2", "MedSustain2ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            GetBCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from SMed2 to Econ2');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            ...
            obj.CaseRenameBase(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MedSustain2ConnectionString")
            GetBCaseDetails()
...
#Region "Delete Case"
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            obj.CaseBaseDelete(Session("USERID").ToString(), CaseId.ToString(), "MedEcon2ConnectionString")
            obj.CaseBaseDelete(Session("USERID").ToString(), CaseId.ToString(), "MedSustain2ConnectionString")
            GetBCaseDetails()
...
#Region "Tools Function"
    Protected Function CreateCase() As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateBaseCase("MedEcon2ConnectionString", "MEDE2", 0)
            obj.CreateBaseCase("MedSustain2ConnectionString", "MEDE2", CaseId)
            Return CaseId
        Catch ex As Exception

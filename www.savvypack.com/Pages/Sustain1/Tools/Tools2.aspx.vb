...
Imports System.Net
Partial Class Pages_Sustain1_Tools_Tools2
...
#Region "Copy A Case"
    Protected Sub btnCopyBcase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCopyBcase.Click
        ...
        Try
            ...
            TCaseId = CreateCase(Session("S1ToolUserName"))
...
#Region "Share Access"
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            ...
            dsShareUserMaxCount = objGetData.GetSelectedUserDetails(hidUserSA.Value, "SUSTAIN1")
            If dsShareUserMaxCount.Tables(0).Rows.Count > 0 Then
                hidShareUserMaxCaseCount.Value = CInt(dsShareUserMaxCount.Tables(0).Rows(0).Item("MAXCASECOUNT")).ToString()
                hidTotalShareCount.Value = CInt(dsShareUserCount.Tables(0).Rows(0).Item("TOTALCOUNT")).ToString()
            Else
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            CaseId = hidPropCase.Value
            obj.CaseRename(CaseId, txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "Sustain1ConnectionString")
            GetPCaseDetails()
...
#Region "Delete Case"
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            CaseId = hidPropCase.Value
            obj.CaseDelete(Session("S1ToolUserName").ToString(), CaseId.ToString(), "EconConnectionString")
...
#Region "Create Case"
    Protected Sub btnCreate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreate.Click
        Try
            Dim CaseId As New Integer
            CaseId = CreateCase(Session("S1ToolUserName"))
            GetPCaseDetails()
            GetTotalCaseCount()
            hidPropCase.Value = "0"
...
#Region "Tools Function"
    Protected Function CreateCase(ByVal UserName As String) As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateCase(UserName, "EconConnectionString", "E1", 0)
            obj.CreateCase(UserName, "Sustain1ConnectionString", "E1", CaseId)
            Return CaseId
        Catch ex As Exception
...
#End Region
   ...
   Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            Dim objUpdateData As New S1UpInsData.UpdateInsert()
            Dim objGetData As New S1GetData.Selectdata()
            Dim ds As New DataSet()
    ...
    Protected Sub SendEmailStatus(ByVal CaseId As String)
        Try
            ...
            Dim objS1GetData As New S1GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            dsUserData = objS1GetData.GetPermissionStatus(CaseId, Session("USERID").ToString())
            If ds.Tables(0).Rows.Count > 0 Then

...
Imports S1GetData
Imports S1UpInsData
Partial Class Pages_Sustain1_Tools_ManageGroups
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            Else
                If Session("Service") = "COMPS1" Then
                    ds = objGetData.GetCompCaseGrpDetails(Session("USERID").ToString(), txtKey.Text.Trim().Replace("'", "''").ToString(), Session("S1ServiceId").ToString())
                Else
    ...
    Protected Sub btnCreateGrp_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCreateGrp.Click
        Try
            ...
            If Name.Length <> 0 Then
                ...
                Else
                    If Session("Service") = "COMPS1" Then
                        objUpdateData.AddCompGroupName(txtGroupDe1.Text.Trim().Replace("'", "''").ToString(), txtGroupDe2.Text.Trim().Replace("'", "''").ToString(), Session("UserId"), Session("S1ServiceId"))
                    Else

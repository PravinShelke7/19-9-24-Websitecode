<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_Sustain1_Tools_Tool" %>
...
<body style="margin-top: 0px;">
    ...
    <div id="MasterContent">
        ...
        <div>
            <table class="S1Module" id="S1Table" runat="server" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                        Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Sustain1/Default.aspx"
                            ...
                            <tr class="AlterNateColor1" style="height: 30px">
                                <td>
                                    ...
                                    <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                        OnClientClick="return ShareMessage('ddlPCases', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Econ1 to Sustain1')"
                                        onmouseout="UnTip()" Style="margin-left: 10px" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tools2.aspx.vb" Inherits="Pages_Sustain1_Tools_Tools2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S1-Tools</title>
...
if(CaseId=="0")
         ...
         else
         {
            ...
            if (Flag == 'SYN') {
                ...
                var msg = "You are going to synchronize case " + CaseId + " from Econ1 to Sustain1. Do you want to proceed?"
            }
             if (Flag == 'RENAME') 
             {
              return true;
...
if(CaseId=="0")
        ...
        //alert(Type);
         ...
         {
        //  alert('Hi1');
          var MaxCount="<%=Session("S1MaxCaseCount")%>";       
    ...
    <form id="form1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                            Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Sustain1/Default2.aspx"
        ...
        <table class="ContentPage" id="ContentPage" runat="server" style="width: 845px">
            <tr style="height: 20px">
                <td>
                    <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Sustain1-Tools')"
                            ...
                            <div>
                              <table>
                                ...
                                <%--<asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link"
                                    Font-Bold="true" NavigateUrl="~/Pages/Sustain1/Tools/AdminTool.aspx"></asp:HyperLink>--%>
                                  ...
                                  <%--   <asp:HyperLink ID="lnkGroupTool" runat="server" Text="Manage Groups" CssClass="Link"
                                    Font-Bold="true" NavigateUrl="~/Pages/Sustain1/Tools/ManageGroups.aspx" ></asp:HyperLink>--%>
                                     <asp:LinkButton ID="lnkGroupmTool" runat="Server" CssClass="Link" Text="Manage Groups" style="font-size:13px;font-weight:bold;" 
                                    OnClientClick="return ShowPopupWindow('../Tools/ManageGroups.aspx');" ></asp:LinkButton>
                                    </div> 
                                  </td>
                                </tr>
                              </table>
                                ...
                                <tr class="AlterNateColor1" style="height: 30px">
                                    <td>
                                        ...
                                        <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                            OnClientClick="return SyncMessage('Prop', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Econ1 to Sustain1')"
                                            onmouseout="UnTip()" Style="margin-left: 10px" />
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCaseDe3" runat="server" CssClass="MediumTextBox" Style="text-align: left;"
                                                TextMode="MultiLine" onKeyUp="javascript:Count(this);"
                                                    onChange="javascript:Count(this);" Height="100px" Width="489px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>

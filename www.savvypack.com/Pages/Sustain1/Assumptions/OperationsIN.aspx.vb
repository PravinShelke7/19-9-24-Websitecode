...
Partial Class Pages_Sustain1_Assumptions_OperationsIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Operating Assumptions"
    End Sub
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    If EqUnit(i - 1) = "fpm" Then
                        OPWebWidth(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$OPWebWidth" + i.ToString() + "")
                    ElseIf EqUnit(i - 1) = "cpm" Or EqUnit(i - 1) = "cpm2" Then
                        OPExits(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$OPExits" + i.ToString() + "")
                    End If

                    OMAXRH(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$ANNUALRUNHOURS" + i.ToString() + "").Replace(",", "")
                    OPINSTR(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$INSTANTANEOUSRATE" + i.ToString() + "").Replace(",", "")
                    DT(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$DOWNTIME" + i.ToString() + "").Replace(",", "")
                    OPWASTE(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$PRODUCTIONWAST" + i.ToString() + "").Replace(",", "")
                    OPWASTE1(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$DESIGNWAST" + i.ToString() + "").Replace(",", "")

...
Partial Class Pages_Sustain1_Assumptions_PlantConfig2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Plant Space Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 3
                    AREA(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$AREA" + (i + 1).ToString() + "")
                    'Check For IsNumric

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LCIComparison.aspx.vb" Inherits="Pages_Sustain1_Assumptions_LCIComparison" %>
                          ...
                          <br />
                             <table width="80%">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                           <asp:DropDownList ID="ddlEffdate" CssClass="DropDown" Width="50%" runat="server" AppendDataBoundItems="true" >
                          ...
                          <table width="80%" cellpadding="0" cellspacing="0">
                                ...
                                <tr class="AlterNateColor1">
                                    <td style="width:210px;padding-left:5px;">
                                         <asp:ListBox CssClass="DropDown" ID="lstLCI" runat="server" SelectionMode="Multiple" Width="200px" Height="150px" EnableViewState="true"  > </asp:ListBox>
                                    </td>
                                    <td valign="top" style="padding-top:5px;">
                                        <b>
                                            Press and hold the control button to select multiple datasets for comparison
                                        </b>
                                    </td>
                                 </tr> 
                                 <tr class="AlterNateColor1">
                                    <td colspan="2">
                                        <asp:Button ID="btnType" runat="server" Text="Display Comparison" CssClass="ButtonWMarigin" OnClientClick="return CountItems();" />
                                    </td>
                                </tr>

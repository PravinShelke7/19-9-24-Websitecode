<%@ Page Title="S1-Preferences" Language="VB" MasterPageFile="~/Masters/Sustain1.master" AutoEventWireup="false" CodeFile="Preferences.aspx.vb" Inherits="Pages_Sustain1_Assumptions_Preferences" %>
    ...
    <div id="ContentPagemargin" runat="server">
       <div style="margin: 0px 200px 5px 5px;;text-align:right ">
        <asp:HyperLink ID="lnkAPref" runat="server" Text="Additional Preferences" CssClass="Link" Target="_blank" 
            Font-Bold="true" NavigateUrl="~/Pages/Sustain1/Assumptions/APreferences.aspx"></asp:HyperLink>

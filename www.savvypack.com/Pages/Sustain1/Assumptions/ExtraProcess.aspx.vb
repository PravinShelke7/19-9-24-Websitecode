...
Partial Class Pages_Sustain1_Assumptions_ExtraProcess
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Extra-process Waste"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 3
                    extraProcess(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$EP" + i.ToString() + "").Replace(",", "")
                    Preffered(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$PREF" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

...
Partial Class Pages_Sustain1_Assumptions_EnergyIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetWizard()
        ...
        Wizardbtn.OnClientClick = "return Wizard('Wizard.aspx?Type=ALL','ERGYWIZ');"
        Wizardbtn.ToolTip = "Energy/GHG/Water Use Wizard"
        'AddHandler Updatebtn.Click, AddressOf Update_Click
    End Sub
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Energy Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_ENERGYIN")
    End Sub
        ...
        Try
            ...
            For i = 1 To 10
                ...
                Select Case i
                    ...
                    Case 7
                        Title = "(MJ)"
                        HeaderTdSetting(tdHeader, "", "Non-Renewable Energy", "2")
                        Header2TdSetting(tdHeader2, "75px", "Electricity", "1")
                        Header2TdSetting(tdHeader1, "75px", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    ...
                    Case 9
                        Title = "(MJ)"
                        HeaderTdSetting(tdHeader, "100px", "Non-Renewable Total", "1")
                        Header2TdSetting(tdHeader2, "100px", "", "1")
                        Header2TdSetting(tdHeader1, "100px", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    Case 10
                        Title = "(MJ)"
                        HeaderTdSetting(tdHeader, "100px", "Renewable Energy", "1")
                        Header2TdSetting(tdHeader2, "100px", "", "1")
                        Header2TdSetting(tdHeader1, "100px", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                ...
                For j = 1 To 10
                    ...
                    Select Case j
                        ...
                        Case 7
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label
                            If ds.Tables(0).Rows(0).Item("NRELEC" + i.ToString() + "").ToString() <> "" Then
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("NRELEC" + i.ToString() + "").ToString(), 0)
                            End If
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 8
                        ...
                        Case 9
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label
                            If ds.Tables(0).Rows(0).Item("TOTALNR" + i.ToString() + "").ToString() <> "" Then
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("TOTALNR" + i.ToString() + "").ToString(), 0)
                            End If
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 10
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label
                            If ds.Tables(0).Rows(0).Item("RELEC" + i.ToString() + "").ToString() <> "" Then
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("RELEC" + i.ToString() + "").ToString(), 0)
                            End If
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
            ...
            For i = 1 To 10
                ...
                Select Case i
                    ...
                    Case 7
                        InnerTdSetting(tdInner, "", "Right")
                        If ds.Tables(0).Rows(0).Item("NRELEC5").ToString() <> "" Then
                            tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("NRELEC5").ToString(), 0) + " </b> </span>"
                        End If
                        trInner.Controls.Add(tdInner)
                    Case 8
                        InnerTdSetting(tdInner, "", "Right")
                    ...
                    Case 9
                        InnerTdSetting(tdInner, "", "Right")
                        If ds.Tables(0).Rows(0).Item("TOTALNR5").ToString() <> "" Then
                            tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTALNR5").ToString(), 0) + " </b> </span>"
                        End If
                        trInner.Controls.Add(tdInner)
                    Case 10
                        InnerTdSetting(tdInner, "", "Right")
                        If ds.Tables(0).Rows(0).Item("RELEC5").ToString() <> "" Then
                            tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("RELEC5").ToString(), 0) + " </b> </span>"
                        End If
                        trInner.Controls.Add(tdInner)
                End Select
            Next
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 1
                    ERGPPREF(i) = Request.Form("ctl00$Sustain1ContentPlaceHolder$ERGPPREF" + (i + 1).ToString() + "")
                    'Check For IsNumric
                ...
                'CFACTORPREF = Request.Form("ctl00$Sustain1ContentPlaceHolder$CFACTORPREF")
                CFACTORPREF(0) = Request.Form("ctl00$Sustain1ContentPlaceHolder$CFACTORPREF1")
                CFACTORPREF(1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$CFACTORPREF2")
...
#Region "Bulk Model Management"
    ...
    Protected Sub btnUpdateBulk_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnUpdateBulk.Click
        ...
        Try
            ...
            str = Session("S1CaseIdString")
            If str <> "" Then
                strArr = str.Split(",")
                For count = 0 To strArr.Length - 1
                    BCaseId = strArr(count)
                    Try
                        ObjUpIns.EnergyUpdateBT(BCaseId, ERGPPREF, CFACTORPREF)
                        'Update Server Date
                        ObjUpIns.ServerDateUpdate(BCaseId, Session("S1UserName"))
                    Catch ex As Exception
                    End Try
                Next

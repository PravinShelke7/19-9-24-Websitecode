...
Partial Class Pages_Sustain1_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Transportation Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                SD = Request.Form("ctl00$Sustain1ContentPlaceHolder$SD").Replace(",", "")
                TruckEffPre = Request.Form("ctl00$Sustain1ContentPlaceHolder$TFUELEFFP").Replace(",", "")
                RailEffPre = Request.Form("ctl00$Sustain1ContentPlaceHolder$RFUELEFFP").Replace(",", "")
                'Check For IsNumric

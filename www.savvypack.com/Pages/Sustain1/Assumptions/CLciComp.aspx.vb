...
Partial Class Pages_Sustain1_Assumptions_CLciComp
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If Session("CompType") = "Energy" Then
                    lblHeaderText.Text = "Sustain1 - LCI Comparison By Energy"
                    Page.Title = "S1-LCI Comparison By Energy"
                ElseIf Session("CompType") = "Green House Gas" Then
                    lblHeaderText.Text = "Sustain1 - LCI Comparison By GHG"
                    Page.Title = "S1-LCI Comparison By GHG"
                Else
                    lblHeaderText.Text = "Sustain1 - LCI Comparison By Water"
                    Page.Title = "S1-LCI Comparison By Water"
                End If
            End If
            GetSessionDetails()

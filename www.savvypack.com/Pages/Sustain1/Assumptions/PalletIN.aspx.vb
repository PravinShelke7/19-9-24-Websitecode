...
Partial Class Pages_Sustain1_Assumptions_PalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Pallet Configuration Assumptions "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_PALLETIN")
    End Sub
...
#End Region
        ...
        Try
            ...
            For i = 1 To 15
                ...
                Select Case i
                    ...
                    Case 2
                        HeaderTdSetting(tdHeader, "140px", "Item", "1")
                        HeaderTdSetting(tdHeader1, "0", "", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    ...
                    Case 4
                        Title = "(Units)"
                        HeaderTdSetting(tdHeader, "70px", "Number Of Uses", "1")
                ...
                For j = 1 To 15
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetPalletDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), Nothing, dsPallet)
                        ...
                        Case 4
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("NOUSE" + i.ToString() + "").ToString(), 2)
                            txt.MaxLength = 4
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 5
                        ...
                        Case 7
                            ...
                            lbl = New Label
                            lbl.Width = 50
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("ERGYS" + i.ToString() + "").ToString(), 1)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 8
                            InnerTdSetting(tdInner, "", "Center")
                        ...
                        Case 9
                            ...
                            lbl = New Label
                            lbl.Width = 50
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("GHGS" + i.ToString() + "").ToString(), 2)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 10
                            InnerTdSetting(tdInner, "", "Center")
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("GHGP" + i.ToString() + "").ToString(), 2)
                            txt.MaxLength = 6
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        ...
                        Case 13
                            ...
                            lbl = New Label
                            lbl.Width = 50
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("SDS" + i.ToString() + "").ToString(), 0)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 14
                            InnerTdSetting(tdInner, "", "Center")
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("SDP" + i.ToString() + "").ToString(), 2)
                            txt.MaxLength = 6
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 15
            ...
            For i = 1 To 15
                ...
                Select Case i
                    ...
                    Case 5
                        ...
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTWEIGHT").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 7
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTENERGY").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 9
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                    ...
                    Case 13
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTSHIPDIS").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 2, 3, 4, 15
                        InnerTdSetting(tdInner, "", "Left")
                        trInner.Controls.Add(tdInner)
            ...
            For i = 1 To 15
                ...
                Select Case i
                    Case 13
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTALOLDPALLETSHIPPING").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 1
                        InnerTdSetting(tdInner, "", "Left")
                        tdInner.ColumnSpan = 2
                ...
                For j = 1 To 8
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            lbl = New Label
                            lbl.Width = 180
                            GetPalletDetails(Nothing, Nothing, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), lbl, dsPallet)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 3
                            InnerTdSetting(tdInner, "", "Right")
                        ...
                        Case 5
                            ...
                            lbl = New Label
                            lbl.Width = 70
                            lbl.Text = ds.Tables(0).Rows(0).Item("SUSMATS" + i.ToString() + "").ToString()
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 6
                            InnerTdSetting(tdInner, "", "Left")
                            ...
                            Link.Width = 70
                            Link.CssClass = "Link"
                            GetSustainMaterialDetails(Link, hid, ds.Tables(0).Rows(0).Item("SUSMATP" + i.ToString() + "").ToString())
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
                        Case 7
            ...
            For i = 1 To 13
                ...
                Select Case i
                    ...
                    Case 3
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTRECOV").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 5
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTSUSMAT").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 7
                        InnerTdSetting(tdInner, "", "center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTREC").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 2
                        InnerTdSetting(tdInner, "", "Left")
                        trInner.Controls.Add(tdInner)
    ...
    Protected Sub GetPalletDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal palletId As Integer, ByVal lbl As Label, ByVal dsPallet As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New S1GetData.Selectdata()
        ...
        Try
            ...
            ElseIf Not IsNothing(lbl) Then
                lbl.Text = dtPallet.Rows(0).Item("PalletDes").ToString()
    ...
    Protected Sub UpdatePage()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        Pallet(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                        Number(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                        NoOfUses(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$NOUSE" + i.ToString() + "").Replace(",", "")
                        PrefWeight(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$WP" + i.ToString() + "").Replace(",", "")
                        PrefErgy(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                        PrefCO2(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$GHGP" + i.ToString() + "").Replace(",", "")
                        PrefSHIPD(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$SDP" + i.ToString() + "").Replace(",", "")
                        Dept(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")
                        PrefWater(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                ...
                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        PrefRECOV(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$RECP" + i.ToString() + "").Replace(",", "")
                        PrefSUSM(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                        PrefPCREC(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$PCRECP" + i.ToString() + "").Replace(",", "")
                        'Check Numeric

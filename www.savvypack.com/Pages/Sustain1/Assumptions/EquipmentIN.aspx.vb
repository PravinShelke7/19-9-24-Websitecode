...
Partial Class Pages_Sustain1_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Equipment Assumptions"
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    PARP(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$PLANTAREAP" + i.ToString() + "").Replace(",", "")
                    ECP(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$NTGP" + i.ToString() + "").Replace(",", "")
                    ...
                    ASSETNUM(i - 1) = Request.Form("ctl00$Sustain1ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    'Check For IsNumric

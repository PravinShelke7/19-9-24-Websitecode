...
Partial Class Pages_Sustain1_Assumptions_PalletInNewout
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Raw Material Packaging Results')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Raw Material Packaging Results "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN1_ASSUMPTIONS_PALLETINNEWOUT")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetPalletInNewout(CaseId, Convert.ToInt32(ViewState("TabId")))
            dsEmat = objGetData.GetEditMaterial(CaseId)
            dsMat = objGetData.GetPalletInNewout(CaseId, ViewState("TabId").ToString())
            dv = dsEmat.Tables(0).DefaultView
            'lblMaterialName.Text = "<b>Material " + ViewState("TabId").ToString() + ":</b>" + ds.Tables(0).Rows(0).Item("MATDES").ToString() + ""
            ...
            For i = 1 To 4
                ...
                Select Case i
                    Case 1
                        HeaderTdSetting(tdHeader, "300px", "Item", "1")
                        trHeader.Controls.Add(tdHeader)
                    Case 2
                        HeaderTdSetting(tdHeader, "90px", "Value", "1")
                        trHeader.Controls.Add(tdHeader)
                    Case 3
                        HeaderTdSetting(tdHeader, "120", "Units", "1")
                        trHeader.Controls.Add(tdHeader)
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            If i = 16 Or i = 17 Or i = 18 Then
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("VAL" + i.ToString() + "").ToString(), 3)
                            Else
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("VAL" + i.ToString() + "").ToString(), 0)
                            End If

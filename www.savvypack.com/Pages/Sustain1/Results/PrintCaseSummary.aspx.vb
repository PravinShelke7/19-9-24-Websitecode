...
Partial Class Pages_Sustain1_Results_PrintCaseSummary
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain1 - Print Case Summary"
    End Sub
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                If ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString() <> "0" Then
                                    dv.RowFilter = "MATID=" + ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()
                                    dt = dv.ToTable
                                    If dt.Rows.Count > 0 Then
                                        Link.Text = dt.Rows(0).Item("MATDES").ToString().Replace("&#", "'")
                                    Else
                                        'Link.Text = ds.Tables(0).Rows(0).Item("MAT" + i.ToString() + "").ToString()

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CResultsEOL2.aspx.vb" Inherits="Pages_Sustain1_Results_CResultsEOL2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S1-Customer End Of Life Comparison</title>
            ...
            <tr>
                <td>
                     <div class="PageHeading" id="divMainHeading" style="width:840px;">
                         Sustain1 - Customer End Of Life Comparison
                     </div>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BulkModelManagement.aspx.vb" Inherits="Pages_Sustain1_BulkModelManagement" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function ClosePopUp() {
            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_loading').style.display = "inline";
            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_lnkSelBulkModel').style.display = "none";
            window.close();
            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_btnUpdateBulk').click();
        }
        function ClosePopUp1() {
            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_loading').style.display = "inline";
            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_lnkSelBulkModel').style.display = "none";
            window.close();
            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_btnUpdateBulk1').click();
        }
    </script>
    <style type="text/css">
        .modalBackground {
    ...
    <script type="text/javascript" language="javascript">
        ...
        function WindowCloseHanlder() {
            if (document.getElementById("hdnUpdate").value == "0") {
                window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_lnkSelBulkModel').style.display = "inline";
            }
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="Div1" class="ContentPage" runat="server" style="width: 1350px;">
            <div id="AlliedLogo">
                <table>
                    <tr>

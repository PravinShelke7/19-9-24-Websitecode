<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateMaterial.aspx.vb"
    Inherits="Pages_Sustain1_PopUp_UpdateMaterial" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S1-Edit Material Name</title>
    ...
    <script type="text/JavaScript">
        function MaterialDet() {
            ...
            document.getElementById('<%= hidMatId.ClientID%>').value = window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hidMatid' + i).value;
        ...
        function CloseWindow() {
            ...
            if (hidMatName != "") {
                ...
                window.opener.document.getElementById(hidMatDes1).title = Name;
                ...
                for (j = 1; j < 11; j++) {
                    var hidMatId = window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hidMatid' + j).value;
                    if (j != i) {
                        if (document.getElementById('<%= hidMatId.ClientID%>').value == hidMatId) {
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hypMatDes' + j).innerHTML = Name;
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hypMatDes' + j).title = Name;
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_imgBut' + j).style.display = "inline";
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_imgDis' + j).style.display = "none";
                        }
                    }
                }
                ...
                for (j = 1; j < 11; j++) {
                    ...
                    if (j != i) {
                        if (document.getElementById('<%= hidMatId.ClientID%>').value == hidMatId) {
                            ...
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_imgBut' + j).style.display = "none";
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_imgDis' + j).style.display = "inline";
                        }
                    }
                }
            }

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateEquip.aspx.vb"
    Inherits="Pages_Sustain1_PopUp_UpdateEquip" %>
    ...
    <script type="text/JavaScript">
        ...
        function CloseWindow() {
            ...
            if (hidEqName != "") {
                ...
                for (j = 1; j < 31; j++) {
                    var hidAssetId = window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hidAssetId' + j).value;

                    if (j != i) {
                        if (document.getElementById('<%= hidAssetId.ClientID%>').value == hidAssetId) {
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hypAssetDes' + j).innerHTML = Name;
                            window.opener.document.getElementById('ctl00_Sustain1ContentPlaceHolder_hypAssetDes' + j).title = Name;

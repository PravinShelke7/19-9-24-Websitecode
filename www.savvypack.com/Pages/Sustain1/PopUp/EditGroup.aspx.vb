Imports System
Imports System.Data
Partial Class Pages_Sustain1_PopUp_EditGroup
    ...
    Protected Sub GetReportDetails()
        ...
        Try
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetCompGroupDetails(Session("UserId").ToString(), "N", Session("CompS1ServiceId").ToString())
            Else
    ...
    Protected Sub lnkGrpId_Click(ByVal sender As Object, ByVal e As EventArgs)
        Dim grpId As String = ""
        Dim ObjUpData As New S1UpInsData.UpdateInsert()
        Try

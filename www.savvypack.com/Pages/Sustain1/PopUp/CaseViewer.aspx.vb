...
Partial Class Pages_Sustain1_PopUp_CaseViewer
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            '    Else
            '        If Session("Service") = "COMPS1" Then
            '            ds = objGetData.GetCompCases(Session("USERID"), CaseDe1, CaseDe2, Session("S1ServiceId"))
            '        Else
            ...
            'Else
            '    If Session("Service") = "COMPS1" Then
            '        ds = objGetData.GetCompCasesByLicense(Session("USERID"), CaseDe1, CaseDe2, Session("S1ServiceId"))
            '    Else

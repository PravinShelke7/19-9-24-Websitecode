<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetMatPopUpGrade.aspx.vb"
    Inherits="Pages_Sustain1_PopUp_GetMatPopUpGrade" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S1-Get Materials</title>
    ...
    <script type="text/JavaScript">
        function testData() {
            ...
            document.getElementById('<%= hidDMatId.ClientID%>').value = window.opener.document.getElementById("ctl00_Sustain1ContentPlaceHolder_hidMatid" + i).value;
        ...
        (MatDes, MatId, GradeName, GradeId, Weight, SG, MatDe3) {
...
<body>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left">
            ...
            <table style="width: 380px;" cellpadding="4" cellspacing="0">
            ...
            <div style="width: 430px; height: 380px; overflow: auto;">
                <asp:GridView Width="380px" runat="server" ID="grdMaterials" DataKeyNames="MATID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Material Des1" SortExpression="MATDE1">
                            <ItemTemplate>
                                <%--<a href="#" onclick="MaterialDet('<%#Container.DataItem("MATDES")%>','<%#Container.DataItem("MATID")%>','<%#Container.DataItem("MATDES3")%>')"
                                    class="Link">

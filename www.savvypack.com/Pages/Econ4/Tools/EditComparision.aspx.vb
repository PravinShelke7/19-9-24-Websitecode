...
Imports E4GetData
Imports E4UpInsData
Partial Class Pages_Econ4_Tools_EditComparision
    ...
    Protected Sub bindDetails()
        Try
            ...
            If Session("SavvyModType") <> "1" Then
                Dts1 = GetData.GetEditCasesE4(Session("USERID").ToString(), AssumptionId, "true", Session("E4LicAdmin"))
                Dts2 = GetData.GetEditCasesE4(Session("USERID").ToString(), AssumptionId, "false", Session("E4LicAdmin"))
            Else

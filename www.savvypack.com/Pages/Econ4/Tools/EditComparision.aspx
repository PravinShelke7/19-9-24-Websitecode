<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="EditComparision.aspx.vb" Inherits="Pages_Econ4_Tools_EditComparision" title="Edit Comparision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ4ContentPlaceHolder" Runat="Server">
 <script type="text/JavaScript" src="../../../JavaScripts/collapseableDIV.js"></script>
    ...
    <table width="840px">
        <tr align="left">
            <td style="width: 43%" class="PageHeading" onmouseover="Tip('E4-Edit Comparison')"
                onmouseout="UnTip()">
                Econ4 - Edit Comparison
            </td>
        </tr>
    </table>
    <br />

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="PersonnelOut.aspx.vb" 
Inherits="Pages_Econ4_IntResults_PersonnelOut" title="E4-Personnel Plan ,Payroll, and Department Breakdown" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Personnel Plan ,Payroll, and Department Breakdown')" onmouseout="UnTip()" >
                  Econ4 - Personnel Plan ,Payroll, and Department Breakdown
                </td>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent3"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PD" checked="checked"   onclick="showhideMax('ctl00_Econ4ContentPlaceHolder_PD'); " />Position Description
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_WK" checked="checked"  onclick="showhideMax('ctl00_Econ4ContentPlaceHolder_WK'); " />Number of Workers
                             <br />                           
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PR" checked="checked"  onclick="showhideMax('ctl00_Econ4ContentPlaceHolder_PR'); " />Payroll
                             <br />

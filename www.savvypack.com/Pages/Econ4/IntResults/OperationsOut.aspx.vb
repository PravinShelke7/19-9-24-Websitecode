...
Partial Class Pages_Econ4_IntResults_OperationsOut
        ...
        Try
            ...
            For i = 0 To DataCnt
                ...
                If Cunits <> Units Or CCurrTitle <> CurrTitle Then
                    Headertext = "Case#:" + arrCaseID(i).ToString() + "<br/>" + dsCaseDetails.Tables(0).Rows(0).Item("CaseDes").ToString() + "<br/> <span  style='color:red'>Unit / Currency Mismatch</span>" + "<input type='hidden' value='" + arrCaseID(i).ToString() + "' name='Case" + i.ToString() + "'/>"
                Else
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("PROCDE" + i.ToString())
                        ...
                        Case 4
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("FEV" + i.ToString() + "").ToString(), 0).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 5
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("FPV" + i.ToString() + "").ToString(), 0).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 6
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("DW" + i.ToString() + "").ToString(), 1).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 7
                        ...
                        Case 8
                            ...
                            For k = 0 To DataCnt
                                ...
                                If CDbl(dstbl.Tables(k).Rows(0).Item("PV" + i.ToString() + "").ToString()) > 0.0 Then
                                    volPer = (CDbl(dstbl.Tables(k).Rows(0).Item("FPV" + i.ToString() + "").ToString()) / CDbl(dstbl.Tables(k).Rows(0).Item("PV" + i.ToString() + "").ToString())) * 100

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ExtrusionOut.aspx.vb" 
Inherits="Pages_Econ4_IntResults_ExtrusionOut" title="E4-Material & Structure Results" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Material and Structure Results')" onmouseout="UnTip()" >
                  Econ4 - Material and Structure Results
                </td>
                 ...
                 <div id="divContent2" class="divContent3"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_W" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_W'); " />Weight
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PA" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_PA'); " />Purchase Vol.
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PB" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_PB'); " />Purchase Cost
                             <br />

...
Partial Class Pages_Econ4_IntResults_ExtrusionOut
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                lbl.Text = dstbl.Tables(k).Rows(0).Item("MATDE" + i.ToString())
                        ...
                        Case 3
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("W" + i.ToString() + "").ToString(), 1).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 4

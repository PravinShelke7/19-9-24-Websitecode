...
Imports E4GetData
Imports E4UpInsData
Partial Class Pages_Econ4_Category_AddEditCategory
    ...
    Protected Sub bindDetails()
        Dim objGetData As New E4GetData.Selectdata
        Dim objUpdateData As New E4UpInsData.UpdateInsert
    ...
    Protected Sub Transfer1(ByVal Fromlst As ListBox, ByVal Tolst As ListBox, ByVal IsAll As Boolean)
        ...
        Try
            ...
            Dim cntVal As String = Request.Form("ctl00$Econ4ContentPlaceHolder$lstRegion1")
    ...
    Protected Sub Transfer2(ByVal Fromlst As ListBox, ByVal Tolst As ListBox, ByVal IsAll As Boolean)
        ...
        Try
            ...
            Dim cnt As Integer = 0
            Dim cntVal As String = Request.Form("ctl00$Econ4ContentPlaceHolder$lstRegion2")
            Dim strCount() As String = Regex.Split(cntVal, ",")
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            message = "Category " + ddlCat.SelectedItem.Text + " updated successfully."

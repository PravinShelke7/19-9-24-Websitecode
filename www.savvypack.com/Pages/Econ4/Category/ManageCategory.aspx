<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ManageCategory.aspx.vb" 
Inherits="Pages_Econ4_Category_ManageCategory" title="E4-Manage Category" %>
...
function IsNumeric(sText)
{
   ...
   return IsNumber;
     ...
     function checkDeletedDrop()
    {
      ...
      {       
        var txtCount=document.getElementById("<%=txtCatCount.ClientId%>").value;
       // var PrevCount=document.getElementById("ctl00$Econ4ContentPlaceHolder$hdnPrevCount").value;
      ...
      function CheckCategory()
      {
           ...
           {
             var txtCat=document.getElementById("ctl00_Econ4ContentPlaceHolder_CATNAME"+i).value;
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:820px">
        <tr style="height:10px">
            <td>
                <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('E4 - Manage Category Set')"
                    onmouseout="UnTip()" style="width: 820px;">
                    Econ4 - Manage Category Set
                </div>
                 <div style="text-align:right ">
                   <asp:HyperLink ID="HyperLink1" runat="server" Text="Go to Charts" CssClass="Link" style="font-size:15px;"
            ...
            <td>
                <div id="ContentPagemargin">
                    <div id="PageSection1" style="text-align: left; margin-left: 0px;">
                        <table width="820px">
                            <tr>
                                <td style="height:3px;width:100%" align="left" colspan="2" >
                                    ...
                                    <tr class="AlterNateColor4">
                                           <td class="PageSHeading" style="font-size: 14px;" colspan="2">
                                            ...
                                            <tr class="AlterNateColor1">
                                                ...
                                                <td >
                                                    <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="ButtonWMarigin" Style="width: 50px;" OnClientClick="return requiredField();"
                                                        onmouseover="Tip('Create a Category Set')" onmouseout="UnTip()" />
                                                </td>
                                            </tr>
                               </table>
                            </td>
                             <td style="width:40%" align="left" >
                               <table>
                                    ...
                                    <tr class="AlterNateColor1">
                                        ...
                                        <td style="width:70%">
                                            <asp:DropDownList ID="ddlCatSetD" CssClass="DropDown" Width="200px" runat="server" >
                                             </asp:DropDownList>
                                        </td>
                                    </tr>                            
                                    <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="ButtonWMarigin" Style="width:80px;"
                                                onmouseover="Tip('delete Category Set')" onmouseout="UnTip()" OnClientClick="return checkDeletedDrop();" />
                                        </td>
                                    </tr>           
                               </table>
                             </td> 
                        ...
                        <table width="820px">
                            ...
                            <tr class="AlterNateColor1">
                                ...
                                <td>
                                    <asp:Button ID="btnSubmit" runat="server" Text="Submit" CssClass="ButtonWMarigin" Style="width:80px;" OnClientClick="return requireCategoryCheck();"
                                        onmouseover="Tip('Create a Category')" onmouseout="UnTip()" />
                                </td>
                            </tr>
                              ...
                              <td></td>
                                <td>
                                    <asp:Button ID="btnAddCat" runat="server" Text="Update" CssClass="ButtonWMarigin" Style="width:80px;"
                                        onmouseover="Tip('Submit')" onmouseout="UnTip()"  OnClientClick="return CheckCategory();"  />
                                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="ButtonWMarigin" Style="width:80px;"
                          ...
                          <table width="100%">
                                ...
                                <tr class="AlterNateColor4">
                                  ...
                                  <tr class="AlterNateColor1">
                                    <td>  
                                        <asp:Button ID="btnAddCategory" runat="server"  CssClass="Button" Width="170px" Enabled=true  Text="Go To Add/Edit Category" style="margin-left:0px;" />                                        
                                    </td>
                                 </tr>   

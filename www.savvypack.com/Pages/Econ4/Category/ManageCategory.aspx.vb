...
Imports E4GetData
Imports E4UpInsData
Partial Class Pages_Econ4_Category_ManageCategory
    ...
    Protected Sub btnAdd_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Dim objGetData As New E4GetData.Selectdata
        Dim objUpdate As New E4UpInsData.UpdateInsert
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            dt = objE4GetData.GetCategoryBySet(ddlCatSet.SelectedValue, "")
    ...
    Protected Sub btnAddCat_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddCat.Click
        ...
        Try
            ...
            For i = 0 To txtCatCount.Text - 1
                strCategory(i) = Request.Form("ctl00$Econ4ContentPlaceHolder$CATNAME" + (i + 1).ToString())
                'Checking Duplicate
    ...
    Protected Sub ddlCatSet_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlCatSet.SelectedIndexChanged
        ...
        Try
            ...
            If ds.Rows.Count > 0 Then
                ...
                'txtCatCount.Enabled = False
                'lblMsg.Text = "<b>Prev. Count:</b>" + ds.Rows.Count.ToString()
    ...
    Protected Sub btnAddCategory_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAddCategory.Click
        Try
            Response.Redirect("~/Pages/Econ4/Category/AddEditCategory.aspx")
        Catch ex As Exception

<%@ Page Title="E4-Comparison Manager" Language="VB" MasterPageFile="~/Masters/Econ4.master"
    AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_Econ4_Default" %>
    ...
    <script type="text/JavaScript">
       function Message() 
        {
         var modType="<%=Session("SavvyModType")%>"; 
                ...
                if(modType=="2")
                {
                               var SisterCases="<%=Session("E4SisterCases")%>"; 
                               var sisCases="";
                               var sisStatus="";
                               var statusId=SisterCases.split(',');
                              // alert(statusId[0]);
                             // alert(SisterCases);
                                var x = document.getElementById("ctl00_Econ4ContentPlaceHolder_CaseComp");
       ...
       function MakeVisible(id) {
        ...
        function valList() {
            ...
            var selCount = 0;
            var namelength = document.getElementById("ctl00$Econ4ContentPlaceHolder$ComparisonName").value
            for (var i = 0; i < document.getElementById("ctl00$Econ4ContentPlaceHolder$CaseComp").length; i++) {
                if (document.getElementById("ctl00$Econ4ContentPlaceHolder$CaseComp")[i].selected) {
                    selCount += 1;
                }

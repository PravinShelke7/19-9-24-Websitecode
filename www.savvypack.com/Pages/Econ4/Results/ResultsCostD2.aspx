<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsCostD2.aspx.vb" 
Inherits="Pages_Econ4_Results_ResultsCostD2" title="E4-Manufacturing Cost with Depreciation(Weight)" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Manufacturing Cost with Depreciation (Weight)')" onmouseout="UnTip()" >
                  Econ4 - Manufacturing Cost with Depreciation (Weight) 
                </td>

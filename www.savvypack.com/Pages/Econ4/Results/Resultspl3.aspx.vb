...
Partial Class Pages_Econ4_Results_Resultspl3
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/E4Charts/CPrftCost.aspx?CaseId=" + obj.Encrypt(AssumptionId) + "&PrftCost=" + objCryptoHelper.Encrypt("PRFT") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&IsDep=" + objCryptoHelper.Encrypt("N") + "&CType=" + objCryptoHelper.Encrypt("PUnit") + "') "
                    ...
                    Select Case j
                        Case 1
                            ...
                            For k = 0 To DataCnt
                                ...
                                If CDbl(dstbl.Tables(k).Rows(0).Item("finvolmsi").ToString()) > 0 Then

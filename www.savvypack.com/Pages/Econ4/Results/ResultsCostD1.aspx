<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsCostD1.aspx.vb" 
Inherits="Pages_Econ4_Results_ResultsCostD1" title="E4-Manufacturing Cost with Depreciation(Currency)" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Manufacturing Cost with Depreciation (Currency)')" onmouseout="UnTip()" >
                  Econ4 - Manufacturing Cost with Depreciation (Currency) 
                </td>

...
Partial Class Pages_Econ4_Results_ResultsplDep2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/E4Charts/CPrftCost.aspx?CaseId=" + obj.Encrypt(AssumptionId) + "&PrftCost=" + objCryptoHelper.Encrypt("PRFT") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&IsDep=" + objCryptoHelper.Encrypt("Y") + "&CType=" + objCryptoHelper.Encrypt("PWeight") + "') "
                    ...
                    Select Case j
                        Case 1
                            ...
                            For k = 0 To DataCnt
                                ...
                                If CDbl(salesVolume) > 1 Then
                                    perwt = CDbl(CDbl(dstbl.Tables(k).Rows(0).Item("PL" + i.ToString() + "").ToString()) / salesVolume * CDbl(dstbl.Tables(k).Rows(0).Item("CURR").ToString())) / CDbl(dstbl.Tables(k).Rows(0).Item("CONVWT").ToString())

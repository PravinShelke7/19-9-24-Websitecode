<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsplDep1.aspx.vb" 
Inherits="Pages_Econ4_Results_ResultsplDep1" title="E4-Profit And Loss with Depreciation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ4ContentPlaceHolder" Runat="Server">
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Profit And Loss with Depreciation (Currency)')" onmouseout="UnTip()" >
                  Econ4 - Profit And Loss with Depreciation (Currency) 
                </td>

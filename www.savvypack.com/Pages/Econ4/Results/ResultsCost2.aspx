<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsCost2.aspx.vb" Inherits="Pages_Econ4_Results_ResultsCost2" title="E4-Manufacturing Cost(Weight)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ4ContentPlaceHolder" Runat="Server">
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Manufacturing Cost (Weight)')" onmouseout="UnTip()" >
                  Econ4 - Manufacturing Cost (Weight) 
                </td>

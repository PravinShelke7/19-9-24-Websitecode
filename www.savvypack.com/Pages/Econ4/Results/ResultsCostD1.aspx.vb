...
Partial Class Pages_Econ4_Results_ResultsCostD1
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/E4Charts/CPrftCost.aspx?CaseId=" + obj.Encrypt(AssumptionId) + "&PrftCost=" + objCryptoHelper.Encrypt("COST") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&IsDep=" + objCryptoHelper.Encrypt("Y") + "&CType=" + objCryptoHelper.Encrypt("Total") + "') "
                            ...
                            For k = 0 To DataCnt
                                ...
                                For cnt = 0 To 1
                                    ...
                                    Else
                                        ...
                                        If CDbl(dstbl.Tables(k).Rows(0).Item("PL25").ToString()) > 0 Then
                                            percentage = CDbl(dstbl.Tables(k).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(dstbl.Tables(k).Rows(0).Item("PL25").ToString()) * 100

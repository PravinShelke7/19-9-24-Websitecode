<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="Resultspl1.aspx.vb"
 Inherits="Pages_Econ4_Results_Resultspl1" title="E4-Profit And Loss (Currency)" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Profit And Loss (Currency)')" onmouseout="UnTip()" >
                  Econ4 - Profit And Loss (Currency) 
                </td>

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsCost1.aspx.vb" Inherits="Pages_Econ4_Results_ResultsCost1" 
title="E4-Manufacturing Cost(Currency)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ4ContentPlaceHolder" Runat="Server">
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Manufacturing Cost (Currency)')" onmouseout="UnTip()" >
                  Econ4 - Manufacturing Cost (Currency) 
                </td>
                              ...
                              <br />                             
                               <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES11" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES11'); " />Insurance Cost
                                ...
                                <%--<input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES23" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES23'); " />Depreciation
                                 <br />--%>
                                  <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES23" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES23'); " />Total Fixed Cost
                                 <br />
                                  <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES24" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES24'); " />Total Cost

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="Resultspl2.aspx.vb" 
Inherits="Pages_Econ4_Results_Resultspl2" title="E4-Profit And Loss(Per Unit Weight)" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Profit And Loss (Per Unit Weight)')" onmouseout="UnTip()" >
                  Econ4 - Profit And Loss (Per Unit Weight) 
                </td>

...
Partial Class Pages_Econ4_Results_ResultsplDep3
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('../../../Charts/E4Charts/CPrftCost.aspx?CaseId=" + obj.Encrypt(AssumptionId) + "&PrftCost=" + objCryptoHelper.Encrypt("PRFT") + "&ChartType=" + objCryptoHelper.Encrypt("RBC") + "&IsDep=" + objCryptoHelper.Encrypt("Y") + "&CType=" + objCryptoHelper.Encrypt("PUnit") + "') "
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            For i = 0 To DataCnt
                ...
                ds = objGetData.GetProfitAndLossDetailsWithDep(arrCaseID(i), True)
                    ...
                    Select Case j
                        Case 1
                            ...
                            For k = 0 To DataCnt
                                ...
                                If CInt(dstbl.Tables(k).Rows(0).Item("finvolmsi").ToString()) > 0 Then
                                    perunit = CDbl(dstbl.Tables(0).Rows(0).Item("PL" + i.ToString() + "").ToString()) / CDbl(dstbl.Tables(k).Rows(0).Item("finvolmsi").ToString()) * 100 * CDbl(dstbl.Tables(k).Rows(0).Item("CURR").ToString()) / CDbl(dstbl.Tables(k).Rows(0).Item("convarea").ToString())

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsplDep3.aspx.vb" 
Inherits="Pages_Econ4_Results_ResultsplDep3" title="E4-Profit And Loss with Depreciation(Per Unit)" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ4ContentPlaceHolder" Runat="Server">
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:54%" class="PageHeading" onmouseover="Tip('Profit And Loss with Depreciation(Per Unit) ')" onmouseout="UnTip()" >
                  Econ4-Profit And Loss with Depreciation(Per Unit) 
                </td>
                              ...
                              <br />                             
                               <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES11" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES11'); " />Lease Cost
                                ...
                                <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES23" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES23'); " />Metal Supplies
                                 ...
                                 <br />
                                  <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PDES25" checked="checked"   onclick="showhide('ctl00_Econ4ContentPlaceHolder_PDES25'); " />Plant Margin

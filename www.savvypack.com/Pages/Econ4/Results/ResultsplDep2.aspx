<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="ResultsplDep2.aspx.vb" 
Inherits="Pages_Econ4_Results_ResultsplDep2" title="E4-Profit And Loss with Depreciation(Per Unit Weight)" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:56%" class="PageHeading" onmouseover="Tip('Profit And Loss with Depreciation(Per Unit Weight)')" onmouseout="UnTip()" >
                  Econ4-Profit And Loss with Depreciation(Per Unit Weight) 
                </td>

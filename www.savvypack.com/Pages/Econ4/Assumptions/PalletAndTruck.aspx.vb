...
Partial Class Pages_Econ4_Assumptions_PalletAndTruck
            ...
            For j = 1 To 14
                ...
                Select Case j
                    ...
                    Case 2
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("M1").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    Case 3
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("M2").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    Case 4
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("M3").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    ...
                    Case 5
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("M4").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    ...
                    Case 6
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("M5").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    ...
                    Case 11
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("T4").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    ...
                    Case 12
                        ...
                        For k = 0 To DataCnt
                            tdInner = New TableCell
                            tdInner.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("T5").ToString(), 0)
                            InnerTdSetting(tdInner, "", "Right")
                            trInner.Controls.Add(tdInner)
                        Next
                    Case 13

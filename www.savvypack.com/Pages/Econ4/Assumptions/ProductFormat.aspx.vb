...
Partial Class Pages_Econ4_Assumptions_ProductFormat
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            dsProd = objGetData.GetProductFormat("-1", "", "")
                    ...
                    Select Case j
                        Case 1
                            ...
                            For k = 0 To DataCnt
                                ...
                                GetProductDetails(lbl, dstbl.Tables(k).Rows(0).Item("M" + i.ToString() + "").ToString(), dsProd)
                        ...
                        Case 2, 3, 4, 5, 6
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = "<b>" + dstbl.Tables(k).Rows(0).Item("FORMAT_M" + (j - 1).ToString() + "").ToString() + "</b><br />" + FormatNumber(dstbl.Tables(k).Rows(0).Item("M" + (j).ToString() + "").ToString(), 3).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        ...
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = "<b>" + dstbl.Tables(k).Rows(0).Item("TITLE8").ToString() + "</b><br />" + FormatNumber(dstbl.Tables(k).Rows(0).Item("PRODUCTWEIGHT").ToString(), 4).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 8
    ...
    Protected Sub GetProductDetails(ByRef lbl As Label, ByVal FromatId As Integer, ByVal dsProd As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New E2GetData.Selectdata()

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="PalletIn.aspx.vb" Inherits="Pages_Econ4_Assumptions_PalletIn" title="Pallet Packaging Assumptions" %>
    ...
    <table width="840px">
            <tr align="left">
                <td style="width:43%" class="PageHeading" onmouseover="Tip('Pallet Packaging Assumptions')" onmouseout="UnTip()" >
                  Econ4 - Pallet Packaging Assumptions
                </td>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_IT" checked="checked"   onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_IT'); " />Item
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_NUM" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_NUM'); " />Number
                             <br />                           
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_NUMU" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_NUMU'); " />Number Of Uses
                             <br />
                          ...
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_WP" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_WP'); " />Weight Pref.
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PS" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_PS'); " />Price Sugg.  
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PP" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_PP'); " />Price Pref.
                             <br />
                           <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_MD" checked="checked"  onclick="showhideALL('ctl00_Econ4ContentPlaceHolder_MD'); " />Mfg. Department 
                        </div>   

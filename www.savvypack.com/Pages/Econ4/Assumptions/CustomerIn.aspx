<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="CustomerIn.aspx.vb"
 Inherits="Pages_Econ4_Assumptions_CustomerIn" title="E4-Customer Assumptions" %>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                           ...
                           <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PP" checked="checked"  onclick="showhideALL3('ctl00_Econ4ContentPlaceHolder_PP'); " />Product Purchase
                             <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_SD" checked="checked"  onclick="showhideALL3('ctl00_Econ4ContentPlaceHolder_SD'); " />Shipping Distance
                             <br />                           
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_MC" checked="checked"  onclick="showhideALL3('ctl00_Econ4ContentPlaceHolder_MC'); " />Mileage cost
                             <br />
                         </div>   

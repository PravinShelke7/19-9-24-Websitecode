...
Partial Class Pages_Econ4_Assumptions_PalletIn
...
#End Region
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                GetPalletDetails(lbl, dstbl.Tables(k).Rows(0).Item("M" + i.ToString() + "").ToString(), dsPallet)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 3
                            tdInner = New TableCell
                            LeftTdSetting(tdInner, "Number (per pallet)", trInner, "AlterNateColor2")
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("NUM" + i.ToString() + "").ToString(), 2).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 4
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("NU" + i.ToString() + "").ToString(), 2).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 5
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("WS" + i.ToString() + "").ToString(), 2).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 6
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("WP" + i.ToString() + "").ToString(), 2).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 7
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PS" + i.ToString() + "").ToString(), 2).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 8
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                lbl.Text = FormatNumber(dstbl.Tables(k).Rows(0).Item("PP" + i.ToString() + "").ToString(), 2).ToString()
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                        Case 9
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                GetDeptDetails(lbl, dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "").ToString(), arrCaseID(k).ToString(), dsDept)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                    End Select
    ...
    Protected Sub GetPalletDetails(ByRef lbl As Label, ByVal palletId As Integer, ByVal dsPallet As DataSet)
        Dim Ds As New DataSet
        ...
        Try
            ...
            lbl.Text = dtPallet.Rows(0).Item("PallteDes").ToString()

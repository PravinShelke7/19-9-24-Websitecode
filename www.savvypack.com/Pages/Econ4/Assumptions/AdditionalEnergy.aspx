<%@ Page Language="VB" MasterPageFile="~/Masters/Econ4.master" AutoEventWireup="false" CodeFile="AdditionalEnergy.aspx.vb"
 Inherits="Pages_Econ4_Assumptions_AdditionalEnergy" title="E4-Additional Energy Info" %>
            ...
            <td>
                 ...
                 <div id="divContent2" class="divContent2"> 
                        <div style="margin-left:7px;margin-top:10px;margin-bottom:5px">
                          ...
                          <b>Plant Space</b>   
                          <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_PROD" checked="checked"  onclick="showhideALL1('ctl00_Econ4ContentPlaceHolder_PROD'); " />Production
                          <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_WAR" checked="checked"  onclick="showhideALL1('ctl00_Econ4ContentPlaceHolder_WAR'); " />Warehouse
                          <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_OFF" checked="checked"  onclick="showhideALL1('ctl00_Econ4ContentPlaceHolder_OFF'); " />Office
                          <br />
                          <input type="checkbox" id="ctl00_Econ4ContentPlaceHolder_SUPP" checked="checked"  onclick="showhideALL1('ctl00_Econ4ContentPlaceHolder_SUPP'); " />Support
                          <br />

...
Partial Class Pages_Econ4_Assumptions_Equipment2In
...
#End Region
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                GetSupportEquipmentInDetails(lbl, dstbl.Tables(k).Rows(0).Item("M" + i.ToString() + "").ToString(), dsSEquip)
                        ...
                        Case 10
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Right")
                                GetCostTypeDetails(lbl, dstbl.Tables(k).Rows(0).Item("COSTTYPE" + i.ToString() + "").ToString(), dsCost)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
    ...
    Protected Sub GetSupportEquipmentInDetails(ByRef lbl As Label, ByVal EqId As Integer, ByVal dsSEquip As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New E2GetData.Selectdata()
        Dim hidval As New HiddenField
        Dim Path As String = String.Empty
        ...
        Try
            ...
            lbl.Text = dtSEquip.Rows(0).Item("equipDES").ToString()
        Catch ex As Exception

...
Partial Class Pages_Econ4_Assumptions_PlantConfig
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            For k = 0 To DataCnt
                                ...
                                GetDeptDetails(lbl, dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P1").ToString(), dsDept)
                                lbl.Font.Bold = True
                        ...
                        Case 3, 4, 5, 6, 7, 8, 9, 10, 11
                            ...
                            For k = 0 To DataCnt
                                ...
                                tdInner = New TableCell
                                InnerTdSetting(tdInner, "", "Left")
                                GetDeptDetails(lbl, dstbl.Tables(k).Rows(0).Item("D" + i.ToString() + "P" + (j - 1).ToString() + "").ToString(), dsDept)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Next
                            If ((j - 2) Mod 2 = 0) Then

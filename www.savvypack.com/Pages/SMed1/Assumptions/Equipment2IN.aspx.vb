...
Partial Class Pages_MedSustain1_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
                    ...
                    Select Case j
                        ...
                        Case 3 'Bug# 375
                            ...
                            If ViewState("IsFirstLoad") = "N" Then
                                txt.Text = FormatNumber(Request.Form("ctl00$SMed1ContentPlaceHolder$ASSETNUM" + i.ToString() + "").Replace(",", ""), 0)
                            Else
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    ECP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$ECP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$NGCP" + i.ToString() + "").Replace(",", "")
                    WATERP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                    HRS(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$HRS" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$ASSETNUM" + i.ToString() + "") 'Bug #375

...
Partial Class Pages_MedSustain1_Assumptions_OperationsIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Operating Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_OPERATIONSIN")
    End Sub
                ...
                For j = 1 To 13
                    ...
                    Select Case j
                        ...
                        Case 8
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("INSTANTANEOUSRATE" + i.ToString() + "").ToString(), 2)
                            txt.MaxLength = 12
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 9
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    'OPWebWidth(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$WEBWIDTH" + i.ToString() + "")
                    If EqUnit(i - 1) = "fpm" Then
                        OPWebWidth(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$OPWebWidth" + i.ToString() + "")
                    ElseIf EqUnit(i - 1) = "cpm" Or EqUnit(i - 1) = "cpm2" Then
                        OPExits(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$OPExits" + i.ToString() + "")
                    End If

                    OMAXRH(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$ANNUALRUNHOURS" + i.ToString() + "").Replace(",", "")
                    OPINSTR(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$INSTANTANEOUSRATE" + i.ToString() + "").Replace(",", "")
                    DT(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$DOWNTIME" + i.ToString() + "").Replace(",", "")
                    OPWASTE(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$PRODUCTIONWAST" + i.ToString() + "").Replace(",", "")
                    OPWASTE1(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$DESIGNWAST" + i.ToString() + "").Replace(",", "")

                    'Check For IsNumric
                    Try
                        'Request.Form("ctl00$SMed1ContentPlaceHolder$WEBWIDTH" + i.ToString() + "").ToString()

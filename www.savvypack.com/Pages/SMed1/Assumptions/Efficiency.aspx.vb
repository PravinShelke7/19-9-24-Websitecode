...
Partial Class Pages_MedSustain1_Assumptions_Efficiency
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Efficiency Table Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_EFFICIENCY")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATA" + i.ToString() + "") <> "" Then
                        MATA(i - 1) = 1
                    Else
                        MATA(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATB" + i.ToString() + "") <> "" Then
                        MATB(i - 1) = 1
                    Else
                        MATB(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATC" + i.ToString() + "") <> "" Then
                        MATC(i - 1) = 1
                    Else
                        MATC(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATD" + i.ToString() + "") <> "" Then
                        MATD(i - 1) = 1
                    Else
                        MATD(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATE" + i.ToString() + "") <> "" Then
                        MATE(i - 1) = 1
                    Else
                        MATE(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATF" + i.ToString() + "") <> "" Then
                        MATF(i - 1) = 1
                    Else
                        MATF(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATG" + i.ToString() + "") <> "" Then
                        MATG(i - 1) = 1
                    Else
                        MATG(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATH" + i.ToString() + "") <> "" Then
                        MATH(i - 1) = 1
                    Else
                        MATH(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATI" + i.ToString() + "") <> "" Then
                        MATI(i - 1) = 1
                    Else
                        MATI(i - 1) = 0
                    End If

                    If Request.Form("ctl00$SMed1ContentPlaceHolder$MATJ" + i.ToString() + "") <> "" Then
                        MATJ(i - 1) = 1
                    Else
                        MATJ(i - 1) = 0
                    End If

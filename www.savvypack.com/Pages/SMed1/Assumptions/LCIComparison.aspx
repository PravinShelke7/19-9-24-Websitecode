<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LCIComparison.aspx.vb" Inherits="Pages_MedSustain1_Assumptions_LCIComparison" %>
...
<body>
    ...
    <div id="MasterContent">
        ...
        <div>
            <table class="SMed1Module" id="SMed1Table" runat="server" cellpadding="0" cellspacing="0"
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlEffdate" CssClass="DropDown" Width="50%" runat="server"
                                            ...
                                            <asp:ListItem Text="Latest Date" Value="0">
                                            </asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlType" CssClass="DropDown" Width="40%" runat="server">
                                            ...
                                            <asp:ListItem Text="Green House Gas" Value="GHG">
                                            </asp:ListItem>

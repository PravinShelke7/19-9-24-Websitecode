...
Partial Class Pages_MedSustain1_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Transportation Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_CUSTOMERIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                SD = Request.Form("ctl00$SMed1ContentPlaceHolder$SD").Replace(",", "")
                TruckEffPre = Request.Form("ctl00$SMed1ContentPlaceHolder$TFUELEFFP").Replace(",", "")
                RailEffPre = Request.Form("ctl00$SMed1ContentPlaceHolder$RFUELEFFP").Replace(",", "")
                'Check For IsNumric

...
Partial Class Pages_MedSustain1_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_EQUIPMENTIN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    hidAssetId(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    PARP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$PLANTAREAP" + i.ToString() + "").Replace(",", "")
                    ECP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$ERGYP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$NTGP" + i.ToString() + "").Replace(",", "")
                    WATERP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$WATERP" + i.ToString() + "").Replace(",", "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    'Check For IsNumric

...
Partial Class Pages_MedSustain1_Assumptions_Extrusion
    Inherits System.Web.UI.Page
    Public CaseDes As String = String.Empty
    Shared objCalb As New SMed1BarrierGetData.Calculations
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Material and Structure Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_EXTRUSION")
    End Sub
...
#End Region
    ...
    Protected Sub GetShipSelectorDetails(ByRef LinkShip As HyperLink, ByVal hid As HiddenField, ByVal ShipId As Integer)
        ...
        Catch ex As Exception
            ErrorLable.Text = "Error:GetShipSelectorDetails:" + ex.Message.ToString() + ""
        End Try
    End Sub
    ...
    Protected Sub UpdatePage()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        Material(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidMatid" + i.ToString() + "")
                        Thickness(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$THICK" + i.ToString() + "")
                        Recycle(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$REC" + i.ToString() + "")
                        ERGYP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$ERGYP" + i.ToString() + "")
                        CO2P(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$CO2P" + i.ToString() + "")
                        SHIPP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$SHIPP" + i.ToString() + "")
                        EP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$EP" + i.ToString() + "")
                        SGP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$SGP" + i.ToString() + "")
                        SHIPU(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$SHIPU" + i.ToString() + "")
                        SHIPS(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidShipSId" + i.ToString() + "")
                        Dept(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidDepid" + i.ToString() + "")
                        WATER(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$WATERP" + i.ToString() + "")

                        OTR(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$OTR" + i.ToString() + "")
                        WVTR(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$WVTR" + i.ToString() + "")
                        GRADE(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidGradeId" + i.ToString() + "")
                    ...
                    For i = 1 To 3
                        ...
                        MaterialDis(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidDisMatid" + i.ToString() + "")
                        WeightDis(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$DISW" + i.ToString() + "")
                        ErgyDis(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$DISERGY" + i.ToString() + "")
                        CO2Dis(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$DISCO" + i.ToString() + "")
                        WaterDis(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$DISWATER" + i.ToString() + "")
                        ...
                        If Request.Form("ctl00$SMed1ContentPlaceHolder$DISW" + i.ToString() + "") <> 0 Then
                    ...
                    plate = Request.Form("ctl00$SMed1ContentPlaceHolder$radPlate")

                    raddiscmatyn = Request.Form("ctl00$SMed1ContentPlaceHolder$raddiscmatyn")
                ...
                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        RECOP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$RECOP" + i.ToString() + "")
                        SUSMat(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                        PCRECP(i - 1) = Request.Form("ctl00$SMed1ContentPlaceHolder$PCRECP" + i.ToString() + "")

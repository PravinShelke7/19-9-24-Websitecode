...
Partial Class Pages_MedSustain1_Assumptions_ProductFormatIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PwtPref = Request.Form("ctl00$SMed1ContentPlaceHolder$PWT").ToString()
                If Session("SMed1ServiceRole") <> "ReadOnly" Then
                    ...
                    M1 = Request.Form("ctl00$SMed1ContentPlaceHolder$hidProductid")
                    ...
                    If UpdateFlag = CDbl(0) Then
                        For i = 2 To 6
                            Input(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                            'Check For IsNumric

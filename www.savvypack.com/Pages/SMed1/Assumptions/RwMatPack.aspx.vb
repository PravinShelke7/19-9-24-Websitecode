...
Partial Class Pages_MedSustain1_Assumptions_RwMatPack
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Raw Material Packaging Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_ASSUMPTIONS_RWMATPACK")
    End Sub
...
#End Region
    ...
    Protected Sub UpdatePage()
        Try
            ...
            Col = Chr(64 + Convert.ToInt32(ViewState("TabId"))).ToString()
            For i = 1 To 10
                Pallet(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                Number(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$NUM" + i.ToString() + "")
                Ergy(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$ERGY" + i.ToString() + "")
                Ghg(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$GHG" + i.ToString() + "")
                Water(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$Water" + i.ToString() + "")
                Recycle(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$RECYCLE" + i.ToString() + "")
                Reco(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$RECO" + i.ToString() + "")
                Osha(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$hidSusMatId" + i.ToString() + "")
                Pc(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$PC" + i.ToString() + "")
                Sd(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$SHIP" + i.ToString() + "")
            ...
            Next
            Tuc = Request.Form("ctl00$SMed1ContentPlaceHolder$Tuc")
            'Check for isNumeric

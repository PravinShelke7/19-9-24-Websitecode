...
Partial Class Pages_MedSustain1_Assumptions_CLciComp
        ...
        Try
            ...
            If Not IsPostBack Then
                ...
                If Session("CompType") = "Energy" Then
                    lblHeaderText.Text = "SMed1 - LCI Comparison By Energy"
                    Page.Title = "SMed1-LCI Comparison By Energy"
                ElseIf Session("CompType") = "Green House Gas" Then
                    lblHeaderText.Text = "SMed1 - LCI Comparison By GHG"
                    Page.Title = "SMed1-LCI Comparison By GHG"
                Else
                    lblHeaderText.Text = "SMed1 - LCI Comparison By Water"
                    Page.Title = "SMed1-LCI Comparison By Water"
                End If
            End If
            GetSessionDetails()

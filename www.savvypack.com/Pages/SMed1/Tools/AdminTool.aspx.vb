...
Imports ToolCCS
Partial Class Pages_MedSustain1_Tools_AdminTool
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.BaseCaseSynch(SCaseId, TCaseId, "MED1", "SMED1", "MedSustain1ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            ...
            obj.CaseRenameBase(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MedSustain1ConnectionString")
            GetBCaseDetails()
...
#Region "Delete Case"
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            obj.CaseBaseDelete(Session("USERID").ToString(), CaseId.ToString(), "MedEcon1ConnectionString")
            obj.CaseBaseDelete(Session("USERID").ToString(), CaseId.ToString(), "MedSustain1ConnectionString")
            GetBCaseDetails()
...
#Region "Tools Function"
    Protected Function CreateCase() As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateBaseCase("MedEcon1ConnectionString", "MEDE1", 0)
            obj.CreateBaseCase("MedSustain1ConnectionString", "MEDE1", CaseId)
            Return CaseId
        Catch ex As Exception

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_MedSustain1_Tools_Tool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>SMed1-Tools</title>
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from Med1 to SMed1. Do you want to proceed?"
            }
        ...
        {
          var MaxCount="<%=Session("SMed1MaxCaseCount")%>";       
   ...
   <%-- <center>--%>
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"  Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/SMed1/Default.aspx"
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('SMed1-Tools')" onmouseout="UnTip()" style="width:840px;">
                     SMed1 - Tools
             ...
             <tr style="height:20px">
              ...
              <br />
                  <table>
                       ...
                       <%-- <asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link" Font-Bold="true" 
                        NavigateUrl="~/Pages/Sustain1/Tools/AdminTool.aspx"></asp:HyperLink>--%>
                         <asp:LinkButton ID="lnkAdminmTool" runat="Server" CssClass="Link" Text="Admin Tool" style="font-size:13px;font-weight:bold;" 
                               ...
                               <td>
                                     <div id="Div2" runat="server" style="margin: 0px 5px 5px 5px;">
                                    ...
                                    <td>
                                           ...
                                           <asp:Button ID="btnCopyPcase" runat="server" Text="Copy" CssClass="ButtonWMarigin" OnClientClick="return CreateMessage('ddlPCases','NCC');"
                                            ...
                                            <asp:Button ID="btnPShareCase" runat="server" Text="Share Access" CssClass="ButtonWMarigin" OnClientClick="return MakeVisible('divshareAccess');"
                                             ...
                                             onmouseover="Tip('Synchronize this Case from Med1 to SMed1')" onmouseout="UnTip()" style="margin-left:10px" />
                                    ...
                                    <tr class="AlterNateColor4">
                                     ...
                                     <tr class="AlterNateColor1">
                                      ...
                                      <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:TextBox id="txtCaseDe3" onKeyUp="javascript:Count(this);"  onChange="javascript:Count(this);" runat="server" CssClass="MediumTextBox" Style="text-align:left;"

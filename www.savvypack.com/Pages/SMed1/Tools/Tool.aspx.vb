...
Imports ToolCCS
Partial Class Pages_MedSustain1_Tools_Tool
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Session("Service") = "COMPS1" Then
                ...
                divMainHeading.InnerHtml = "SMed1 - Competitive Module - Tools"
                divMainHeading.Attributes.Add("onmouseover", "Tip('SMed1-Competitive Module-Tools')")
                Page.Title = "SMed1-Competitive Module-Tools"
                IsAdmin.Visible = False
            End If
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetPCaseCompDetails(Session("USERID").ToString(), Session("SMed1ServiceId").ToString())
            Else
    ...
    Protected Sub GetUserDetails()
        ...
        Try
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetCompUserCompanyUsers(Session("SMed1UserName").ToString(), Session("SMed1ServiceID").ToString())
            Else
                ds = objGetData.GetUserCompanyUsers(Session("SMed1UserName").ToString())
            End If
    ...
    Protected Sub GetTotalCaseCount()
        ...
        Try
            ...
            If Session("Service") = "COMPS1" Then
                ds = objGetData.GetCompTotalCaseCount(Session("USERID").ToString(), Session("SMed1ServiceId").ToString())
            Else
            ...
            If Session("Service") = "COMPS1" Then
                dsSUserCount = objGetData.GetCompTotalCaseCount(ddlUser2.SelectedItem.Value.ToUpper(), Session("SMed1ServiceId").ToString())
            Else
            ...
            If dsSUserMaxCountSMed1.Tables(0).Rows.Count > 0 Then
                hidUserMaxCaseCount.Value = CInt(dsSUserMaxCountSMed1.Tables(0).Rows(0).Item("MAXCASECOUNT")).ToString()
            ...
            Else
                ...
                If dsSUserMaxCountMed1.Tables(0).Rows.Count > 0 Then
                    hidUserMaxCaseCount.Value = dsSUserMaxCountMed1.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString().Trim()
            ...
            If Session("Service") = "COMPS1" Then
                dsShareUserCount = objGetData.GetCompTotalCaseCount(ddlUsers.SelectedItem.Value.ToUpper(), Session("SMed1ServiceId").ToString())
                dsShareUserMaxCount = objGetData.GetSelectedUserDetails(ddlUsers.SelectedItem.Text, "CompSustain")
            Else
                dsShareUserCount = objGetData.GetTotalCaseCount(ddlUsers.SelectedItem.Value.ToUpper())
                dsShareUserMaxCount = objGetData.GetSelectedUserDetails(ddlUsers.SelectedItem.Text, "MedS1")
            End If
...
#Region "Tools Function"
    Protected Function CreateCase(ByVal USERID As String) As Integer
        ...
        Dim objData As New SMed1UpInsData.UpdateInsert()
        Try
            ...
            If Session("Service") = "COMPS1" Then
                objData.UpdateSustainServiceId(CaseId, Session("ServiceMed1"), Session("ServiceSMed1"), USERID)
            End If
            Return CaseId
        Catch ex As Exception
...
#Region "Share Access"
    Protected Sub btnShareAccess_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnShareAccess.Click
        ...
        Try
            ...
            obj.CaseAccess(USERID, CaseId, "MedEcon1ConnectionString")
            obj.CaseAccess(USERID, CaseId, "MedSustain1ConnectionString")
            If Session("Service") = "COMPS1" Then
                objData.UpdateSustainServiceId(CaseId, Session("ServiceMed1"), Session("ServiceSMed1"), USERID)
            End If
            Flag = True
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.CaseSynch(SCaseId, TCaseId, "MED1", "SMED1", "MedSustain1ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
        ...
        If Flag Then
            GetPCaseDetails()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('You have suceessfully synchronized Case #" + SCaseId.ToString() + " from Med1 to SMed1');", True)
        End If
    End Sub
#End Region
...
#Region "Rename Case"
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            CaseId = ddlPCases.SelectedValue.ToString()
            obj.CaseRename(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MedSustain1ConnectionString")
            GetPCaseDetails()

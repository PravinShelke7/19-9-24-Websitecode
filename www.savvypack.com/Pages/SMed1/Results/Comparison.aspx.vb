...
Partial Class Pages_MedSustain1_Results_Comparison
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            End If
            If Type = "ERGY" Then
                lblTitle.Text = "SMed1 - Energy Comparison Selector"
                Page.Title = "SMed1-Energy Comparison Selector"
            ElseIf Type = "CERGY" Then
                lblTitle.Text = "SMed1 - Customer Energy Comparison Selector"
                Page.Title = "SMed1-Customer Customer Energy Comparison Selector"
            ElseIf Type = "GHG" Then
                lblTitle.Text = "SMed1 - GHG Comparison Selector"
                Page.Title = "SMed1-GHG Comparison Selector"
            ElseIf Type = "CGHG" Then
                lblTitle.Text = "SMed1 - Customer GHG Comparison Selector"
                Page.Title = "SMed1-Customer GHG Comparison Selector"
            ElseIf Type = "CGHG" Then
                lblTitle.Text = "SMed1 - Customer GHG Comparison Selector"
                Page.Title = "SMed1-Customer GHG Comparison Selector"
            ElseIf Type = "WATER" Then
                lblTitle.Text = "SMed1 - Water Comparison Selector"
                Page.Title = "SMed1-Water Comparison Selector"
            ElseIf Type = "CWATER" Then
                lblTitle.Text = "SMed1 - Water Comparison Selector"
                Page.Title = "SMed1-Water Comparison Selector"
            ElseIf Type = "CEOL" Then
                lblTitle.Text = "SMed1 - Customer End Of Life Comparison Selector"
                Page.Title = "SMed1-Customer End Of Life Comparison Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            lblSessionCaseId.Text = Session("SMed1CaseId")
    ...
    Protected Sub btnType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnType.Click
        ...
        Try
            ...
            ds = objGetData.GetProductFormtByID(Session("SMed1CaseId"), ddlPCases.SelectedValue)
            ...
            Else
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('These cases are not comparable because Case " + Session("SMed1CaseId").ToString() + " is in " + Units1 + " and Case " + ddlPCases.SelectedValue + " is in " + Units2 + ".');", True)
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        ...
        Try
            ...
            URL = "../../../Charts/SMed1Charts/CErgyGhgWat.aspx?CaseId=" + CaseId + "&ErgyGHG=" + objCryptoHelper.Encrypt(Type) + "&ChartType=" + objCryptoHelper.Encrypt(TypeDes) + ""

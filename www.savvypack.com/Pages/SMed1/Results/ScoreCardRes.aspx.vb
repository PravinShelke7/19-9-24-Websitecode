...
Partial Class Pages_MedSustain1_Results_ScoreCardRes
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "SMed1 - Scorecard Results "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDSUSTAIN1_RESULTS_SCORECARDRES")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 9
                    LowRange(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$LOWP_" + i.ToString() + "").Replace(",", "")
                    HighRange(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$HIGHP_" + i.ToString() + "").Replace(",", "")
                    Weightings(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$WTP_" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric
                    ...
                    If i > 7 Then
                        RawStore(i) = Request.Form("ctl00$SMed1ContentPlaceHolder$RW" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_MedSustain1_Default" %>
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif" runat="server"  ToolTip="Log Off"  Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=SMED1"/>  
             ...
             <tr style="height:20px">
                ...
                <div id="ContentPagemargin" runat="server">
                   <div id="PageSection1" style="text-align:left;" >
                           <br />
                            <div class="PageHeading" style="width:90%"><center>Select from Existing Cases</center></div>
                              <table width="90%">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlBaseCases" CssClass="DropDown" Width="96%" runat="server"></asp:DropDownList>
                                    </td>
                                 </tr> 
                                 <tr class="AlterNateColor1">
                                    <td>  
                            ...
                            <br />
                             <table width="90%">
                                ...
                                <tr class="AlterNateColor4">
                                 ...
                                 <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlPCase" CssClass="DropDown" Width="96%" runat="server"></asp:DropDownList>
                                 ...
                                 <tr class="AlterNateColor1">
                                  ...
                                  <tr class="AlterNateColor1">
                                    ...
                                    <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCaseDe3" onKeyUp="javascript:Count(this);"  onChange="javascript:Count(this);" runat="server" CssClass="MediumTextBox" Style="text-align: left;font-size:11px;"

...
Imports System.Net
Partial Class Pages_MedSustain1_Default2
...
#End Region
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            ...
            Else
                ...
                Session("S1CaseId") = hidApprovedCase.Value
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        ...
        Try
            ...
            Else
                Session("S1CaseId") = hidPropCase.Value ' ddlPCase.SelectedValue.ToString()
                lnkPropCase.Text = hidPropCaseD.Value
                Session("CaseType") = "Prop"

                CaseId = Session("S1CaseId")
                User = Session("S1UserName")
                dsSt = objgetdata.GetStatusForSister("S1", CaseId, User)
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            Dim objUpdateData As New SMed1UpInsData.UpdateInsert()
            ...
            If hidPropCase.Value = "0" Then
                ...
                lnkPropCase.Text = "Select case"
            Else
                objUpdateData.PermissionStatusUpdate(hidPropCase.Value, Session("S1UserName").ToString())
    ...
    Protected Sub SendEmailStatus(ByVal CaseId As String)
        Try
            ...
            Dim objS1GetData As New SMed1GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            dsUserData = objS1GetData.GetPermissionStatus(CaseId, Session("S1UserName").ToString())
            If ds.Tables(0).Rows.Count > 0 Then

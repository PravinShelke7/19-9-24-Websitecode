<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CaseGroup.aspx.vb" Inherits="Pages_MedSustain1_PopUp_CaseGroup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SMed1-Case Group Details</title> 
                    ...
                    <Columns>
                        <asp:BoundField DataField="CaseId" HeaderText="CaseId" SortExpression="CaseId" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="GROUP NAME" SortExpression="CaseDe1">                              
                                <ItemTemplate>
                                   <a href="#" onclick="CaseSearch('<%#Container.DataItem("GROUPDES")%>','<%#Container.DataItem("GROUPID")%>')" class="Link">

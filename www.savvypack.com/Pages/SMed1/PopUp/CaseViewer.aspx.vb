...
Partial Class Pages_MedSustain1_PopUp_CaseViewer
        ...
        Try
            If Session("SMed1LicAdmin") = "N" Then
                If Request.QueryString("GrpID") <> "0" Then
                    ds = objGetData.GetGroupCases(Session("SMed1UserName"), CaseDe1, CaseDe2, Request.QueryString("GrpID").ToString())
                Else
                    If Session("Service") = "COMPS1" Then
                        ds = objGetData.GetCompCases(Session("USERID"), CaseDe1, CaseDe2, Session("SMed1ServiceId"))
                    Else
            ...
            Else
                If Session("Service") = "COMPS1" Then
                    ds = objGetData.GetCompCasesByLicense(Session("USERID"), CaseDe1, CaseDe2, Session("SMed1ServiceId"))
                Else

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditGroup.aspx.vb" Inherits="Pages_MedSustain1_PopUp_EditGroup" %>
                ...
                <asp:GridView Width="640px" runat="server" ID="grdGrpCases" DataKeyNames="GROUPID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtGroupName" MaxLength="25"  CssClass="SmallTextBox"  style="text-align:left;" Font-Size="8"   Width="200px" Enabled="true" runat="server" Text='<%# bind("GROUPNAME")%>'
                                AutoPostBack="false" />
                            </ItemTemplate>

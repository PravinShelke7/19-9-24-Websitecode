...
Partial Class Pages_MedSustain1_PopUp_CaseSearch
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            If hidCaseid.Value = "ddlPCase" Then
                If Session("SMed1LicAdmin") = "N" Then
                    ...
                    Else
                        If Session("Service") = "COMPS1" Then
                            ds = objGetData.GetCompCases(Session("USERID"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Session("SMed1ServiceId"))
                        Else
                ...
                Else
                    If Session("Service") = "COMPS1" Then
                        ds = objGetData.GetCompCasesByLicense(Session("USERID"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Session("SMed1ServiceId").ToString())
                    Else

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetGradeDetails.aspx.vb" Inherits="Pages_MedSustain1_PopUp_GetGradeDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SMed1-Get Grades</title> 
       ...
       <div id="PageSection1" style="text-align:left">
        <asp:Label ID="_lErrorLble" runat="server"></asp:Label>
           ...
           <asp:GridView Width="400px" runat="server" ID="grdGrade" DataKeyNames="GRADEID" AutoGenerateSelectButton="false"
                    ...
                    <Columns>
                        <asp:BoundField DataField="GRADEID" HeaderText="GRADEID" SortExpression="GRADEID" Visible="false">  
                        </asp:BoundField>
                          <asp:TemplateField HeaderText="GRADE NAME" SortExpression="GRADENAME">                              
                                <ItemTemplate>
                                   <a href="#" onclick="GradeDetails('<%#Container.DataItem("GRADENAME")%>','<%#Container.DataItem("GRADEID")%>','<%#Container.DataItem("WEIGHT")%>','<%#Container.DataItem("SG")%>')" class="Link"><%#Container.DataItem("GRADEID")%>:<%#Container.DataItem("GRADENAME")%></a>
                                </ItemTemplate>

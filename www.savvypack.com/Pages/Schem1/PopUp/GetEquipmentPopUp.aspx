<%@ Page Language="VB" MasterPageFile="~/Masters/Schem1PopUp.master" AutoEventWireup="false" CodeFile="GetEquipmentPopUp.aspx.vb" Inherits="Pages_Schem1_PopUp_GetAssetPopUp" title="Schem1-Get Equipment" %>
...
//             window.close();
       ...
       function EquipmentDet(EquipDes, EquipId, EQUIPDES3) {
           ...
           if (document.getElementById('<%= hidMod.ClientID%>').value == 'Schem1') {
               if (EquipId == "0") {

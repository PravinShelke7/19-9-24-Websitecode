...
Partial Class Pages_Schem1_PopUp_CaseSearch
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            If hidCaseid.Value = "ddlPCase" Then
                'ds = objGetData.GetCases(Session("S2UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                If Session("Schem1LicAdmin") = "N" Then
                    ...
                    End If
                Else
                    ds = objGetData.GetCasesByLicense(Session("Schem1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If
                Else

...
Partial Class Pages_Schem1_PopUp_GetSchem1CasePopup
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            ...
            ds = objGetData.GetSchem1Cases(-1, Session("Schem1CaseId").ToString(), txtCaseDe1.Text.Trim.ToString(), txtCaseDe2.Text.Trim.ToString(), Session("USERID").ToString())

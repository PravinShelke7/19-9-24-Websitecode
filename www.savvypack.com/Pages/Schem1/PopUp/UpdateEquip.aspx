<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateEquip.aspx.vb" Inherits="Pages_Schem1_PopUp_UpdateEquip" %>
    ...
    <script type="text/JavaScript">
        ...
        function CloseWindow() {
            ...
            if (hidEqName != "") {
                ...
                window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgBut' + i).style.display = "inline";
                window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgDis' + i).style.display = "none";
                for (j = 1; j < 31; j++) {
                    var hidAssetId = window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_hidAssetId' + j).value;

                    if (j != i) {
                        if (document.getElementById('<%= hidAssetId.ClientID%>').value == hidAssetId) {
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_hypAssetDes' + j).innerHTML = Name;
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_hypAssetDes' + j).title = Name;
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgBut' + j).style.display = "inline";
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgDis' + j).style.display = "none";
                ...
                window.opener.document.getElementById(hidEqDes1).innerHTML = Name;
                window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgBut' + i).style.display = "none";
                window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgDis' + i).style.display = "inline";
                ...
                for (j = 1; j < 31; j++) {
                    ...
                    if (j != i) {
                        if (document.getElementById('<%= hidAssetId.ClientID%>').value == hidAssetId) {
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_hypAssetDes' + j).innerHTML = Name;
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgBut' + j).style.display = "none";
                            window.opener.document.getElementById('ctl00_Schem1ContentPlaceHolder_imgDis' + j).style.display = "inline";

...
Partial Class Pages_Schem1_PopUp_UpdateEquip
    ...
    Public Sub GetPageDetails()
        ...
        Try
            ...
            dsEmat = objGetData.GetEditEquip(Session("Schem1CaseId"))
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Try
            objUpIns.EditEqName(Session("Schem1CaseId"), hidAssetId.Value, txtName.Text.Replace("'", "''"))

...
Partial Class Pages_Schem1_PopUp_CaseViewer
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            'ds = objGetData.GetCases(Session("Schem1UserName"), CaseDe1, CaseDe2)
            If Session("Schem1LicAdmin") = "N" Then
                ...
                End If
            Else
                ds = objGetData.GetCasesByLicense(Session("Schem1UserName"), CaseDe1, CaseDe2)
            End If
                With ddlCases
                    .DataSource = ds
                    .DataTextField = "CASEDE"

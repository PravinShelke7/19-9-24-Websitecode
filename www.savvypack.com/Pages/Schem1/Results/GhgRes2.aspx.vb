...
Partial Class Pages_Schem1_Results_GhgRes2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Schem1 - Greenhouse Gas Results2 Statement "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_RESULTS_GHGRES2")
    End Sub
            ...
            For i = 1 To 4
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        HeaderTdSetting(tdHeader, "140px", "Gasoline", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        Header2TdSetting(tdHeader2, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                        ...
                        Case 3
                            ...
                            If CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    ...
                                    ElseIf i = 12 Then
                                        lbl.Text = FormatNumber(totGhg * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)
                                        arrCustomerTotal(i - 1) = lbl.Text
                                    ElseIf i = 13 Then

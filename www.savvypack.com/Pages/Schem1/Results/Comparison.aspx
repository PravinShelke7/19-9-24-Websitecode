<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Comparison.aspx.vb" Inherits="Pages_Schem1_Results_Comparison" %>
                ...
                <div id="ContentPagemargin" runat="server">
                   <div id="PageSection1" style="text-align:left;" >
                          ...
                          <table width="80%">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlType" CssClass="DropDown" Width="25%" runat="server"  >
                          ...
                          <table width="80%">
                                ...
                                <tr class="AlterNateColor1">
                                   ...
                                   <tr class="AlterNateColor1">
                                    <td>
                                        <asp:Button ID="btnChartType" runat="server" Text="Display Comparison" Enabled="false"  CssClass="ButtonWMarigin"  />
                                    </td>
                                </tr>
                          </table>
                   </div>

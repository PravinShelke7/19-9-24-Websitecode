<%@ Page Language="VB" MasterPageFile="~/Masters/Schem1.master" AutoEventWireup="false" CodeFile="ErgyRes2.aspx.vb" Inherits="Pages_Schem1_Results_ErgyRes2" Title="Schem1- Customer Energy Statement"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="Schem1ContentPlaceHolder" Runat="Server">
   ...
   <script type="text/JavaScript">
        ...
        //        alert(navigator.appName);
                  var bt = parent.document.getElementById(buttonid);   
                    if (bt)
                    { 
    ...
    <div id="ContentPagemargin" runat="server">
       <div id="PageSection1" style="text-align:left" >
        ...
        <table cellspacing="2" style="width:630px">
         <tr>
                   <td>
                    ...
                    <td>
                      <asp:TextBox ID="txtNewSaleValue" runat="Server" MaxLength="12" CssClass="MediumTextBox" style="width:84px;" ></asp:TextBox>
                    </td>
                </tr>

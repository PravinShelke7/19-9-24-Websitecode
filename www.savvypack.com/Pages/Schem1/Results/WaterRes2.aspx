<%@ Page Language="VB" MasterPageFile="~/Masters/Schem1.master" AutoEventWireup="false" CodeFile="WaterRes2.aspx.vb" Inherits="Pages_Schem1_Results_WaterRes2" title="Schem1- Customer Water Statement" %>
        ...
        <table cellspacing="2" style="width:630px">
         <tr>
                   <td>
                    ...
                    <td>
                      <asp:TextBox ID="txtNewSaleValue" runat="Server" CssClass="MediumTextBox"></asp:TextBox>
                    </td>
                </tr>

...
Partial Class Pages_Schem1_Results_ErgyRes2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparison.aspx?Type=" + obj.Encrypt("CERGY") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Energy Statement')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Schem1 - Customer Energy Statement "
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_Pages_SCHEM1_Results_ErgyRes2")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            'txtNewSaleValue.Text = ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()
            ...
            For i = 1 To 4
                ...
                Select Case i
                    ...
                    Case 3
                        Title = "(MJ)"
                        HeaderTdSetting(tdHeader, "140px", "Customer Total", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        Header2TdSetting(tdHeader2, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                    ...
                    Case 4
                        Title = "(kwh)"
                        HeaderTdSetting(tdHeader, "140px", "Electricity", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        Header2TdSetting(tdHeader2, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                        ...
                        Case 3
                            ...
                            If CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0.0 Then
                                If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()) <> 0 Then
                                    ...
                                    ElseIf i = 12 Then
                                        lbl.Text = FormatNumber(totEnergy * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()), 0)
                                        arrCustomerTotal(i - 1) = lbl.Text
                                    ElseIf i = 13 Then

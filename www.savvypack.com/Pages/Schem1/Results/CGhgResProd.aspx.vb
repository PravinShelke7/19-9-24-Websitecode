...
Partial Class Pages_Schem1_Results_CGhgResProd
...
#End Region
    ...
    Protected Sub GetPageDetails()
        Try
            ...
            ds1 = objGetData.GetGhgResultsProd(CaseId1)
            ds2 = objGetData.GetGhgResultsProd(CaseId2)
            ...
            For i = 1 To 4
                ...
                Select Case i
                    Case 1
                        ...
                        HeaderTdSetting(tdHeader4, "", "Unit:", "1")
                ...
                For j = 1 To 4
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            'If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0 Then
                            '    Wt1 = (CDbl(ds1.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()))
                            'Else
                            '    Wt1 = 0
                            'End If

                            'If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0 Then
                            '    Wt2 = (CDbl(ds2.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()))
                            'Else
                            '    Wt2 = 0
                            'End If
                ...
                For j = 1 To 4
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            Dim Wt2 As New Decimal
                            If CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                Wt1 = (CDbl(ds1.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) / CDbl(ds1.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()))
                            Else
                                Wt1 = 0
                            End If

                            If CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()) > 0 Then
                                Wt2 = (CDbl(ds2.Tables(0).Rows(0).Item("T" + i.ToString() + "").ToString()) / CDbl(ds2.Tables(0).Rows(0).Item("SALESVOLUMEUNIT").ToString()))
                            Else
                                Wt2 = 0
                            End If
    ...
    Protected Sub GetCaseDetails(ByVal td1 As TableCell, ByVal td2 As TableCell, ByVal CaseId12 As Integer)
        Dim objData As New Schem1GetData.Selectdata
        Dim ds As New DataSet
        Try
            CaseId12 = CaseId12
            ds = objData.GetCaseDetails(CaseId12.ToString())

...
Partial Class Pages_Schem1_Results_ResultsEOLProd
    Inherits System.Web.UI.Page
    Public CaseDes As String = String.Empty


#Region "Get Set Variables"
    Dim _lErrorLabel As Label
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Material End-of-life Results Statement Product')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Schem1 - End-of-life Results Statement Product"
    End Sub

    Protected Sub GeContentPlaceHolder()
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_RESULTS_RESULTSEOLPROD")
    End Sub
...
#End Region
    ...
    Protected Sub GetSessionDetails()
        ...
        Catch ex As Exception
            _lErrorLabel.Text = "Error:GetSessionDetails:" + ex.Message.ToString()
        End Try
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetEOLResultsProd(CaseId)
            ...
            Next
            tblComparision.Rows.Add(trHeader)
                ...
                For j = 1 To 6
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Else
                                count = count + 1
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATB" + count.ToString() + "").ToString(), 0)
                            End If
                            tdInner.Controls.Add(lbl)
                        ...
                        Case 3
                            ...
                            Else
                                If i < 14 Then
                                    lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATRE" + count.ToString() + "").ToString(), 0)
                                Else
                                    lbl.Text = ""
                                End If
                        ...
                        Case 4
                            ...
                            If i = 1 Or i = 2 Or i = 5 Or i = 6 Or i = 8 Or i = 9 Or i = 11 Or i = 14 Or i = 22 Then
                                lbl.Text = ""
                            Else
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATIN" + count.ToString() + "").ToString(), 0)
                            End If
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 5
                            ...
                            If i < 14 Or i > 22 Then
                                If i = 1 Or i = 2 Or i = 5 Or i = 6 Or i = 8 Or i = 9 Or i = 11 Or i = 22 Then
                                    lbl.Text = ""
                                Else
                                    lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATCM" + count.ToString() + "").ToString(), 0)
                                End If
                            End If
                        ...
                        Case 6
                            ...
                            Else
                                If i < 14 Then
                                    lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MATLF" + count.ToString() + "").ToString(), 0)
                                Else
                                    lbl.Text = ""
                                End If
...
#Region "UI Settings"
    Protected Sub HeaderTdSetting(ByVal Td As TableCell, ByVal Width As String, ByVal HeaderText As String, ByVal ColSpan As String)
        ...
        Catch ex As Exception
            _lErrorLabel.Text = "Error:HeaderTdSetting:" + ex.Message.ToString()
        End Try
    End Sub
    ...
    Protected Sub InnerTdSetting(ByVal Td As TableCell, ByVal Width As String, ByVal Align As String)
        Try
            ...
            End If
        Catch ex As Exception
            _lErrorLabel.Text = "Error:InnerTdSetting:" + ex.Message.ToString()
        End Try
    End Sub
    Protected Sub TextBoxSetting(ByVal txt As TextBox, ByVal Css As String)
        ...
        Catch ex As Exception
            _lErrorLabel.Text = "Error:TextBoxSetting:" + ex.Message.ToString()
        End Try
    End Sub
    ...
    Protected Sub LableSetting(ByVal lbl As Label, ByVal Css As String)
        ...
        Catch ex As Exception
            _lErrorLabel.Text = "Error:LableSetting:" + ex.Message.ToString()
        End Try
    End Sub
    ...
    Protected Sub LeftTdSetting(ByVal Td As TableCell, ByVal Text As String, ByVal tr As TableRow, ByVal Css As String)
        Try
            ...
            tr.CssClass = Css
        Catch ex As Exception
            _lErrorLabel.Text = "Error:LeftTdSetting:" + ex.Message.ToString()
        End Try
    End Sub
#End Region
    ...
    Protected Sub Calculate()
        Try
            ...
            Dim obj As New Schem1Calculation.Schem1Calculations(Schem1Conn, Econ2Conn, Sustain1Conn, Econ1Conn)

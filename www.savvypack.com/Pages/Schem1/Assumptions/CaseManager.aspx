<%@ Page Language="VB" MasterPageFile="~/Masters/Schem1.master" AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_Schem1_Assumptions_CaseManager" Title="Schem1-Case Manager" %>
        ...
        <table width="98%" style="text-align:left;">
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft"> 
                        <%-- <a href="../Results/ErgyRes.aspx" class="Link" target="_blank">Energy</a>--%>
                          <a href="../Results/ErgyResProd.aspx" class = "Link" target="_blank">Energy Product</a>
                    </td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft">
                      ...
                      <a href ="../Results/GhgResProd.aspx" class="Link" target="_blank">GHG Product</a>
                          </td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                   ...
                   <a href="../Results/ResultsEOLProd.aspx" class="Link" target="_blank"  >End Of Life Product</a> 
                        </td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                 ...
                 <td class="StaticTdLeft"> 
                        ...
                        <a href="../Results/WaterResProd.aspx"  class="Link" target="_blank"> Water Product</a>
                          </td>
                </tr>

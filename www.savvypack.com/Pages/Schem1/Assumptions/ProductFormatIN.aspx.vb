...
Partial Class Pages_Schem1_Assumptions_ProductFormatIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Schem1 - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            dsPro = objGetData.GetProductFormt("-1", "", "")
            For i = 1 To 9
                ...
                Select Case i
                    ...
                    Case 7
                        ...
                        HeaderTdSetting(tdHeader, "100px", "Packaging and Product Weight", "1")
            ...
            For i = 1 To 9
                ...
                Select Case i
                    Case 1
                        ...
                        Link.Width = 110
                        Link.CssClass = "Link"
                        GetProductDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("M1").ToString()), dsPro)
    ...
    Protected Sub GetProductDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal FromatId As Integer, ByVal dsPro As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New Schem1GetData.Selectdata()
        ...
        Try
            ...
            dvPro = dsPro.Tables(0).DefaultView
            dvPro.RowFilter = "FORMATID= " + FromatId.ToString()
            dtpro = dvPro.ToTable()

            LinkMat.Text = dtpro.Rows(0).Item("FormatDes").ToString()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                If Session("Schem1ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$Schem1ContentPlaceHolder$hidProductid")
                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$Schem1ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

...
Partial Class PAGES_SCHEM1_ASSUMPTIONS_PLANTCONFIG
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Schem1 - Plant Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_ASSUMPTIONS_PLANTCONFIG")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDA" + i.ToString())
                    DEPTB(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDB" + i.ToString())
                    DEPTC(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDC" + i.ToString())
                    DEPTD(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDD" + i.ToString())
                    DEPTE(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDE" + i.ToString())
                    DEPTF(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDF" + i.ToString())
                    DEPTG(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDG" + i.ToString())
                    DEPTH(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDH" + i.ToString())
                    DEPTI(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDI" + i.ToString())
                    DEPTJ(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepDJ" + i.ToString())

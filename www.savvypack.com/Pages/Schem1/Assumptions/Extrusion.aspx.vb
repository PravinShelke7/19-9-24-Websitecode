...
Partial Class Pages_Schem1_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Schem1 - Material Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_ASSUMPTIONS_EXTRUSION")
    End Sub
...
#End Region
        ...
        Try
            ...
            For i = 1 To 19
                ...
                Select Case i
                    ...
                    Case 4
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 5
                        HeaderTdSetting(tdHeader, "120px", "Schem1 Cases", "1")
                        Header2TdSetting(tdHeader2, "", "(%)", "1")
                        Header2TdSetting(tdHeader1, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    ...
                    Case 8                                  'Bug #378
                        'Weight Distribution
                        Title = "(%)"
                        HeaderTdSetting(tdHeader, "", "Weight Distribution", "1")
                    ...
                    Case 9                                  'Bug #378
                        ...
                        Title = "(%)"
                        HeaderTdSetting(tdHeader, "", "Environmental Distribution", "1")
                        Header2TdSetting(tdHeader2, "", Title, "1")
                        Header2TdSetting(tdHeader1, "80px", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 10
                    ...
                    Case 13
                        ...
                        HeaderTdSetting(tdHeader, "", "CO2", "2")
                        Header2TdSetting(tdHeader2, "", Title, "2")
                        Header2TdSetting(tdHeader1, "80px", "Suggested", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                ...
                For j = 1 To 19
                    ...
                    Select Case j
                        ...
                        Case 5
                            ...
                            Link.Width = 120
                            Link.CssClass = "Link"
                            'GetSustain1Details(Link, hid, CInt(ds.Tables(0).Rows(0).Item("C" + i.ToString() + "").ToString()))
                            GetSchem1Details(Link, hid, CInt(ds.Tables(0).Rows(0).Item("C" + i.ToString() + "").ToString()), dSChem1)
                        ...
                        Case 8 'Bug #378
                            ...
                            txt.CssClass = "SmallTextBox"
                            txt.Width = 50
                            txt.ID = "WD" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("WD" + i.ToString() + "").ToString() = "" Then
                                txt.Text = 0
                            Else
                                txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("WD" + i.ToString() + "").ToString(), 1)
                            End If
                            txt.MaxLength = 6
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 9
                            ...
                            txt.Width = 50
                            txt.MaxLength = 6
                            txt.ID = "ED" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("ED" + i.ToString() + "").ToString() = "" Then
                                txt.Text = 0
                            Else
                                txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("ED" + i.ToString() + "").ToString(), 1)
                            End If
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 10
                        ...
                        Case 15
                            ...
                            lbl = New Label
                            lbl.Width = 50
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("WATERS" + i.ToString() + "").ToString(), 3)
                        ...
                        Case 16
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("WATERP" + i.ToString() + "").ToString(), 3)
                            txt.MaxLength = 9
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 17
            ...
            For i = 1 To 19
                ...
                Select Case i
                    ...
                    Case 7
                        InnerTdSetting(tdInner, "", "Center")
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTWGHTDIS").ToString(), 1) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 8
                        InnerTdSetting(tdInner, "", "Center")
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTENVDIS").ToString(), 1) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 10
                        InnerTdSetting(tdInner, "", "Center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTERGY").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 12
                        InnerTdSetting(tdInner, "", "Center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTCO2").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
                    Case 14
                        InnerTdSetting(tdInner, "", "Center")
                        tdInner.ColumnSpan = 2
                        tdInner.Text = "<span class='CalculatedFeilds'><b>" + FormatNumber(ds.Tables(0).Rows(0).Item("TOTWATER").ToString(), 3) + " </b> </span>"
                        trInner.Controls.Add(tdInner)
    ...
    Protected Sub GetSchem1Details(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal CaseIdS1 As Integer, ByVal dSChem1 As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New Schem1GetData.Selectdata()
        Dim hidval As New HiddenField
        Dim Path As String = String.Empty
        Dim dvSChem1 As New DataView
        Dim dtSChem1 As New DataTable
        Try
            'Ds = ObjGetdata.GetSchem1Cases(CaseIdS1, CaseId, "", "", Session("USERID").ToString())
            dvSChem1 = dSChem1.Tables(0).DefaultView
            dvSChem1.RowFilter = "CASEID= " + CaseIdS1.ToString()
            dtSChem1 = dvSChem1.ToTable()

            If dtSChem1.Rows.Count = 0 Then
                LinkMat.Text = "Conflict"
                LinkMat.Attributes.Add("text-decoration", "none")
            Else
                LinkMat.Text = dtSChem1.Rows(0).Item("CASDES").ToString()
                LinkMat.ToolTip = dtSChem1.Rows(0).Item("CASDES").ToString()
                LinkMat.Attributes.Add("text-decoration", "none")
            End If

            hid.Value = CaseIdS1.ToString()
            Path = "../PopUp/GetSchem1CasePopup.aspx?Des=" + ctlContentPlaceHolder.ClientID.ToString() + "_" + LinkMat.ClientID + "&Id=" + ctlContentPlaceHolder.ClientID.ToString() + "_" + hid.ClientID + ""
            LinkMat.NavigateUrl = "javascript:ShowPopWindow('" + Path + "')"

        Catch ex As Exception
            ErrorLable.Text = "Error:GetSchem1Details:" + ex.Message.ToString() + ""
        End Try
    End Sub

    'Protected Sub GetSustain1Details(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal CaseIdS1 As Integer)
    '    Dim Ds As New DataSet
    '    Dim ObjGetdata As New Schem1GetData.Selectdata()
    '    Dim hidval As New HiddenField
    '    Dim Path As String = String.Empty
    ...
    '        Ds = ObjGetdata.GetSustain1Cases(CaseIdS1, CaseId, "", "", Session("Schem1UserName").ToString())
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Dim plate As String
        Dim i As New Integer
        Dim WeightDis(9) As String
        Dim EnvDis(9) As String
        Dim ERGYP(9) As String  'Bug #378
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Qty(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$Schem1ContentPlaceHolder$IC" + i.ToString() + "") <> "" Then
                        PComp(i - 1) = 1
                    Else
                        PComp(i - 1) = 0
                    End If
                    SCase(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$R" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$E" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidDepid" + i.ToString() + "")
                    WeightDis(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$WD" + i.ToString() + "")
                    EnvDis(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$ED" + i.ToString() + "")
                    ERGYP(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$ERGYP" + i.ToString() + "") 'Bug #378
                    CO2P(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$CO2P" + i.ToString() + "")
                    WATER(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$WATERP" + i.ToString() + "")
                    'Check For IsNumric
                ...
                Next
                plate = Request.Form("ctl00$Schem1ContentPlaceHolder$radPlate")


                ObjUpIns.ExtrusionUpdate(CaseId, Material, Qty, PComp, SCase, Weight, Recycle, Extra, Dept, plate, WeightDis, EnvDis, ERGYP, CO2P, WATER, False)
                Calculate()
            End If
            GetPageDetails()
        Catch ex As Exception

...
Partial Class Pages_Schem1_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Schem1 - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    ECP(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$ECP" + i.ToString() + "").Replace(",", "")
                    NGCP(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$NGCP" + i.ToString() + "").Replace(",", "")
                    HRS(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$HRS" + i.ToString() + "").Replace(",", "")

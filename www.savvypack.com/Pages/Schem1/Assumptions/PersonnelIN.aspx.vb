...
Partial Class Pages_Schem1_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Schem1 - Personnel Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SCHEM1_ASSUMPTIONS_PERSONNELIN")
    End Sub
                ...
                For j = 1 To 4
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetPersonnelDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("ID" + i.ToString() + "").ToString()), effCountry, dsPer)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    NoWorker(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$NUMBER" + i.ToString() + "").Replace(",", "")
                    DeptId(i - 1) = Request.Form("ctl00$Schem1ContentPlaceHolder$hidPerDepid" + i.ToString() + "")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageGroups.aspx.vb" Inherits="Pages_Schem1_Tools_ManageGroups" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>SChem1-Manage Groups</title>
                                        ...
                                        <asp:GridView Width="1190px" CssClass="GrdUsers" runat="server" ID="grdCase" DataKeyNames="CASEID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="GROUP NAME" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkGroId" runat="server"  Width="140px"
                                                            Style="color: Black; font-family: Verdana; font-size: 12px;" Text='<%# bind("GROUPNAME")%>'></asp:LinkButton>
                                                    </ItemTemplate>

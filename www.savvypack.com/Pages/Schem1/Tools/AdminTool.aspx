<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdminTool.aspx.vb" Inherits="Pages_Schem1_Tools_AdminTool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Schem1-Admin Tools</title>
   ...
   <%-- <center>--%>
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Schem1 - Admin Tools')" onmouseout="UnTip()" style="width:840px;">
                     Schem1 - Admin Tools
                                    ...
                                    <td>
                                           ...
                                           <asp:Button ID="btnCopyPcase" runat="server" Text="Copy" CssClass="ButtonWMarigin" OnClientClick="return CreateMessage('ddlPCases','NCC');"
                                            ...
                                            <asp:Button ID="btnPTransfer" runat="server" Text="Transfer" CssClass="ButtonWMarigin" OnClientClick="return MakeVisible('divCopy');"
                                             ...
                                             <asp:Button ID="btnPRename" runat="server" onmouseover="Tip('Rename this Case')" onmouseout="UnTip()"  Text="Rename" CssClass="ButtonWMarigin"  style="margin-left:10px" />

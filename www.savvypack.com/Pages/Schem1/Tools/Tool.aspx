<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_Schem1_Tools_Tool" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>Schem1-Tools</title>
...
'.google-analytics.com/ga.js';
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from Echem1 to Schem1. Do you want to proceed?"
            }
...
//          alert(MaxCount);
        ...
        {
          var MaxCount="<%=Session("Schem1MaxCaseCount")%>";       
   ...
   <%-- <center>--%>
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"  Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Schem1/Default.aspx"
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Schem1-Tools')" onmouseout="UnTip()" style="width:840px;">
                     Schem1 - Tools
           ...
           <br />
                   <%--  <div id="IsAdmin" runat="server" visible="false" style="margin:0px 5px 5px 5px;">
                        <asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link" Font-Bold="true" NavigateUrl="~/Pages/Schem1/Tools/AdminTool.aspx"></asp:HyperLink>
                     </div>--%>
                       <table>
                            <tr>
                                <td>
                                    <div id="IsAdmin" runat="server" visible="false" style="margin: 0px 5px 5px 5px;">
                                        <asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link"
                                            Font-Bold="true" NavigateUrl="~/Pages/Schem1/Tools/AdminTool.aspx"></asp:HyperLink>
                                    </div>
                                </td>
                                <td>
                                    <div id="Div2" runat="server" style="margin: 0px 5px 5px 5px;">
                                        <asp:HyperLink ID="lnkGroupTool" runat="server" Text="Manage Groups" CssClass="Link"
                                            Font-Bold="true" NavigateUrl="~/Pages/Schem1/Tools/ManageGroups.aspx"></asp:HyperLink>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                    ...
                                    <td>
                                           ...
                                           <asp:Button ID="btnCopyPcase" runat="server" Text="Copy" CssClass="ButtonWMarigin" OnClientClick="return CreateMessage('ddlPCases','NCC');"
                                            ...
                                            <asp:Button ID="btnPShareCase" runat="server" Text="Share Access" CssClass="ButtonWMarigin" OnClientClick="return MakeVisible('divshareAccess');"
                                             ...
                                             onmouseover="Tip('Synchronize this Case from Echem1 to Schem1')" onmouseout="UnTip()" style="margin-left:10px" />

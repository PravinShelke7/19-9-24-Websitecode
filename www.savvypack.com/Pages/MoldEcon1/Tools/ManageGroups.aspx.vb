...
Partial Class Pages_MoldEcon1_Tools_ManageGroups
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            If Session("SavvyModType") <> "1" Then
                ds = objGetData.GetPCaseGrpDetailsBem(Session("MoldE1UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim())
            Else
                If Session("Service") = "COMP" Then
                    ds = objGetData.GetCompCaseGrpDetails(Session("MoldE1UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim(), Session("ServiceId"))
                Else
                    ds = objGetData.GetPCaseGrpDetails(Session("MoldE1UserName").ToString(), Session("USERID").ToString(), txtKey.Text.Trim())
                End If

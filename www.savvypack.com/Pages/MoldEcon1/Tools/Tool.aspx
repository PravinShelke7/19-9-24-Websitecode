<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_MoldEcon1_Tools_Tool" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
      ...
      function Count(text) {
        ...
        {
          var MaxCount="<%=Session("MoldE1MaxCaseCount")%>";       
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                        Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/MoldEcon1/Default.aspx"
                            ...
                            <tr class="AlterNateColor1" style="height: 30px">
                                <td>
                                    ...
                                    <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                        OnClientClick="return ShareMessage('ddlPCases', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Sustain1 Mold to Econ1 Mold')"
                                        onmouseout="UnTip()" Style="margin-left: 10px" />
                                ...
                                <tr class="AlterNateColor1">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCaseDe3" runat="server" onKeyUp="javascript:Count(this);" onChange="javascript:Count(this);"
                                            CssClass="MediumTextBox" Style="text-align: left;" TextMode="MultiLine" Height="100px"

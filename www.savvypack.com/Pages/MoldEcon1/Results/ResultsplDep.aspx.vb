...
Partial Class Pages_MoldEcon1_Results_ResultsplDep
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("PLDEP") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Profit and Loss Statement With Depreciation"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_RESULTS_RESULTSPLDEP")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                UnitPrice = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$UNITPP").Replace(",", "")
                UnitType = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$UNITTYPE")
                'Check For IsNumric

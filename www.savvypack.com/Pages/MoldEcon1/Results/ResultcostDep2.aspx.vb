...
Partial Class Pages_MoldEcon1_Results_ResultcostDep2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("CSTDEPC") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Customer Cost With Depreciation')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Econ1 Mold - Customer Cost With Depreciation"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_RESULTS_RESULTCOSTDEP2")
    End Sub
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetCostDetails(CaseId, True)
                ...
                For j = 1 To 6
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                                    CustValue = CDbl(ds.Tables(0).Rows(0).Item("PL25").ToString() * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString())) * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString())
                                End If
                            Else
                                If CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString()) > 0 Then
                                    CustValue = CDbl(ds.Tables(0).Rows(0).Item("PL25").ToString()) * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString()) * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SUNITVAL").ToString())
                                End If
                            End If
                        ...
                        Case 5
                            ...
                            'If CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString()) > 0 Then
                            '    perwt = CDbl(newVal) / CDbl(ds.Tables(0).Rows(0).Item("SVOLUME").ToString())
                        ...
                        Case 6
                            ...
                            '    perunit = CDbl(newVal / CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString())) * CDbl(ds.Tables(0).Rows(0).Item("SUNIT").ToString())
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Try
            ...
            If Not objRefresh.IsRefresh Then
                cusSalesVolume = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$txtNewSaleValue")

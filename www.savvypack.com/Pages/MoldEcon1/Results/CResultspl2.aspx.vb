...
Partial Class Pages_MoldEcon1_Results_CResultspl2
...
#End Region
    ...
    Protected Sub GetByTotal(ByVal ds1 As DataSet, ByVal ds2 As DataSet)
        ...
        Try
            customerSaleValue1 = FormatNumber(((CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME").ToString()))), 0).ToString()
            ...
            Else
                If CDbl(ds2.Tables(0).Rows(0).Item("FINVOLMSI").ToString()) > 0 Then
                    customerSaleValue2 = FormatNumber(CDbl(ds1.Tables(0).Rows(0).Item("CUSSALESVOLUME1").ToString()) * CDbl(ds2.Tables(0).Rows(0).Item("CONVAREA").ToString()), 0)

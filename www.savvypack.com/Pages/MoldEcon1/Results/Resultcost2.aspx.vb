...
Partial Class Pages_MoldEcon1_Results_Resultcost2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("CSTC") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Customer Cost')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Econ1 Mold - Customer Cost"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_RESULTS_RESULTCOST2")
    End Sub

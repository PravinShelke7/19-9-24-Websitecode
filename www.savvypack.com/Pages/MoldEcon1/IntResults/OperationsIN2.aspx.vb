...
Partial Class Pages_MoldEcon1_IntResults_OperationsIN2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Operating Results"
    End Sub
            ...
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 3
                        HeaderTdSetting(tdHeader, "100px", "Production Volume(Capacity)", "1")
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE8").ToString() + ")"
                        Header2TdSetting(tdHeader1, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                    Case 4
                        HeaderTdSetting(tdHeader, "100px", "Finished Equivalent Production Volume", "1")
                        Title = "(" + ds.Tables(0).Rows(0).Item("TITLE8").ToString() + ")"
                        Header2TdSetting(tdHeader1, "", Title, "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                ...
                For j = 1 To 8
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            lbl = New Label()
                            lbl.Text = ds.Tables(0).Rows(0).Item("DEPTS" + i.ToString() + "").ToString()
                            lbl.Width = 150
                        ...
                        Case 4
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label()
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("FEQV" + i.ToString() + "").ToString(), 0)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 5
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label()
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("FV" + i.ToString() + "").ToString(), 0)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 6
                            InnerTdSetting(tdInner, "", "Right")
                            lbl = New Label()
                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("AD" + i.ToString() + "").ToString(), 1)
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 7
                            InnerTdSetting(tdInner, "", "Right")
                        ...
                        Case 8
                            ...
                            If CDbl(ds.Tables(0).Rows(0).Item("PV" + i.ToString() + "").ToString()) > 0.0 Then
                                volPer = (CDbl(ds.Tables(0).Rows(0).Item("FV" + i.ToString() + "").ToString()) / CDbl(ds.Tables(0).Rows(0).Item("PV" + i.ToString() + "").ToString())) * 100

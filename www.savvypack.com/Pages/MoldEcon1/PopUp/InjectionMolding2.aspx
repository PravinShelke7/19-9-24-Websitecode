<%@ Page Title="E1 Mold- Injection Molding Assistant" Language="VB" MasterPageFile="~/Masters/MoldE1Ink.master"
    AutoEventWireup="false" CodeFile="InjectionMolding2.aspx.vb" Inherits="Pages_MoldEcon1_PopUp_InjectionMolding2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MoldE1InkContentPlaceHolder" runat="Server">
    ...
    <table cellpadding="0" border="0" cellspacing="0" style="border-collapse: collapse;
        text-align: center; padding-left: 55px;">
        <tr>
            <td colspan="2">
                <asp:Table ID="tblTab" border="0" runat="server" CellPadding="0" CellSpacing="0">
                </asp:Table>
            </td>
        </tr>
    </table>
    <div id="PageSection1" style="text-align: left;">
            ...
            <tr>
                ...
                <td valign="top" colspan="2">
                    <div id="divVariable" style="height: 480px;">
                        <asp:Table ID="tblComparision" border="0" runat="server" CellPadding="0" CellSpacing="2">
                        </asp:Table>
                    </div>
                </td>
            </tr>
        ...
        <div style="margin-left: 5px; margin-top: 5px;">
            <asp:Table ID="tblComparision1" runat="server" border="0" CellPadding="0" CellSpacing="2">
            </asp:Table>
        </div>
        <br />
    </div>

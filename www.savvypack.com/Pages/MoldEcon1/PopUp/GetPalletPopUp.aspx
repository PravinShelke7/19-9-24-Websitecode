<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetPalletPopUp.aspx.vb"
    Inherits="Pages_MoldEcon1_PopUp_GetPalletPopUp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1 Mold-Get Pallets</title>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left">
            ...
            <div style="width: 450px; height: 230px; overflow: auto;">
                <asp:GridView Width="400px" runat="server" ID="grdPallets" DataKeyNames="PalletId"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Pallet Des1" SortExpression="palletde1">
                            <ItemTemplate>
                                <a href="#" onclick="PalletDet('<%#Container.DataItem("PallteDes1")%>','<%#Container.DataItem("PalletId")%>')"
                                    class="Link">
                        ...
                        <asp:BoundField DataField="palletde2" HeaderText="Pallet Des2" SortExpression="palletde2"
                            Visible="true">

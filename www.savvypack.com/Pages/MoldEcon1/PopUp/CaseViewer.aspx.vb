...
Partial Class Pages_MoldEcon1_PopUp_CaseViewer
    ...
    Protected Sub GetBCaseDetails()
        ...
        Try
            If Session("Service") = "COMP" Then
                ds = objGetData.GetCompBCases(CaseDe1, CaseDe2)
            Else
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            If Session("MoldE1LicAdmin") = "N" Then
                ...
                Else
                    If Session("Service") = "COMP" Then
                        ds = objGetData.GetCompCases(Session("MoldE1UserName"), CaseDe1, CaseDe2, Session("ServiceId"))
                    Else
            ...
            Else
                If Session("Service") = "COMP" Then
                    ds = objGetData.GetCompCasesByLicense(Session("MoldE1UserName"), CaseDe1, CaseDe2, Session("ServiceId"))
                Else

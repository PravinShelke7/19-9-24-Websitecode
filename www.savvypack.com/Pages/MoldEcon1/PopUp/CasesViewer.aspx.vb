...
Partial Class Pages_MoldEcon1_PopUp_CasesViewer
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            ' ds = objGetData.GetCases(Session("E1UserName"), CaseDe1, CaseDe2)
            If Session("MoldE1LicAdmin") = "N" Then
                If Request.QueryString("CTYPE") <> "AP" Then
                    If Request.QueryString("GrpID") <> "0" Then
                        ds = objGetData.GetGroupPCases(Session("MoldE1UserName"), CaseDe1, CaseDe2, Request.QueryString("GrpID").ToString())
                    Else
                        ds = objGetData.GetPropCases(Session("MoldE1UserName"), CaseDe1, CaseDe2)
                    End If

                Else
                    ds = objGetData.GetApprovedCases(Session("MoldE1UserName"), CaseDe1, CaseDe2)
                End If

            Else
                ds = objGetData.GetCasesByLicense(Session("MoldE1UserName"), CaseDe1, CaseDe2)
            End If

            Dim dv As DataView = New DataView(ds.Tables(0))
            dv.RowFilter = "Caseid>0"
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            lblRevenue.Text = FormatNumber(ds.Tables(0).Rows(0).Item("REVENUE").ToString(), 0)
            lblRevenuePref.Text = ds.Tables(0).Rows(0).Item("TITLE2").ToString()

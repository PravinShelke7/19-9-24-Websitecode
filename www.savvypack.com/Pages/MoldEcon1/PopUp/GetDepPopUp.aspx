<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetDepPopUp.aspx.vb" Inherits="Pages_MoldEcon1_PopUp_GetDepPopUp" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1 Mold-Get Department</title>
    ...
    <script type="text/JavaScript">
        function MaterialDet(MatDes, MatId) {
            ...
            window.opener.document.getElementById(hidMatdes).style.color = 'black';
                ...
                <asp:GridView Width="400px" runat="server" ID="grdDepartment" DataKeyNames="PROCID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Dept. Des1" SortExpression="PROCDE1">
                            <ItemTemplate>
                                <a href="#" onclick="MaterialDet('<%#Container.DataItem("PROCDE")%>','<%#Container.DataItem("PROCID")%>')"
                                    class="Link">
                        ...
                        <asp:BoundField DataField="PROCDE2" HeaderText="Dept. Des2" SortExpression="PROCDE2"
                            Visible="true">

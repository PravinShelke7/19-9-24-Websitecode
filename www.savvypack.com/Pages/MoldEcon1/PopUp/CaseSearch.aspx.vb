...
Partial Class Pages_MoldEcon1_PopUp_CaseSearch
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            If hidCaseid.Value = "ddlPCase" Then
                If Session("MoldE1LicAdmin") = "N" Then
                    ...
                    Else
                        If Session("Service") = "COMP" Then
                            ds = objGetData.GetCompCases(Session("MoldE1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Session("ServiceId"))
                        Else
                ...
                Else
                    If Session("Service") = "COMP" Then
                        ds = objGetData.GetCompCasesByLicense(Session("MoldE1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Session("ServiceId").ToString())
                    Else
                        ds = objGetData.GetCasesByLicense(Session("MoldE1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                    End If
                End If
            Else
                If Session("Service") = "COMP" Then

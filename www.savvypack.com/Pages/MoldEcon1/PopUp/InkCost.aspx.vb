...
Partial Class Pages_MoldEcon1_PopUp_InkCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Ink Cost Assistant"
    End Sub
#End Region
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Color(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$hidColId" + i.ToString() + "")
                    Coverage(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$COV" + i.ToString() + "")
                Next

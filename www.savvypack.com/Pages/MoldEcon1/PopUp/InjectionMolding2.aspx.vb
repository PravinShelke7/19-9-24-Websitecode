...
Partial Class Pages_MoldEcon1_PopUp_InjectionMolding2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetPrefLink()
        ...
        PrefLink.NavigateUrl = "../Pages/MoldEcon1/Assumptions/Preferences.aspx"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Injection Molding Assistant"
    ...
    Protected Sub UpdatePage()
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        Material(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$hidMatId" + i.ToString() + "")
                        PartWt(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$PWT" + i.ToString() + "").Replace(",", "")
                        MaxWallThick(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$MWT" + i.ToString() + "").Replace(",", "")
                        AvgWallThick(i - 1) = 0
                        SurfaceArea(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$SA" + i.ToString() + "").Replace(",", "")
                ...
                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        Levels(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$LVLS" + i.ToString() + "").Replace(",", "")
                        CavPrLevels(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$CAVPL" + i.ToString() + "").Replace(",", "")

                        If Request.Form("ctl00$MoldE1InkContentPlaceHolder$ISM" + i.ToString() + "") = "on" Then
                            StackMold(i - 1) = "1"
                        Else
                            StackMold(i - 1) = "0"
                        End If

                        If Request.Form("ctl00$MoldE1InkContentPlaceHolder$RunnerSys" + i.ToString() + "") = "IC" + i.ToString() + "" Then
                            RunSys(i - 1) = "1"
                        ElseIf Request.Form("ctl00$MoldE1InkContentPlaceHolder$RunnerSys" + i.ToString() + "") = "IH" + i.ToString() + "" Then
                            RunSys(i - 1) = "2"
                        Else
                            RunSys(i - 1) = "0"
                        End If
                ...
                ElseIf ViewState("TabId").ToString() = "3" Then
                    For i = 1 To 10
                        ScrewDia(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$SD" + i.ToString() + "").Replace(",", "")
                        InjRate(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$INJRATEPS" + i.ToString() + "").Replace(",", "")
                        EjectTmp(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$EJECTTMP" + i.ToString() + "")
                        DryCycleTm(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$DRYCT" + i.ToString() + "").Replace(",", "")
                        InjectTmp(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$INJECTTMP" + i.ToString() + "").Replace(",", "")
                        MoldTmp(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$MOLDTMP" + i.ToString() + "").Replace(",", "")
                        'Check Numeric
                ...
                ElseIf ViewState("TabId").ToString() = "5" Then
                    For i = 1 To 10
                        NoOfPresses(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$NoPr" + i.ToString() + "").Replace(",", "")
                        FixEnrgyLoad(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$FEL" + i.ToString() + "").Replace(",", "")
                        ProcessLoad(i - 1) = Request.Form("ctl00$MoldE1InkContentPlaceHolder$PL" + i.ToString() + "")

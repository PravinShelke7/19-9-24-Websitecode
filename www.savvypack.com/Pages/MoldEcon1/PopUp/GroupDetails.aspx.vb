Imports System
Imports System.Data
Partial Class Pages_MoldEcon1_PopUp_GroupDetails
    ...
    Protected Sub GetReportDetails()
        ...
        Try
            If Session("Service") = "COMP" Then
                ds = objGetData.GetCompGroupDetails(Session("USERID").ToString(), "Y", Session("CompServiceId").ToString())
            Else
    ...
    Protected Sub lnkGrpId_Click(ByVal sender As Object, ByVal e As EventArgs)
        Dim grpId As String = ""
        Dim ObjUpData As New MoldE1UpInsData.UpdateInsert()
        Try

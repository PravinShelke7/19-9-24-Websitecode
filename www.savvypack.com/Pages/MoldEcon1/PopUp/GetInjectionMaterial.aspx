<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetInjectionMaterial.aspx.vb"
    Inherits="Pages_MoldEcon1_PopUp_GetInjectionMaterial" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1 Mold-Get Injection Material</title>
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <div style="width: 450px; height: 230px; overflow: auto;">
                <asp:GridView Width="900px" runat="server" ID="grdInject" DataKeyNames="MATID" AutoGenerateSelectButton="false"
                    AllowPaging="false" AllowSorting="true" AutoGenerateColumns="False" ShowHeader="true"
                    CellSpacing="2" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Material Des" SortExpression="MATDE2">
                            <ItemTemplate>
                                <a href="#" onclick="ColorDet('<%#Container.DataItem("MATDES")%>','<%#Container.DataItem("MATID")%>')"
                                    class="Link">
                                    <%# Container.DataItem("MATDE1")%>:<%# Container.DataItem("MATDE2")%></a>
                            </ItemTemplate>
                        ...
                        <asp:BoundField DataField="SERVERDATE" HeaderText="SERVERDATE" SortExpression="SERVERDATE"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField DataField="INJMOLD" HeaderText="INJMOLD" SortExpression="INJMOLD"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="MELTDENSITY" HeaderText="MELTDENSITY" SortExpression="MELTDENSITY"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="INJTEMPMELT" HeaderText="INJTEMPMELT" SortExpression="INJTEMPMELT"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="INJTEMPTOOL" HeaderText="INJTEMPTOOL" SortExpression="INJTEMPTOOL"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="120px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="INJTEMPEJECT" HeaderText="INJTEMPEJECT" SortExpression="INJTEMPEJECT"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="EFFDIFFUSIVITY" HeaderText="EFFDIFFUSIVITY" SortExpression="EFFDIFFUSIVITY"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="CFFACTOR" HeaderText="CFFACTOR" SortExpression="CFFACTOR"
                            Visible="true">
                            <ItemStyle HorizontalAlign="Left" Width="60px" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>

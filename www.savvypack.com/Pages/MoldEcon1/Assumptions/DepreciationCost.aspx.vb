...
Partial Class Pages_MoldEcon1_Assumptions_DepreciationCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Depreciation Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    DEPRE(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DEPRE" + i.ToString() + "")
                    DEPRESE(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DEPRES" + i.ToString() + "")

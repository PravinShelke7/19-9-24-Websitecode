<%@ Page Title="E1 Mold-Case Manager" Language="VB" MasterPageFile="~/Masters/MoldEcon1.master"
    AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_MoldEcon1_Assumptions_CaseManager" %>
        ...
        <div id="PageSection1" style="text-align: left">
            <table width="98%" style="text-align: left;">
                ...
                <tr class="AlterNateColor2">
                    ...
                    <td class="StaticTdLeft">
                        <a href="../Results/ResultsplDep.aspx" class="Link" target="_blank">Profit And Loss
                            With Depreciation</a>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                ...
                <tr class="AlterNateColor2">
                    ...
                    <td class="StaticTdLeft">
                        <a href="../Results/ResultcostDep.aspx" class="Link" target="_blank">Cost With Depreciation</a>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td class="StaticTdLeft" style="width: 56px">
                ...
                <tr class="AlterNateColor2">
                    ...
                    <td class="StaticTdLeft">
                        <a href="../Results/ResultsplDep2.aspx" class="Link" target="_blank">Customer Profit
                ...
                <tr class="AlterNateColor2">
                    ...
                    <td class="StaticTdLeft">
                        <a href="../Results/ResultcostDep2.aspx" class="Link" target="_blank">Customer Cost
                            With Depreciation </a>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                ...
                <tr class="AlterNateColor1">
                    ...
                    <td class="StaticTdLeft" style="width: 223px">
                        <a href="../Assumptions/DepreciationCost.aspx" class="Link" target="_blank">Depreciation
                            Assumptions</a>
                    </td>
                    <td class="StaticTdLeft" style="width: 169px">
                    </td>

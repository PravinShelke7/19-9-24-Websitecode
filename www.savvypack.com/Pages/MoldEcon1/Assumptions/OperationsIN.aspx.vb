...
Partial Class Pages_MoldEcon1_Assumptions_OperationsIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Operating Assumptions"
    End Sub
                ...
                For j = 1 To 13
                    ...
                    Select Case j
                        ...
                        Case 8
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("OPINSTR" + i.ToString() + "").ToString(), 6)
                            txt.MaxLength = 12
                            tdInner.Controls.Add(txt)
                            trInner.Controls.Add(tdInner)
                        Case 9
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    If EqUnit(i - 1) = "fpm" Then
                        OPWebWidth(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$OPWebWidth" + i.ToString() + "")
                    ElseIf EqUnit(i - 1) = "cpm" Then
                        OPExits(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$OPExits" + i.ToString() + "")
                    End If
                    OMAXRH(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$OMAXRH" + i.ToString() + "")
                    OPINSTR(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$OPINSTR" + i.ToString() + "")
                    DT(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DT" + i.ToString() + "")
                    OPWASTE(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$OPWASTE" + i.ToString() + "")
                    DWASTE(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DWASTE" + i.ToString() + "")
                    'Check For IsNumric
                    Try

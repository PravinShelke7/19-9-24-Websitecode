...
Partial Class Pages_MoldEcon1_Assumptions_EnergyIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetChartbtn()
        ...
        Chartbtn.OnClientClick = "return Chart('../../../Charts/MoldE1Charts/EnergyPrice.aspx','EnergyPriceChart');"
        'AddHandler Updatebtn.Click, AddressOf Update_Click
    End Sub
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Plant Energy Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_ENERGYIN")
    End Sub
            ...
            For i = 1 To 3
                ...
                Select Case i
                    ...
                    Case 2
                        ...
                        trHeader1.Controls.Add(tdHeader1)
                    Case 3
                        Header2TdSetting(tdHeader2, "70px", "Preferred", "1")
                ...
                For j = 1 To 3
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("ERGPPREF" + i.ToString() + "").ToString(), 3)
                            txt.MaxLength = 6
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 1
                    ERGPPREF(i) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$ERGPPREF" + (i + 1).ToString() + "")
                    'Check For IsNumric

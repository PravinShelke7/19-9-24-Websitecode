...
Partial Class Pages_MoldEcon1_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Support Equipment Assumptions"
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    HRS(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$HRS" + i.ToString() + "")

...
Partial Class Pages_MoldEcon1_Assumptions_PlantConfig
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Plant Configuration"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptA" + i.ToString() + "")
                    DEPTB(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptB" + i.ToString() + "")
                    DEPTC(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptC" + i.ToString() + "")
                    DEPTD(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptD" + i.ToString() + "")
                    DEPTE(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptE" + i.ToString() + "")
                    DEPTF(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptF" + i.ToString() + "")
                    DEPTG(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptG" + i.ToString() + "")
                    DEPTH(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptH" + i.ToString() + "")
                    DEPTI(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptI" + i.ToString() + "")
                    DEPTJ(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidIdDeptJ" + i.ToString() + "")

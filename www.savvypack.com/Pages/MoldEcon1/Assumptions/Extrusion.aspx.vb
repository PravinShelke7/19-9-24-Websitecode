...
Partial Class Pages_MoldEcon1_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetChartbtn()
        ...
        Chartbtn.OnClientClick = "return Chart('../../../Charts/MoldE1Charts/MaterialPrice.aspx','MatPriceChart');"
        'AddHandler Updatebtn.Click, AddressOf Update_Click
    End Sub
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Material Assumption"
    End Sub
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ...
            For l = 1 To 10
                ...
                If dsPref.Tables(0).Rows(0).Item("PRP" + l.ToString() + "").ToString() <> "0" And dsPref.Tables(0).Rows(0).Item("PRP" + l.ToString() + "").ToString() <> "" Then
            ...
            For m = 1 To 10
                If CDbl(dsPref.Tables(0).Rows(0).Item("M" + m.ToString() + "").ToString()) <> 0 Then
                    If dsPref.Tables(0).Rows(0).Item("PRP" + m.ToString() + "").ToString() <> "0" And dsPref.Tables(0).Rows(0).Item("PRP" + m.ToString() + "").ToString() <> "" Then
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Thickness(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$T" + i.ToString() + "")
                    Price(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$P" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$R" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$E" + i.ToString() + "")
                    Sg(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$SG" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidDepid" + i.ToString() + "")

                    OTR(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$OTR" + i.ToString() + "")
                    WVTR(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$WVTR" + i.ToString() + "")
                    GRADE(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidGradeId" + i.ToString() + "")
                ...
                For i = 1 To 3
                    ...
                    MaterialDis(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidDisMatid" + i.ToString() + "")
                    WeightDis(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DISW" + i.ToString() + "")
                    WeightPrice(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DISP" + i.ToString() + "")
                    ...
                    If Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DISW" + i.ToString() + "") <> 0 Then
                ...
                plate = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$radPlate")
                raddiscmatyn = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$raddiscmatyn")
                If DisCount = 0 Then

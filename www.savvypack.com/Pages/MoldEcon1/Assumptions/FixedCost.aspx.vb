...
Partial Class Pages_MoldEcon1_Assumptions_FixedCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Fixed Cost Guidelines"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    FixedCostVal(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$FIXCOST" + i.ToString() + "")
                    FixedCostPref(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$FCPREF" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidFCDepid" + i.ToString() + "")
                ...
                Next
                depreciate = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$DEPYEARS")

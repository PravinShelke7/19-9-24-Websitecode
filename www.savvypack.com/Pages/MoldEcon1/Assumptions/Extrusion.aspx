<%@ Page Title="E1 Mold-Material And Structure" Language="VB" MasterPageFile="~/Masters/MoldEcon1.master"
    AutoEventWireup="false" CodeFile="Extrusion.aspx.vb" Inherits="Pages_MoldEcon1_Assumptions_Extrusion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MoldEcon1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript" src="../../../JavaScripts/MoldE1Barr.js"></script>
    <script type="text/JavaScript">
        ...
        function CallBackBarrier() {
            ...
            var msgBarr = ""
            var msgBarr1 = ""
            if (document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_hidBarrier").value == "0") {
                document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_hidBarrier").value = "1";
                document.getElementById('ctl00_imgBarProp').title = "Hide Barrier Properties";
                showDisplay();
                msgBarr = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_hidMessageBarr").value;
                ...
                document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_hidBarrier").value = "0";
        ...
        function showhide() {
            ...
            var obj4;
            //Grade
            obj1 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_GradeHeader");
            obj2 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_GradeHeader2");
            obj3 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_GradeHeader1");
            ...
            var i;
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_GradeVal" + i);
                objDep.style.display = "none";
            }

            //OTR
            obj1 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_OTRHeader");
            obj2 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_OTRHeader2");
            obj3 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_OTRSHeader1");
            obj4 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_OTRPHeader1");
            ...
            var i;
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_OTRSVal" + i);
                objDep.style.display = "none";
            }
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_OTRPVal" + i);
                objDep.style.display = "none";
            }

            //WVTR
            obj1 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_WVTRHeader");
            obj2 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_WVTRHeader2");
            obj3 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_WVTRSHeader1");
            obj4 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_WVTRPHeader1");
            ...
            var i;
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_WVTRSVal" + i);
                objDep.style.display = "none";
            }
            for (i = 1; i <= 10; i++) {
                var objDep = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_WVTRPVal" + i);
                objDep.style.display = "none";
            }

            //OTR/WVTR TEMP and HUMIDITY  
            obj1 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_tblBarrier");
            obj1.style.display = "none";

            //Total
            obj1 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_Total5");
            obj2 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_Total7");
            obj3 = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_Total3");

<%@ Page Title="E1 Mold-Preferences" Language="VB" MasterPageFile="~/Masters/MoldEcon1.master"
    AutoEventWireup="false" CodeFile="Preferences.aspx.vb" Inherits="Pages_MoldEcon1_Assumptions_Preferences" %>
    ...
    <div id="ContentPagemargin" runat="server">
        <div style="margin: 0px 200px 5px 5px; text-align: right">
            <asp:HyperLink ID="lnkAPref" runat="server" Text="Additional Preferences" CssClass="Link"
                Target="_blank" Font-Bold="true" NavigateUrl="~/Pages/MoldEcon1/Assumptions/APreferences.aspx"></asp:HyperLink>
        </div>
        <div id="PageSection1" style="text-align: left">
            ...
            <table width="60%">
                ...
                <tr class="AlterNateColor1">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlMfg" CssClass="DropDown" Width="125px" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlDesti" CssClass="DropDown" Width="125px" runat="server">
                        </asp:DropDownList>
                    </td>
                </tr>
            </table>

...
Partial Class Pages_MoldEcon1_Assumptions_TruckPalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Pallet and Truck Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_TRUCKPALLETIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                M1 = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidProductid")
                For i = 1 To 5
                    Pallet(i) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Truck(i) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$T" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

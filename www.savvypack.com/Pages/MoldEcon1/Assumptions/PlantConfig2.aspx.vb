...
Partial Class Pages_MoldEcon1_Assumptions_PlantConfig2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Plant Space Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 2 To 4
                    AREA(i - 2) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$AR" + i.ToString() + "")
                    'Check For IsNumric
                ...
                For i = 0 To 5
                    PrefLease(i) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$PREF" + (i + 1).ToString() + "")
                    'Check For IsNumric

...
Partial Class Pages_MoldEcon1_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Customer Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$PRODPUR")
                SHIPDIST = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$SHIPDIST")
                MILCOST = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$MILCOST")
                'Check For IsNumric

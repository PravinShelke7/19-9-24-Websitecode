...
Partial Class Pages_MoldEcon1_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetChartbtn()
        ...
        Chartbtn.OnClientClick = "return Chart('../../../Charts/MoldE1Charts/SalaryPrice.aspx','SalaryPriceChart');"
        'AddHandler Updatebtn.Click, AddressOf Update_Click
    End Sub
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 Mold - Personnel Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    PosId(i) = PosDes(i - 1)
                    NoWorker(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$NOWORKER" + i.ToString() + "")
                    PrefSal(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$SALPREF" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidCosId" + i.ToString() + "")
                    DeptId(i - 1) = Request.Form("ctl00$MoldEcon1ContentPlaceHolder$hidPerDepid" + i.ToString() + "")

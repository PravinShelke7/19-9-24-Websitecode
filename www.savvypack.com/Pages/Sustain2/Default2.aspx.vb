...
Imports System.Net
Partial Class Pages_Sustain2_Default2
...
#End Region
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("S2UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("S2ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("S2UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("S2ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("S2MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
            'Set for License Administrator
            Session("S2LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("S2LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
    ...
    Protected Sub SetToolButton()
        Try
            If Session("S2ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            ...
            Else
                ...
                Session("S2CaseId") = hidApprovedCase.Value
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        ...
        Try
            ...
            Else
                Session("S2CaseId") = hidPropCase.Value ' ddlPCase.SelectedValue.ToString()
                lnkPropCase.Text = hidPropCaseD.Value
                Session("CaseType") = "Prop"

                CaseId = Session("S2CaseId")
                User = Session("USERID")
                dsSt = objgetdata.GetStatusForSister("S2", CaseId, User)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "Sustain2ConnectionString")
            hidPropCase.Value = "0"
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            Dim objUpdateData As New S2UpInsData.UpdateInsert()
    ...
    Protected Sub SendEmailStatus(ByVal CaseId As String)
        Try
            ...
            Dim objS2GetData As New S2GetData.Selectdata()
            Dim ds As New DataSet()
            ...
            dsUserData = objS2GetData.GetPermissionStatus(CaseId, Session("USERID").ToString())
            If ds.Tables(0).Rows.Count > 0 Then

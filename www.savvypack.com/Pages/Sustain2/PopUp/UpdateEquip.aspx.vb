...
Partial Class Pages_Sustain2_PopUp_UpdateEquip
    ...
    Public Sub GetPageDetails()
        ...
        Try
            ...
            dsEmat = objGetData.GetEditEquip(Session("S2CaseId"))
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        ...
        Try
            objUpIns.EditEqName(Session("S2CaseId"), hidAssetId.Value, txtName.Text.Replace("'", "''"))

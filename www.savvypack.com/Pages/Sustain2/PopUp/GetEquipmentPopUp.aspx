<%@ Page Language="VB" MasterPageFile="~/Masters/S2PopUp.master" AutoEventWireup="false" CodeFile="GetEquipmentPopUp.aspx.vb" Inherits="Pages_Sustain2_PopUp_GetAssetPopUp" title="S2-Get Equipment" %>
...
//             window.close();
       ...
       function EquipmentDet(EquipDes, EquipId, EQUIPDES3) {
           ...
           if (document.getElementById('<%= hidMod.ClientID%>').value == 'S2') {
               if (EquipId == "0") {

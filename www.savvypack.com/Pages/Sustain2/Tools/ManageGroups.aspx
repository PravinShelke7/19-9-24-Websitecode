<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageGroups.aspx.vb" Inherits="Pages_Sustain2_Tools_ManageGroups" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>S2-Manage Groups</title>
                                                ...
                                                <asp:TemplateField HeaderText="GROUP NAME" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkGroId" runat="server" Width="140px" Style="color: Black; font-family: Verdana;
                                                            font-size: 12px;" Text='<%# bind("GROUPNAME")%>'></asp:LinkButton>
                                                    </ItemTemplate>

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tools2.aspx.vb" Inherits="Pages_Sustain2_Tools_Tools2" %>
...
if(CaseId=="0")
         ...
         else
         {
            ...
            if (Flag == 'SYN') {
                ...
                var msg = "You are going to synchronize case " + CaseId + " from Econ2 to Sustain2. Do you want to proceed?"
            }
             if (Flag == 'RENAME') 
             {
              return true;
    ...
    <form id="form1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                            Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Sustain2/Default2.aspx"
        ...
        <table class="ContentPage" id="ContentPage" runat="server" style="width: 845px">
            <tr style="height: 20px">
                <td>
                    <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Sustain2-Tools')"
                                ...
                                <tr class="AlterNateColor1" style="height: 30px">
                                    <td>
                                        ...
                                        <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                            OnClientClick="return SyncMessage('Prop', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Econ2 to Sustain2')"
                                            onmouseout="UnTip()" Style="margin-left: 10px" />

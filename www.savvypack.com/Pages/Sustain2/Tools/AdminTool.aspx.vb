...
Imports ToolCCS
Partial Class Pages_Sustain2_Tools_AdminTool
...
#Region "Synchronize"
    Protected Sub btnSynchronize_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSynchronize.Click
        ...
        Try
            ...
            obj.BaseCaseSynch(SCaseId, TCaseId, "ECON2", "SUSTAIN2", "Sustain2ConnectionString", "SystemConnectionString")
            Flag = True
        Catch ex As Exception
            Flag = False
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            ...
            obj.CaseRenameBase(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "Sustain2ConnectionString")
            GetBCaseDetails()
...
#Region "Delete Case"
    Protected Sub btnDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            obj.CaseBaseDelete(Session("USERID").ToString(), CaseId.ToString(), "Econ2ConnectionString")
            obj.CaseBaseDelete(Session("USERID").ToString(), CaseId.ToString(), "Sustain2ConnectionString")
            GetBCaseDetails()
...
#Region "Tools Function"
    Protected Function CreateCase() As Integer
        ...
        Dim obj As New ToolCCS
        Try
            CaseId = obj.CreateBaseCase("Econ2ConnectionString", "E2", 0)
            obj.CreateBaseCase("Sustain2ConnectionString", "E2", CaseId)
            Return CaseId
        Catch ex As Exception

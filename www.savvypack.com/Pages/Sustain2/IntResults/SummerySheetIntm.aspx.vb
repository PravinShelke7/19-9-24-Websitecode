...
Partial Class Pages_Sustain2_IntResults_SummerySheetIntm
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Scorecard Intermediate"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                M10 = Request.Form("ctl00$Sustain2ContentPlaceHolder$M10").Replace(",", "")
                M11 = Request.Form("ctl00$Sustain2ContentPlaceHolder$M11").Replace(",", "")
                'Check For IsNumric

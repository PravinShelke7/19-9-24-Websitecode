...
Partial Class Pages_Sustain2_Assumptions_ProductFormatIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Product Format Assumptions"
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("S2ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$Sustain2ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

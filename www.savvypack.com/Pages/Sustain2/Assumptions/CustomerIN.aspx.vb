...
Partial Class Pages_Sustain2_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Transportation Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                SD = Request.Form("ctl00$Sustain2ContentPlaceHolder$SD").Replace(",", "")
                TruckEffPre = Request.Form("ctl00$Sustain2ContentPlaceHolder$TFUELEFFP").Replace(",", "")
                RailEffPre = Request.Form("ctl00$Sustain2ContentPlaceHolder$RFUELEFFP").Replace(",", "")
                'Check For IsNumric

...
Partial Class PAGES_SUSTAIN2_ASSUMPTIONS_PLANTCONFIG
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Plant Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN2_ASSUMPTIONS_PLANTCONFIG")
    End Sub
                ...
                For j = 1 To 11
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            GetDeptDetails(Link, hid, CInt(x).ToString(), dsDept)
                        ...
                        Case 3, 4, 5, 6, 7, 8, 9, 10, 11
                            ...
                            Dim x As String
                            x = (ds.Tables(0).Rows(0).Item(("D" + Chr(64 + j - 1)) + i.ToString()).ToString())
                            GetDeptDetails(Link, hid, CInt(x), dsDept)
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDA" + i.ToString())
                    DEPTB(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDB" + i.ToString())
                    DEPTC(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDC" + i.ToString())
                    DEPTD(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDD" + i.ToString())
                    DEPTE(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDE" + i.ToString())
                    DEPTF(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDF" + i.ToString())
                    DEPTG(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDG" + i.ToString())
                    DEPTH(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDH" + i.ToString())
                    DEPTI(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDI" + i.ToString())
                    DEPTJ(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidDepDJ" + i.ToString())

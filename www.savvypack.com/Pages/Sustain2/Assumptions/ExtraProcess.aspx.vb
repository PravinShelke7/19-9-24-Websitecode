...
Partial Class Pages_Sustain2_Assumptions_ExtraProcess
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Extra-process Waste"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 3
                    extraProcess(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$EP" + i.ToString() + "").Replace(",", "")
                    Preffered(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$PREF" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$Sustain2ContentPlaceHolder$hidPalletDepid" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

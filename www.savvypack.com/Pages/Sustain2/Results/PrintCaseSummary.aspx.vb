...
Partial Class Pages_Sustain2_Results_PrintCaseSummary
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Print Case Summary"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_SUSTAIN2_RESULTS_PRINTCASESUMMARY")
    End Sub
...
#End Region
                    ...
                    For j = 1 To 6
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                '    lbl = New Label
                                '    lbl.Width = 50
                                '    lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("WEIGHT" + i.ToString() + "").ToString(), 3)
                                '    tdInner.Controls.Add(lbl)
                                '    trInner.Controls.Add(tdInner)
                            Case 3
                                InnerTdSetting(tdInner, "", "Right")
                    ...
                    For j = 1 To 4
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                lbl = New Label()
                                lbl.Width = 250
                                GetEquipmentInDetails(lbl, CInt(ds.Tables(0).Rows(0).Item("M" + i.ToString() + "").ToString()), dsEquip)
            ...
            For i = 1 To 6
                ...
                Select Case i
                    ...
                    Case 5
                        ...
                        trHeader2.Controls.Add(tdHeader2)
                    Case 6
                        HeaderTdSetting(tdHeader, "70px", "Waste", "0")
                        Header2TdSetting(tdHeader2, "", "(%)", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    ...
                    For j = 1 To 6
                        ...
                        Select Case j
                            ...
                            Case 3
                                InnerTdSetting(tdInner, "", "Right")
                                lbl = New Label
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("MAXHOUR" + i.ToString() + "").ToString(), 0)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            ...
                            Case 4
                                ...
                                lbl.Text = FormatNumber(cal, 2)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Case 5
                                InnerTdSetting(tdInner, "", "Right")
                                lbl = New Label
                                lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("DT" + i.ToString() + "").ToString(), 2)
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
                            Case 6
                                InnerTdSetting(tdInner, "", "Right")
                    ...
                    For j = 1 To 4
                        ...
                        Select Case j
                            ...
                            Case 2
                                InnerTdSetting(tdInner, "", "Left")
                                lbl = New Label()
                                GetPersonnelDetails(lbl, CInt(ds.Tables(0).Rows(0).Item("ID" + i.ToString() + "").ToString()), "")
                                tdInner.Controls.Add(lbl)
                                trInner.Controls.Add(tdInner)
    ...
    Protected Sub GetEquipmentold(ByRef lbl As Label, ByVal EqId As Integer)
        Dim Ds As New DataSet
        Dim ObjGetdata As New S2GetData.Selectdata()
        Dim hidval As New HiddenField
        Dim Path As String = String.Empty

...
Partial Class Pages_Sustain2_Results_ScoreCardRes
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Sustain2 - Scorecard Results "
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 9
                    LowRange(i) = Request.Form("ctl00$Sustain2ContentPlaceHolder$LOWP_" + i.ToString() + "").Replace(",", "")
                    HighRange(i) = Request.Form("ctl00$Sustain2ContentPlaceHolder$HIGHP_" + i.ToString() + "").Replace(",", "")
                    Weightings(i) = Request.Form("ctl00$Sustain2ContentPlaceHolder$WTP_" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric
                    ...
                    If i > 7 Then
                        RawStore(i) = Request.Form("ctl00$Sustain2ContentPlaceHolder$RW" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

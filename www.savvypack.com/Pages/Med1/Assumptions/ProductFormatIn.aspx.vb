...
Partial Class Pages_MedEcon1_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Product Format Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_PRODUCTFORMATIN")
    End Sub
...
#End Region
    ...
    '                For i = 2 To 6
    '                    Input(i) = Request.Form("ctl00$Med1ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
    '                    'Check For IsNumric
    ...
    Protected Sub Update()
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PwtPref = Request.Form("ctl00$Med1ContentPlaceHolder$PWT").ToString()

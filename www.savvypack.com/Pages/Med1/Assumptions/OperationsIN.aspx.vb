...
Partial Class Pages_MedEcon1_Assumptions_OperationsIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Operating Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_OPERATIONSIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    'OPWebWidth(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$OPWebWidth" + i.ToString() + "")
                    If EqUnit(i - 1) = "fpm" Then
                        OPWebWidth(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$OPWebWidth" + i.ToString() + "")
                    ElseIf EqUnit(i - 1) = "cpm" Then
                        OPExits(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$OPExits" + i.ToString() + "")
                    End If
                    OMAXRH(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$OMAXRH" + i.ToString() + "")
                    OPINSTR(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$OPINSTR" + i.ToString() + "")
                    DT(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$DT" + i.ToString() + "")
                    OPWASTE(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$OPWASTE" + i.ToString() + "")
                    DWASTE(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$DWASTE" + i.ToString() + "")
                    'Check For IsNumric
                    Try
                        ...
                        ElseIf EqUnit(i - 1) = "cpm" Then
                            ...
                            End If
                        End If
                        'Request.Form("ctl00$Med1ContentPlaceHolder$OPWebWidth" + i.ToString() + "").ToString()
                        'If Not IsNumeric(OPWebWidth(i - 1)) Then
                        '    Response.Redirect("../Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDE111").Replace("+", "!Plus!").Replace("#", "!Hash!").Replace("&", "!And!") + "")
                        'End If
                    Catch ex As Exception

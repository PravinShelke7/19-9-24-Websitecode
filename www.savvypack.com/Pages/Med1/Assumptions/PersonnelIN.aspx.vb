...
Partial Class Pages_MedEcon1_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetChartbtn()
        ...
        Chartbtn.OnClientClick = "return Chart('../../../Charts/Med1Charts/SalaryPrice.aspx','SalaryPriceChart');"
        'AddHandler Updatebtn.Click, AddressOf Update_Click
    End Sub
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Personnel Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_PERSONNELIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    PosId(i) = PosDes(i - 1)
                    NoWorker(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$NOWORKER" + i.ToString() + "")
                    PrefSal(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$SALPREF" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidCosId" + i.ToString() + "")
                    DeptId(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidPerDepid" + i.ToString() + "")

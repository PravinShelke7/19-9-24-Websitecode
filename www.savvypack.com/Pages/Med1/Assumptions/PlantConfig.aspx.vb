...
Partial Class Pages_MedEcon1_Assumptions_PlantConfig
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Plant Configuration"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_PLANTCONFIG")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    DEPTA(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptA" + i.ToString() + "")
                    DEPTB(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptB" + i.ToString() + "")
                    DEPTC(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptC" + i.ToString() + "")
                    DEPTD(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptD" + i.ToString() + "")
                    DEPTE(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptE" + i.ToString() + "")
                    DEPTF(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptF" + i.ToString() + "")
                    DEPTG(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptG" + i.ToString() + "")
                    DEPTH(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptH" + i.ToString() + "")
                    DEPTI(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptI" + i.ToString() + "")
                    DEPTJ(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidIdDeptJ" + i.ToString() + "")

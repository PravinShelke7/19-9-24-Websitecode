...
Partial Class Pages_MedEcon1_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
                ...
                For j = 1 To 12
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetSupportEquipmentInDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("ASSETID" + i.ToString() + "").ToString()))
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    hidAssetId(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    ASSETP(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$ASSETP" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$ECP" + i.ToString() + "")
                    NGCP(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$NGCP" + i.ToString() + "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    HRS(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$HRS" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidCosId" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    'Check For IsNumric

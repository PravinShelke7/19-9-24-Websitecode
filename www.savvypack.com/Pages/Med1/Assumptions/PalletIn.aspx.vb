...
Partial Class Pages_MedEcon1_Assumptions_PalletIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Pallet Packaging Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_PALLETIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Pallet(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                    Number(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$NUM" + i.ToString() + "")
                    NoOfUses(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$NOFUSE" + i.ToString() + "")
                    PrefWeight(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$W" + i.ToString() + "")
                    PrefPrice(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$P" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$Med1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")

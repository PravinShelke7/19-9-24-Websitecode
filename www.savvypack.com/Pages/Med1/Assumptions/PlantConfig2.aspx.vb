...
Partial Class Pages_MedEcon1_Assumptions_PlantConfig2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Plant Space Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_ASSUMPTIONS_PLANTCONFIG2")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 2 To 4
                    AREA(i - 2) = Request.Form("ctl00$Med1ContentPlaceHolder$AR" + i.ToString() + "")
                    'Check For IsNumric
                ...
                For i = 0 To 5
                    PrefLease(i) = Request.Form("ctl00$Med1ContentPlaceHolder$PREF" + (i + 1).ToString() + "")
                    'Check For IsNumric

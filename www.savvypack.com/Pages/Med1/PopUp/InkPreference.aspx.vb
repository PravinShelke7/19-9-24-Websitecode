...
Partial Class Pages_MedEcon1_PopUp_InkPreference
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Med1 - Ink Cost Preferences"
    End Sub
#End Region
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_POPUP_INKPREFERENCE")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 11
                    WetCost(i - 1) = Request.Form("ctl00$Med1InkContentPlaceHolder$WETPP" + i.ToString() + "")
                    PerSol(i - 1) = Request.Form("ctl00$Med1InkContentPlaceHolder$PERSOLP" + i.ToString() + "")
                    SGravity(i - 1) = Request.Form("ctl00$Med1InkContentPlaceHolder$SGRAVITYP" + i.ToString() + "")
                Next

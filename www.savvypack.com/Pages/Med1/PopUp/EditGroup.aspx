<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditGroup.aspx.vb" Inherits="Pages_MedEcon1_PopUp_EditGroup" %>
                ...
                <asp:GridView Width="640px" runat="server" ID="grdGrpCases" DataKeyNames="GROUPID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                            ...
                            <ItemTemplate>
                                <asp:TextBox ID="txtGroupName"  CssClass="SmallTextBox" MaxLength="25"  style="text-align:left;" Font-Size="8"   Width="200px" Enabled="true" runat="server" Text='<%# bind("GROUPNAME")%>'
                                AutoPostBack="false" />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="210px" Wrap="true" HorizontalAlign="Left" />
                        </asp:TemplateField>
                          <asp:TemplateField HeaderText="Group Description" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPDES"
                            Visible="true" ItemStyle-HorizontalAlign="Left">
                            <ItemTemplate>
                                <asp:TextBox ID="txtGroupDes"  CssClass="SmallTextBox" onKeyUp="javascript:Count(this);" onChange="javascript:Count(this);" style="text-align:left;width: 400px;height:30px;" TextMode="MultiLine"  Font-Size="8"   Width="120px" Enabled="true" runat="server" Text='<%# bind("GROUPDES")%>'
                                AutoPostBack="false" />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                 ...
                 <table>
                    <tr>
                       <td style="width:100px">
                          <asp:Button ID="btnUpdate" Height="25px" Width="90px" runat="server" Text="Update" CssClass="ButtonWMarigin"/>
                       </td>
                       <td style="width:100px">
                            <asp:Button ID="btnDelete" Height="25px" Width="90px" runat="server" Text="Delete" CssClass="ButtonWMarigin" OnClientClick="return Delete();"/>
                       </td>
                       <td style="width:100px">
                         <asp:Button ID="btnClose" Height="25px" Width="90px" runat="server" Text="Close" CssClass="ButtonWMarigin"/>
                       </td>
                    </tr>
                 </table>

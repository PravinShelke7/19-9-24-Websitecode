...
Partial Class Pages_MedEcon1_PopUp_CaseViewer
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            If Session("Med1LicAdmin") = "N" Then
                ...
                Else
                    If Session("Service") = "COMP" Then
                        ds = objGetData.GetCompCases(Session("Med1UserName"), CaseDe1, CaseDe2, Session("ServiceId"))
                    Else
            ...
            Else
                If Session("Service") = "COMP" Then
                    ds = objGetData.GetCompCasesByLicense(Session("Med1UserName"), CaseDe1, CaseDe2, Session("ServiceId"))
                Else

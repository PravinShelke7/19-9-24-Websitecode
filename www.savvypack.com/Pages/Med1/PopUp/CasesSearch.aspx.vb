...
Partial Class Pages_MedEcon1_PopUp_CasesSearch
        ...
        Try
            If hidCaseid.Value = "hidPropCase" Or hidCaseid.Value = "hidTargetApp" Or hidCaseid.Value = "hidTargetProp" Then
                If Session("Med1LicAdmin") = "N" Then
                    ...
                    Else
                        ds = objGetData.GetPropCases(Session("Med1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                    End If

                Else
                    ds = objGetData.GetPropCasesByLicense(Session("Med1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If
            Else
                If Session("Med1LicAdmin") = "N" Then
                    ds = objGetData.GetApprovedCases(Session("Med1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                Else
                    ds = objGetData.GetAppCasesByLicense(Session("Med1UserName"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"))
                End If

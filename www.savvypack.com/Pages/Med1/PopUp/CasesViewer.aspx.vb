...
Partial Class Pages_MedEcon1_PopUp_CasesViewer
        ...
        Try
            ...
            If Session("Med1LicAdmin") = "N" Then
                If Request.QueryString("CTYPE") <> "AP" Then
                    ...
                    Else
                        ds = objGetData.GetPropCases(Session("Med1UserName"), CaseDe1, CaseDe2)
                    End If

                Else
                    ds = objGetData.GetApprovedCases(Session("Med1UserName"), CaseDe1, CaseDe2)
                End If

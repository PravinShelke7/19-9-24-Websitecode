...
Partial Class Pages_MedEcon1_Results_Comparision
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Type = "PL" Then
                lblTitle.Text = "Med1 - Profit and Loss Comparison Selector"
                Page.Title = "Med1-Profit and Loss Comparison Selector"
            ElseIf Type = "PLC" Then
                lblTitle.Text = "Med1 - Customer Profit and Loss Comparison Selector"
                Page.Title = "Med1-Customer Profit and Loss Comparison Selector"
            ElseIf Type = "PLDEP" Then
                lblTitle.Text = "Med1 - Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "Med1-Profit and Loss With Depreciation Comparison Selector"
            ElseIf Type = "PLDEPC" Then
                lblTitle.Text = "Med1 - Customer Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "Med1-Customer Profit and Loss With Depreciation Comparison Selector"
            ElseIf Type = "CST" Then
                lblTitle.Text = "Med1 - Cost Comparison Selector"
                Page.Title = "Med1-Cost Comparison Selector"
            ElseIf Type = "CSTC" Then
                lblTitle.Text = "Med1 - Customer Cost Comparison Selector"
                Page.Title = "Med1-Customer Cost Comparison Selector"
            ElseIf Type = "CSTDEP" Then
                lblTitle.Text = "Med1 - Cost Comparison With Depreciation Selector"
                Page.Title = "Med1-Cost Comparison With Depreciation Selector"
            ElseIf Type = "CSTDEPC" Then
                lblTitle.Text = "Med1 - Customer Cost Comparison With Depreciation Selector"
                Page.Title = "Med1-Customer Cost Comparison With Depreciation Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            ...
            lblSessionCaseId.Text = Session("Med1CaseId")
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            Else
                If Session("Service") = "COMP" Then
                    ds = objGetData.GetCompPCaseDetailsByLicense(Session("Med1UserName").ToString(), Session("ServiceId").ToString())
                Else
    ...
    Protected Sub btnType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnType.Click
        ...
        Try
            ...
            ds = objGetData.GetProductFormtByID(Session("Med1CaseId"), ddlPCases.SelectedValue)
            ...
            Else
                ...
                For i = 0 To ds.Tables(0).Rows.Count - 1
                    If ds.Tables(0).Rows(i).Item("CaseId") = Session("Med1CaseId") Then
            ...
            Else
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('These cases are not comparable because Case " + Session("Med1CaseId").ToString() + " is in " + Units1 + " and Case " + ddlPCases.SelectedValue + " is in " + Units2 + ".');", True)
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        Try
            ...
            URL = "../../../Charts/Med1Charts/CPrftCost.aspx?CaseId=" + CaseId + "&PrftCost=" + objCryptoHelper.Encrypt(PrftCost) + "&ChartType=" + ChType + "&IsDep=" + objCryptoHelper.Encrypt(IsDep) + ""

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default.aspx.vb" Inherits="Pages_MedEcon1_Default" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Med1-Global Manager</title>
    ...
    <script type="text/JavaScript">
        ...
        function Help() {
            ...
            params += ', status=yes';
            params += ', toolbar=yes';
            URL = "../Med1/help/SavvyPackInstructions1.htm"
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif" runat="server"  ToolTip="Log Off"  Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=MEDE1"/>  
                            ...
                            <br />
                             <table width="90%">
                               <tr class="AlterNateColor4">
                                  ...
                                  <tr class="AlterNateColor1">
                                     <td>
                                        <asp:DropDownList ID="ddlCaseGroup" CssClass="DropDown" Width="98%" runat="server" AutoPostBack="true"></asp:DropDownList>

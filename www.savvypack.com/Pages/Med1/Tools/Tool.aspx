<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tool.aspx.vb" Inherits="Pages_MedEcon1_Tools_Tool"  %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Med1-Tools</title>
    ...
    <script type="text/javascript">
      ...
      function Count(text) {
        ...
        function CreateMessage(Case, Flag) 
        {
          ...
          var MaxCount="<%=Session("Med1MaxCaseCount")%>";       
...
//          alert(MaxCount);
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from SMed1 to Med1. Do you want to proceed?"
            }
   ...
   <%-- <center>--%>
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"  Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Med1/Default.aspx" 
    ...
    <table class="ContentPage" id="ContentPage" runat="server" style="width:845px">         
            <tr style="height:20px">
                <td>
                  <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Med1-Tools')" onmouseout="UnTip()" style="width:840px;">
                     Med1 - Tools
             ...
             <br />
                 <table>
                       ...
                       <%-- <asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link" Font-Bold="true" 
                        NavigateUrl="~/Pages/Econ1/Tools/AdminTool.aspx"></asp:HyperLink>--%>
             ...
             <br />
                ...
                <table width="820px">
                                    ...
                                    <td>
                                           ...
                                           <asp:Button ID="btnCopyPcase" runat="server" Text="Copy" CssClass="ButtonWMarigin" OnClientClick="return CreateMessage('ddlPCases','NCC');"
                                            ...
                                            <asp:Button ID="btnPShareCase" runat="server" Text="Share Access" CssClass="ButtonWMarigin" OnClientClick="return MakeVisible('divshareAccess');"
                                             ...
                                             onmouseover="Tip('Synchronize this Case from SMed1 to Med1')" onmouseout="UnTip()" style="margin-left:10px" />
                            ...
                            <div style="display:none;margin-top:40px;" runat="server"  id="divsharecopy">
                                <table width="700px">
                                    <tr class="AlterNateColor4">
                                        <td class="PageSHeading" style="font-size:14px;">
                                            Share with this User 
                                    ...
                                    <tr class="AlterNateColor4">
                                     ...
                                     <tr class="AlterNateColor1">
                                      ...
                                      <tr class="AlterNateColor1">
                                        ...
                                        <td>
                                            <asp:TextBox id="txtCaseDe3" runat="server"  onKeyUp="javascript:Count(this);"  onChange="javascript:Count(this);" CssClass="MediumTextBox" Style="text-align:left;"

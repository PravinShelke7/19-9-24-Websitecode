...
Partial Class Pages_MedEcon1_Default
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_MEDECON1_DEFAULT")
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Session("Back") = Nothing Then
                ...
                Response.Redirect("Errors/Error.aspx?ErrorCode=" + obj.Encrypt("ALDMed112") + "")
            End If

            If Not IsPostBack Then
                If Session("Service") = "COMP" Then
                    Med1table.Attributes.Add("class", "Med1CompModule")
                    Page.Title = "Med1-Competitive Module"
                    divMainHeading.InnerHtml = "Med1-Competitive Module- Global Manager"
                End If
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("Med1UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("Med1ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("Med1UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("Med1ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("Med1MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()

            'Set for License Administrator
            Session("Med1LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("Med1LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
    ...
    Protected Sub SetToolButton()
        Try
            If Session("Med1ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("Med1CaseId") = ddlBaseCases.SelectedValue.ToString()
            If Session("Service") = "COMP" Then
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("Med1CaseId") = ddlPCase.SelectedValue.ToString()
            If Session("Service") = "COMP" Then
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            'GetPCaseDetails()
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "MedEcon1ConnectionString")
            GetPCaseDetails()

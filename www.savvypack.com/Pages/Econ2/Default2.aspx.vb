...
Imports System.Net
Partial Class Pages_Econ2_Default2
...
#End Region
    ...
    Protected Sub SetSessions()
        ...
        Try
            ...
            Session("E2UserRole") = ds.Tables(0).Rows(0).Item("USERROLE").ToString()
            Session("E2ServiceRole") = ds.Tables(0).Rows(0).Item("SERVIECROLE").ToString()
            Session("E2UserName") = ds.Tables(0).Rows(0).Item("USERNAME").ToString()
            Session("E2ToolUserName") = ds.Tables(0).Rows(0).Item("TOOLUSERNAME").ToString()
            Session("E2MaxCaseCount") = ds.Tables(0).Rows(0).Item("MAXCASECOUNT").ToString()
            'Set for License Administrator
            Session("E2LicAdmin") = ds.Tables(0).Rows(0).Item("ISIADMINLICUSR").ToString()
            Session("E2LicenseId") = ds.Tables(0).Rows(0).Item("LICENSEID").ToString()
    ...
    Protected Sub SetToolButton()
        Try
            If Session("E2ServiceRole") <> "ReadWrite" Then
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            ...
            Else
                ...
                Session("E2CaseId") = hidApprovedCase.Value
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        ...
        Try
            ...
            Else
                Session("E2CaseId") = hidPropCase.Value ' ddlPCase.SelectedValue.ToString()
                ...
                User = Session("USERID")
                dsSt = objgetdata.GetStatusForSister("E2", CaseId, User)
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().ToString().Replace("'", "''"), txtCaseDe2.Text.Trim().ToString().Replace("'", "''"), txtCaseDe3.Text.Trim.ToString().Replace("'", "''"), "Econ2ConnectionString")
            'GetPCaseDetails()
            lnkPropCase.Text = "Select Case"
            hidPropCase.Value = "0"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageGroups.aspx.vb" Inherits="Pages_Econ2_Tools_ManageGroups" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E2-Manage Groups</title>
    ...
    <script type="text/javascript">
        ...
        function ShareMessage(Case, User, Flag) {
            ...
            if (Flag == 'SYN') {
                ...
                var msg = "You are going to synchronize case " + Case1.value + " from Sustain1 to Econ2. Do you want to proceed?"
            }
                                        ...
                                        <asp:GridView Width="1190px" CssClass="GrdUsers" runat="server" ID="grdCase" DataKeyNames="CASEID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="GROUP NAME" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkGroId" runat="server" Text='<%# bind("GROUPNAME")%>' Width="140px"
                                                            Style="color: Black; font-family: Verdana; font-size: 12px; text-decoration: underline;"></asp:LinkButton>
                                                    </ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox TextMode="MultiLine" ID="txtGroupDe2" runat="server" CssClass="MediumTextBox"
                                                    Style="text-align: left; height: 40px; width: 400px" MaxLength="100"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">

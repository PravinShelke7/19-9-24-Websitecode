...
Imports ToolCCS
Partial Class Pages_Econ2_Tools_Tool
...
#End Region
    ...
    Protected Sub GetBCaseDetails()
        Dim objGetData As New E2GetData.Selectdata() 'change made E1GetData by E2GetData
    ...
    Protected Sub GetUserDetails()
        ...
        Dim ds As New DataSet()
        Try
            ds = objGetData.GetUserCompanyUsers(Session("E2UserName").ToString()) 'Replace E1UserName
            With ddlUsers
                .DataSource = ds
...
#Region "Rename Case"
    ...
    Protected Sub btnRename_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRename.Click
        ...
        Try
            If Not objRefresh.IsRefresh Then
                CaseId = ddlPCases.SelectedValue.ToString()
                obj.CaseRename(ddlPCases.SelectedValue.ToString(), txtCaseDe1.Text.Trim().Replace("'", "''").ToString(), txtCaseDe2.Text.Trim().Replace("'", "''").ToString(), txtCaseDe3.Text.Trim().Replace("'", "''").ToString(), "Econ2ConnectionString")
                GetPCaseDetails()

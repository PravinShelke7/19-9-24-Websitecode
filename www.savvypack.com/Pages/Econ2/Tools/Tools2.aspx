<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tools2.aspx.vb" Inherits="Pages_Econ2_Tools_Tools2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E2-Tools</title>
...
if(CaseId=="0")
         ...
         else
         {
            ...
            if (Flag == 'SYN') {
                ...
                var msg = "You are going to synchronize case " + CaseId + " from Sustain2 to Econ2. Do you want to proceed?"
            }
             if (Flag == 'RENAME') 
             {
              return true;
...
if(CaseId=="0")
        ...
        //alert(Type);
         ...
         {
        //  alert('Hi1');
          var MaxCount="<%=Session("E2MaxCaseCount")%>";       
    ...
    <form id="form1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                            Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Econ2/Default2.aspx"
        ...
        <table class="ContentPage" id="ContentPage" runat="server" style="width: 845px">
            <tr style="height: 20px">
                <td>
                    <div class="PageHeading" id="divMainHeading" runat="server" onmouseover="Tip('Econ2-Tools')"
                            ...
                            <div>
                              <table>
                               ...
                               <%-- <asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link"
                                    Font-Bold="true" NavigateUrl="~/Pages/Econ2/Tools/AdminTool.aspx"></asp:HyperLink>--%>
                                  ...
                                  <td>
                                   ...
                                   <%--  <asp:HyperLink ID="lnkGroupTool" runat="server" Text="Manage Groups" CssClass="Link"
                                    Font-Bold="true" NavigateUrl="~/Pages/Econ2/Tools/ManageGroups.aspx" ></asp:HyperLink>--%>
                                ...
                                <tr class="AlterNateColor1" style="height: 30px">
                                    <td>
                                        ...
                                        <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                            OnClientClick="return SyncMessage('Prop', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Sustain2 to Econ2')"
                                            onmouseout="UnTip()" Style="margin-left: 10px" />

...
Partial Class Pages_Econ2_Results_PrintCaseSummary
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Print Case Summary"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_RESULTS_PRINTCASESUMMARY")
    End Sub
...
#End Region
    ...
    '                            InnerTdSetting(tdInner, "", "Right")
    '                            lbl = New Label
    '                            lbl.Text = FormatNumber(ds.Tables(0).Rows(0).Item("PRICE" + i.ToString() + "").ToString(), 3)
    '                            tdInner.Controls.Add(lbl)
    '                            trInner.Controls.Add(tdInner)
    '                        Case 6
    '                            InnerTdSetting(tdInner, "", "Right")
                    ...
                    For j = 1 To 4
                        ...
                        Select Case j
                            Case 1
                                ...
                                trInner.Controls.Add(tdInner)
                            Case 2
                                InnerTdSetting(tdInner, "170px", "Left")
                                lbl = New Label()
                    ...
                    For j = 1 To 5
                        ...
                        Select Case j
                            ...
                            Case 2
                                ...
                                'Link.CssClass = "Link"
                                GetPersonnelDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("PERSPOS" + i.ToString() + "").ToString()), "")
                                tdInner.Controls.Add(hid)
                                tdInner.Controls.Add(Link)
                                trInner.Controls.Add(tdInner)

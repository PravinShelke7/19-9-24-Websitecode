...
Imports E2GetData
Imports E2UpInsData
Partial Class Pages_Econ2_Results_Resultcost2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("CustomerCST") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Customer Packaging Cost')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Econ2 - Customer Packaging Cost"
    End Sub
...
#End Region
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            If CDbl(ds.Tables(0).Rows(0).Item("CUSSALESUNIT").ToString()) = 0 Then
                                If CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString()) > 0 Then
                                    ...
                                    CustValue = CDbl(ds.Tables(0).Rows(0).Item("PL24").ToString() * CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString())) * customerSaleValue / CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString())
                                End If
                            Else
                        ...
                        Case 4
                            ...
                            If CDbl(CustValue) > 0 Then
                                'percentage = CDbl(newVal) / CDbl(ds.Tables(0).Rows(0).Item("PL24").ToString()) * 100 / CDbl(ds.Tables(0).Rows(0).Item("CURR").ToString())
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        Try
            ...
            cusSalesVolume = Request.Form("ctl00$Econ2ContentPlaceHolder$txtNewSaleValue")

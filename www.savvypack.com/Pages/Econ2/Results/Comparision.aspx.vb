...
Partial Class Pages_Econ2_Results_Comparision
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Type = "PL" Then
                lblTitle.Text = "Econ2 - Profit and Loss Comparison Selector"
                Page.Title = "E2-Profit and Loss Comparison Selector"
            ElseIf Type = "PLDEP" Then
                lblTitle.Text = "Econ2 - Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "E2-Profit and Loss With Depreciation Comparison Selector"
            ElseIf Type = "CST" Then
                lblTitle.Text = "Econ2 - Cost Comparison Selector"
                Page.Title = "E2-Cost Comparison Selector"
            ElseIf Type = "CSTDEP" Then
                lblTitle.Text = "Econ2 - Cost Comparison With Depreciation Selector"
                Page.Title = "E2-Cost Comparison With Depreciation Selector"
            ElseIf Type = "CustomerPL" Then
                lblTitle.Text = "Econ2 - Customer Profit and Loss Comparison Selector"
                Page.Title = "E2-Customer Profit and Loss Comparison Selector"
            ElseIf Type = "CustomerPLDEP" Then
                lblTitle.Text = "Econ2 - Customer Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "E2-Customer Profit and Loss With Depreciation Comparison Selector"
            ElseIf Type = "CustomerCST" Then
                lblTitle.Text = "Econ2 - Customer Cost Comparison Selector"
                Page.Title = "E2-Customer Cost Comparison Selector"
            ElseIf Type = "CustomerCSTDEP" Then
                lblTitle.Text = "Econ2 - Customer Cost Comparison With Depreciation Selector"
                Page.Title = "E2-Customer Cost Comparison With Depreciation Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            ...
            lblSessionCaseId.Text = Session("E2CaseId")
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        Try
            ...
            URL = "../../../Charts/E2Charts/CPrftCost.aspx?CaseId=" + CaseId + "&PrftCost=" + objCryptoHelper.Encrypt(PrftCost) + "&ChartType=" + ChType + "&IsDep=" + objCryptoHelper.Encrypt(IsDep) + ""

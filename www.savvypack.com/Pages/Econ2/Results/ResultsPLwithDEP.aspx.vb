...
Partial Class Pages_Econ2_Results_ResultsPLwithDEP
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Profit and Loss Statement with Depreciation"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                UnitPrice = Request.Form("ctl00$Econ2ContentPlaceHolder$UNITPP").Replace(",", "")
                UnitType = Request.Form("ctl00$Econ2ContentPlaceHolder$UNITTYPE")
                'Check For IsNumric

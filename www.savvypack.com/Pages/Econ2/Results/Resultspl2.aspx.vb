...
Imports E2GetData
Imports E2UpInsData
Partial Class Pages_Econ2_Results_Resultspl2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("CustomerPL") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Customer Profit and Loss Statement"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_RESULTS_RESULTSPL")
    End Sub
                    ...
                    Select Case j
                        ...
                        Case 4
                            ...
                            If CDbl(CustValue) > 0 Then
                                perwt = newVal / CustValue * 100
                                lbl.Text = FormatNumber(perwt, 2)
                            End If
                        ...
                        Case 5
                            ...
                            '    perwt = CDbl(newVal) / CDbl(ds.Tables(0).Rows(0).Item("SALESVOLUMELB").ToString())

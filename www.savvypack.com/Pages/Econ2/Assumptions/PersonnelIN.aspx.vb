...
Partial Class Pages_Econ2_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Personnel Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_ASSUMPTIONS_PERSONNELIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidPosId" + i.ToString() + "").Replace(",", "")
                    NoWorker(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$NOWORKER" + i.ToString() + "").Replace(",", "")
                    PrefSal(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$SALPREF" + i.ToString() + "").Replace(",", "")
                    CostType(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidCosId" + i.ToString() + "").Replace(",", "")
                    DeptId(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidPerDepid" + i.ToString() + "").Replace(",", "")

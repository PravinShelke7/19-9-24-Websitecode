...
Partial Class Pages_Econ2_Assumptions_ProductFormatIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Product Format Assumptions"
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                If Session("E2ServiceRole") <> "ReadOnly" Then
                    M1 = Request.Form("ctl00$Econ2ContentPlaceHolder$hidProductid")

                    For i = 2 To 6
                        Input(i) = Request.Form("ctl00$Econ2ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                        'Check For IsNumric

...
Partial Class Pages_Econ2_Assumptions_EnergyIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Plant Energy Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 1
                    ERGPPREF(i) = Request.Form("ctl00$Econ2ContentPlaceHolder$ERGPPREF" + (i + 1).ToString() + "").Replace(",", "")
                    'Check For IsNumric

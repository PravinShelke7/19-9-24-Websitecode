...
Partial Class Pages_Econ2_Assumptions_FixedCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Fixed Cost Guidelines"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_ASSUMPTIONS_FIXEDCOST")
    End Sub
                    ...
                    Select Case j
                        ...
                        Case 1
                            ...
                            If dtFCost.Rows.Count > 0 Then
                                ...
                                Else
                                    lbl.Text = FormatNumber(dtFCost.Rows(0).Item("value").ToString() * ds.Tables(0).Rows(0).Item("CURR").ToString(), 0)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    FixedCostVal(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$FIXCOST" + i.ToString() + "").Replace(",", "")
                    FixedCostPref(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$FCPREF" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidFCDepid" + i.ToString() + "")
                ...
                Next
                depreciate = "0"'Request.Form("ctl00$Econ2ContentPlaceHolder$DEPYEARS").Replace(",", "")

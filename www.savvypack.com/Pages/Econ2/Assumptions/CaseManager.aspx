<%@ Page Language="VB" MasterPageFile="~/Masters/Econ2.master" AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_Econ2_Assumptions_CaseManager"  Title="E2-Case Manager"  %>
       ...
       <div id="PageSection1" style="text-align:left" >
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                    <td class="StaticTdLeft"> 
                        <a href="../Results/ResultsPLwithDEP2.aspx" class="Link" target="_blank">Customer Profit And 
                         Loss With Depreciation </a></td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                     ...
                     <td class="StaticTdLeft"> 
                         ...
                         <a href="../Results/Resultcost2.aspx" class="Link" target="_blank">Customer Cost</a></td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                 ...
                 <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft" style="width: 223px">
                         <a href="DepreciationAssumption.aspx" class="Link" target="_blank">Depreciation Assumptions</a>  </td>
                    <td class="StaticTdLeft" style="width: 169px">

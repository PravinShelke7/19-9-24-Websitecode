...
Partial Class Pages_Econ2_Assumptions_DepreciationAssumption
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    DEPRE(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$DEPRE" + i.ToString() + "")
                    DEPRESE(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$DEPRES" + i.ToString() + "")

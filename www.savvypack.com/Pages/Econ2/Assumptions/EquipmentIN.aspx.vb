...
Partial Class Pages_Econ2_Assumptions_EquipmentIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_ASSUMPTIONS_EQUIPMENTIN")
    End Sub
        ...
        Try
            ...
            For i = 1 To 13
                ...
                Select Case i
                    ...
                    Case 2
                        HeaderTdSetting(tdHeader, "120px", "Asset Description", "1")
                        Header2TdSetting(tdHeader1, "0", "", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader2.Controls.Add(tdHeader2)
                    ...
                    Case 6
                        HeaderTdSetting(tdHeader, "", "Area Type", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                    ...
                    Case 12
                        Header2TdSetting(tdHeader1, "70px", "Preferred", "1")
                    Case 13
                        HeaderTdSetting(tdHeader, "", "Mfg. Dept.", "1")
                        Header2TdSetting(tdHeader2, "", "", "1")
                ...
                For j = 1 To 13
                    ...
                    Select Case j
                        ...
                        Case 6
                            InnerTdSetting(tdInner, "", "Left")
                            lbl = New Label
                            lbl.Text = ds.Tables(0).Rows(0).Item("AT" + i.ToString() + "").ToString().Trim()
                            lbl.Width = 80
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 7
    ...
    Protected Sub GetEquipmentInDetails(ByRef LinkMat As HyperLink, ByVal hid As HiddenField, ByVal EqId As Integer, ByVal dsEquip As DataSet)
        ...
        Try
            ...
            Else
                ...
                hid.Value = EqId.ToString()
            End If
            Path = "../PopUp/GetEquipmentPopUp.aspx?Des=" + ctlContentPlaceHolder.ClientID.ToString() + "_" + LinkMat.ClientID + "&Id=" + ctlContentPlaceHolder.ClientID.ToString() + "_" + hid.ClientID + "&Case=" + CaseId.ToString() + ""
            LinkMat.NavigateUrl = "#"
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    hidAssetId(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidAssetId" + i.ToString() + "")
                    AP(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$AP" + i.ToString() + "")
                    PAP(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$PAP" + i.ToString() + "")
                    ECP(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$ECP" + i.ToString() + "")
                    NGP(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$NGP" + i.ToString() + "")
                    ASSETNUM(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$ASSETNUM" + i.ToString() + "")
                    hidAssetDep(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidEqDepid" + i.ToString() + "")
                    ...
                    End If
                Next
                ObjUpIns.EquipmentUpdate(CaseId, hidAssetId, AP, PAP, ECP, NGP, hidAssetDep, ASSETNUM)
                Calculate()
                'Update Server Date

...
Partial Class Pages_Econ2_Assumptions_Extrusion
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Material Assumption"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("PAGES_ECON2_ASSUMPTIONS_EXTRUSION")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Material(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidMatid" + i.ToString() + "")
                    Weight(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$WEIGHT" + i.ToString() + "")
                    Price(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$PRICE" + i.ToString() + "")
                    Recycle(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$REC" + i.ToString() + "")
                    Extra(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$EP" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidDepid" + i.ToString() + "")
                    E1Cases(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidCaseId" + i.ToString() + "")
                    Quant(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$Q" + i.ToString() + "")
                    If Request.Form("ctl00$Econ2ContentPlaceHolder$PCOMP" + i.ToString() + "") <> "" Then
                        PC(i - 1) = 1
                    Else
                        PC(i - 1) = 0
                    End If
                ...
                Next
                plate = Request.Form("ctl00$Econ2ContentPlaceHolder$radPlate")

...
Partial Class Pages_Econ2_Assumptions_TruckPalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Pallet and Truck Configuration"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 5
                    Pallet(i) = Request.Form("ctl00$Econ2ContentPlaceHolder$M" + i.ToString() + "").Replace(",", "")
                    Truck(i) = Request.Form("ctl00$Econ2ContentPlaceHolder$T" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric

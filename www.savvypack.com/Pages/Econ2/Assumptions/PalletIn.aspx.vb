...
Partial Class Pages_Econ2_Assumptions_PalletIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Pallet Packaging Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Pallet(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidPalid" + i.ToString() + "")
                    Number(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$NUM" + i.ToString() + "").Replace(",", "")
                    NoOfUses(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$NOFUSE" + i.ToString() + "").Replace(",", "")
                    PrefWeight(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$W" + i.ToString() + "").Replace(",", "")
                    PrefPrice(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Dept(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")

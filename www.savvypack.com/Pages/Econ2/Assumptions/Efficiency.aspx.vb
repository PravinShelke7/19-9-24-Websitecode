...
Partial Class Pages_Econ2_Assumptions_Efficiency
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Efficiency Table Assumptions"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATA" + i.ToString() + "") <> "" Then
                        MATA(i - 1) = 1
                    Else
                        MATA(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATB" + i.ToString() + "") <> "" Then
                        MATB(i - 1) = 1
                    Else
                        MATB(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATC" + i.ToString() + "") <> "" Then
                        MATC(i - 1) = 1
                    Else
                        MATC(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATD" + i.ToString() + "") <> "" Then
                        MATD(i - 1) = 1
                    Else
                        MATD(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATE" + i.ToString() + "") <> "" Then
                        MATE(i - 1) = 1
                    Else
                        MATE(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATF" + i.ToString() + "") <> "" Then
                        MATF(i - 1) = 1
                    Else
                        MATF(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATG" + i.ToString() + "") <> "" Then
                        MATG(i - 1) = 1
                    Else
                        MATG(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATH" + i.ToString() + "") <> "" Then
                        MATH(i - 1) = 1
                    Else
                        MATH(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATI" + i.ToString() + "") <> "" Then
                        MATI(i - 1) = 1
                    Else
                        MATI(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ2ContentPlaceHolder$MATJ" + i.ToString() + "") <> "" Then
                        MATJ(i - 1) = 1
                    Else
                        MATJ(i - 1) = 0
                    End If

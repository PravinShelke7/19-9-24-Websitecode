...
Partial Class Pages_Econ2_Assumptions_Equipment2IN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ2 - Support Equipment Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON2_ASSUMPTIONS_EQUIPMENT2IN")
    End Sub
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    ...
                    HRS(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$HRS" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$Econ2ContentPlaceHolder$hidCosId" + i.ToString() + "")

...
Partial Class Pages_Econ1_Assumptions_FixedCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("onclick", "return CheckForFixedCost('" + ctlContentPlaceHolder.ClientID + "','FIXCOST','FCPREF');")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Fixed Cost Guidelines"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_FIXEDCOST")
    End Sub
            ...
            For i = 0 To 6
                ...
                Select Case i
                    ...
                    Case 1
                        ...
                        HeaderTdSetting(tdHeader, "", "Fixed Cost Guidelines Value", "2")
                        ...
                        trHeader2.Controls.Add(tdHeader2)
                    Case 2
                        Header2TdSetting(tdHeader2, "", "Preferred", "1")
                        trHeader2.Controls.Add(tdHeader2)
                    Case 3
                ...
                For j = 0 To 6
                    ...
                    Select Case j
                        ...
                        Case 1
                            ...
                            dvFCost.RowFilter = "CATEGORYDES='" + ds.Tables(0).Rows(0).Item("CATEGORY" + i.ToString() + "").ToString() + "' AND EFFDATE='" + ds.Tables(0).Rows(0).Item("EFFDATE").ToString() + "' AND COUNTRYID=" + ds.Tables(0).Rows(0).Item("OCOUNTRY").ToString() + ""
                            ...
                            If dtFCost.Rows.Count > 0 Then
                                ...
                                Else
                                    lbl.Text = FormatNumber(dtFCost.Rows(0).Item("value").ToString() * ds.Tables(0).Rows(0).Item("CURR").ToString(), 2)
                        ...
                        Case 2
                            ...
                            If ds.Tables(0).Rows(0).Item("FIXCOST" + i.ToString()).ToString() <> "" Then
                                txt.Text = FormatNumber(ds.Tables(0).Rows(0).Item("FIXCOST" + i.ToString() + "").ToString(), 2)
                            End If
                            txt.MaxLength = 8
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    FixedCostVal(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$FIXCOST" + i.ToString() + "")
                    FixedCostPref(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$FCPREF" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$hidFCDepid" + i.ToString() + "")

                    'Check For IsNumric
                    If Not IsNumeric(FixedCostVal(i - 1)) And FixedCostVal(i - 1) <> "" Then
                ...
                Next
                depreciate = Request.Form("ctl00$Econ1ContentPlaceHolder$DEPYEARS")
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.FixedCostUpdate(BCaseId, FixedCostVal, FixedCostPref, Dept, depreciate)
                        'Update Server Date

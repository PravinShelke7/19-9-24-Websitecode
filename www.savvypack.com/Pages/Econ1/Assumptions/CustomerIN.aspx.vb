...
Partial Class Pages_Econ1_Assumptions_CustomerIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Customer Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_CUSTOMERIN")
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                PRODPUR = Request.Form("ctl00$Econ1ContentPlaceHolder$PRODPUR")
                SHIPDIST = Request.Form("ctl00$Econ1ContentPlaceHolder$SHIPDIST")
                MILCOST = Request.Form("ctl00$Econ1ContentPlaceHolder$MILCOST")
                'Check For IsNumric
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.CustomerInUpdate(BCaseId, PRODPUR, SHIPDIST, MILCOST)
                        'Update Server Date

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="Equipment2IN.aspx.vb" Inherits="Pages_Econ1_Assumptions_Equipment2IN" Title="E1-Support Equipment Assumptions " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Support+Equipment&SCaseID=" + SCaseID;

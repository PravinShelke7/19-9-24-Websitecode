...
Partial Class Pages_Econ1_Assumptions_PalletIn
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Pallet Packaging Assumptions"
    End Sub
                ...
                For j = 1 To 9
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetPalletDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("ITEM" + i.ToString() + "").ToString()), dsPallet)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Pallet(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$hidPalid" + i.ToString() + "")
                    Number(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$NUM" + i.ToString() + "")
                    NoOfUses(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$NOFUSE" + i.ToString() + "")
                    PrefWeight(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$W" + i.ToString() + "")
                    PrefPrice(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$P" + i.ToString() + "")
                    Dept(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$hidPalletDepid" + i.ToString() + "")
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.PalletUpdate(BCaseId, Pallet, Number, NoOfUses, PrefWeight, PrefPrice, Dept)
                        'Update Server Date

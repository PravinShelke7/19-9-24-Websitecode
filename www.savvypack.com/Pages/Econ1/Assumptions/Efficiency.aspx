<%@ Page Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="Efficiency.aspx.vb" Inherits="Pages_Econ1_Assumptions_Efficiency" Title="E1-Efficiency Table Assumptions " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Material+Efficiency&SCaseID=" + SCaseID;

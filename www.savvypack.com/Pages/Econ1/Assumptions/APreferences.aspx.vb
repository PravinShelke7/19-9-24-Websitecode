...
Partial Class Pages_Econ1_Assumptions_APreferences
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Additional Preferences"
    End Sub
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.AdPrefrencesUpdate(BCaseId, ErgyCalc, DWCalc)
                        'Update Server Date

...
Partial Class Pages_Econ1_Assumptions_PersonnelIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetUpdatebtn()
        ...
        Updatebtn.Attributes.Add("onclick", "return CheckForPersonnelPage('" + ctlContentPlaceHolder.ClientID + "','hidPosId','SALS','SALPREF','txtPrefRatio','hidCosId','hypCosDes','N','hidPerDepid','hypPerDep');")
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Personnel Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_PERSONNELIN")
    End Sub
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            GetSessionDetails()
            txtPrefRatio.Attributes.Add("OnBlur", "return CheckForPersonnelPage('" + ctlContentPlaceHolder.ClientID + "','hidPosId','SALS','SALPREF','txtPrefRatio','hidCosId','hypCosDes','Y','hidPerDepid','hypPerDep');")
                ...
                For j = 1 To 7
                    ...
                    Select Case j
                        ...
                        Case 2
                            ...
                            Link.Width = 150
                            Link.CssClass = "Link"
                            GetPersonnelDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("PERSPOS" + i.ToString() + "").ToString()), "", dsPer)
                        ...
                        Case 6
                            ...
                            Link.Width = 100
                            Link.CssClass = "Link"
                            GetCostTypeDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("COSTTYPID" + i.ToString() + "").ToString()), dsCost)
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
                        Case 7
                            ...
                            Link.Width = 120
                            Link.CssClass = "Link"
                            GetDeptDetails(Link, hid, CInt(ds.Tables(0).Rows(0).Item("DEPID" + i.ToString() + "").ToString()), dsDept)
                            tdInner.Controls.Add(hid)
                            tdInner.Controls.Add(Link)
                            trInner.Controls.Add(tdInner)
    ...
    Protected Sub GetPersonnelDetails(ByRef LinkPer As HyperLink, ByVal hid As HiddenField, ByVal PersId As Integer, ByVal COUNTRY As String, ByVal dsPer As DataSet)
        Dim Ds As New DataSet
        Dim ObjGetdata As New E1GetData.Selectdata()
        ...
        Try
            ...
            dvPer.RowFilter = "PERSID = " + PersId.ToString()
            dtPer = dvPer.ToTable()

            LinkPer.Text = dtPer.Rows(0).Item("persDES").ToString()
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 30
                    PosDes(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$hidPosId" + i.ToString() + "")
                    PosId(i) = PosDes(i - 1)
                    NoWorker(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$NOWORKER" + i.ToString() + "")
                    PrefSal(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$SALPREF" + i.ToString() + "")
                    CostType(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$hidCosId" + i.ToString() + "")
                    DeptId(i - 1) = Request.Form("ctl00$Econ1ContentPlaceHolder$hidPerDepid" + i.ToString() + "")
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.PersonnelInUpdate(BCaseId, PosDes, NoWorker, PrefSal, CostType, DeptId)
                        'Update Server Date

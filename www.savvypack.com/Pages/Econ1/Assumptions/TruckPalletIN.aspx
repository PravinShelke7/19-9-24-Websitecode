<%@ Page Title="E1-Pallet and Truck Configuration" Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="TruckPalletIN.aspx.vb" Inherits="Pages_Econ1_Assumptions_TruckPalletIN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Pallet+%26+Truck+Configuration&SCaseID=" + SCaseID;

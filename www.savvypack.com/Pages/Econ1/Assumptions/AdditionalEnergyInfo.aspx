<%@ Page Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="AdditionalEnergyInfo.aspx.vb" Inherits="Pages_Econ1_Assumptions_AdditionalEnergyInfo" Title="Additional Energy Info" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Energy+Additional+Assumptions&SCaseID=" + SCaseID;

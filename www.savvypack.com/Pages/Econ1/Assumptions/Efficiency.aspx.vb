...
Partial Class Pages_Econ1_Assumptions_Efficiency
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Efficiency Table Assumptions"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_EFFICIENCY")
    End Sub
...
#End Region
        ...
        Try
            ...
            For i = 1 To 17
                ...
                Select Case i
                    ...
                    Case 13
                        Title = ds.Tables(0).Rows(0).Item("PROC11").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 14
                        Title = ds.Tables(0).Rows(0).Item("PROC12").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 15
                        Title = ds.Tables(0).Rows(0).Item("PROC13").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 16
                        Title = ds.Tables(0).Rows(0).Item("PROC14").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                    Case 17
                        Title = ds.Tables(0).Rows(0).Item("PROC15").ToString()
                        Header2TdSetting(tdHeader, "67px", Title, "1")
                        'Header2TdSetting(tdHeader2, "", Title, "2")
                        trHeader.Controls.Add(tdHeader)
                ...
                For j = 1 To 17
                    ...
                    Select Case j
                        ...
                        Case 3
                            ...
                            If ds.Tables(0).Rows(0).Item("MATA" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 4
                            ...
                            If ds.Tables(0).Rows(0).Item("MATB" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 5
                            ...
                            If ds.Tables(0).Rows(0).Item("MATC" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 6
                            ...
                            If ds.Tables(0).Rows(0).Item("MATD" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 7
                            ...
                            If ds.Tables(0).Rows(0).Item("MATE" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 8
                            ...
                            If ds.Tables(0).Rows(0).Item("MATF" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 9
                            ...
                            If ds.Tables(0).Rows(0).Item("MATG" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 10
                            ...
                            If ds.Tables(0).Rows(0).Item("MATH" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 11
                            ...
                            If ds.Tables(0).Rows(0).Item("MATI" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 12
                            ...
                            If ds.Tables(0).Rows(0).Item("MATJ" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 13
                            InnerTdSetting(tdInner, "", "Center")
                            chk = New CheckBox
                            chk.ID = "MATK" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("MATK" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 14
                            InnerTdSetting(tdInner, "", "Center")
                            chk = New CheckBox
                            chk.ID = "MATL" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("MATL" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 15
                            InnerTdSetting(tdInner, "", "Center")
                            chk = New CheckBox
                            chk.ID = "MATM" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("MATM" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 16
                            InnerTdSetting(tdInner, "", "Center")
                            chk = New CheckBox
                            chk.ID = "MATN" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("MATN" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
                        ...
                        Case 17
                            InnerTdSetting(tdInner, "", "Center")
                            chk = New CheckBox
                            chk.ID = "MATO" + i.ToString()
                            If ds.Tables(0).Rows(0).Item("MATO" + i.ToString()) > 0 Then
                                chk.Checked = True
                            Else
                                chk.Checked = False
                            End If
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Dim MATK(9) As String
        Dim MATL(9) As String
        Dim MATM(9) As String
        Dim MATN(9) As String
        Dim MATO(9) As String
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATA" + i.ToString() + "") <> "" Then
                        MATA(i - 1) = 1
                    Else
                        MATA(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATB" + i.ToString() + "") <> "" Then
                        MATB(i - 1) = 1
                    Else
                        MATB(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATC" + i.ToString() + "") <> "" Then
                        MATC(i - 1) = 1
                    Else
                        MATC(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATD" + i.ToString() + "") <> "" Then
                        MATD(i - 1) = 1
                    Else
                        MATD(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATE" + i.ToString() + "") <> "" Then
                        MATE(i - 1) = 1
                    Else
                        MATE(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATF" + i.ToString() + "") <> "" Then
                        MATF(i - 1) = 1
                    Else
                        MATF(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATG" + i.ToString() + "") <> "" Then
                        MATG(i - 1) = 1
                    Else
                        MATG(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATH" + i.ToString() + "") <> "" Then
                        MATH(i - 1) = 1
                    Else
                        MATH(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATI" + i.ToString() + "") <> "" Then
                        MATI(i - 1) = 1
                    Else
                        MATI(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATJ" + i.ToString() + "") <> "" Then
                        MATJ(i - 1) = 1
                    Else
                        MATJ(i - 1) = 0
                    End If

                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATK" + i.ToString() + "") <> "" Then
                        MATK(i - 1) = 1
                    Else
                        MATK(i - 1) = 0
                    End If
                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATL" + i.ToString() + "") <> "" Then
                        MATL(i - 1) = 1
                    Else
                        MATL(i - 1) = 0
                    End If
                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATM" + i.ToString() + "") <> "" Then
                        MATM(i - 1) = 1
                    Else
                        MATM(i - 1) = 0
                    End If
                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATN" + i.ToString() + "") <> "" Then
                        MATN(i - 1) = 1
                    Else
                        MATN(i - 1) = 0
                    End If
                    If Request.Form("ctl00$Econ1ContentPlaceHolder$MATO" + i.ToString() + "") <> "" Then
                        MATO(i - 1) = 1
                    Else
                        MATO(i - 1) = 0
                    End If
                ...
                ObjUpIns.EfficiencyUpdate(CaseId, MATA, MATB, MATC, MATD, MATE, MATF, MATG, MATH, MATI, MATJ, MATK, MATL, MATM, MATN, MATO)
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        'ObjUpIns.EfficiencyUpdate(BCaseId, MATA, MATB, MATC, MATD, MATE, MATF, MATG, MATH, MATI, MATJ)
                        ObjUpIns.EfficiencyUpdate(BCaseId, MATA, MATB, MATC, MATD, MATE, MATF, MATG, MATH, MATI, MATJ, MATK, MATL, MATM, MATN, MATO)

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DepreciationCost.aspx.vb" Inherits="Pages_Econ1_Assumptions_DepreciationCost" MasterPageFile="~/Masters/Econ1.master" Title="E1-Depreciation Assumption" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Depreciation+Assumptions&SCaseID=" + SCaseID;
    ...
    <div id="ContentPagemargin" runat="server">
        <div id="PageSection1" style="text-align: left">
            ...
            <br />
            <asp:Table ID="tblSupportEqui" runat="server" CellPadding="0" CellSpacing="2"></asp:Table>
            <br />
            <div>
                <asp:Table ID="tblGTotal" runat="server" CellPadding="0" CellSpacing="2"></asp:Table>
            </div>
            <br />
        </div>

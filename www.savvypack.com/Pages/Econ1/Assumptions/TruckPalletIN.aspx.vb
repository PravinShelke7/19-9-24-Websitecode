...
Partial Class Pages_Econ1_Assumptions_TruckPalletIN
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Pallet and Truck Configuration"
    End Sub
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                ...
                For i = 1 To 5
                    Pallet(i) = Request.Form("ctl00$Econ1ContentPlaceHolder$P" + i.ToString() + "").Replace(",", "")
                    Truck(i) = Request.Form("ctl00$Econ1ContentPlaceHolder$T" + i.ToString() + "").Replace(",", "")
                    'Check For IsNumric
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.PalletAndTruckUpdate(BCaseId, Pallet, Truck)
                        'Update Server Date

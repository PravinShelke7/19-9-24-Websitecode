...
Partial Class Pages_Econ1_Assumptions_AdditionalEnergyInfo
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Additional Energy Info"
    End Sub
...
#Region "Browser Refresh Check"
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        objRefresh = New zCon.Net.Refresh("_PAGES_ECON1_ASSUMPTIONS_ADDITIONALENERGYINFO")
    End Sub
        ...
        Try
            ...
            For i = 1 To 5
                ...
                Select Case i
                    ...
                    Case 2
                        Title = "(kw/" + ds.Tables(0).Rows(0).Item("TITLE7").ToString() + "/year)"
                    ...
                    Case 4
                        Title = "(ft3/" + ds.Tables(0).Rows(0).Item("TITLE7").ToString() + "/year)"
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            If Not objRefresh.IsRefresh Then
                For i = 0 To 2
                    EnergyConsum1(i) = Request.Form("ctl00$Econ1ContentPlaceHolder$ENERGYCONSUMAP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric
                ...
                For i = 0 To 3
                    EnergyConsum2(i) = Request.Form("ctl00$Econ1ContentPlaceHolder$ENERGYCONSUMBP" + (i + 1).ToString()).Replace(",", "")
                    'Check For IsNumric
                ...
                ObjUpIns.AdditionalEnergyUpdate(CaseId, EnergyConsum1, EnergyConsum2)
                Calculate()
                'Update Server Date
        ...
        Try
            ...
            If str <> "" Then
                ...
                For count = 0 To strArr.Length - 1
                    ...
                    Try
                        ObjUpIns.AdditionalEnergyUpdate(BCaseId, EnergyConsum1, EnergyConsum2)
                        'Update Server Date

<%@ Page Title="E1-Product Format Assumptions" Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="ProductFormatIn.aspx.vb" Inherits="Pages_Econ1_Assumptions_ProductFormatIn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Product+Format&SCaseID=" + SCaseID;
    ...
    <div id="ContentPagemargin" runat="server">
        <div id="PageSection1" style="text-align: left">
          ...
          <div id="Tbl2" runat="server">
             <asp:Table ID="tblComparision2" runat="server" ></asp:Table>
            </div>

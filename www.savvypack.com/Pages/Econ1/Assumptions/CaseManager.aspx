<%@ Page Title="E1-Case Manager" Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="CaseManager.aspx.vb" Inherits="Pages_Econ1_Assumptions_CaseManager" %>
       ...
       <div id="PageSection1" style="text-align:left" >
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        <a href="../IntResults/ExtrusrionOut.aspx" class="Link" target="_blank">Material and Structure</a>
                    </td>
                    <td class="StaticTdLeft"> 
                         <a href="../Results/Resultspl.aspx" class="Link" target="_blank">Profit And 
                         Loss</a></td>
                </tr>
                 ...
                 <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                    <td class="StaticTdLeft"> 
                         <a href="../Results/ResultsplDep.aspx" class="Link" target="_blank">Profit And 
                         Loss With Depreciation</a></td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft"> 
                          <a href="../Results/ResultcostDep.aspx" class="Link" target="_blank">Cost With Depreciation</a></td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                    <td class="StaticTdLeft"> 
                    <a href="../Results/Result.aspx" class="Link" target="_blank">Direct Materials with Depreciation</a></td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft" style="width: 169px">
                        &nbsp;</td>
                    <td class="StaticTdLeft"> 
                      <a href="../Results/ResultsplDep2.aspx" class="Link" target="_blank">Customer Profit And 
                         Loss With Depreciation</a>   
                    </td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                    ...
                    <td class="StaticTdLeft"> 
                          <a href="../Results/Resultcost2.aspx" class="Link" target="_blank">Customer Cost
                        </a>                       
                    </td>
                </tr>
                ...
                <tr class="AlterNateColor2"> 
                    ...
                    <td class="StaticTdLeft"> 
                         <a href="../Results/ResultcostDep2.aspx" class="Link" target="_blank">Customer Cost With Depreciation
                        </a>       
                    </td>
                </tr>
                ...
                <tr class="AlterNateColor1"> 
                    <td class="StaticTdLeft" style="width: 56px">
                        Step15 </td>
                    <td class="StaticTdLeft" style="width: 223px">
                        <a href="../Assumptions/DepreciationCost.aspx" class="Link" target="_blank">Depreciation Assumptions</a>
                    </td>
                    <td class="StaticTdLeft" style="width: 169px">

<%@ Page Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="PlantConfig.aspx.vb" Inherits="Pages_Econ1_Assumptions_PlantConfig" Title="E1-Plant Configuration" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Plant+Configuration&SCaseID=" + SCaseID;
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 830px">
                <tr>
                    <td valign="top" style="width: 10%">
                        <asp:Table ID="tblComparisionFix" runat="server" CellPadding="0" CellSpacing="2"></asp:Table>
                    </td>
                    <td valign="top" style="width: 90%;">
                        <div style="width: 670px; overflow: auto; height: 455px;">

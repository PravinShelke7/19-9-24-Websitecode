<%@ Page Title="E1-Pallet Packaging Assumptions" Language="VB" MasterPageFile="~/Masters/Econ1.master" AutoEventWireup="false" CodeFile="PalletIn.aspx.vb" Inherits="Pages_Econ1_Assumptions_PalletIn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Econ1ContentPlaceHolder" runat="Server">
    ...
    <script type="text/JavaScript">
        ...
        function ShowBulkMMPopWindow(Page) {
            ...
            params += ', status=yes';
            params += ', toolbar=no';
            Page = Page + "?PageNm=Pallet+Packaging&SCaseID=" + SCaseID;

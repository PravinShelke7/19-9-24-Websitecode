...
Imports System
Imports System.Data
Partial Class Pages_Econ1_PopUp_AllApprovedGroupsDetails
    ...
    Protected Sub BindGrdGroup()
        ...
        Try
            If Session("Service") = "COMP" Then
                ds = objGetData.GetAllAppCompGroupDetails(Session("USERID").ToString(), Session("CompServiceId").ToString())
            Else
                ds = objGetData.GetAllAppGroupDetails(Session("USERID").ToString())
            End If

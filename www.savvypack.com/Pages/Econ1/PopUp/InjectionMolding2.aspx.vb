...
Partial Class Pages_Econ1_PopUp_InjectionMolding2
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetPrefLink()
        ...
        PrefLink.NavigateUrl = "../Pages/Econ1/Assumptions/Preferences.aspx"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Injection Molding Assistant"
            ...
            If Not objRefresh.IsRefresh Then
                If ViewState("TabId").ToString() = "1" Then
                    For i = 1 To 10
                        ...
                        PartWt(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$PWT" + i.ToString() + "").Replace(",", "")
                        MaxWallThick(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$MWT" + i.ToString() + "").Replace(",", "")
                        AvgWallThick(i - 1) = 0
                        SurfaceArea(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$SA" + i.ToString() + "").Replace(",", "")
                ...
                ElseIf ViewState("TabId").ToString() = "2" Then
                    For i = 1 To 10
                        Levels(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$LVLS" + i.ToString() + "").Replace(",", "")
                        CavPrLevels(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$CAVPL" + i.ToString() + "").Replace(",", "")

                        If Request.Form("ctl00$E1InkContentPlaceHolder$ISM" + i.ToString() + "") = "on" Then
                            StackMold(i - 1) = "1"
                        Else
                            StackMold(i - 1) = "0"
                        End If

                        If Request.Form("ctl00$E1InkContentPlaceHolder$RunnerSys" + i.ToString() + "") = "IC" + i.ToString() + "" Then
                            RunSys(i - 1) = "1"
                        ElseIf Request.Form("ctl00$E1InkContentPlaceHolder$RunnerSys" + i.ToString() + "") = "IH" + i.ToString() + "" Then
                            RunSys(i - 1) = "2"
                        Else
                            RunSys(i - 1) = "0"
                        End If
                ...
                ElseIf ViewState("TabId").ToString() = "3" Then
                    For i = 1 To 10
                        ScrewDia(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$SD" + i.ToString() + "").Replace(",", "")
                        InjRate(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$INJRATEPS" + i.ToString() + "").Replace(",", "")
                        EjectTmp(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$EJECTTMP" + i.ToString() + "")
                        DryCycleTm(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$DRYCT" + i.ToString() + "").Replace(",", "")
                        InjectTmp(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$INJECTTMP" + i.ToString() + "").Replace(",", "")
                        MoldTmp(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$MOLDTMP" + i.ToString() + "").Replace(",", "")
                        'Check Numeric
                ...
                ElseIf ViewState("TabId").ToString() = "5" Then
                    For i = 1 To 10
                        NoOfPresses(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$NoPr" + i.ToString() + "").Replace(",", "")
                        FixEnrgyLoad(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$FEL" + i.ToString() + "").Replace(",", "")
                        ProcessLoad(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$PL" + i.ToString() + "")

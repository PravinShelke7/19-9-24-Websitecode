Imports System
Imports System.Data
Partial Class Pages_Econ1_PopUp_ApprovedGroupDetails
    ...
    Protected Sub GetReportDetails()
        ...
        Try
            If Session("Service") = "COMP" Then
                ds = objGetData.GetApprovedCompGroupDetails(Session("USERID").ToString(), "Y", Session("CompServiceId").ToString())
            Else
                ds = objGetData.GetApprovedGroupDetails(Session("USERID").ToString(), "Y")
            End If
    ...
    Protected Sub lnkGrpId_Click(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Try
            ...
            If Request.QueryString("groupId") <> Nothing And Request.QueryString("CaseId") <> Nothing Then
                'Code tp Update Case
                ObjUpData.UpdateApprovedGroupByCaseID(Request.QueryString("groupId"), grpId, Request.QueryString("CaseId"))
            End If

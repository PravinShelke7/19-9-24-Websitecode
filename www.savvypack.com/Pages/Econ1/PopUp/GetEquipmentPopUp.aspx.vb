...
Partial Class Pages_Econ1_PopUp_GetEquipmentPopUp
    ...
    Protected Sub GetEquipmentDetails()
        ...
        Try
            ...
            ds = objGetData.GetPopUpEquipment("-1", txtMatDe1.Text.Trim.ToString(), txtMatDe2.Text.Trim.ToString(), Request.QueryString("Case").ToString())
    ...
    Protected Sub BindLink()
        ...
        Dim objGetData As New E1GetData.Selectdata
        Try
            dsEmat = objGetData.GetEditEquip(Session("E1CaseId"))
            ...
            For Each Gr As GridViewRow In grdEquipment.Rows
                ...
                lnkBtnval.Attributes("onclick") = "javascript:return EquipmentDet('" + ds.Tables(0).Rows(Gr.RowIndex).Item("EQUIPDES").ToString() + "'," + ds.Tables(0).Rows(Gr.RowIndex).Item("EQUIPID").ToString() + ",'" + ds.Tables(0).Rows(Gr.RowIndex).Item("ELabel1").ToString() + "')"
            Next
        Catch ex As Exception

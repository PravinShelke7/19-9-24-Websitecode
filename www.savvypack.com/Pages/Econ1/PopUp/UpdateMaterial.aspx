<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UpdateMaterial.aspx.vb"
    Inherits="Pages_Econ1_PopUp_UpdateMaterial" %>
        ...
        function CloseWindow() {
            ...
            if (hidMatName != "") {
                ...
                for (j = 1; j < 11; j++) {
                    ...
                    var hidMatId = window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_hidMatid' + j).value;
                    if (j != i) {
                        if (document.getElementById('<%= hidMatId.ClientID%>').value == hidMatId) {
                            window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_hypMatDes' + j).innerHTML = Name;
                            window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_hypMatDes' + j).title = Name;
                            window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_imgBut' + j).style.display = "inline";
                            window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_imgDis' + j).style.display = "none";
                        }
                    }
                }
            }
                ...
                for (j = 1; j < 11; j++) {
                    ...
                    if (j != i) {
                        if (document.getElementById('<%= hidMatId.ClientID%>').value == hidMatId) {
                            ...
                            window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_imgBut' + j).style.display = "none";
                            window.opener.document.getElementById('ctl00_Econ1ContentPlaceHolder_imgDis' + j).style.display = "inline";
                        }
                    }
                }
            }

...
Partial Class Pages_Econ1_PopUp_InkCost
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Ink Cost Assistant"
    End Sub
#End Region
...
#End Region
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 10
                    Color(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$hidColId" + i.ToString() + "")
                    Coverage(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$COV" + i.ToString() + "")
                Next
    ...
    Protected Sub Calculate()
        Try
            Dim objCalc As New E1InkColorCalc.Calculation()
            objCalc.InkColorCalculate(CaseId, Session("USERID").ToString())
    ...
    Protected Sub GetPageDetails2(ByVal objInkCalc As E1InkColorCalc.Calculation)
        Dim ds As New DataSet
        Dim objGetData As New E1GetData.Selectdata

...
Partial Class Pages_Econ1_PopUp_CaseSearch
    ...
    Protected Sub GetCaseDetails()
        ...
        Try
            If hidCaseid.Value = "ddlPCase" Then
                ...
                '            ds = objGetData.GetCompCases(Session("USERID"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Session("ServiceId"))
                '        Else
                ...
                'Else
                '    If Session("Service") = "COMP" Then
                '        ds = objGetData.GetCompCasesByLicense(Session("USERID"), txtCaseDe1.Text.Trim.ToString().Replace("'", "''"), txtCaseDe2.Text.Trim.ToString().Replace("'", "''"), Session("ServiceId").ToString())
                '    Else

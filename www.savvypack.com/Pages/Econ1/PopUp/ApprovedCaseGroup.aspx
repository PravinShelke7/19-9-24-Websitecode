<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ApprovedCaseGroup.aspx.vb" Inherits="Pages_Econ1_PopUp_ApprovedCaseGroup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1-Case Group Details</title> 
  ...
  var str = CaseDes.replace(/##/g, "'");
            ...
            // alert(hidCaseId);
             //window.opener.document.getElementById(hidCasedes).innerText = CaseDes.replace(new RegExp("&#", 'g'), "'"); ;
            // window.opener.document.getElementById(hidCaseIdD).value = CaseDes.replace(new RegExp("&#", 'g'), "'"); ;
   window.opener.document.getElementById(hidCasedes).innerText = str; // CaseDes.replace(new RegExp("&#", 'g'), "'");  ;
             window.opener.document.getElementById(hidCaseIdD).value = str;//CaseDes.replace(new RegExp("&#", 'g'), "'"); ;

             window.opener.document.getElementById("hidApprovedCase").value = "0";
             window.opener.document.getElementById("hidApprovedCaseD").value = "Select case";
             window.opener.document.getElementById("lnkApprovedCase").innerText = "Select case";
    ...
    <div id="ContentPagemargin" style="width:100%;margin:0 0 0 0">
       <div id="PageSection1" style="text-align:left">
        <asp:Label ID="_lErrorLble" runat="server"></asp:Label>
           ...
           <asp:GridView Width="700px" runat="server" ID="grdCaseSearch" DataKeyNames="GROUPID" AutoGenerateSelectButton="false"
                    ...
                    <Columns>
                        <asp:BoundField DataField="CaseId" HeaderText="CaseId" SortExpression="CaseId" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="GROUP NAME" SortExpression="CaseDe1">                              
                                <ItemTemplate>
                                   <a href="#" onclick="CaseSearch('<%#Container.DataItem("GROUPDES1")%>','<%#Container.DataItem("GROUPID")%>')" class="Link">
                                      <%#Container.DataItem("GROUPDES")%></a>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" Width="30%" />
                                <HeaderStyle HorizontalAlign="Left" /> 
                          </asp:TemplateField>
                         <asp:BoundField DataField="CASEIDS" HeaderText="Case(s)" SortExpression="CASEIDS" Visible="true"> 

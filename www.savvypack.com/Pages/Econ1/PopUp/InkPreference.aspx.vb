...
Partial Class Pages_Econ1_PopUp_InkPreference
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Ink Cost Preferences"
    End Sub
#End Region
...
#End Region
    ...
    Protected Sub GetPageDetails()
        ...
        Try
            ds = objGetData.GetColorPrefDetails(Session("USERID").ToString(), CaseId)
    ...
    Protected Sub Update_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Try
            ...
            If Not objRefresh.IsRefresh Then
                For i = 1 To 11
                    WetCost(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$WETPP" + i.ToString() + "")
                    PerSol(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$PERSOLP" + i.ToString() + "")
                    SGravity(i - 1) = Request.Form("ctl00$E1InkContentPlaceHolder$SGRAVITYP" + i.ToString() + "")
                Next
                ObjUpIns.ColorPreferenceUpdate(Session("USERID").ToString(), WetCost, PerSol, SGravity, CaseId)

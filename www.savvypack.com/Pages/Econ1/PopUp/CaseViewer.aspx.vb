...
Partial Class Pages_Econ1_PopUp_CaseViewer
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            '    Else
            '        If Session("Service") = "COMP" Then
            '            ds = objGetData.GetCompCases(Session("USERID"), CaseDe1, CaseDe2, Session("ServiceId"))
            '        Else
            ...
            'Else
            '    If Session("Service") = "COMP" Then
            '        ds = objGetData.GetCompCasesByLicense(Session("USERID"), CaseDe1, CaseDe2, Session("ServiceId"))
            '    Else

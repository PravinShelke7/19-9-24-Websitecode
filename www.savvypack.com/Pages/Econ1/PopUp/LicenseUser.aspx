<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LicenseUser.aspx.vb" Inherits="Pages_Econ1_PopUp_LicenseUser" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1-User Details</title> 
     <link href="../../../App_Themes/SkinFile/AlliedNew.css" rel="stylesheet" type="text/css" />
     <script type="text/JavaScript">
         function CaseSearch(CaseId, CaseDes) {
                    ...
                    <Columns>
                        <asp:BoundField DataField="USERID" HeaderText="USERID" SortExpression="USERID" Visible="false">  
                          ...
                          <asp:TemplateField HeaderText="USER NAME" SortExpression="USERNAME">                              
                                <ItemTemplate>
                                   <a href="#" onclick="CaseSearch('<%#Container.DataItem("USERID")%>','<%#Container.DataItem("USERNAME")%>')" class="Link">

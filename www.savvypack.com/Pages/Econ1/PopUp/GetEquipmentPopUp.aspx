<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GetEquipmentPopUp.aspx.vb"
    Inherits="Pages_Econ1_PopUp_GetEquipmentPopUp" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/JavaScript">
        function EquipmentDet1(EquipDes, EquipId) {
...
<body>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left;height:600px;">
            ...
            <table style="width:700px;" cellpadding="4" cellspacing="0">
            ...
            <div style="width: 720px; height:480px; overflow: auto;">
                <asp:GridView Width="700px" runat="server" ID="grdEquipment" DataKeyNames="equipID"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="equipDE2" HeaderText="Equipment Des2" SortExpression="equipDE2"
                         ...
                         <asp:BoundField DataField="EUnit" HeaderText="Equipment Unit" SortExpression="EUNIT"
                            Visible="true">

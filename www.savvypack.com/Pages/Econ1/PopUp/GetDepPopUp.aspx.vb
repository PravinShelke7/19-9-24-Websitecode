...
Partial Class Pages_Econ1_PopUp_GetDepPopUp
    ...
    Protected Sub GetDeptDetails()
        ...
        Try
		 If Request.QueryString("CaseID") <> Nothing Then
                ds = objGetData.GetDept(-1, txtDepDe1.Text.Trim.ToString(), txtDepDe2.Text.Trim.ToString(), Request.QueryString("CaseID").ToString())
            Else

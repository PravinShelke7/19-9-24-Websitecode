<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EditApprovedGroups.aspx.vb" Inherits="Pages_Econ1_PopUp_EditApprovedGroups" %>


<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Edit Approved Group Details</title>
                    ...
                    <td>
                        <div style="width: 670px;">
                            <asp:GridView Width="640px" runat="server" ID="grdGrpCases" DataKeyNames="GROUPID"
                                ...
                                <HeaderStyle Height="25px" BackColor="#6B696B" Font-Size="11px" Font-Bold="True"
                                    ForeColor="White" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Group Description" HeaderStyle-HorizontalAlign="center"
                                        ...
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtGroupDes" CssClass="SmallTextBox" Style="text-align: left; width: 400px;
                                                height: 30px;" TextMode="MultiLine" Font-Size="8" Width="120px" Enabled="true"
                                                runat="server" Text='<%# bind("GROUPDES")%>' AutoPostBack="false" />
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Left" />

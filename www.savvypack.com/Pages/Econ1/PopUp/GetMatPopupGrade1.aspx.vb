...
Imports E1GetData
Partial Class Pages_Econ1_PopUp_GetMatPopupGrade1
    Inherits System.Web.UI.Page
    Dim objGetE1Data As New E1GetData.Selectdata()
    Dim objGetSAData As New StandGetData.Selectdata()
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
            ...
            Ds = objGetdata1.GetCategory(hidDMatId.Value, "", "")
          
            If Not IsPostBack Then
                hidMatGrp.Value = Request.QueryString("Grp").ToString()
                hvUserGrd.Value = "0"
                hvGroupQ.Value = Request.QueryString("Grp").ToString()
                hidMatCat.Value = Request.QueryString("Grp").ToString()
            ...
            If Ds.Tables(0).Rows.Count > 0 Then
                hidMatGrp.Value = Ds.Tables(0).Rows(0).Item("CATEGORY")
            End If
    ...
    Public Sub Link_Click()
        ...
        Dim objE1GetData As New E1GetData.Selectdata()

        Try

            If hidMatGrp.Value <> "N" And hidMatGrp.Value <> "Nothing  selected " Then
                ...
                ' ds1 = objE1GetData.GetPopupMaterials(-1, hidMatGrp.Value, txtMatDe1.Text.ToString(), Session("E1CaseId"))
                Session("EconMat") = ds
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    If i < ds.Tables(0).Rows.Count Then
                        Select Case j
                            Case 1
                                ...
                                Link.NavigateUrl = "GetMatPopUpGrade1.aspx?Des=" + hidMatdes.Value + "&Id=" + hidMatid.Value + "&GradeDes=" + hidGradedes.Value + "&GradeId=" + hidGradeid.Value + "&SG=" + hidSG.Value + "&MatDes=" + hidMatD.Value + " &Grp=" + Link.Text + "&LinkId=" + Link.ID + "&Flag=Y&MatId=0"
                                i = i + 1
    ...
    Protected Sub grdMaterials_RowDataBound(ByVal sender As Object, ByVal e As GridViewRowEventArgs) Handles grdMaterials.RowDataBound
        ...
        Dim ds As New DataSet()
        ds = CType(Session("EconMat"), DataSet)
        ...
        If ds.Tables(0).Rows().Count > 0 Then
            If e.Row.RowType = DataControlRowType.DataRow Then
                ...
                DsGrade = objGetSAData.GetGradeId(ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString())
                If DsGrade.Tables(0).Rows.Count > 0 Then
                    graid = DsGrade.Tables(0).Rows(0).Item("GRADEID").ToString()
                    sg = DsGrade.Tables(0).Rows(0).Item("SG").ToString()
                Else
                    graid = "0"
                    sg = "0"
                End If

                ' DsGrade = objGetE1Data.GetPopupMaterials(ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString(), ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString(), " ", Session("E1CaseId"))
                If ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() <> "0" Then
                    ...
                    If (hidMatGrp.Value).ToUpper() = "RESIN" Then
                        ...
                        'GetGradeId(matid.ToString, GradeValue.ToString())
                        Dim i As Integer = 0
                        ...
                        btn.Attributes("onclick") = "javascript:return MaterialDet('" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "'," + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() + ",'" + GradeValue + "','" + graid.ToString() + "','','" + sg.ToString() + "','" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "','" + MouseoverValue + "')"
                ...
                Else
                    Dim btn As LinkButton = DirectCast(e.Row.FindControl("lnkBtnval"), LinkButton)
                    btn.Attributes("onclick") = "javascript:return MaterialDet('" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "'," + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() + ",'','','','','" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "','')"
        ...
        '            btn.Attributes("onclick") = "javascript:return MaterialDet('" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES").ToString() + "'," + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATID").ToString() + ",'" + ds.Tables(0).Rows(e.Row.RowIndex).Item("GRADENAME").ToString() + "'," + ds.Tables(0).Rows(e.Row.RowIndex).Item("GRADEID").ToString() + ",'" + ds.Tables(0).Rows(e.Row.RowIndex).Item("WEIGHT").ToString() + "','" + ds.Tables(0).Rows(e.Row.RowIndex).Item("SG").ToString() + "','" + ds.Tables(0).Rows(e.Row.RowIndex).Item("MATDES3").ToString() + "')"

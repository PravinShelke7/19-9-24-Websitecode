<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Tools2.aspx.vb" Inherits="Pages_Econ1_Tools_Tools2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1-Tools</title>
    <link href="../../../App_Themes/SkinFile/AlliedNew.css" rel="stylesheet" type="text/css" />

    <script type="text/javascript">
        javascript: window.history.forward(1);
        function ShowColPopup(Page) {
        ...
        function ShowPopupWindow(page) 
      {
        ...
        function ShowPopWindow(PageN, Type) {
            ...
            if (Type == "AP") {
                //pn = PageN;
                var grpId = document.getElementById("<%=hidApprovedGroupId.ClientID %>").value;
                //alert(grpId);
...
if(CaseId=="0")
         ...
         else
         {
            ...
            if (Flag == 'SYN') {
                ...
                var msg = "You are going to synchronize case " + CaseId + " from Sustain1 to Econ1. Do you want to proceed?"
            }
             if (Flag == 'RENAME') 
             {
              return true;
        ...
        function ShareMessage(Case, User, Flag) 
        {
            ...
            if (Flag == 'SYN') {
                var Case1 = document.getElementById(Case)
                var msg = "You are going to synchronize case " + Case1.value + " from Sustain1 to Econ1. Do you want to proceed?"
            }
        ...
        var UserN=""   
           ...
           UserN= document.getElementById(User).innerText;
           if(UserN=="Select User")
           {
...
//          alert(MaxCount);
          if(TotalCount != "" || MaxCount != "")
          {
                  ...
                  {
                          var Name = document.getElementById(User).innerText;
                          var msg = "You are trying to share a copy with user " + Name + ".  " + UserN + " has reached their limit of "+MaxCount+" cases.  Please contact SavvyPack Corporation (952-405-7500) to purchase more cases.";
                          alert(msg);
                          return false;
                  }
            }
            ...
            {
                         var Name = document.getElementById(User).innerText;
                          var msg = "You are trying to share a copy with user " + Name + ".  " + UserN + " does not have permissions to the appropriate module.  Please contact SavvyPack Corporation (952-405-7500) to purchase these permissions.";
                          alert(msg);
                          return false;
            }
            }
...
if(CaseId=="0")
         ...
         else
         {
            ...
            if (Flag == 'UC') {
                                  ...
                                  {
                                        alert("Description 1 cannot be blank");
                                        return false;
                                  }
                                  else if (document.getElementById("txtCaseDe2").value.split(' ').join('').length == 0) 
                                  {
                                        alert("Description 2 cannot be blank");
                                        return false;
                                  }
                                  else 
                                  {
...
<body style="margin-top: 0px;">
    ...
    <form id="form1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="Button1" runat="server" ImageUrl="~/Images/GlobalManager.gif"
                                            Text="Global Manager" CssClass="ButtonWMarigin" PostBackUrl="~/Pages/Econ1/Default2.aspx"
                        ...
                        <div id="PageSection1" style="text-align: left">
                              ...
                              <table>
                                ...
                                <%--<asp:HyperLink ID="lnkAdminTool" runat="server" Text="Admin Tool" CssClass="Link"
                                    Font-Bold="true" NavigateUrl="~/Pages/Econ1/Tools/AdminTool.aspx"></asp:HyperLink>--%>
                                     <asp:LinkButton ID="lnkAdminmTool" runat="Server" CssClass="Link" Text="Admin Tool" style="font-size:13px;font-weight:bold;" 
                                    OnClientClick="return ShowPopupWindow('../Tools/AdminTool.aspx');" ></asp:LinkButton>
                                  ...
                                  <td>
                                   ...
                                   <%--  <asp:HyperLink ID="lnkGroupTool" runat="server" Text="Manage Groups" CssClass="Link"
                                    Font-Bold="true" NavigateUrl="~/Pages/Econ1/Tools/ManageGroups.aspx" ></asp:HyperLink>--%>
                                      <asp:LinkButton ID="lnkGroupmTool" runat="Server" CssClass="Link" Text="Manage Groups" style="font-size:13px;font-weight:bold;" 
                                    OnClientClick="return ShowPopupWindow('../Tools/ManageGroups.aspx');" Visible="false"  ></asp:LinkButton>
                                    </div> 
                                  </td>
                                </tr>
                              </table>
                            ...
                            <table width="820px">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlBCases" CssClass="DropDown" Width="96%" Visible="false"  runat="server">
                                        </asp:DropDownList>
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:Button ID="btnCopyBcase" runat="server" Text="Copy" CssClass="ButtonWMarigin"
                                            OnClientClick="return CreateMessage('APP','NCC');" 
                                        ...
                                        <asp:Button ID="btnBTransfer" runat="server" Text="Transfer" CssClass="ButtonWMarigin"
                                            Style="margin-left: 10px" OnClientClick="return MakeVisible('APP','divBCopy');" onmouseover="Tip('Transfer Variables from One Case to Another Case')"
                                            onmouseout="UnTip()" />
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="820px">
                                ...
                                <tr class="AlterNateColor1">
                                    <td>
                                        <asp:DropDownList ID="ddlPCases" CssClass="DropDown" Width="96%" Visible="false"  runat="server">
                                        </asp:DropDownList>
                                ...
                                <tr class="AlterNateColor1" style="height: 30px">
                                    <td>
                                        ...
                                        <asp:Button ID="btnSynchronize" runat="server" Text="Synchronize" CssClass="ButtonWMarigin"
                                            OnClientClick="return SyncMessage('Prop', '', 'SYN');" onmouseover="Tip('Synchronize this Case from Sustain1 to Econ1')"
                                            onmouseout="UnTip()" Style="margin-left: 10px" />
                                        <asp:Button ID="btnPRename" runat="server" Text="Rename" CssClass="ButtonWMarigin"
                                            onmouseover="Tip('Rename this Case')" OnClientClick="return SyncMessage('Prop', '', 'RENAME');" onmouseout="UnTip()" Style="margin-left: 10px" />
                                        ...
                                        <asp:Button ID="btnCreate" runat="server" Text="Create" CssClass="ButtonWMarigin"
                                            ...
                                            onmouseout="UnTip()" Style="margin-left: 10px" />
                                                <asp:Button  ID="btnSubmit" runat="server" onmouseout="UnTip()" onmouseover="Tip('Submitted for approval for addition to Approved cases')" Text="Submit" OnClientClick="return StatusMessage();" CssClass="Button"></asp:Button>
                                    </td>
                                </tr>
                            </table>
                            <br />
                                ...
                                <table width="820px">
                                    ...
                                    <tr class="AlterNateColor1">
                                        <td>
                                            ...
                                            <asp:LinkButton ID="lnkTargetApp" Style="font-size: 14px;padding-left: 10px" runat="server" CssClass="Link" 
                                        Width="500px" OnClientClick="return ShowPopWindow('../PopUp/CasesSearch.aspx?Des=lnkTargetApp&Id=hidTargetApp&IdD=hidTargetAppD','PRP');">Select case</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
                            ...
                            <div style="display: none; margin-top: 40px;" id="divCopy" runat="server"   >
                                <table width="820px">
                                    ...
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:DropDownList ID="ddlTarget1" CssClass="DropDown" Width="96%" runat="server" Visible="false"  >
                                            </asp:DropDownList>
                                             <asp:LinkButton ID="lnkTargetProp" Style="font-size: 14px;padding-left: 10px" runat="server" CssClass="Link" 
                                        Width="500px" OnClientClick="return ShowPopWindow('../PopUp/CasesSearch.aspx?Des=lnkTargetProp&Id=hidTargetProp&IdD=hidTargetPropD','PRP');">Select case</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:Button ID="btnPS2T" runat="server" Text="Transfer" CssClass="ButtonWMarigin"
                                                OnClientClick="return CaseCopyCheck('lnkPropCase','hidTargetProp');" onmouseover="Tip('Transfer On Target')"
                                                onmouseout="UnTip()" />
                            ...
                            <div style="display: none; margin-top: 40px;" id="divshareAccess" runat="Server">
                                <table width="700px">
                                    ...
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:DropDownList ID="ddlUsers" CssClass="DropDown" Width="30%" Visible="false"  runat="server" AutoPostBack="true">
                                            </asp:DropDownList>

                                            <asp:LinkButton ID="lnkUsers1" Style="font-size: 14px;padding-left: 10px" runat="server" CssClass="Link" 
                                        Width="500px" OnClientClick="return ShowUserWindow('../PopUp/LicenseUser.aspx?Des=lnkUsers1&Id=hidUserSA','PRP');">Select User</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:Button ID="btnShareAccess" runat="server" Text="Share Access" CssClass="ButtonWMarigin"
                                                OnClientClick="return ShareMessageNew('lnkPropCase', 'lnkUsers1', 'SC');" onmouseover="Tip('Share Access to this Case with Another User')"
                                                onmouseout="UnTip()" />
                            ...
                            <div style="display: none; margin-top: 40px;" id="divsharecopy" runat="Server">
                                <table width="700px">
                                    ...
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:DropDownList ID="ddlUser2" CssClass="DropDown" Visible="false"  Width="30%" runat="server" AutoPostBack="true">
                                            </asp:DropDownList>
                                             <asp:LinkButton ID="lnkUser2" Style="font-size: 14px;padding-left: 10px" runat="server" CssClass="Link" 
                                        Width="500px" OnClientClick="return ShowUserWindow('../PopUp/LicenseUser.aspx?Des=lnkUser2&Id=hidUserSC','PRP');">Select User</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
                                            <asp:Button ID="btnShareCopy" runat="server" Text="Share a Copy" CssClass="ButtonWMarigin"
                                                OnClientClick="return ShareCopyMessageNew('lnkPropCase', 'lnkUser2', 'SCC');" onmouseover="Tip('Share a Copy of this Case with Another User')"
                                                onmouseout="UnTip()" />
                                ...
                                <table width="700px">
                                    ...
                                    <tr class="AlterNateColor1">
                                        <td align="right" style="width: 200px;">
                                            <b>Model Brief Description 1:</b>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCaseDe1" runat="server" CssClass="MediumTextBox" Style="text-align: left; font-size: 11px; width: 230px"
                                                MaxLength="25"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td align="right">
                                            <b>Model Brief Description 2:</b>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCaseDe2" runat="server" CssClass="MediumTextBox" Style="text-align: left; font-size: 11px; width: 230px"
                                                MaxLength="25"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="AlterNateColor1">
                                        <td align="right">
                                            <b>Package Specification Group:</b>
                                        </td>
                                        <td  style="width: 500px;">
                                            <asp:LinkButton ID="lnkPackSpecGRP" Style="font-size: 14px; padding-left: 5px;width:180px;" runat="server" CssClass="Link"
                                                OnClientClick="return ShowColPopup('../PopUp/PackSpecGroup.aspx?Des=lnkPackSpecGRP&ID=hidPackSpecGrp');">Select Package Specification Group</asp:LinkButton>
                                            <asp:TextBox runat="server" ID="txtPackSpecGrpAdd" CssClass="MediumTextBox" style="width:180px;display:none;"></asp:TextBox>
                                        </td>
                                    </tr>            
                                    <tr class="AlterNateColor1">
                                        <td align="right">
                                            <b>Associated PACKSPEC Company:</b>
                                        </td>
                                        <td>
                                            <asp:LinkButton ID="ddlPackSpecCMPNY" Style="font-size: 14px; padding-left: 5px" runat="server" CssClass="Link"
                                                OnClientClick="return ShowColPopup('../PopUp/PackSpecCompany.aspx?Des=ddlPackSpecCMPNY&ID=hidPackSpecCMPNY');">Select Package Specification Company</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1" runat="server" id="txtCmpnyId" visible="false">
                                        <td align="right">
                                            <b>Company Name:</b>
                                        </td>
                                        <td>
                                            <asp:TextBox runat="server" ID="txtCmpny" CssClass="MediumTextBox" Style="text-align: left; font-size: 11px; width: 130px"></asp:TextBox></td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td align="right">
                                            <b>Model Long:</b>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCaseDe3" runat="server" onKeyUp="javascript:Count(this);"
                                                ...
                                                TextMode="MultiLine" Height="100px" Width="389px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr class="AlterNateColor1">
                                        <td>
        ...
        <asp:HiddenField ID="hidShareUserMaxCaseCount" runat="server" />
         ...
         <asp:HiddenField ID="hidApprovedGroupId" runat="server" />
        ...
        <asp:HiddenField ID="hidTargetPropD" runat="server" />
         ...
         <asp:HiddenField ID="hidUserSC" runat="server" />
                 ...
                 <asp:HiddenField ID="hidPackSpecGrp" runat="server" />
<asp:HiddenField ID="hidPackSpecCMPNY" runat="server" />

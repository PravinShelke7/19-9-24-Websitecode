<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ManageApprovedGroups.aspx.vb" Inherits="Pages_Econ1_Tools_ManageApprovedGroups" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1-Manage Approved Groups</title>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:ImageButton ID="btnGlobalManager" runat="server" ImageUrl="~/Images/Close.gif"
                                        OnClientClick="window.close();" Text="Close window" CssClass="ButtonWMarigin"
                                        onmouseover="Tip('Close window')" onmouseout="UnTip()" />
                                </td>
                                <td>
                            ...
                            <tr class="AlterNateColor2">
                                <td style="width: 900px; padding-left: 5px; margin-right: 0px;" align="left" colspan="3">
                                    ...
                                    <asp:LinkButton ID="lnkGroups" runat="server" Width="140px" Style="color: Black;
                                        font-family: Verdana; font-size: 12px;" Text='Display All Groups' OnClientClick="return ShowGroupPopup('../Popup/AllApprovedGroupsDetails.aspx');"></asp:LinkButton>
                                    ...
                                    <div style="overflow: auto; height: 450px; margin-left: 0px;">
                                        <asp:GridView Width="1190px" CssClass="GrdUsers" runat="server" ID="grdCase" DataKeyNames="CASEID"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="GROUP NAME" HeaderStyle-HorizontalAlign="center" SortExpression="GROUPNAME"
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkGroId" runat="server" Width="140px" Style="color: Black; font-family: Verdana;
                                                            font-size: 12px; text-decoration: underline;" Text='<%# bind("GROUPNAME")%>'></asp:LinkButton>
                                                    </ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="DESCRIPTION 1" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <asp:TemplateField HeaderText="DESCRIPTION 2" HeaderStyle-HorizontalAlign="Left"
                                                ...
                                                <asp:TemplateField HeaderText="LONG DESCRIPTION" HeaderStyle-HorizontalAlign="Left"
                            ...
                            <tr class="AlterNateColor1">
                                <td colspan="3">
                                    ...
                                    <asp:Button ID="btnEditGroup" runat="server" Text="Edit Group" CssClass="ButtonWMarigin"
                                        ToolTip="Edit Group and Description" OnClientClick="return OpenEGroupPopup('../Popup/EditApprovedGroups.aspx')" />
                                </td>
                            </tr>

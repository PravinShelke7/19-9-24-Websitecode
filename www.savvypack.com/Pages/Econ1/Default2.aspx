<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Default2.aspx.vb" Inherits="Pages_Econ1_Default2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>E1-Global Manager</title>
...
<body>
               ...
               <td style="padding-left:490px">
                    <table cellpadding="0" cellspacing="5"   style="border-collapse:collapse">
                        <tr>
                                ...
                                <td>
                                    <asp:ImageButton ID="imgLogoff" ImageAlign="Middle" ImageUrl="~/Images/LogOff.gif" runat="server"  ToolTip="Log Off"  Visible="true" PostBackUrl="~/Universal_loginN/Pages/ULogOff.aspx?Type=E1"/>  
             ...
             <tr style="height:20px">
                ...
                <div id="ContentPagemargin" runat="server">
                 <div style="text-align:right;margin-right:10px;">
                    <asp:LinkButton ID="lnkAppCase" runat="Server" CssClass="Link" Text="Manage Approval Cases" Visible="false" 
                                            Style="font-size: 13px; font-weight: bold;" OnClientClick="return ShowPopupWindow('ClientAdmin/CaseApproval.aspx');"></asp:LinkButton>
                   </div>
                   <div id="PageSection1" style="text-align:left;" >
                           ...
                           <br />
                            <div class="PageHeading" style="width:80%"><center>Select from Existing Cases</center></div>
                                <table width="90%">
                                <tr class="AlterNateColor4" runat="server" id="trApp1" visible ="true"  >
                                <td class="PageSHeading" style="font-size: 14px;">
                                    Select Approved Case Groups
                                </td>
                            </tr>
                            <tr class="AlterNateColor1"  runat="server" id="trApp2" visible ="true">
                                <td id="td3" runat="server">
                                        <asp:LinkButton ID="lnkApprovedCaseGroup" Style="font-size: 14px;padding-left: 10px" runat="server" CssClass="Link" 
                                        Width="400px" OnClientClick="return ShowPopWindow('PopUp/ApprovedCaseGroup.aspx?Des=lnkApprovedCaseGroup&Id=hidApprovedGroupId&IdD=hidApprovedGroupCaseD','APR');">All Groups and All Cases</asp:LinkButton>   
                                        <asp:LinkButton ID="lnkApprovedGrp" Style="text-align:right;font-size: 14px;padding-left: 10px" runat="server" CssClass="Link"  Visible ="false" 
                                        Width="200px" OnClientClick="return openWindowU('Tools/ManageApprovedGroups.aspx');">Manage Groups</asp:LinkButton>                                       
                                </td>
                            </tr>                                
                            </table>
                        <br />      
                       <table width="90%">
                                ...
                                <tr class="AlterNateColor4">
                                  ...
                                  <tr class="AlterNateColor1">
                                     <td>
                                        ...
                                        Width="400px" OnClientClick="return ShowPopWindow('PopUp/CaseGroup.aspx?Des=lnkCaseGroup&Id=hidGroupId&IdD=hidGroupCaseD','PRP');">All Groups and All Cases</asp:LinkButton>
                                         <asp:LinkButton ID="lnkGrp" Style="text-align:right;font-size: 14px;padding-left: 10px" runat="server" CssClass="Link" 
                                        Width="200px" OnClientClick="return openWindowU('Tools/ManageGroups.aspx') ;">Manage Groups</asp:LinkButton>                                       
                                     </td>
                                </tr>                                 
                                   <tr >
                            ...
                            <div style="margin-top: 40px;display:none" id="divRename" runat="server">
                            <table width="700px">
                            <tr class="AlterNateColor4">
                            ...
                            <div class="PageHeading" style="width:80%"><center>Case Modification Tools</center></div>
                               <table width="90%">
                                <tr class="AlterNateColor4">
                                  ...
                                  <tr class="AlterNateColor1">
                                    <td>  
                                        <asp:Button ID="btnToolBox" ToolTip="Manage Groups and Cases" runat="server"  CssClass="Button" Text="Go To Toolbox" style="margin-left:0px;"   />                                        
  ...
  <asp:HiddenField ID="hidApprovedGroupCaseD" runat="server" />

...
Partial Class Pages_Econ1_Results_ResultcostDep
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetComparebtn()
        ...
        Comparebtn.OnClientClick = "return Compare('Comparision.aspx?Type=" + obj.Encrypt("CSTDEP") + "') "
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.Attributes.Add("onmouseover", "Tip('Manufacturing Cost with Depreciation')")
        MainHeading.Attributes.Add("onmouseout", "UnTip()")
        MainHeading.InnerHtml = "Econ1 - Manufacturing Cost with Depreciation"
    End Sub
            ...
            For i = 1 To 8
                ...
                Select Case i
                    ...
                    Case 7
                        ...
                        Title = ds.Tables(0).Rows(0).Item("Title2").ToString()
                        HeaderTdSetting(tdHeader, "100px", "By Volume", "1")
                        Header2TdSetting(tdHeader1, "", "(" + Title + "/thousand Impressions )", "1")
                        trHeader.Controls.Add(tdHeader)
                        trHeader1.Controls.Add(tdHeader1)
                End Select

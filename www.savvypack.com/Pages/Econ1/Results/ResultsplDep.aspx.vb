...
Partial Class Pages_Econ1_Results_ResultsplDep
...
#Region "MastePage Content Variables"
    ...
    Protected Sub GetMainHeadingdiv()
        ...
        MainHeading.InnerHtml = "Econ1 - Profit and Loss Statement With Depreciation"
    End Sub
 ...
 End If
  ...
  Protected Sub GetPageDetails2()
        ...
        Try
            ...
            Next
        Catch ex As Exception
            _lErrorLble.Text = "Error:GetPageDetails2:" + ex.Message.ToString()
        End Try
    End Sub

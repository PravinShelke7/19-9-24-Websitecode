...
Partial Class Pages_Econ1_Results_Comparision
...
#End Region
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            ElseIf Type = "PLC" Then
                lblTitle.Text = "Econ1 - Customer Profit and Loss Comparison Selector"
                Page.Title = "E1-Customer Profit and Loss Comparison Selector"
            ...
            ElseIf Type = "PLDEPC" Then
                lblTitle.Text = "Econ1 - Customer Profit and Loss With Depreciation Comparison Selector"
                Page.Title = "E1-Customer Profit and Loss With Depreciation Comparison Selector"
            ...
            ElseIf Type = "CSTC" Then
                lblTitle.Text = "Econ1 - Customer Cost Comparison Selector"
                Page.Title = "E1-Customer Cost Comparison Selector"
            ...
            ElseIf Type = "CSTDEPC" Then
                lblTitle.Text = "Econ1 - Customer Cost Comparison With Depreciation Selector"
                Page.Title = "E1-Customer Cost Comparison With Depreciation Selector"
            End If
    ...
    Protected Sub GetSessionDetails()
        Try
            ...
            lblSessionCaseId.Text = Session("E1CaseId")
    ...
    Protected Sub GetPCaseDetails()
        ...
        Try
            ...
            'Else
            '    If Session("Service") = "COMP" Then
            '        ds = objGetData.GetCompPCaseDetailsByLicense(Session("USERID").ToString(), Session("ServiceId").ToString())
            '    Else
    ...
    Protected Sub btnType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnType.Click
        ...
        Try
            ...
            ds = objGetData.GetProductFormtByID(Session("E1CaseId"), ddlPCases.SelectedValue)
            ...
            Else
                Page.ClientScript.RegisterStartupScript(Me.GetType(), "New_WinCreate", "alert('These cases are not comparable because Case " + Session("E1CaseId").ToString() + " is in " + Units1 + " and Case " + ddlPCases.SelectedValue + " is in " + Units2 + ".');", True)
    ...
    Protected Sub btnChartType_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnChartType.Click
        Try
            ...
            URL = "../../../Charts/E1Charts/CPrftCost.aspx?CaseId=" + CaseId + "&PrftCost=" + objCryptoHelper.Encrypt(PrftCost) + "&ChartType=" + ChType + "&IsDep=" + objCryptoHelper.Encrypt(IsDep) + ""

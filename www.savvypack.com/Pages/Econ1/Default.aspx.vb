...
Partial Class Pages_Econ1_Default
...
#End Region
    ...
    Protected Sub btnBCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBCase.Click
        Try
            Session("E1CaseId") = ddlBaseCases.SelectedValue.ToString()
            If Session("Service") = "COMP" Then
    ...
    Protected Sub btnPCase_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnPCase.Click
        Try
            Session("E1CaseId") = ddlPCase.SelectedValue.ToString()
            If Session("Service") = "COMP" Then
    ...
    Protected Sub btnUpdate_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        ...
        Try
            ...
            'GetPCaseDetails()
            obj.CaseRename(txtCaseid.Value, txtCaseDe1.Text.Trim().Replace("'", "''").ToString(), txtCaseDe2.Text.Trim().Replace("'", "''").ToString(), txtCaseDe3.Text.Trim().Replace("'", "''").ToString(), "EconConnectionString")
            GetPCaseDetails()

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PackagingDetails.aspx.vb"
    Inherits="Pages_PopUp_PackagingDetails" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
            ...
            <table>
                    ...
                    <td>
                        <table cellpadding="0" cellspacing="2" width="400px" style="margin-left: 20px;">
                            <tr class="AlterNateColor1">
                                <td align="left">
                                    <b>
                                        <asp:Label ID="Label1" runat="server" ToolTip="Name Displayed in the Grid" Text="Packaging Process Name:"
                            ...
                            <tr class="AlterNateColor1">
                                <td align="left">
                                    <b>
                                        <asp:Label ID="Label2" runat="server" Text="Order Size:" ToolTip="Order size (or order frequency)"
                                            CssClass="SavvyPackLabel"></asp:Label></b>
                                </td>
                                <td>
                            ...
                            <tr class="AlterNateColor1">
                                <td align="left">
                                    <b>
                                        <asp:Label ID="Label3" runat="server" Text="Run Size:" ToolTip="Volume for each run"
                                            CssClass="SavvyPackLabel"></asp:Label></b>
                                </td>
                                <td>
                ...
                <asp:Table ID="tblPackg" runat="server">
                </asp:Table>
                <br />

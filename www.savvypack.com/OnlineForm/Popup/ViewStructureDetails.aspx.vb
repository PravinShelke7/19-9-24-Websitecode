...
Partial Class Pages_PopUp_ViewStructureDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                Try
                    objUpIns.InsertLog1(Session("UserId").ToString(), "ViewStructureDetails.aspx", "Opened to View Structure Details Popup for Project:" + Session("ProjectId") + "", Session("ProjectId"), Session("SPROJLogInCount").ToString())
    ...
    Protected Sub PageDetails()
        ...
        Try
            ...
            ds = objGetData.GetStructureDetails(Request.QueryString("StructureId").ToString(), Request.QueryString("ProjId").ToString())
                ...
                For j = 1 To 6
                    ...
                    Select Case j
                        ...
                        Case 3
                            InnerTdSetting(tdInner, "", "Center")
                            lbl = New Label
                            lbl.ID = "lblDim" + i.ToString()
                            lbl.Text = ds.Tables(0).Rows(0).Item("DIM" + i.ToString()).ToString()
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 4
                            InnerTdSetting(tdInner, "", "Center")
                            lbl = New Label
                            lbl.ID = "lblDen" + i.ToString()
                            lbl.Text = ds.Tables(0).Rows(0).Item("DEN" + i.ToString()).ToString()
                            tdInner.Controls.Add(lbl)
                            trInner.Controls.Add(tdInner)
                        Case 5
                            InnerTdSetting(tdInner, "", "Center")

...
Partial Class Pages_PopUp_ViewManufactoryDetails
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                Try
                    objUpIns.InsertLog1(Session("UserId").ToString(), "ViewManufactoryDetails.aspx", "Opened to view Manufactory Details Popup for Project:" + Session("ProjectId") + "", Session("ProjectId"), Session("SPROJLogInCount").ToString())
    ...
    Protected Sub PageDetails()
        ...
        Try
            ...
            ds = objGetData.GetManufactoryDetails(Request.QueryString("ManufactoryId").ToString(), Request.QueryString("ProjId").ToString())

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewGraphicsDetails.aspx.vb"
    Inherits="Pages_PopUp_ViewGraphicsDetails" %>
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <table cellpadding="0" cellspacing="2" width="400px" style="text-align: center; vertical-align: middle;
                ...
                <tr class="AlterNateColor1">
                    ...
                    <td align="left" style="width: 50%; word-wrap: normal; word-break: break-all;">
                        <asp:Label ID="lblDesg" runat="server" CssClass="SavvyPackLabel"></asp:Label>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left" style="width: 50%;">
                        <b>
                            <asp:Label runat="server" Text="Number of Colors:" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td align="left" style="width: 50%; word-wrap: normal; word-break: break-all;">
                        <asp:Label ID="lblColor" runat="server" CssClass="SavvyPackLabel"></asp:Label>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left" style="width: 50%;">
                    ...
                    <td align="left" style="width: 50%; word-wrap: normal; word-break: break-all;">
                        <asp:Label ID="lblVolDesg" runat="server" CssClass="SavvyPackLabel"></asp:Label>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left" style="width: 50%;">

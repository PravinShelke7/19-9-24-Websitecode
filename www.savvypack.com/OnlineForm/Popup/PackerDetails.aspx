<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PackerDetails.aspx.vb" Inherits="Pages_PopUp_MaterialDetails" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Packer Details</title>
                ...
                for (var i = 0; i < txtarray.length; i++) {
                    if (txtarray[i].type == "text") {
                        ...
                        $('#' + id).change(function () {
                            ...
                            else if (ControlID == "txtLoc") {
                                key = 'Location of packaging  plant';
                            }
                            else if (ControlID == "txtCap") {
                                key = 'Annual Capacity of the plant';
                            }
                            else if (ControlID == "txtLines") {
                                key = 'Number of Packing lines in plant';
                            }
        ...
        <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
            ...
            <table cellpadding="0" cellspacing="2" width="500px" style="margin-left: 50px;">
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Packer's Name:" ToolTip="Name displayed in the Grid"
                ...
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Location:" ToolTip="Location of packaging  plant"
                                CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtLoc" runat="server" MaxLength="100" ToolTip="Location of packaging  plant"
                            CssClass="SavvyMediumTextBox" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    ...
                    <td>
                        <asp:TextBox ID="txtCap" runat="server" MaxLength="100" ToolTip="Annual Capacity of the plant"
                            CssClass="SavvyMediumTextBox" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Lines:" ToolTip="Number of Packing lines in plant"
                                CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtLines" runat="server" MaxLength="100" ToolTip="Number of Packing lines in plant"
                            CssClass="SavvyMediumTextBox" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    ...
                    <td>
                        <asp:TextBox ID="txtInfo" runat="server" MaxLength="500" TextMode="MultiLine" ToolTip="Any Other Information on the plant"

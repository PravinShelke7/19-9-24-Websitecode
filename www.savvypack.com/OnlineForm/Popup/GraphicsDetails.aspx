<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GraphicsDetails.aspx.vb"
    Inherits="Pages_PopUp_GraphicsDetails" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
                ...
                for (var i = 0; i < txtarray.length; i++) {
                    if (txtarray[i].type == "text") {
                        ...
                        $('#' + id).change(function () {
                            ...
                            else if (ControlID == "txtDesg") {
                                key = 'Design';
                            }
                            else if (ControlID == "txtColor") {
                                key = 'Color';
                            }
                            else if (ControlID == "txtVolDesg") {
                                key = 'Volume/Design';
                            }
        ...
        //        }
        //        else if (text.id == "txtDesg") {
        //            alert("You cannot use the following COMBINATIONS of characters:< > \\  &# in Design. Please choose alternative characters.");
        //        }
        //        else if (text.id == "txtColor") {
        //            alert("You cannot use the following COMBINATIONS of characters:< > \\  &# in Color. Please choose alternative characters.");
        //        }
        //        else if (text.id == "txtVolDesg") {
        //            alert("You cannot use the following COMBINATIONS of characters:< > \\  &# in Volume/Design. Please choose alternative characters.");
        //        }
        //        else {
        ...
        <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
            ...
            <table cellpadding="0" cellspacing="2" width="500px" style="margin-left: 50px;">
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Name:" ToolTip="Name Displayed in the Grid" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                ...
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Design (#):" ToolTip="Number of Designs" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtDesg" runat="server" MaxLength="100" CssClass="SavvyMediumTextBox"
                            ToolTip="Number of Designs" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Color (#):" ToolTip="Number of Colors" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtColor" runat="server" MaxLength="100" CssClass="SavvyMediumTextBox"
                            ToolTip="Number of Colors" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left" style="margin-left: 5px;">
                        <b>
                            <asp:Label runat="server" Text="Volume/Design:" ToolTip="Volume of Production per Design"
                                CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVolDesg" runat="server" MaxLength="100" ToolTip="Volume of Production per Design"
                            CssClass="SavvyMediumTextBox" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Additional Information:" CssClass="SavvyPackLabel"
                                ToolTip="Any other Information on the stucture"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtInfo" runat="server" MaxLength="500" TextMode="MultiLine" ToolTip="Any other Information on the stucture"
                            CssClass="SavvyMediumTextBox" Width="320px"

...
Partial Class Pages_PopUp_ViewMaterialDetails
    ...
    Public Sub PageDetails()
        ...
        Try
            ds = objGetData.GetPackerDetails(Request.QueryString("PackId").ToString(), Request.QueryString("ProjId").ToString())
            ...
            Try
                objUpIns.InsertLog1(Session("UserId").ToString(), "ViewMaterialDetails.aspx", "Opened Material Popup to View Material Details for Model:" + Request.QueryString("ModelId").ToString() + " And Material Name:" + lblName.Text + "", Session("ProjectId"), Session("SPROJLogInCount").ToString())

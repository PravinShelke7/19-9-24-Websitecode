<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewStructureDetails.aspx.vb"
    Inherits="Pages_PopUp_ViewStructureDetails" %>
        ...
        <div id="PageSection1" style="text-align: left">
            ...
            <table cellpadding="0" cellspacing="2" width="400px" style="margin-left: 20px;">
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="Structure Name:" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>

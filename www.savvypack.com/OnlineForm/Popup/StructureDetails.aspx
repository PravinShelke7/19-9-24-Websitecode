<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StructureDetails.aspx.vb"
    Inherits="Pages_PopUp_StructureDetails" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
                    ...
                    if (txtarray[i].type == "text") {
                        ...
                        $('#' + id).change(function () {
                            ...
                            if (ControlID == "txtName") {
                                ...
                                key = "Material " + matches[0];
                            }
                            else if (ControlID.search("txtDim") == 0) {
                                var matches = ControlID.match(/(\d+)/);
                                key = "Dimension " + matches[0];
                            }
                            else if (ControlID.search("txtDen") == 0) {
                                var matches = ControlID.match(/(\d+)/);
                                key = "Density " + matches[0];
                            }
        ...
        //            key = "Material " + matches[0];
        //        }
        //        else if (str.search("txtDim") == 0) {
        //            var matches = str.match(/(\d+)/);
        //            key = "Dimension " + matches[0];
        //        }
        //        else if (str.search("txtDen") == 0) {
        //            var matches = str.match(/(\d+)/);
        //            key = "Density " + matches[0];
        //        }
        ...
        <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
            ...
            <table cellpadding="0" cellspacing="2" width="400px" style="margin-left: 20px;">
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label ID="Label1" runat="server" Text="Structure Name:" ToolTip="Name Displayed in the Grid"
                ...
                <tr class="AlterNateColor2">
                    ...
                    <td>
                        <asp:Button ID="btnSheet" runat="server" Text="Upload a Spec Sheet" Width="150px"
                            OnClientClick="return ShowPopWindow('FileUpload.aspx?Type=Structure')" />
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label ID="Label2" runat="server" Text="Package Size:" ToolTip="Specifiy the detail info of the package size"
                                CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtSize" runat="server" MaxLength="100" ToolTip="Specifiy the detail info of the package size"
                            CssClass="SavvyMediumTextBox" Width="200px"></asp:TextBox>
                    </td>
                </tr>
            </table>

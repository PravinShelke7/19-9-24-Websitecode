...
Partial Class Savvypack_Popup_UploadFiles
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If Not IsPostBack Then
                ...
                Try
                    'objUpIns.InsertLog1(Session("UserId").ToString(), "UploadFiles.aspx", "Opened Popup to View Uploaded File", Session("ProjectId"), Session("SPROJLogInCount").ToString())
                    objUpIns.InsertLog2(Session("UserId").ToString(), "UniversalUploadFiles.aspx", "Opened Universal Upload/Download File for ProjectId:" + Request.QueryString("ProjectId").ToString(), Request.QueryString("ProjectId").ToString(), Session("SPROJLogInCount").ToString(), "", "", "")
            ...
            If Request.QueryString("Flag") <> Nothing Then
                If Request.QueryString("Flag") = "N" Then
                    fuSheet.Enabled = False
    ...
    Private Sub GetPageDetails()
        ...
        Try
            ...
            Session("UUFExistingFile") = objGetData.GetAllFileNameByProjID(ProjectId)
    ...
    Protected Sub lnkBtn_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            'DownloadPath = "D:\SavvyPackRepository\Savvypack\" + "Project" + ProjectId + "_" + filename(0)
            ...
            'strBody = strBody + "<p>SavvyPack® User " + ds.Tables(0).Rows(0).Item("FIRSTNAME").ToString() + " " + ds.Tables(0).Rows(0).Item("LASTNAME").ToString() + " has Downloaded file from UniversalUploadFiles Popup of Project Manager Page , </p>"
            ...
            'Started Activity Log Changes
            Try
                ' objUpIns.InsertLog1(UserId, "UniversalFileUpload.aspx", "File Downloaded for ProjectId:" + ProjectId + " and File Name: " + filename(0) + "", ProjectId, Session("SPROJLogInCount").ToString())
                objUpIns.InsertLog2(UserId, "UniversalFileUpload.aspx", "File Downloaded for ProjectId:" + ProjectId + " and File Name: " + filename(0) + "", ProjectId, Session("SPROJLogInCount").ToString(), "Download", filename(1), filename(2))
            Catch ex As Exception
                ...
                Else
                    ...
                    Try
                        ...
                        Else
                            FileAction = "Uploaded"
                        End If
                        objUpIns.InsertLog2(UserId, "UniversalUploadFiles.aspx", "File " + FileAction.ToString() + " for ProjectId:" + ProjectId + " and File Name: " + fuSheet.FileName + "", ProjectId, Session("SPROJLogInCount").ToString(), "Upload", FileType, PFileId)
    ...
    Private Function fileUpload() As String
        ...
        Dim UploadPath1 As String = String.Empty
        Try
    ...
    Protected Sub SendMail()
        ...
        Try
            ...
            'strBody = strBody + "<div style='font-family:Verdana;font-size:12px;margin-top:10px;margin-bottom:10px;'>"
            'strBody = strBody + "<p>SavvyPack® User " + ds.Tables(0).Rows(0).Item("FIRSTNAME").ToString() + " " + ds.Tables(0).Rows(0).Item("LASTNAME").ToString() + " has Uploaded file from UniversalUploadFiles Popup of Project Manager Page , </p>"
            'strBody = strBody + "<p>Project Id: " + ProjectId.ToString() + " and Project Title: " + dt.Rows(0).Item("TITLE").ToString().Replace("&#", "'") + " .</p>"
            'strBody = strBody + "<p>Project Owner: " + dt.Rows(0).Item("OWNER").ToString() + " and Uploaded File: " + fuSheet.FileName + " .</p>"
            'strBody = strBody + "</div> "
            ...
            If dsNew.Tables(0).Rows.Count > 0 Then
                ...
                strBody = String.Empty
                strBody = strBody + "<div style='font-family:Verdana;font-size:12px;margin-top:10px;margin-bottom:10px;'>"
                strBody = strBody + "<p>SavvyPack® User " + ds.Tables(0).Rows(0).Item("FIRSTNAME").ToString() + " " + ds.Tables(0).Rows(0).Item("LASTNAME").ToString() + " has " + FileAction.ToString() + " file from UniversalUploadFiles Popup of Project Manager Page , </p>"
                strBody = strBody + "<p>Project Id: " + ProjectId.ToString() + " and Project Title: " + dt.Rows(0).Item("TITLE").ToString().Replace("&#", "'") + " .</p>"
                strBody = strBody + "<p>Project Owner: " + dt.Rows(0).Item("OWNER").ToString() + " and Uploaded File: " + fuSheet.FileName + " .</p>"
                strBody = strBody + "</div> "

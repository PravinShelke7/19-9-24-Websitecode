<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ViewProducerDetails.aspx.vb"
    Inherits="Pages_PopUp_ViewProducerDetails" %>
            ...
            <table cellpadding="0" cellspacing="2" width="400px" style="text-align: center; vertical-align: middle;
                ...
                <tr class="AlterNateColor1">
                    <td align="left" style="width: 50%;">
                        <b>
                            <asp:Label runat="server" Text="Producer's Name:" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>

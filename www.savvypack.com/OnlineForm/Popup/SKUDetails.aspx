<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SKUDetails.aspx.vb" Inherits="Pages_PopUp_SKUDetails" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
                ...
                for (var i = 0; i < txtarray.length; i++) {
                    if (txtarray[i].type == "text") {
                        ...
                        $('#' + id).change(function () {
                            ...
                            else if (ControlID == "txtSKU") {
                                key = 'Number of SKUs';
                            }
                            else if (ControlID == "txtVolSKU") {
                                key = 'Volume/SKU';
                            }
        ...
        //        }
        //        else if (text.id == "txtSKU") {
        //            alert("You cannot use the following COMBINATIONS of characters:< > \\  &# in SKU. Please choose alternative characters.");
        //        }
        //        else if (text.id == "txtVolSKU") {
        //            alert("You cannot use the following COMBINATIONS of characters:< > \\  &# in Volume/SKU. Please choose alternative characters.");
        //        }
        //        else {
        ...
        <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
            ...
            <table cellpadding="0" cellspacing="2" width="500px" style="margin-left: 50px;">
                ...
                <tr class="AlterNateColor1">
                    <td align="left">
                        <b>
                            <asp:Label runat="server" Text="SKU (#):" ToolTip="Number of SKUs" CssClass="SavvyPackLabel"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtSKU" runat="server" MaxLength="100" CssClass="SavvyMediumTextBox"
                            ToolTip="Number of SKUs" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left" style="margin-left: 5px;">
                        <b>
                            <asp:Label runat="server" Text="Volume/SKU:" CssClass="SavvyPackLabel" ToolTip="Volume of Production per SKU"></asp:Label></b>
                    </td>
                    <td>
                        <asp:TextBox ID="txtVolSKU" runat="server" MaxLength="100" CssClass="SavvyMediumTextBox"
                            ToolTip="Volume of Production per SKU" Width="270px"></asp:TextBox>
                    </td>
                </tr>
                <tr class="AlterNateColor1">
                    <td align="left">
                    ...
                    <td>
                        <asp:TextBox ID="txtInfo" runat="server" MaxLength="500" TextMode="MultiLine" CssClass="SavvyMediumTextBox"
                            ToolTip="Any other Information on the stucture" Width="320px" Height="70px"></asp:TextBox>
                    </td>
                </tr>
            </table>
                <br />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SelectUser.aspx.vb" Inherits="OnlineForm_Popup_SelectUser" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/JavaScript">
        function UserSearch(UserDes, UesrId) {
            ...
            var hidUsrDes = document.getElementById('<%= hidUsrDes.ClientID%>').value;

            var str = UserDes.replace(/##/g, "'");
            str = str.replace(/$#/g, '"');
            window.opener.document.getElementById(hidCaseLinkid).innerText = UserDes.replace("&#","'");
            window.opener.document.getElementById(hidUsrDes).value = UserDes.replace("&#", "'");
...
<body>
    ...
    <div id="ContentPagemargin" style="width: 100%; margin: 0 0 0 0">
        <div id="PageSection1" style="text-align: left; margin: 0 0 0 0; width: 580px;">
            ...
            <table cellpadding="0" cellspacing="2" style="width: 480px;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtUser" runat="server" CssClass="SavvyTextBox" Width="252px" autocomplete="off"></asp:TextBox>
                    </td>
                    <td>
            ...
            <div style="height: 340px; overflow: auto; width: 570px;">
                <asp:GridView Width="550px" runat="server" ID="grdUserDetails" DataKeyNames="USERID"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="EMAILADDRESS" SortExpression="EMAILADDRESS">
                            <ItemTemplate>
                                <a href="#" onclick="UserSearch('<%#Container.DataItem("EMAILADDRESS")%>','<%#Container.DataItem("USERID")%>')"
                                    class="Link">
                                    <%# Container.DataItem("EMAILADDRESS")%></a>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" Width="200px" CssClass="breakword" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="FIRSTNAME" HeaderText="FIRST NAME" SortExpression="COMPANY">
                            <ItemStyle HorizontalAlign="Left" Width="150px" CssClass="breakword" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                        <asp:BoundField DataField="LASTNAME" HeaderText="LAST NAME" SortExpression="LICENSENAME">
                            <ItemStyle HorizontalAlign="Left" Width="150px" CssClass="breakword" />
                            <HeaderStyle HorizontalAlign="Left" />
                        </asp:BoundField>
                    </Columns>
        ...
        <asp:HiddenField ID="hidUsrDes" runat="server" />
    </div>
    </form>
</body>
</html>

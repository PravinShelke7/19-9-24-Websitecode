...
<head runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkValidation() {
            //alert(window.opener.document.getElementById('ctl00$ContentPlaceHolder1$txtQuestion').value)         
        ...
        function closewindowSavvy(flag) {
            ...
            window.opener.document.getElementById('btnRefresh').click();
            window.open('ProjectManager.aspx', '_blank');
            window.close();
        }
            ...
            <tr>
                <td style="width: 55%;" align="left">
                    <table style="margin-left: 35px;">
                        ...
                        <tr>
                            <td style="width: 580px; font-weight: bold; padding-top: 10px;" align="left">
                                <asp:LinkButton ID="lnkForgotPass" runat="Server" CssClass="LinkFL" Text="Retrieve your password"
                                    OnClientClick="ShowPopWindow()"></asp:LinkButton>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 580px; font-weight: bold; padding-top: 10px;" align="left">
                ...
                <td style="width: 45%;" align="left" valign="bottom">
                    <table style="padding-left: 30px;">
                        ...
                        <tr>
                            <td style="width: 360px; font-size: 14px; font-family: Optima; font-weight: bold;
                                padding-top: 5px; color: #ff7b3c;" align="left">
                                Questions?
                            </td>
                        </tr>
                        <tr>

...
<head>
    <title>Environmental Analysis Module One</title>
    <style type="text/css">
        A:link
        {
            FONT-WEIGHT: bold;
...
RSinv.CursorType = 3
RSinv.Source = "select * from Inventory WHERE partid ='ENVIRMO1' "
RSinv.Open
                            ...
                            <td style="width:70%;" valign="top">
                                ...
                                <div style="margin-top:5px; text-align:left">
                                    ...
                                    <div>
										...
										<div style="margin-top:15px;font-size:12px;text-align:justify">
											<p>The packaging manufacturing module is a combination of software and content delivered to you through the Internet. It provides a broad array of environmental analysis capabilities, which can be used to analyze the environmental effects of the packaging production industry.</p>
											<p></p>
											...
											<p><img src="../Images/ArrowRight.jpg" alt="" height="9" width="18" border="0"><font size="-2" color="#3a0bff" face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular"><b><a href="../Interactive/InteractiveServices.asp" style="text-decoration: none">Back to Interactive List</a></b></font></p>
										</div>
...
%></td>
                                            ...
                                            <td valign="top">
                                                ...
                                                <div style="margin-left:0px;margin-top:20px;">
															<a title="Order Module One" onmouseover="changeImages( /*CMP*/'order_study_1',/*URL*/'../Images/Order2.gif');return true" onmouseout="changeImages( /*CMP*/'order_study_1',/*URL*/'../Images/Order.gif');return true" href="../NewShoppingCart/Order.asp?Id=ENVIRMO1" target="_blank"><img src="../Images/Order.gif" alt="" name="order_study_1" height="35" width="97" border="0"></a>
                                    ...
                                    <div style="margin-top:15px;font-size:12px;text-align:center">
                                        <a href="../EconModules/ModuleOne.asp#anchor"style="text-decoration: none;font-size:9px;"><b>Top of Page</b></a>
                                    </div>
                                </div>

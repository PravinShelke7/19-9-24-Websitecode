<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserInformation.aspx.vb"
    Inherits="ShoppingCart_UserInformation" MasterPageFile="~/Masters/SavvyPackMenu.master"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="ContentPage" id="ContentPage" style="background-color: White;" runat="server" width="952px">
        <tr>
            <td>

...
Partial Class AnalyticalServices
    ...
    Protected Sub btnSubmit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSubmit.Click
        Try
            ...
            Try
                objUpdataData.InsertASUserDetails(txtEmail.Text.Trim(), txtFName.Text.Trim(), txtLName.Text.Trim())
    ...
    Protected Function GetEmailBodyData(ByVal fName As String, ByVal lName As String, ByVal EMAILADDRESS As String) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<p>Dear " + fName + " " + lName + ",<br/><br/>   Thank you for contacting us regarding your interest in SavvyPack® Analytical Service. We have received your request and will respond within 24 hours. </p>"
            ...
            StrSqlBody = StrSqlBody + "SavvyPack Corporation Sales Team<br/><br/>SavvyPack Corporation<br/>1850 East 121st Street Suite 106B<br/>Burnsville, MN USA 55337<br/><a style='font-family:verdana;' href='http://www.savvypack.com'>www.savvypack.com</a><br/>Phone: 1-952-405-7500</div> "
            StrSqlBody = StrSqlBody + "</p> "

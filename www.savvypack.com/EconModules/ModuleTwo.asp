...
<head>
    <title>Economic Analysis Module Two</title>
    <style type="text/css">
        A:link
        {
            FONT-WEIGHT: bold;
...
RSinv.CursorType = 3
RSinv.Source = "select * from Inventory WHERE partid ='ECONMO2' "
RSinv.Open
                            ...
                            <td style="width:70%;" valign="top">
                                ...
                                <div style="margin-top:5px; text-align:left">
                                    ...
                                    <div>
										...
										<div style="margin-top:15px;font-size:12px;text-align:justify">
											<p>The packaging filling module is a combination of software and content delivered to you through the Internet. It provides a broad array of economic analysis capabilities, which can be used to analyze the economics of the package filling industry.</p>
											<p></p>
...
%></td>
                                            ...
                                            <td valign="top">
                                                ...
                                                <div style="margin-left:0px;margin-top:20px;">
															<a title="Order Module Two" onmouseover="changeImages( /*CMP*/'order_study_1',/*URL*/'../Images/Order2.gif');return true" onmouseout="changeImages( /*CMP*/'order_study_1',/*URL*/'../Images/Order.gif');return true" href="../NewShoppingCart/Order.asp?Id=ECONMO2" target="_blank"><img src="../Images/Order.gif" alt="" name="order_study_1" height="35" width="97" border="0"></a>
</div>

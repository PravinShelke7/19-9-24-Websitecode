<%@ Page Language="VB" MasterPageFile="~/Masters/AlliedMasterMenu.master" AutoEventWireup="false"
    CodeFile="EnvModule1.aspx.vb" Inherits="InteractiveServices_EnvModule1" Title="Environmental Analysis - Sustain1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function OpenOrderPage()
   {
     ...
     OpenNewWindow('../ShoppingCart/Order.aspx?Id=' + reportId ,'SUSTAIN1');
   ...
   function OpenBrochure()
   {
     ...
     var reportId=document.getElementById('<%=hdnRepId.ClientID%>').value;    
     OpenNewWindow('../Email/EASTool_Final.pdf','BRCPAGES1');
     return false;   
   }
    ...
    <div style="height: 22px; width: 97.5%; font-weight: bold; font-size: 23px; text-align: center;
        ...
        <i>SavvyPack</i><sup>&reg;</sup> Environmental Analysis System <span style="font-size: 13px;
            ...
            <tr>
                <td colspan="2">
                    <span style="font-weight: bold; color: Black; font-family: Verdana; font-size: 15px;">
                        Sustain1 - the package manufacturing module</span>
                </td>
            </tr>
            <tr>
                <td style="font-weight: 500; color: Black; font-family: Optima; font-size: 16px;
                    ...
                    <span>
                        <font face="Verdana"><font size="2">The packaging manufacturing module is a combination
                            of software and content delivered to you through the Internet. It provides a broad
                            array of environmental analysis capabilities, which can be used to analyze the environmental
                            effects of the packaging production industry. </font></font>
                    </span>
                </td>
            </tr>
            <tr>
                <td style="font-weight: 500; color: Black; font-family: Optima; font-size: 16px;
                    ...
                    <span>
                        <font face="Verdana"><font size="2">To learn about the system, we recommend you request
                            ...
                            does and how it will benefit you and your company. </font></font>
                    </span>
                </td>
            </tr>
            <tr>
                        ...
                        <tr>
                            <td>
                                <%--  <asp:LinkButton ID="lnkOrder" runat="Server" onmouseover="roll_over('order_study_1', '../Images/Order2.gif')"  onmouseout="roll_over('order_study_1', '../Images/Order.gif')" ToolTip="Order Module One">
                                     <img src="../Images/Order.gif"  name="order_study_1" height="35" width="115" border="0" runat="Server"  />
                                   </asp:LinkButton>--%>
                                <asp:ImageButton ImageUrl="~/Images/OrderButton.jpg" ID="imgbtnOrder" Visible="false"  runat="Server" OnClientClick="return ConfirmMessage('OS');"
                                    ToolTip="Order Sustain1"></asp:ImageButton>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <%-- <asp:LinkButton ID="lnkPdf" runat="Server"  ToolTip="Environmental Analysis Brochure">
                                    <img id="Img1" src="../Images/download_brochure-1.jpg"  height="30" width="120" align="middle" border="0" runat="Server"  />
                                   </asp:LinkButton>--%>
                                <asp:ImageButton ImageUrl="~/Images/ViewBrochure.gif" ID="imgbtnVwBrch" runat="Server" OnClientClick="return OpenBrochure();" 
                                    ToolTip="Environmental Analysis Brochure"></asp:ImageButton>
                            </td>
                        </tr>
                    </table>
                </td>

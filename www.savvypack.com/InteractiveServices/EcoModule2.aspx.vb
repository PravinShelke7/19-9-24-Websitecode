...
Partial Class InteractiveServices_EcoModule2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            End If
            hdnRepId.Value = ObjCrypto.Encrypt("ECONMO2")
    ...
    Public Sub GetInventoryDetails()
        ...
        Try
            dsInventory = objGetData.GetInventoryDetails("ECONMO2")
    ...
    Protected Sub imgbtnOrder_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnOrder.Click
        Try
            Dim ObjCrypto As New CryptoHelper()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "_New", " window.open('../ShoppingCart/Order.aspx?Id=" + ObjCrypto.Encrypt("ECONMO2") + "');", True)

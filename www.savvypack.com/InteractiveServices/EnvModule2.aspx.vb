...
Partial Class InteractiveServices_EnvModule2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            End If
            hdnRepId.Value = ObjCrypto.Encrypt("ENVIRMO2")
    ...
    Public Sub GetInventoryDetails()
        ...
        Try
            dsInventory = objGetData.GetInventoryDetails("ENVIRMO2")
    ...
    Protected Sub imgbtnOrder_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnOrder.Click
        Try
            Dim ObjCrypto As New CryptoHelper()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "_New", " window.open('../ShoppingCart/Order.aspx?Id=" + ObjCrypto.Encrypt("ENVIRMO2") + "');", True)

        Catch ex As Exception
            lblError.Text = "Error:lnkOrder_Click:" + ex.Message.ToString()
        End Try
    End Sub

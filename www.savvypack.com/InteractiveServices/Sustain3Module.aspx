<%@ Page Language="VB" MasterPageFile="~/Masters/AlliedMasterMenu.master" AutoEventWireup="false" CodeFile="Sustain3Module.aspx.vb" Inherits="InteractiveServices_Sustain3Module" title="Environmental Analysis - Sustain3" %>
            ...
            <tr>
                <td colspan="2">
                    <span style="font-weight: bold; color: Black; font-family: Verdana; font-size: 15px;">
                        Sustain3 - the package manufacturing module</span>
                </td>
            </tr>
            <tr>
                <td style="font-weight: 500; color: Black; font-family: Optima; font-size: 16px;
                    ...
                    <span>
                        <font face="Verdana"><font size="2">
                                The SavvyPack® System is a subscription based online software and content system 
                                for packaging. The system provides the capability to conduct economic and environmental
                                 analysis of ALL packaging types. Pre-researched data is available in the SavvyPack® database, 
                                 which saves users valuable time and money.
                         </font></font>
                    </span>
                </td>
            </tr>
             <tr>
                <td style="font-weight: 500; color: Black; font-family: Optima; font-size: 16px;
                    ...
                    <span>
                        <font face="Verdana"><font size="2">
                               SUSTAIN3 interfaces simultaneously with many Sustain1 cases. 
                               You can compare assumptions, compare results, create graphics, 
                               create tables, and many others.
                         </font></font>
                    </span>
                </td>
            </tr>

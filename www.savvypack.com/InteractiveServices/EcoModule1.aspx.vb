...
Partial Class InteractiveServices_EcoModule1
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            End If
            'Set Report Id
            hdnRepId.Value = ObjCrypto.Encrypt("ECONMO1")
    ...
    Public Sub GetInventoryDetails()
        ...
        Try
            dsInventory = objGetData.GetInventoryDetails("ECONMO1")
    ...
    Protected Sub imgbtnOrder_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles imgbtnOrder.Click
        Try
            Dim ObjCrypto As New CryptoHelper()
            Page.ClientScript.RegisterStartupScript(Me.GetType(), "_New", " window.open('../ShoppingCart/Order.aspx?Id=" + ObjCrypto.Encrypt("ECONMO1") + "');", True)

<%@ Page Language="VB" MasterPageFile="~/Masters/AlliedMasterMenu.master" AutoEventWireup="false"
    CodeFile="EcoModule1.aspx.vb" Inherits="InteractiveServices_EcoModule1" Title="Economic Analysis - Econ1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function OpenOrderPage()
   {
     ...
     OpenNewWindow('../ShoppingCart/Order.aspx?Id=' + reportId ,'ECON1');
            ...
            <tr>
                <td colspan="2">
                    <span style="font-weight: bold; color: Black; font-family: Verdana; font-size: 15px;">
                        Econ1 - the package manufacturing module</span>
                </td>
            </tr>
            <tr>
                <td style="font-weight: 500; color: Black; font-family: Optima; font-size: 16px;
                    ...
                    <span>
                        <font face="Verdana"><font size="2">The packaging manufacturing module is a combination
                            ...
                            of the packaging production industry. </font></font>
                    </span>
                </td>
            </tr>
            <tr>
                            ...
                            <asp:Label ID="lblPDate" runat="Server"></asp:Label></li><li style="margin-top: 3px;">
                                ...
                                <asp:Label ID="lblSNo" runat="Server"></asp:Label></li><li style="margin-top: 3px;">
                                    ...
                                    <asp:Label ID="lblCopyR" runat="Server"></asp:Label></li><li style="margin-top: 3px;">
                                        ...
                                        <asp:Label ID="lblS1" runat="Server"></asp:Label></li>
                                        </ul> 
                </td>
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <asp:ImageButton ImageUrl="~/Images/OrderButton.jpg" ID="imgbtnOrder" runat="Server" Visible="false"   OnClientClick="return ConfirmMessage('OS');"
                                    ToolTip="Order Econ1"></asp:ImageButton>
                            </td>
                        </tr>
                    </table>
                </td>

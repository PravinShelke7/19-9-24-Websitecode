<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ErrorU.aspx.vb" Inherits="Universal_loginN_Pages_ErrorU" %>
...
<body>
    <form id="form1" runat="server">
        <div id="MasterContent">
            <div id="AlliedLogo">
                <asp:Image ImageAlign="AbsMiddle" ID="imgLogo" ImageUrl="~/Images/SavvyPackLogoB.gif" Height="45px"
                    runat="server" />
            </div>
            <div>

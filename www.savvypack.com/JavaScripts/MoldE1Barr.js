...
function CheckForMaterialPageBarrierNew(MasterId, Mat, Thick, Dep, DepName, OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL) {
    ...
    var IsDep;
    //Numeric Check
     var radbarr = document.getElementById("ctl00_MoldEcon1ContentPlaceHolder_hidBarrier").value;
     //alert(radbarr);
    if (radbarr == "0") {
...
//alert(IsTemp);
        if (!IsTemp) 
        {
            ...
            {
                //alert('wwwwww');
                inlineMsgBarrier("ctl00_MoldEcon1ContentPlaceHolder_txtOTRTemp", "Please enter a value between 32 and 122 Fahrenheit.");
            }
            else 
            {
                inlineMsgBarrier("ctl00_MoldEcon1ContentPlaceHolder_txtOTRTemp", "Please enter a value between 0 and 50 celsius");
            }
        }
    ...
    if (IsTemp) 
    {
        ...
        if (!IsTemp1) 
        {
            ...
            if (UIDVAL == "0") {
                inlineMsgBarrier("ctl00_MoldEcon1ContentPlaceHolder_txtWVTRTemp", "Please enter a value between 32 and 122 Fahrenheit.");
            }
            else {
                inlineMsgBarrier("ctl00_MoldEcon1ContentPlaceHolder_txtWVTRTemp", "Please enter a value between 0 and 50 celsius");
            }
    ...
    if (IsTemp1) {
        ...
        if (!IsRH) 
        {
            ...
            inlineMsgBarrier("ctl00_MoldEcon1ContentPlaceHolder_txtOTRHumidity", "Please enter a value between 0% and 100%.");
    ...
    if (IsRH) {
        ...
        if (!IsRH2) {
            ...
            inlineMsgBarrier("ctl00_MoldEcon1ContentPlaceHolder_txtWVTRHumidity", "Please enter a value between 90% and 100%.");

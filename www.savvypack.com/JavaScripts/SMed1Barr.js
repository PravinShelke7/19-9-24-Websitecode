...
function inlineMsgB(target, string, autohide) {
   ...
   // topposition = topposition - 20;
    ...
    function CheckForMaterialPageBarr(MasterId, Mat, Thick, ShipUnit, ShipSel, ShipSelName, Dep, DepName, divVariable, rdScrollOff,OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL) {
        ...
        //Numeric Check
        var radbarr = document.getElementById("ctl00_SMed1ContentPlaceHolder_hidBarrier").value;
    ...
    function CheckForBarrierPageNew(MasterId, OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL) {
        ...
        //    alert(OTRTEMPValL + '-' + OTRTEMPValH);
            ...
            if (!IsTemp) {
                istemp = false;
                if (UIDVAL == "0") {
                    inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtOTRTemp", "Please enter a value between 32 and 122 Fahrenheit.");
                }
                else {
                    inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtOTRTemp", "Please enter a value between 0 and 50 celsius");
                }
            }
        ...
        if (IsTemp) {
            ...
            if (!IsTemp1) {
                ...
                if (UIDVAL == "0") {
                    inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtWVTRTemp", "Please enter a value between 32 and 122 Fahrenheit.");
                }
                else {
                    inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtWVTRTemp", "Please enter a value between 0 and 50 celsius");
                }
                //inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtWVTRTemp", "Update did not complete.Please enter proper Temprature.");
        ...
        if (IsTemp1) {
            ...
            if (!IsRH) {
                ...
                inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtOTRHumidity", "Please enter a value between 0% and 100%.");
        ...
        if (IsRH) {
            ...
            if (!IsRH2) {
                ...
                inlineMsgBarrier("ctl00_SMed1ContentPlaceHolder_txtWVTRHumidity", "Please enter a value between 90% and 100%.");

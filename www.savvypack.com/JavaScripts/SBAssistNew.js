...
function CheckForMaterialPageData(MasterId, MasterId1, Mat, Thick, OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL1, RHVAL2, RHTEMPVAL1) 
{
    var tabid = MasterId + "_hdnTabNum";
    var tabNum = document.getElementById(tabid).value;
   // alert(tabNum);
    if (tabNum == "0") {
        return CheckForMaterialPageNew(MasterId, MasterId1, Mat, Thick, OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL1, RHVAL2);
    }
    else {
...
function CheckForMaterialPageNew(MasterId, MasterId1, Mat, Thick, OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL1, RHVAL2) {

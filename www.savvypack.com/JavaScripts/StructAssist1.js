...
function checkNumeric2AllWithBarr(MasterId, MasterId1, OTRTEMP, RH, TEMPVAL1, TEMPVAL2, RHVAL1, RHVAL2) {
    ...
    for (var i = 0; i < txtarray.length; i++) {
        if (txtarray[i].type == "text") {
            ...
            var TS1ID = MasterId1 + "_TS1Val" + k2;
            var TS2ID = MasterId1 + "_TS2Val" + k9;
            var BOTRID = MasterId1 + "_BOTR" + k3 + "_" + k4;
            var BWVTRID = MasterId1 + "_BWVTR" + k5 + "_" + k6;
            var BTS1ID = MasterId1 + "_BTS1Val" + k7 + "_" + k8;
            var BTS2ID = MasterId1 + "_BTS2Val" + k10 + "_" + k11;
            ...
            if (txtarray[i].value.match(/\S/)) {
                ...
                if (IsNumeric(txtarray[i].value.replace(/,/g, ""))) {
                    ...
                    else if (TS1ID == id)//check for Preferred Price Textboxes
                    {
                        k2 = k2 + 1;
                        flag = true;
                    }
                    else if (TS2ID == id)//check for Preferred Price Textboxes
                    {
                        k9 = k9 + 1;
                        flag = true;
                    }
                    ...
                    else if (BTS1ID == id)//check for Preferred Price Textboxes
                    {
                        if (k8 == 1) {
                            k8 = k8 + 1;
                        }
                    ...
                    else if (BTS2ID == id)//check for Preferred Price Textboxes
                    {
                        if (k11 == 1) {
                            k11 = k11 + 1;
                        }

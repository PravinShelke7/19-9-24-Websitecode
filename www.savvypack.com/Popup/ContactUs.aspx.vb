...
Partial Class Popup_ContactUs
    ...
    Protected Function GetEmailBodyData(ByVal fName As String, ByVal lName As String, ByVal EMAILADDRESS As String) As String
        ...
        Try
            ...
            StrSqlBody = StrSqlBody + "<p>Dear " + fName + " " + lName + ",<br/><br/>   Thank you for contacting us regarding your interest in SavvyPack®. We have received your request and will respond within 24 hours. </p>"
    ...
    Protected Sub btnClos_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnClos.Click
        Try
            Page.ClientScript.RegisterClientScriptBlock(Me.GetType(), "close", "return ClosePopup();", True)
        Catch ex As Exception

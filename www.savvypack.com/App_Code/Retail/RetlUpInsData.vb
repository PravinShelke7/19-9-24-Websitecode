...
#Region "Case Details"
        Public Sub CaseDesUpdate(ByVal CaseId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String)
            Try
                ...
                odbUtil.UpIns(StrSqlUpadate, RetailConnection)
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:CaseDesUpdate:" + ex.Message.ToString())
            End Try
...
#Region "Assumptions"
        Public Sub ExtrusionUpdate(ByVal CaseID As String, ByVal Material() As String, ByVal Weight() As String, ByVal Price() As String, ByVal Recyle() As String, ByVal Extra() As String, ByVal PC() As String, ByVal Dept() As String, ByVal E1Cases() As String, ByVal plate As String, ByVal IsDisUpdate As Boolean)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:ExtrusionUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PrefrencesUpdate(ByVal CaseID As String, ByVal Ocountry As String, ByVal DCountry As String, ByVal Currancy As String, ByVal Units As String, ByVal Effdate As String, ByVal PVOLUSE As String, ByVal ErgyCalc As String)
            ...
            Try
                ...
                odbUtil.UpIns(StrSql, RetailConnection)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:PrefrencesUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub ProductFormatUpdate(ByVal CaseID As String, ByVal M1 As String, ByVal Input() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:ProductFormatUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PalletAndTruckUpdate(ByVal CaseID As String, ByVal Pallet() As String, ByVal Truck() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:PalletAndTruckUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PlantConfigUpdate(ByVal CaseID As String, ByVal DEPTA() As String, ByVal DEPTB() As String, ByVal DEPTC() As String, ByVal DEPTD() As String, ByVal DEPTE() As String, ByVal DEPTF() As String, ByVal DEPTG() As String, ByVal DEPTH() As String, ByVal DEPTI() As String, ByVal DEPTJ() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:PlantConfigUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub EfficiencyUpdate(ByVal CaseID As String, ByVal MATA() As String, ByVal MATB() As String, ByVal MATC() As String, ByVal MATD() As String, ByVal MATE() As String, ByVal MATF() As String, ByVal MATG() As String, ByVal MATH() As String, ByVal MATI() As String, ByVal MATJ() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:EfficiencyUpdate:" + ex.Message.ToString())
            End Try

        End Sub

        Public Sub EquipmentUpdate(ByVal CaseID As String, ByVal hidAssetId() As String, ByVal ASSETP() As String, ByVal PARP() As String, ByVal ECP() As String, ByVal NGCP() As String, ByVal hidAssetDep() As String)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:EquipmentUpdate:" + ex.Message.ToString())
            End Try

        End Sub

        Public Sub SupportEquipmentUpdate(ByVal CaseID As String, ByVal hidAssetId() As String, ByVal ASSETP() As String, ByVal ECP() As String, ByVal NGCP() As String, ByVal hidAssetDep() As String)
            Try
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:SupportEquipmentUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub OperationInUpdate(ByVal CaseID As String, ByVal OMAXRH() As String, ByVal OPINSTR() As String, ByVal DT() As String, ByVal OPWASTE() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:OperationInUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PersonnelInUpdate(ByVal CaseID As String, ByVal PosDes() As String, ByVal NoWorker() As String, ByVal PrefSal() As String, ByVal CostType() As String, ByVal DEPTID() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:PersonnelInUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PlantConfig2Update(ByVal CaseID As String, ByVal AREA() As String, ByVal PrefLease() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:PlantConfig2Update:" + ex.Message.ToString())
            End Try
        ...
        Public Sub EnergyUpdate(ByVal CaseID As String, ByVal ERGPPREF() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:EnergyUpdate:" + ex.Message.ToString())
            End Try

        End Sub

        Public Sub CustomerInUpdate(ByVal CaseID As String, ByVal PRODPUR As String, ByVal SHIPDIST As String, ByVal MILCOST As String, ByVal MFGPRMO As String)
            Try
                ...
                For i = 0 To 3
                    ...
                    ElseIf i = 3 Then
                        itemVal = CDbl(MFGPRMO / Curr)
                        StrSqlIUpadate = StrSqlIUpadate + " M4" + " = " + itemVal.ToString() + ","
                    End If
                Next
                StrSqlIUpadate = StrSqlIUpadate.Remove(StrSqlIUpadate.Length - 1)
                StrSqlUpadate = StrSqlUpadate + StrSqlIUpadate
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:CustomerInUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub FixedCostUpdate(ByVal CaseID As String, ByVal FixedCostVal() As String, ByVal FixedCostPref() As String, ByVal Dept() As String, ByVal depreciate As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:FixedCostUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PalletUpdate(ByVal CaseID As String, ByVal Pallet() As String, ByVal Number() As String, ByVal NoOfUses() As String, ByVal PrefWeight() As String, ByVal PrefPrice() As String, ByVal Dept() As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:PalletUpdate:" + ex.Message.ToString())
            End Try
...
#Region "Results"
        Public Sub ResultsPl(ByVal CaseId As String, ByVal UnitPrice As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:ResultsPl:" + ex.Message.ToString())
            End Try
...
#Region "Notes"
        Public Sub NotesUpdate(ByVal CaseId As String, ByVal AssumptionCode As String, ByVal Notes As String)
            ...
            Catch ex As Exception
                Throw New Exception("RetlUpDateData:NotesUpdate:" + ex.Message.ToString())
            End Try
...
#Region "Wizard"
        Public Function UpdateWizard(ByVal CaseId As String) As Integer
            ...
            Try
                ...
                odbUtil.UpIns(StrSqlUpadate, RetailConnection)
            Catch ex As Exception
                Throw (New Exception("RetlUpDateData:UpdateWizard:" + ex.Message.ToString()))
            End Try
            Return WSessionID
        End Function
#End Region

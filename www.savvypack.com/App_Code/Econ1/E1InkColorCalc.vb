...
Public Class E1InkColorCalc
    Public Class Calculation
        ...
        Public Sub InkColorCalculate(ByVal caseid As String, ByVal UserId As String)
            ...
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    For i = 0 To 9
                        ...
                        If CDbl(colorCode(i)) > 0.0 Then
                            dsColor = GetColors(colorCode(i).ToString(), UserId, caseid)
                        ...
                        If CDbl(colorCode(i)) > 0.0 Then
                            dsPref = GetColorPrefDetails(UserId, colorCode(i).ToString(), caseid)
...
#Region "GetData"
        Protected Function GetColorDetails(ByVal CaseId As Integer) As DataSet
            ...
            End Try
        End Function
        Public Function GetColors(ByVal ColId As Integer, ByVal UserId As String, ByVal CaseId As String) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim ds As New DataSet()
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    StrSql = "SELECT COLORID, (COLORID||'  '||COLORDETAILS.COLORNAME)COLDES,COLORDETAILS.COLORNAME,PMS,  "
                    ...
                    StrSql = StrSql + "ON IP.USERID=" + UserId.ToString() + " "
            ...
            End Try
        End Function
        Public Function GetColorPrefDetails(ByVal UserId As String, ByVal ColId As String, ByVal CaseId As String) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim ds As New DataSet()
            Try
                ...
                If ds.Tables(0).Rows.Count > 0 Then
                    ...
                    StrSql = StrSql + "ON INKP.USERID=" + UserId.ToString() + " "

...
#Region "Equipment"
        Public Function GetPopUpEquipment(ByVal CaseID As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM ECON.EQUIPMENT EQ  "
                ...
                Dts = odbUtil.FillDataSet(StrSql, SustainConnection)
                Return Dts
        ...
        Public Function GetEditEquip(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                ds = odbUtil.FillDataSet(strSql, SustainConnection)
                Return ds
            Catch ex As Exception
...
#Region "UserDetails"
        Public Function GetUserDetails(ByVal Id As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND SERVICES.SERVICEDE='SUSTAIN1' "
...
#Region "Supporting Assumptions Pages"
        ...
        Public Function GetShipingSelector(ByVal shipId As Integer, ByVal shipDes As String) As DataSet
            ...
            Try
                ...
                StrSql = "select shipid, shipdes  "
                StrSql = StrSql + "FROM Shippingselector "
        ...
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim CaseId As String = HttpContext.Current.Session("S1CaseId").ToString()
            Try
                StrSql = "SELECT PROCID,(PROCDE1||'  '||PROCDE2) AS PROCDE,PROCDE1,PROCDE2  "
                StrSql = StrSql + "FROM ECON.PROCESS "
        ...
        Public Function GetDeptN(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetDeptN:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        End Function
		 ...
		 Public Function GetPopupMaterials(ByVal MatId As Integer, ByVal MatDe1 As String, ByVal MatDe2 As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                'StrSql = StrSql + "AND NVL(UPPER(MATDE2),'#') LIKE '" + MatDe2.ToUpper() + "%' "
                'StrSql = StrSql + "ORDER BY  MATDE1)"
                StrSql = "SELECT MAT.MATID, (MAT.MATDE1||'  '||MAT.MATDE2)MATDES,MAT.MATDE1,MAT.MATDE2,B.MATDE3,B.MATDES3,GRADE.GRADENAME,GRADE.GRADEID,GRADE.WEIGHT,MAT.SG   "
                StrSql = StrSql + "FROM ECON.MATERIALS MAT "
                ...
                StrSql = StrSql + "FROM(ECON.MATERIALS)"
                StrSql = StrSql + " INNER JOIN ECON.MATGRADE MG ON MG.MATID=MATERIALS.MATID  "
                StrSql = StrSql + "LEFT JOIN USERSMATERIAL UM ON UM.MATID=MATERIALS.MATID  "
                StrSql = StrSql + "INNER JOIN ECON.GRADE ON GRADE.GRADEID=MG.GRADEID AND GRADE.ISDEFAULT='Y' "
                StrSql = StrSql + "WHERE MATERIALS.MATID = CASE WHEN " + MatId.ToString() + "  = -1 THEN "
                StrSql = StrSql + "MATERIALS.MATID "
                StrSql = StrSql + "ELSE "
                StrSql = StrSql + "" + MatId.ToString() + " "
                ...
                StrSql = StrSql + "INNER JOIN ECON.MATGRADE MG ON MG.MATID=MAT.MATID  "
                StrSql = StrSql + "INNER JOIN ECON.GRADE ON GRADE.GRADEID=MG.GRADEID AND GRADE.ISDEFAULT='Y' "
        ...
        Public Function GetLCIDataByMatAndDate(ByVal InvId As String, ByVal matId As String, ByVal caseId As String, ByVal effDate As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM MATERIALSARCH MATA "
        ...
        Public Function GetLatestLCIDate(ByVal InvId As String) As DataSet
            ...
            Dim StrSql As String = String.Empty
            Try
                StrSql = "SELECT  TO_CHAR(MAX(EFFDATE),'MON DD,YYYY')AS EDATE FROM MATERIALSARCH WHERE INVENTORYTYPE= " + InvId
                Dts = odbUtil.FillDataSet(StrSql, SustainConnection)
                Return Dts
            Catch ex As Exception
        ...
        Public Function GetLCIEffDates() As DataSet
            ...
            Try
                ...
                StrSql = "select TO_CHAR(EFFDATE,'MON DD,YYYY')EDATE from MATERIALSARCH,InventoryType Group By EffDate"
                Dts = odbUtil.FillDataSet(StrSql, SustainConnection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetEffDate:" + ex.Message.ToString())
...
#Region "Assumptions Pages"
        ...
        Public Function GetExtrusionDetailsSugg(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM MATERIALINPUT MAT "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT1 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT2 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT3 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT4 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT5 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT6 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT7 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT8 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT9 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MAT10 "
        ...
        Public Function GetRWPalletMat(ByVal CaseId As Integer, ByVal Col As String) As DataSet
            ...
            Dim ds As New DataSet()
            Try
                StrSql = "SELECT MATS.MATID,(MATS.MATDE1||' ' ||MATS.MATDE2)MATDES, "
                StrSql = StrSql + "(CASE WHEN MAT.M" + Col + "=0 THEN '' ELSE (SELECT UM.MATDES FROM USERSMATERIAL UM"
                StrSql = StrSql + " INNER JOIN MATERIALINPUT MAT ON UM.MATID=MAT.M" + Col + " AND UM.CASEID=MAT.CASEID  WHERE MAT.CASEID=" + CaseId.ToString() + " ) END) AS UMDES "

                StrSql = StrSql + "FROM MATERIALINPUT MAT "
                StrSql = StrSql + "INNER JOIN ECON.MATERIALS MATS "
                StrSql = StrSql + "ON MATS.MATID=MAT.M" + Col + " "

                StrSql = StrSql + "WHERE MAT.CASEID=" + CaseId.ToString() + ""
                ds = objDBUtil.FillDataSet(StrSql, SustainConnection)
            Catch ex As Exception
        ...
        Public Function GetRWPalletInSugg(ByVal CaseId As Integer, ByVal Col As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH1 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH2 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH3 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH4 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH5 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH6 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH7 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH8 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH9 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PARCH10 "
        ...
        Public Function GetMaterialsSource(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M1=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES1, "
                StrSql = StrSql + "(CASE WHEN MAT.M2= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M2=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES2, "
                StrSql = StrSql + "(CASE WHEN MAT.M3= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M3=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES3, "
                StrSql = StrSql + "(CASE WHEN MAT.M4= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M4=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES4, "
                StrSql = StrSql + "(CASE WHEN MAT.M5= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M5=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES5, "
                StrSql = StrSql + "(CASE WHEN MAT.M6= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M6=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES6, "
                StrSql = StrSql + "(CASE WHEN MAT.M7= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M7=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES7, "
                StrSql = StrSql + "(CASE WHEN MAT.M8= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M8=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES8, "
                StrSql = StrSql + "(CASE WHEN MAT.M9= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M9=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
                StrSql = StrSql + " END) AS MATDES9, "
                StrSql = StrSql + "(CASE WHEN MAT.M10= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                StrSql = StrSql + " (SELECT MATDES FROM USERSMATERIAL INNER JOIN MATERIALINPUT MAT ON MAT.M10=USERSMATERIAL.MATID AND MAT.CASEID=USERSMATERIAL.CASEID WHERE  MAT.CASEID=" + CaseId.ToString() + ") "
        ...
        Public Function GetPalletInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT1 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT2 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT3 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT4 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT5 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT6 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT7 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT8 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT9 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN PALLETARCH PAT10 "
        ...
        Public Function GetEffiencyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
				...
				StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M1= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES1, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M2= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES2, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M3= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES3, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M4= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES4, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M5= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES5, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M6= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES6, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M7= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES7, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M8= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES8, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M9= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + " END) AS MATDES9, "
                StrSql = StrSql + "(CASE WHEN MATERIALINPUT.M10= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
        ...
        Public Function GetOperationInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                'END BUG#344
                'Equipment Label
                StrSql = StrSql + ",(CASE WHEN EQUIPMENTTYPE.M1= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M2= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M3= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M4= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M5= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M6= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M7= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M8= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M9= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M10= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M11= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M12= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M13= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M14= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M15= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M16= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M17= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M18= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M19= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M20= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M21= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M22= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M23= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M24= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M25= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M26= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M27= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M28= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M29= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQUIPMENTTYPE.M30= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
 ...
 Dim Dsc As New DataSet()
            Try
 StrSql = "SELECT OCOUNTRY FROM PREFERENCES WHERE CASEID=" + CaseId.ToString() + ""
                Dsc = odbUtil.FillDataSet(StrSql, SustainConnection)
                ...
                StrSql = StrSql + "PREF.TITLE12, "
                StrSql = StrSql + "PREF.UNITS, "
                 StrSql = StrSql + "CASE WHEN PREF.OCOUNTRY = " + Dsc.Tables(0).Rows(0).Item("OCOUNTRY").ToString() + " THEN 'PERSONNELALL' ELSE 'NOCOUNTRY' END COUNTRY "
                StrSql = StrSql + "FROM "
        ...
        Public Function GetCaseViewer(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC1 "
                StrSql = StrSql + "ON PROC1.PROCID = PLANTCONFIG.M1 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC2 "
                StrSql = StrSql + "ON PROC2.PROCID = PLANTCONFIG.M2 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC3 "
                StrSql = StrSql + "ON PROC3.PROCID = PLANTCONFIG.M3 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC4 "
                StrSql = StrSql + "ON PROC4.PROCID = PLANTCONFIG.M4 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC5 "
                StrSql = StrSql + "ON PROC5.PROCID = PLANTCONFIG.M5 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC6 "
                StrSql = StrSql + "ON PROC6.PROCID = PLANTCONFIG.M6 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC7 "
                StrSql = StrSql + "ON PROC7.PROCID = PLANTCONFIG.M7 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC8 "
                StrSql = StrSql + "ON PROC8.PROCID = PLANTCONFIG.M8 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC9 "
                StrSql = StrSql + "ON PROC9.PROCID = PLANTCONFIG.M9 "
                StrSql = StrSql + "INNER JOIN ECON.PROCESS PROC10 "
...
#Region "Intermediate result Pages"
        ...
        Public Function GetPalletInNewout(ByVal CaseId As Integer, ByVal Col As String) As DataSet
            ...
            Try
                StrSql = "SELECT  "
                StrSql = StrSql + "PNEWOUT.CASEID, MAT" + Col + ".MATID,"
                StrSql = StrSql + "(CASE WHEN MATIN.M" + Col + "=0 THEN '' ELSE (SELECT UM.MATDES FROM USERSMATERIAL UM INNER JOIN MATERIALINPUT MAT ON UM.MATID=MAT.M" + Col + " AND UM.CASEID=MAT.CASEID  WHERE MAT.CASEID=" + CaseId.ToString() + " ) END) AS UMDES,"
                ...
                StrSql = StrSql + "INNER JOIN ECON.MATERIALS MAT" + Col
        ...
        Public Function GetPalletInout(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                'StrSql = StrSql + "AND PERMISSIONSCASES.USERNAME ='Administrator' "
                'StrSql = StrSql + ") "
...
#Region "Case Grouping:"
        Public Function GetPCaseGrpDetails(ByVal UserID As String, ByVal keyWord As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM ECON.GROUPS "
                StrSql = StrSql + "INNER JOIN ECON.GROUPCASES "
        ...
        Public Function GetGroupDetails(ByVal UserID As String, ByVal flag As Char) As DataSet
            ...
            End Try
        End Function
        Public Function GetPerBaseCases1(ByVal UserName As String) As DataTable
            ...
            Try
                ...
                Dts = odbUtil.FillDataTable(StrSql, SustainConnection)
                Return Dts
            Catch ex As Exception
        ...
        Public Function GetPCaseDetailsByGroup(ByVal UserId As String, ByVal grpId As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + " INNER JOIN ECON.GROUPCASES ON GROUPCASES.CASEID=PERMISSIONSCASES.CASEID "
                ...
                StrSql = StrSql + " AND PERMISSIONSCASES.CASEID IN(SELECT CASEID FROM ECON.GROUPCASES WHERE GROUPID =" + grpId + ")"
                StrSql = StrSql + "ORDER BY UPPER(CASEDE1),CASEID "
...
#Region "Bemis"
        ...
        Public Function GetApprovedCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetApprovedCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetStatusDetailsByID(ByVal CaseId As String, ByVal UserName As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "CASEID = " + CaseId + " AND UPPER(USERS.USERNAME)='" + UserName.ToString().ToUpper() + "' ORDER BY DATED ASC "
        ...
        Public Function GetPermissionStatus(ByVal CaseId As Integer, ByVal UserId As String) As DataSet
            Try
                ...
                StrSql = StrSql + "WHERE CASEID=" + CaseId.ToString() + " AND ACTIONBY=" + UserId.ToString() + " "
                Dts = odbUtil.FillDataSet(StrSql, SustainConnection)
                Return Dts
            Catch ex As Exception
        ...
        Public Function GetUserCompanyUsersBem(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "ON SERVICES.SERVICEID = USERPERMISSIONS.SERVICEID "
                'StrSql = StrSql + "WHERE USERS.LICENSEID=(SELECT LICENSEID FROM USERS WHERE UPPER(USERNAME)='" + UserName.ToUpper.ToString() + "') "
                StrSql = StrSql + "WHERE USERS.LICENSEID=(SELECT LICENSEID FROM USERS WHERE USERID=" + UserId.ToString() + ") "
...
Public Function GetAllGradesVal(ByVal GRADEID As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetAllGradesVal:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Edit Material Name"
        ...
        Public Function GetEditMaterial(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return ds
            Catch ex As Exception
                Throw New Exception("S1GetData:GetEditMaterial:" + ex.Message.ToString())
                Return ds
            End Try
        End Function
#End Region
...
#Region "Bulk Model Tool"
        ...
        Public Function GetGroupCasesBMM(ByVal GroupId As String, ByVal USERID As String) As DataSet
            ...
            Try
                If GroupId = "0" Then
                    ...
                    StrSql = StrSql + "FROM ECON.GROUPS "
                    StrSql = StrSql + "INNER JOIN ECON.GROUPCASES ON GROUPS.GROUPID=GROUPCASES.GROUPID "
                    ...
                    StrSql = StrSql + "WHERE "
                    StrSql = StrSql + "GRPS.GROUPID IN (SELECT GROUPID FROM ECON.GROUPS WHERE USERID=" + USERID + ") AND PR.USERID=" + USERID
                    'End
        ...
        Public Function GetAllCases(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "LEFT JOIN ECON.GROUPCASES GC ON GC.CASEID=PR.CASEID  "
                StrSql = StrSql + "WHERE PR.USERID='" + USERID + "'"
                Ds = odbUtil.FillDataSet(StrSql, SustainConnection)
                Return Ds
            Catch ex As Exception

...
#Region "Equipment"
        Public Function GetEditEquip(ByVal CaseId As String) As DataSet
            ...
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEditEquip:" + ex.Message.ToString())
                Return ds
            End Try
        End Function
        Public Function GetPopUpEquipment(ByVal CaseID As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM ECON2.EQUIPMENT EQ  "
                ...
                Dts = odbUtil.FillDataSet(StrSql, Sustain2Connection)
                Return Dts
            Catch ex As Exception
...
#Region "Supporting Assumptions Pages"
        ...
        Public Function GetBCaseDetails() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetBCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPCaseDetails(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSelectedUserDetails(ByVal UserId As String, ByVal Schema As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetSelectedUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetBCases(ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetBCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseViewer(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC1 "
                StrSql = StrSql + "ON PROC1.PROCID = PLANTCONFIG.M1 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC2 "
                StrSql = StrSql + "ON PROC2.PROCID = PLANTCONFIG.M2 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC3 "
                StrSql = StrSql + "ON PROC3.PROCID = PLANTCONFIG.M3 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC4 "
                StrSql = StrSql + "ON PROC4.PROCID = PLANTCONFIG.M4 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC5 "
                StrSql = StrSql + "ON PROC5.PROCID = PLANTCONFIG.M5 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC6 "
                StrSql = StrSql + "ON PROC6.PROCID = PLANTCONFIG.M6 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC7 "
                StrSql = StrSql + "ON PROC7.PROCID = PLANTCONFIG.M7 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC8 "
                StrSql = StrSql + "ON PROC8.PROCID = PLANTCONFIG.M8 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC9 "
                StrSql = StrSql + "ON PROC9.PROCID = PLANTCONFIG.M9 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS PROC10 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetCaseViewer:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetMaterials(ByVal MatId As Integer, ByVal MatDe1 As String, ByVal MatDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetMaterials:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSustain1Cases(ByVal CaseIdS1 As Integer, ByVal CaseIdS2 As Integer, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal UserId As String) As DataSet
            ...
            Try
                If CaseIdS2 >= 1000 Then
                    If CaseIdS1 = -1 And CaseDe1 <> "Nothing" And CaseDe1 <> "Selected" Then
                        ...
                        StrSql = StrSql + "FROM PermissionsCases "
                        StrSql = StrSql + "WHERE PermissionsCases.USERID=" + UserId.ToString() + " AND NVL(UPPER(Casede1),'#') LIKE '" + CaseDe1.ToUpper() + "%' "
                    ...
                    Else
                        StrSql = "SELECT CaseId, (Casede1||'  '||Casede2)CASDES,Casede1,Casede2  "
                        StrSql = StrSql + "FROM PermissionsCases "
                        StrSql = StrSql + "WHERE PermissionsCases.USERID=" + UserId.ToString() + " AND CaseId = CASE WHEN " + CaseIdS1.ToString() + " = -1 THEN "
                        'StrSql = StrSql + "WHERE Upper(Username)='" + userName.ToUpper() + "' AND CaseId = CASE WHEN " + CaseIdS1.ToString() + " = -1 THEN "
            ...
            Catch ex As Exception
                Throw New Exception("S2GetData:GetSustain1Cases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String) As DataSet
            ...
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim CaseId As String = HttpContext.Current.Session("S2CaseId").ToString()
            Try
                StrSql = "SELECT PROCID,(PROCDE1||'  '||PROCDE2) AS PROCDE,PROCDE1  "
                StrSql = StrSql + "FROM ECON2.PROCESS "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetDept:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetProductFormt(ByVal FormtId As Integer, ByVal FormtDe1 As String, ByVal FormtDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetProductFormat:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPallets(ByVal PalletId As Integer, ByVal PalDe1 As String, ByVal PalDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPallets:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSustainableMaterial(ByVal TYPEID As Integer, ByVal TYPE As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetSustainableMaterial:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDeptPlantConfig(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetDeptPlantConfig:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetSupportEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEFFCOUNTRY(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetExtrusionDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInfo(ByVal PersId As Integer, ByVal PersDe1 As String, ByVal PersDe2 As String, ByVal Country As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPersonnelInfo:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetUserCompanyUsers(ByVal UserName As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetUserCompanyUsers:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffDate(ByVal Inventorytype As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEffDate:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetLCI() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetLCI:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetConversionFactor() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetConversionFactor:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCustomerPageLists() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetCustomerPageLists:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "UserDetails"
        Public Function GetUserDetails(ByVal Id As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND SERVICES.SERVICEDE='SUSTAIN2' "
                Dts = odbUtil.FillDataSet(StrSql, EconConnection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetTotalCaseCount(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetTotalCaseCount:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Notes"
        Public Function GetAssumptionPageDetails(ByVal AssumptionType As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetAssumptionPageDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPageNoteDetails(ByVal AssumptionType As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPageNoteDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseNoteDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetCaseNoteDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Assumptions Pages"
        Public Function GetExtrusionDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT1 "
                StrSql = StrSql + "ON MAT1.MATID=MI.M1 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT2 "
                StrSql = StrSql + "ON MAT2.MATID=MI.M2 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT3 "
                StrSql = StrSql + "ON MAT3.MATID=MI.M3 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT4 "
                StrSql = StrSql + "ON MAT4.MATID=MI.M4 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT5 "
                StrSql = StrSql + "ON MAT5.MATID=MI.M5 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT6 "
                StrSql = StrSql + "ON MAT6.MATID=MI.M6 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT7 "
                StrSql = StrSql + "ON MAT7.MATID=MI.M7 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT8 "
                StrSql = StrSql + "ON MAT8.MATID=MI.M8 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT9 "
                StrSql = StrSql + "ON MAT9.MATID=MI.M9 "
                StrSql = StrSql + "INNER JOIN ECON2.MATERIALS MAT10 "
        ...
        Public Function GetProductFromatIn(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECON2.PRODUCTFORMAT "
                StrSql = StrSql + "ON PRODUCTFORMAT.FORMATID = PF.M1 "
                StrSql = StrSql + "AND PREF.UNITS = 0 "
                StrSql = StrSql + "LEFT OUTER JOIN ECON2.PRODUCTFORMAT2 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetProductFromatIn:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletAndTruck(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPalletAndTruck:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPalletInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfigDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPlantConfigDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffiencyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM PLANTCONFIG PC "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P1 "
                StrSql = StrSql + "ON P1.PROCID=PC.M1 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P2 "
                StrSql = StrSql + "ON P2.PROCID=PC.M2 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P3 "
                StrSql = StrSql + "ON P3.PROCID=PC.M3 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P4 "
                StrSql = StrSql + "ON P4.PROCID=PC.M4 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P5 "
                StrSql = StrSql + "ON P5.PROCID=PC.M5 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P6 "
                StrSql = StrSql + "ON P6.PROCID=PC.M6 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P7 "
                StrSql = StrSql + "ON P7.PROCID=PC.M7 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P8 "
                StrSql = StrSql + "ON P8.PROCID=PC.M8 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P9 "
                StrSql = StrSql + "ON P9.PROCID=PC.M9 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS P10 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEffiencyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ1 "
                StrSql = StrSql + "ON EQ1.EQUIPID=EQT.M1 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ2 "
                StrSql = StrSql + "ON EQ2.EQUIPID=EQT.M2 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ3 "
                StrSql = StrSql + "ON EQ3.EQUIPID=EQT.M3 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ4 "
                StrSql = StrSql + "ON EQ4.EQUIPID=EQT.M4 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ5 "
                StrSql = StrSql + "ON EQ5.EQUIPID=EQT.M5 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ6 "
                StrSql = StrSql + "ON EQ6.EQUIPID=EQT.M6 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ7 "
                StrSql = StrSql + "ON EQ7.EQUIPID=EQT.M7 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ8 "
                StrSql = StrSql + "ON EQ8.EQUIPID=EQT.M8 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ9 "
                StrSql = StrSql + "ON EQ9.EQUIPID=EQT.M9 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ10 "
                StrSql = StrSql + "ON EQ10.EQUIPID=EQT.M10 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ11 "
                StrSql = StrSql + "ON EQ11.EQUIPID=EQT.M11 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ12 "
                StrSql = StrSql + "ON EQ12.EQUIPID=EQT.M12 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ13 "
                StrSql = StrSql + "ON EQ13.EQUIPID=EQT.M13 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ14 "
                StrSql = StrSql + "ON EQ14.EQUIPID=EQT.M14 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ15 "
                StrSql = StrSql + "ON EQ15.EQUIPID=EQT.M15 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ16 "
                StrSql = StrSql + "ON EQ16.EQUIPID=EQT.M16 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ17 "
                StrSql = StrSql + "ON EQ17.EQUIPID=EQT.M17 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ18 "
                StrSql = StrSql + "ON EQ18.EQUIPID=EQT.M18 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ19 "
                StrSql = StrSql + "ON EQ19.EQUIPID=EQT.M19 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ20 "
                StrSql = StrSql + "ON EQ20.EQUIPID=EQT.M20 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ21 "
                StrSql = StrSql + "ON EQ21.EQUIPID=EQT.M21 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ22 "
                StrSql = StrSql + "ON EQ22.EQUIPID=EQT.M22 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ23 "
                StrSql = StrSql + "ON EQ23.EQUIPID=EQT.M23 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ24 "
                StrSql = StrSql + "ON EQ24.EQUIPID=EQT.M24 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ25 "
                StrSql = StrSql + "ON EQ25.EQUIPID=EQT.M25 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ26 "
                StrSql = StrSql + "ON EQ26.EQUIPID=EQT.M26 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ27 "
                StrSql = StrSql + "ON EQ27.EQUIPID=EQT.M27 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ28 "
                StrSql = StrSql + "ON EQ28.EQUIPID=EQT.M28 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ29 "
                StrSql = StrSql + "ON EQ29.EQUIPID=EQT.M29 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT EQ30 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEquipmentDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ1 "
                StrSql = StrSql + "ON EQ1.EQUIPID=EQT.M1 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ2 "
                StrSql = StrSql + "ON EQ2.EQUIPID=EQT.M2 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ3 "
                StrSql = StrSql + "ON EQ3.EQUIPID=EQT.M3 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ4 "
                StrSql = StrSql + "ON EQ4.EQUIPID=EQT.M4 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ5 "
                StrSql = StrSql + "ON EQ5.EQUIPID=EQT.M5 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ6 "
                StrSql = StrSql + "ON EQ6.EQUIPID=EQT.M6 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ7 "
                StrSql = StrSql + "ON EQ7.EQUIPID=EQT.M7 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ8 "
                StrSql = StrSql + "ON EQ8.EQUIPID=EQT.M8 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ9 "
                StrSql = StrSql + "ON EQ9.EQUIPID=EQT.M9 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ10 "
                StrSql = StrSql + "ON EQ10.EQUIPID=EQT.M10 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ11 "
                StrSql = StrSql + "ON EQ11.EQUIPID=EQT.M11 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ12 "
                StrSql = StrSql + "ON EQ12.EQUIPID=EQT.M12 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ13 "
                StrSql = StrSql + "ON EQ13.EQUIPID=EQT.M13 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ14 "
                StrSql = StrSql + "ON EQ14.EQUIPID=EQT.M14 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ15 "
                StrSql = StrSql + "ON EQ15.EQUIPID=EQT.M15 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ16 "
                StrSql = StrSql + "ON EQ16.EQUIPID=EQT.M16 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ17 "
                StrSql = StrSql + "ON EQ17.EQUIPID=EQT.M17 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ18 "
                StrSql = StrSql + "ON EQ18.EQUIPID=EQT.M18 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ19 "
                StrSql = StrSql + "ON EQ19.EQUIPID=EQT.M19 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ20 "
                StrSql = StrSql + "ON EQ20.EQUIPID=EQT.M20 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ21 "
                StrSql = StrSql + "ON EQ21.EQUIPID=EQT.M21 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ22 "
                StrSql = StrSql + "ON EQ22.EQUIPID=EQT.M22 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ23 "
                StrSql = StrSql + "ON EQ23.EQUIPID=EQT.M23 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ24 "
                StrSql = StrSql + "ON EQ24.EQUIPID=EQT.M24 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ25 "
                StrSql = StrSql + "ON EQ25.EQUIPID=EQT.M25 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ26 "
                StrSql = StrSql + "ON EQ26.EQUIPID=EQT.M26 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ27 "
                StrSql = StrSql + "ON EQ27.EQUIPID=EQT.M27 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ28 "
                StrSql = StrSql + "ON EQ28.EQUIPID=EQT.M28 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ29 "
                StrSql = StrSql + "ON EQ29.EQUIPID=EQT.M29 "
                StrSql = StrSql + "INNER JOIN ECON2.EQUIPMENT2 EQ30 "
                StrSql = StrSql + "ON EQ30.EQUIPID=EQT.M30 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetSupportDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetOperationInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetOperationInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
 ...
 StrSql = "SELECT OCOUNTRY FROM PREFERENCES WHERE CASEID=" + CaseId.ToString() + ""
                dsc = odbUtil.FillDataSet(StrSql, Sustain2Connection)
                StrSql = ""
               ...
               StrSql = StrSql + "CASE WHEN PREF.OCOUNTRY = " + dsc.Tables(0).Rows(0).Item("OCOUNTRY").ToString() + " THEN 'PERSONNELALL' ELSE 'NOCOUNTRY' END  COUNTRY "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPersonnelInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfig2Details(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPlantConfig2Details:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEnergyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEnergyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetAdditionalEnergyInfo(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetAdditionalEnergyInfo:" + ex.Message.ToString())
                Return Dts
        ...
        Public Function GetTransportDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetTransportDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetExtraProcessDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetExtraProcessDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Intermediate result Pages"
        Public Function GetExtrusionOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetExtrusionOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetResultsEOLIN(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetResultsEOLIN:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPalletInout(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPalletInout:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetScoreCard(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetScoreCard:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetOperationsOut(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT1 "
                StrSql = StrSql + "ON OPOUT1.PROCID = OPOUT.M1 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT2 "
                StrSql = StrSql + "ON OPOUT2.PROCID = OPOUT.M2 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT3 "
                StrSql = StrSql + "ON OPOUT3.PROCID = OPOUT.M3 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT4 "
                StrSql = StrSql + "ON OPOUT4.PROCID = OPOUT.M4 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT5 "
                StrSql = StrSql + "ON OPOUT5.PROCID = OPOUT.M5 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT6 "
                StrSql = StrSql + "ON OPOUT6.PROCID = OPOUT.M6 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT7 "
                StrSql = StrSql + "ON OPOUT7.PROCID = OPOUT.M7 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT8 "
                StrSql = StrSql + "ON OPOUT8.PROCID = OPOUT.M8 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT9 "
                StrSql = StrSql + "ON OPOUT9.PROCID = OPOUT.M9 "
                StrSql = StrSql + "INNER JOIN ECON2.PROCESS OPOUT10 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetOperationsOut:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Results Pages"
        Public Function GetEnergyResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEnergyResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEOLResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetEOLResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetScoreCardResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetScoreCardResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetGhgResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetGhgResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetWaterResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetWaterResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        'Water End
...
#Region "Error"
        Public Function GetErrors(ByVal ErrorCode As String) As DataSet
            ...
            Try
                ...
                MyConnectionString = System.Configuration.ConfigurationManager.AppSettings("Sustain2ConnectionString")
                Dim StrSql As String = ""
...
#Region "Charts"
        Public Function GetChartErgyRes(ByVal CaseId1 As String, ByVal CaseId2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetChartErgyRes:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartGhgRes(ByVal CaseId1 As String, ByVal CaseId2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetChartGhgRes:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartErgy() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetChartErgy:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartGhg() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetChartGhg:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartPref(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetChartPref:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "LicenseAdministrator"
        Public Function GetPCaseDetailsByLicense(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPCaseDetailsByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCasesByLicense(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetCasesByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Case Grouping:"
        ...
        Public Function GetPCaseGrpDetails(ByVal UserID As String, ByVal keyWord As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM ECON2.GROUPS "
                StrSql = StrSql + "INNER JOIN ECON2.GROUPCASES "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPCaseGrpDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetGroupIDByUSer(ByVal UserID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetGroupIDByUSer:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPCaseDetailsByGroup(ByVal UserId As String, ByVal grpId As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + " INNER JOIN ECON2.GROUPCASES ON GROUPCASES.CASEID=PERMISSIONSCASES.CASEID "
                ...
                StrSql = StrSql + " AND PERMISSIONSCASES.CASEID IN(SELECT CASEID FROM ECON2.GROUPCASES WHERE GROUPID =" + grpId + ")"
                StrSql = StrSql + "ORDER BY UPPER(CASEDE1),CASEID "

                Dts = odbUtil.FillDataSet(StrSql, Sustain2Connection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPCaseDetailsByGroup:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Bemis"
        Public Function GetStatusForSister(ByVal Schema As String, ByVal CaseId As String, ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetStatusDetailsByID:" + ex.Message.ToString())
            End Try
        End Function
        ...
        Public Function GetPropCasesById(ByVal UserId As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPropCasesById:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPropCaseStatus(ByVal UserId As String) As String
            ...
            Try
                ...
                Return CaseIds
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPropCaseStatus:" + ex.Message.ToString())
                Return CaseIds
            End Try
        End Function
        Public Function GetPropDisAppStatus(ByVal UserId As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                'StrSql = StrSql + "WHERE UPPER(USERNAME)='" + UserName.ToUpper().ToString() + "' AND CASEID=" + CaseId.ToString() + " AND UPPER(STATUS)='APPROVED' ORDER BY DATED ASC "
                Dts = odbUtil.FillDataSet(StrSql, Sustain2Connection)
                If Dts.Tables(0).Rows.Count > 0 Then
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPropDisAppStatus:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPropCasesByLicense(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetPropCasesByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPermissionStatus(ByVal CaseId As Integer, ByVal UserId As String) As DataSet
            Try
                ...
                StrSql = StrSql + "WHERE CASEID=" + CaseId.ToString() + " AND ACTIONBY=" + UserId.ToString() + " ORDER BY DATED ASC  "
                Dts = odbUtil.FillDataSet(StrSql, Sustain2Connection)
                Return Dts
            Catch ex As Exception
        ...
        Public Function GetUserCompanyUsersBem(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S2GetData:GetUserCompanyUsersBem:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region

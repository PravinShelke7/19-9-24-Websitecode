...
#Region "Equipment"
        Public Function GetEditEquip(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                ds = odbUtil.FillDataSet(strSql, Schem1Connection)
                Return ds
            ...
            End Try
        End Function
        Public Function GetPopUpEquipment(ByVal CaseID As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
                StrSql = "SELECT DISTINCT EQ.EQUIPID, (EQ.EQUIPDE1||'  '||EQ.EQUIPDE2)EQUIPDES,EQ.EQUIPDE1,EQ.EQUIPDE2 , EQUIPDES ELabel "
                StrSql = StrSql + "FROM Echem1.EQUIPMENT EQ  "
                ...
                Dts = odbUtil.FillDataSet(StrSql, Schem1Connection)
                Return Dts
            Catch ex As Exception
...
#Region "Supporting Assumptions Pages"
        ...
        Public Function GetBCaseDetails() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetBCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPCaseDetails(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCases(ByVal USERID As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetBCases(ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetBCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseViewer(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC1 "
                StrSql = StrSql + "ON PROC1.PROCID = PLANTCONFIG.M1 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC2 "
                StrSql = StrSql + "ON PROC2.PROCID = PLANTCONFIG.M2 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC3 "
                StrSql = StrSql + "ON PROC3.PROCID = PLANTCONFIG.M3 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC4 "
                StrSql = StrSql + "ON PROC4.PROCID = PLANTCONFIG.M4 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC5 "
                StrSql = StrSql + "ON PROC5.PROCID = PLANTCONFIG.M5 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC6 "
                StrSql = StrSql + "ON PROC6.PROCID = PLANTCONFIG.M6 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC7 "
                StrSql = StrSql + "ON PROC7.PROCID = PLANTCONFIG.M7 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC8 "
                StrSql = StrSql + "ON PROC8.PROCID = PLANTCONFIG.M8 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC9 "
                StrSql = StrSql + "ON PROC9.PROCID = PLANTCONFIG.M9 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS PROC10 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetCaseViewer:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetMaterials(ByVal MatId As Integer, ByVal MatDe1 As String, ByVal MatDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetMaterials:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSustain1Cases(ByVal CaseIdS1 As Integer, ByVal CaseIdS2 As Integer, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal USERID As String) As DataSet
            ...
            Try
                If CaseIdS2 >= 1000 Then
                    ...
                    Dts = odbUtil.FillDataSet(StrSql, Sustain1Connection)
                    Return Dts
                Else
                    If CaseIdS1 = -1 Then
                        StrSql = "SELECT CaseId, (Casede1||'  '||Casede2)CASDES,Casede1,Casede2  "
            ...
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetSustain1Cases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String) As DataSet
            ...
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim CaseId As String = HttpContext.Current.Session("Schem1CaseId").ToString()
            Try
                StrSql = "SELECT PROCID,(PROCDE1||'  '||PROCDE2) AS PROCDE,PROCDE1  "
                StrSql = StrSql + "FROM Echem1.PROCESS "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetDept:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetDept:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetSchem1Cases(ByVal CaseIdS1 As Integer, ByVal CaseIdS2 As Integer, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal USERID As String) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
            ...
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetSchem1Cases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPref(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetExtrusionDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetProductFormt(ByVal FormtId As Integer, ByVal FormtDe1 As String, ByVal FormtDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetProductFormat:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPallets(ByVal PalletId As Integer, ByVal PalDe1 As String, ByVal PalDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPallets:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSustainableMaterial(ByVal TYPEID As Integer, ByVal TYPE As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetSustainableMaterial:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDeptPlantConfig(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetDeptPlantConfig:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetSupportEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInfo(ByVal PersId As Integer, ByVal PersDe1 As String, ByVal PersDe2 As String, ByVal Country As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPersonnelInfo:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetUserCompanyUsers(ByVal UserName As String) As DataSet
            ...
            Try
                ...
                'StrSql = StrSql + "(USERCONTACTS.FIRSTNAME||' '||USERCONTACTS.LASTNAME)NAME, "
                'StrSql = StrSql + "USERS.USERNAME "
                'StrSql = StrSql + "FROM USERS "
                'StrSql = StrSql + "INNER JOIN USERS USR "
                'StrSql = StrSql + "ON USR.COMPANY  = USERS.COMPANY "
                'StrSql = StrSql + "LEFT OUTER JOIN USERCONTACTS "
                'StrSql = StrSql + "ON USERCONTACTS.USERID  = USERS.USERID "
                'StrSql = StrSql + "WHERE UPPER(USR.USERNAME)='" + UserName.ToUpper.ToString() + "' "
                ''StrSql = StrSql + " AND Upper(USERS.USERNAME)='" + UserName.ToUpper.ToString() + "' "
                ...
                StrSql = StrSql + "AND SERVICES.SERVICEDE IN ('ECON1','ECON2','SUSTAIN1','SUSTAIN2','ECHEM1','SCHEM1') "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetUserCompanyUsers:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffDate(ByVal Inventorytype As String) As DataSet
            ...
            Dim StrSql As String = String.Empty
            Try
                StrSql = "SELECT DISTINCT TO_CHAR(EFFDATE,'MON DD,YYYY')AS EDATE FROM MATERIALSARCH WHERE INVENTORYTYPE=" + Inventorytype + ""
                Dts = odbUtil.FillDataSet(StrSql, Sustain1Connection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEffDate:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetLCI() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetLCI:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetLCI(ByVal Inventorytype As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetLCI:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetConversionFactor() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetConversionFactor:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCustomerPageLists() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetCustomerPageLists:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPCaseDetailsByLicense(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPCaseDetailsByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCasesByLicense(ByVal USERID As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetCasesByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "UserDetails"
        Public Function GetUserDetails(ByVal Id As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND SERVICES.SERVICEDE='SCHEM1' "
                Dts = odbUtil.FillDataSet(StrSql, EconConnection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetTotalCaseCount(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetTotalCaseCount:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSelectedUserDetails(ByVal usreName As String, ByVal Schema As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetSelectedUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Notes"
        Public Function GetAssumptionPageDetails(ByVal AssumptionType As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetAssumptionPageDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPageNoteDetails(ByVal AssumptionType As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPageNoteDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseNoteDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetCaseNoteDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Assumptions Pages"
        Public Function GetExtrusionDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C1),0) WEIGHTS1,  "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C2),0) WEIGHTS2, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C3),0) WEIGHTS3, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C4),0) WEIGHTS4, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C5),0) WEIGHTS5, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C6),0) WEIGHTS6, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C7),0) WEIGHTS7, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C8),0) WEIGHTS8, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C9),0) WEIGHTS9, "
                StrSql = StrSql + "NVL((SELECT PRODWT*PREF.CONVWT FROM SUSTAIN.TOTAL WHERE CASEID=MI.C10),0) WEIGHTS10, "
                ...
                'Bug#378 Start
                StrSql = StrSql + "MI.WD1, "
                StrSql = StrSql + "MI.WD2, "
                StrSql = StrSql + "MI.WD3, "
                StrSql = StrSql + "MI.WD4, "
                StrSql = StrSql + "MI.WD5, "
                StrSql = StrSql + "MI.WD6, "
                StrSql = StrSql + "MI.WD7, "
                StrSql = StrSql + "MI.WD8, "
                StrSql = StrSql + "MI.WD9, "
                StrSql = StrSql + "MI.WD10, "
                StrSql = StrSql + "MI.ED1, "
                StrSql = StrSql + "MI.ED2, "
                StrSql = StrSql + "MI.ED3, "
                StrSql = StrSql + "MI.ED4, "
                StrSql = StrSql + "MI.ED5, "
                StrSql = StrSql + "MI.ED6, "
                StrSql = StrSql + "MI.ED7, "
                StrSql = StrSql + "MI.ED8, "
                StrSql = StrSql + "MI.ED9, "
                StrSql = StrSql + "MI.ED10, "

                '#378 changes for MIddle
                StrSql = StrSql + "CASE WHEN MI.C1=0 THEN (NVL(MATS1.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C1)/(CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END))/PREF.CONVWT) END)END ERGYS1, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C1)/(CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END))/PREF.CONVWT) END)END ERGYS1, "

                StrSql = StrSql + "CASE WHEN MI.C2=0 THEN (NVL(MATS2.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C2)/(CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END))/PREF.CONVWT) END)END ERGYS2, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C2)/(CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END))/PREF.CONVWT) END)END ERGYS2, "

                StrSql = StrSql + "CASE WHEN MI.C3=0 THEN (NVL(MATS3.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C3)/(CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END))/PREF.CONVWT) END)END ERGYS3, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C3)/(CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END))/PREF.CONVWT) END)END ERGYS3, "

                StrSql = StrSql + "CASE WHEN MI.C4=0 THEN (NVL(MATS4.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C4)/(CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END))/PREF.CONVWT) END)END ERGYS4, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C4)/(CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END))/PREF.CONVWT) END)END ERGYS4, "

                StrSql = StrSql + "CASE WHEN MI.C5=0 THEN (NVL(MATS5.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C5)/(CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END))/PREF.CONVWT) END)END ERGYS5, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C5)/(CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END))/PREF.CONVWT) END)END ERGYS5, "

                StrSql = StrSql + "CASE WHEN MI.C6=0 THEN (NVL(MATS6.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C6)/(CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END))/PREF.CONVWT) END)END ERGYS6, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C6)/(CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END))/PREF.CONVWT) END)END ERGYS6, "

                StrSql = StrSql + "CASE WHEN MI.C7=0 THEN (NVL(MATS7.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C7)/(CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END))/PREF.CONVWT) END)END ERGYS7, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C7)/(CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END))/PREF.CONVWT) END)END ERGYS7, "

                StrSql = StrSql + "CASE WHEN MI.C8=0 THEN (NVL(MATS8.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C8)/(CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END))/PREF.CONVWT) END)END ERGYS8, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C8)/(CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END))/PREF.CONVWT) END)END ERGYS8, "

                StrSql = StrSql + "CASE WHEN MI.C9=0 THEN (NVL(MATS9.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C9)/(CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END))/PREF.CONVWT) END)END ERGYS9, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C9)/(CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END))/PREF.CONVWT) END)END ERGYS9, "

                StrSql = StrSql + "CASE WHEN MI.C10=0 THEN (NVL(MATS10.JOULE,0)/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMERGY FROM TOTAL WHERE CASEID=MI.C10)/(CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END))/PREF.CONVWT) END)END ERGYS10, "
                StrSql = StrSql + "ELSE (((SELECT  RMERGY+RMPACKERGY+RMANDPACKTRNSPTERGY+PROCERGYS2+PACKGEDPRODPACK+PPPTRNSPT+PACKGEDPRODTRNSPT FROM TOTALPROD WHERE CASEID=MI.C10)/(CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END))/PREF.CONVWT) END)END ERGYS10, "
                ...
                StrSql = StrSql + "CASE WHEN MI.C1=0 THEN (NVL(MATS1.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C1)/(CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END))) END)END CO2S1, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C1)/(CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END))) END)END CO2S1, "


                StrSql = StrSql + "CASE WHEN MI.C2=0 THEN (NVL(MATS2.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C2)/(CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END))) END)END CO2S2, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C2)/(CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END))) END)END CO2S2, "


                StrSql = StrSql + "CASE WHEN MI.C3=0 THEN (NVL(MATS3.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C3)/(CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END))) END)END CO2S3, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C3)/(CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END))) END)END CO2S3, "

                StrSql = StrSql + "CASE WHEN MI.C4=0 THEN (NVL(MATS4.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C4)/(CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END))) END)END CO2S4, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C4)/(CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END))) END)END CO2S4, "


                StrSql = StrSql + "CASE WHEN MI.C5=0 THEN (NVL(MATS5.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END),0)<=0 THEN 0 "
                ' StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C5)/(CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END))) END)END CO2S5, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C5)/(CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END))) END)END CO2S5, "


                StrSql = StrSql + "CASE WHEN MI.C6=0 THEN (NVL(MATS6.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END),0)<=0 THEN 0 "
                ' StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C6)/(CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END))) END)END CO2S6, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C6)/(CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END))) END)END CO2S6, "


                StrSql = StrSql + "CASE WHEN MI.C7=0 THEN (NVL(MATS7.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END),0)<=0 THEN 0 "
                ' StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C7)/(CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END))) END)END CO2S7, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C7)/(CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END))) END)END CO2S7, "


                StrSql = StrSql + "CASE WHEN MI.C8=0 THEN (NVL(MATS8.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END),0)<=0 THEN 0 "
                ' StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C8)/(CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END))) END)END CO2S8, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C8)/(CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END))) END)END CO2S8, "


                StrSql = StrSql + "CASE WHEN MI.C9=0 THEN (NVL(MATS9.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C9)/(CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END))) END)END CO2S9, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C9)/(CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END))) END)END CO2S9, "

                StrSql = StrSql + "CASE WHEN MI.C10=0 THEN (NVL(MATS10.PRICE,0))  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMGRNHUSGAS FROM TOTAL WHERE CASEID=MI.C10)/(CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END))) END)END CO2S10, "
                StrSql = StrSql + "ELSE (((SELECT  RMGRNHUSGAS+RMPACKGRNHUSGAS+RMANDPACKTRNSPTGRNHUSGAS+PROCGRNHUSGASS2+PACKGEDPRODPACKGRNHUSGAS+PPPTRNSPTGRNHUSGAS+PACKGEDPRODTRNSPTGRNHUSGAS FROM TOTALPROD WHERE CASEID=MI.C10)/(CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END))) END)END CO2S10, "

                StrSql = StrSql + "(MATGHGPREF.M1) AS CO2P1, "
                StrSql = StrSql + "(MATGHGPREF.M2) AS CO2P2, "
                StrSql = StrSql + "(MATGHGPREF.M3) AS CO2P3, "
                StrSql = StrSql + "(MATGHGPREF.M4) AS CO2P4, "
                StrSql = StrSql + "(MATGHGPREF.M5) AS CO2P5, "
                StrSql = StrSql + "(MATGHGPREF.M6) AS CO2P6, "
                StrSql = StrSql + "(MATGHGPREF.M7) AS CO2P7, "
                StrSql = StrSql + "(MATGHGPREF.M8) AS CO2P8, "
                StrSql = StrSql + "(MATGHGPREF.M9) AS CO2P9, "
                StrSql = StrSql + "(MATGHGPREF.M10) AS CO2P10, "


                StrSql = StrSql + "CASE WHEN MI.C1=0 THEN (NVL(MATS1.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C1)/(CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS1, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C1)/(CASE WHEN VOL1.PVOLUSE=0 THEN VOL1.VOLUME ELSE VOL1.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS1, "

                StrSql = StrSql + "CASE WHEN MI.C2=0 THEN (NVL(MATS2.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C2)/(CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS2, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C2)/(CASE WHEN VOL2.PVOLUSE=0 THEN VOL2.VOLUME ELSE VOL2.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS2, "


                StrSql = StrSql + "CASE WHEN MI.C3=0 THEN (NVL(MATS3.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C3)/(CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS3, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C3)/(CASE WHEN VOL3.PVOLUSE=0 THEN VOL3.VOLUME ELSE VOL3.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS3, "

                StrSql = StrSql + "CASE WHEN MI.C4=0 THEN (NVL(MATS4.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C4)/(CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS4, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C4)/(CASE WHEN VOL4.PVOLUSE=0 THEN VOL4.VOLUME ELSE VOL4.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS4, "

                StrSql = StrSql + "CASE WHEN MI.C5=0 THEN (NVL(MATS5.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C5)/(CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS5, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C5)/(CASE WHEN VOL5.PVOLUSE=0 THEN VOL5.VOLUME ELSE VOL5.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS5, "

                StrSql = StrSql + "CASE WHEN MI.C6=0 THEN (NVL(MATS6.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C6)/(CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS6, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C6)/(CASE WHEN VOL6.PVOLUSE=0 THEN VOL6.VOLUME ELSE VOL6.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS6, "

                StrSql = StrSql + "CASE WHEN MI.C7=0 THEN (NVL(MATS7.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C7)/(CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS7, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C7)/(CASE WHEN VOL7.PVOLUSE=0 THEN VOL7.VOLUME ELSE VOL7.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS7, "

                StrSql = StrSql + "CASE WHEN MI.C8=0 THEN (NVL(MATS8.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C8)/(CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS8, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C8)/(CASE WHEN VOL8.PVOLUSE=0 THEN VOL8.VOLUME ELSE VOL8.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS8, "

                StrSql = StrSql + "CASE WHEN MI.C9=0 THEN (NVL(MATS9.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C9)/(CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS9, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C9)/(CASE WHEN VOL9.PVOLUSE=0 THEN VOL9.VOLUME ELSE VOL9.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS9, "

                StrSql = StrSql + "CASE WHEN MI.C10=0 THEN (NVL(MATS10.WATER,0)*PREF.CONVGALLON/PREF.CONVWT)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END),0)<=0 THEN 0 "
                'StrSql = StrSql + "ELSE (((SELECT RMWATER FROM TOTAL WHERE CASEID=MI.C10)/(CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS10, "
                StrSql = StrSql + "ELSE (((SELECT RMWATER+RMPACKWATER+RMANDPACKTRNSPTWATER+PROCWATERS2+PACKGEDPRODPACKWATER+PPPTRNSPTWATER+PACKGEDPRODTRNSPTWATER FROM TOTALPROD WHERE CASEID=MI.C10)/(CASE WHEN VOL10.PVOLUSE=0 THEN VOL10.VOLUME ELSE VOL10.SVOLUME END))*PREF.CONVGALLON/PREF.CONVWT) END)END WATERS10, "
                ...
                StrSql = StrSql + "TOTAL.WEIGHTDIS*100 AS TOTWGHTDIS, "
                StrSql = StrSql + "TOTAL.ENVDIS*100 AS TOTENVDIS, "
                ...
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT1 "
                'StrSql = StrSql + "ON MAT1.MATID=MI.M1 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT2 "
                'StrSql = StrSql + "ON MAT2.MATID=MI.M2 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT3 "
                'StrSql = StrSql + "ON MAT3.MATID=MI.M3 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT4 "
                'StrSql = StrSql + "ON MAT4.MATID=MI.M4 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT5 "
                'StrSql = StrSql + "ON MAT5.MATID=MI.M5 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT6 "
                'StrSql = StrSql + "ON MAT6.MATID=MI.M6 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT7 "
                'StrSql = StrSql + "ON MAT7.MATID=MI.M7 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT8 "
                'StrSql = StrSql + "ON MAT8.MATID=MI.M8 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT9 "
                'StrSql = StrSql + "ON MAT9.MATID=MI.M9 "
                'StrSql = StrSql + "INNER JOIN Echem1.MATERIALS MAT10 "
                ...
                StrSql = StrSql + "INNER JOIN MATENERGYPREF MATERGY " 'Bug #378
                StrSql = StrSql + "ON MATERGY.CASEID=MI.CASEID "
                StrSql = StrSql + "INNER JOIN MATGHGPREF "
                StrSql = StrSql + "ON MATGHGPREF.CASEID=MI.CASEID "
                StrSql = StrSql + "INNER JOIN MATWATERPREF "
                StrSql = StrSql + "ON MATWATERPREF.CASEID=MI.CASEID "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS1 "
                StrSql = StrSql + "ON MATS1.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS1.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS1.MATID = MI.M1 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS2 "
                StrSql = StrSql + "ON MATS2.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS2.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS2.MATID = MI.M2 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS3 "
                StrSql = StrSql + "ON MATS3.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS3.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS3.MATID = MI.M3 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS4 "
                StrSql = StrSql + "ON MATS4.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS4.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS4.MATID = MI.M4 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS5 "
                StrSql = StrSql + "ON MATS5.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS5.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS5.MATID = MI.M5 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS6 "
                StrSql = StrSql + "ON MATS6.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS6.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS6.MATID = MI.M6 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS7 "
                StrSql = StrSql + "ON MATS7.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS7.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS7.MATID = MI.M7 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS8 "
                StrSql = StrSql + "ON MATS8.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS8.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS8.MATID = MI.M8 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS9 "
                StrSql = StrSql + "ON MATS9.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS9.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS9.MATID = MI.M9 "
                StrSql = StrSql + "LEFT OUTER JOIN MATERIALSARCH MATS10 "
                StrSql = StrSql + "ON MATS10.EFFDATE = PREF.EFFDATE "
                StrSql = StrSql + "AND MATS10.INVENTORYTYPE =  PREF.INVENTORYTYPE "
                StrSql = StrSql + "AND MATS10.MATID = MI.M10 "

                StrSql = StrSql + "Left Join RESULTSPLPROD VOL1 "
                StrSql = StrSql + "on VOL1.CaseId=MI.C1 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL2 "
                StrSql = StrSql + "on VOL2.CaseId=MI.C2 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL3 "
                StrSql = StrSql + "on VOL3.CaseId=MI.C3 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL4 "
                StrSql = StrSql + "on VOL4.CaseId=MI.C4 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL5 "
                StrSql = StrSql + "on VOL5.CaseId=MI.C5 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL6 "
                StrSql = StrSql + "on VOL6.CaseId=MI.C6 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL7 "
                StrSql = StrSql + "on VOL7.CaseId=MI.C7 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL8 "
                StrSql = StrSql + "on VOL8.CaseId=MI.C8 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL9 "
                StrSql = StrSql + "on VOL9.CaseId=MI.C9 "
                StrSql = StrSql + "Left Join RESULTSPLPROD VOL10 "
                StrSql = StrSql + "on VOL10.CaseId=MI.C10 "
        ...
        Public Function GetProductFromatIn(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "LEFT OUTER JOIN Echem1.PRODUCTFORMAT "
                StrSql = StrSql + "ON PRODUCTFORMAT.FORMATID = PF.M1 "
                StrSql = StrSql + "AND PREF.UNITS = 0 "
                StrSql = StrSql + "LEFT OUTER JOIN Echem1.PRODUCTFORMAT2 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetProductFromatIn:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletAndTruck(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPalletAndTruck:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPalletInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfigDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPlantConfigDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffiencyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM PLANTCONFIG PC "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P1 "
                StrSql = StrSql + "ON P1.PROCID=PC.M1 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P2 "
                StrSql = StrSql + "ON P2.PROCID=PC.M2 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P3 "
                StrSql = StrSql + "ON P3.PROCID=PC.M3 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P4 "
                StrSql = StrSql + "ON P4.PROCID=PC.M4 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P5 "
                StrSql = StrSql + "ON P5.PROCID=PC.M5 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P6 "
                StrSql = StrSql + "ON P6.PROCID=PC.M6 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P7 "
                StrSql = StrSql + "ON P7.PROCID=PC.M7 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P8 "
                StrSql = StrSql + "ON P8.PROCID=PC.M8 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P9 "
                StrSql = StrSql + "ON P9.PROCID=PC.M9 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS P10 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEffiencyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ1 "
                StrSql = StrSql + "ON EQ1.EQUIPID=EQT.M1 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ2 "
                StrSql = StrSql + "ON EQ2.EQUIPID=EQT.M2 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ3 "
                StrSql = StrSql + "ON EQ3.EQUIPID=EQT.M3 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ4 "
                StrSql = StrSql + "ON EQ4.EQUIPID=EQT.M4 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ5 "
                StrSql = StrSql + "ON EQ5.EQUIPID=EQT.M5 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ6 "
                StrSql = StrSql + "ON EQ6.EQUIPID=EQT.M6 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ7 "
                StrSql = StrSql + "ON EQ7.EQUIPID=EQT.M7 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ8 "
                StrSql = StrSql + "ON EQ8.EQUIPID=EQT.M8 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ9 "
                StrSql = StrSql + "ON EQ9.EQUIPID=EQT.M9 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ10 "
                StrSql = StrSql + "ON EQ10.EQUIPID=EQT.M10 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ11 "
                StrSql = StrSql + "ON EQ11.EQUIPID=EQT.M11 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ12 "
                StrSql = StrSql + "ON EQ12.EQUIPID=EQT.M12 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ13 "
                StrSql = StrSql + "ON EQ13.EQUIPID=EQT.M13 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ14 "
                StrSql = StrSql + "ON EQ14.EQUIPID=EQT.M14 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ15 "
                StrSql = StrSql + "ON EQ15.EQUIPID=EQT.M15 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ16 "
                StrSql = StrSql + "ON EQ16.EQUIPID=EQT.M16 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ17 "
                StrSql = StrSql + "ON EQ17.EQUIPID=EQT.M17 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ18 "
                StrSql = StrSql + "ON EQ18.EQUIPID=EQT.M18 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ19 "
                StrSql = StrSql + "ON EQ19.EQUIPID=EQT.M19 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ20 "
                StrSql = StrSql + "ON EQ20.EQUIPID=EQT.M20 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ21 "
                StrSql = StrSql + "ON EQ21.EQUIPID=EQT.M21 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ22 "
                StrSql = StrSql + "ON EQ22.EQUIPID=EQT.M22 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ23 "
                StrSql = StrSql + "ON EQ23.EQUIPID=EQT.M23 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ24 "
                StrSql = StrSql + "ON EQ24.EQUIPID=EQT.M24 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ25 "
                StrSql = StrSql + "ON EQ25.EQUIPID=EQT.M25 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ26 "
                StrSql = StrSql + "ON EQ26.EQUIPID=EQT.M26 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ27 "
                StrSql = StrSql + "ON EQ27.EQUIPID=EQT.M27 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ28 "
                StrSql = StrSql + "ON EQ28.EQUIPID=EQT.M28 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ29 "
                StrSql = StrSql + "ON EQ29.EQUIPID=EQT.M29 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT EQ30 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEquipmentDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ1 "
                StrSql = StrSql + "ON EQ1.EQUIPID=EQT.M1 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ2 "
                StrSql = StrSql + "ON EQ2.EQUIPID=EQT.M2 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ3 "
                StrSql = StrSql + "ON EQ3.EQUIPID=EQT.M3 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ4 "
                StrSql = StrSql + "ON EQ4.EQUIPID=EQT.M4 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ5 "
                StrSql = StrSql + "ON EQ5.EQUIPID=EQT.M5 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ6 "
                StrSql = StrSql + "ON EQ6.EQUIPID=EQT.M6 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ7 "
                StrSql = StrSql + "ON EQ7.EQUIPID=EQT.M7 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ8 "
                StrSql = StrSql + "ON EQ8.EQUIPID=EQT.M8 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ9 "
                StrSql = StrSql + "ON EQ9.EQUIPID=EQT.M9 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ10 "
                StrSql = StrSql + "ON EQ10.EQUIPID=EQT.M10 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ11 "
                StrSql = StrSql + "ON EQ11.EQUIPID=EQT.M11 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ12 "
                StrSql = StrSql + "ON EQ12.EQUIPID=EQT.M12 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ13 "
                StrSql = StrSql + "ON EQ13.EQUIPID=EQT.M13 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ14 "
                StrSql = StrSql + "ON EQ14.EQUIPID=EQT.M14 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ15 "
                StrSql = StrSql + "ON EQ15.EQUIPID=EQT.M15 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ16 "
                StrSql = StrSql + "ON EQ16.EQUIPID=EQT.M16 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ17 "
                StrSql = StrSql + "ON EQ17.EQUIPID=EQT.M17 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ18 "
                StrSql = StrSql + "ON EQ18.EQUIPID=EQT.M18 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ19 "
                StrSql = StrSql + "ON EQ19.EQUIPID=EQT.M19 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ20 "
                StrSql = StrSql + "ON EQ20.EQUIPID=EQT.M20 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ21 "
                StrSql = StrSql + "ON EQ21.EQUIPID=EQT.M21 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ22 "
                StrSql = StrSql + "ON EQ22.EQUIPID=EQT.M22 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ23 "
                StrSql = StrSql + "ON EQ23.EQUIPID=EQT.M23 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ24 "
                StrSql = StrSql + "ON EQ24.EQUIPID=EQT.M24 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ25 "
                StrSql = StrSql + "ON EQ25.EQUIPID=EQT.M25 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ26 "
                StrSql = StrSql + "ON EQ26.EQUIPID=EQT.M26 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ27 "
                StrSql = StrSql + "ON EQ27.EQUIPID=EQT.M27 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ28 "
                StrSql = StrSql + "ON EQ28.EQUIPID=EQT.M28 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ29 "
                StrSql = StrSql + "ON EQ29.EQUIPID=EQT.M29 "
                StrSql = StrSql + "INNER JOIN Echem1.EQUIPMENT2 EQ30 "
                StrSql = StrSql + "ON EQ30.EQUIPID=EQT.M30 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetSupportDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetOperationInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "EQNUM.M30 AS NUM30 "
                'Equipment Label
                StrSql = StrSql + ",(CASE WHEN EQT.M1= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M2= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M3= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M4= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M5= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M6= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M7= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M8= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M9= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M10= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M11= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M12= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M13= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M14= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M15= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M16= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M17= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M18= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M19= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M20= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M21= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M22= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M23= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M24= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M25= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M26= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M27= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M28= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M29= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                StrSql = StrSql + "(CASE WHEN EQT.M30= 0 THEN "
                StrSql = StrSql + " '' "
                StrSql = StrSql + " ELSE "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetOperationInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPersonnelInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfig2Details(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPlantConfig2Details:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEnergyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEnergyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetAdditionalEnergyInfo(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetAdditionalEnergyInfo:" + ex.Message.ToString())
                Return Dts
        ...
        Public Function GetTransportDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetTransportDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetExtraProcessDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetExtraProcessDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Intermediate result Pages"
        Public Function GetExtrusionOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetExtrusionOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetResultsEOLIN(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "( CASE WHEN RESULTSPL.FINVOLMSI >0 THEN "
                StrSql = StrSql + "'Sales Volume '|| PREF.TITLE3 "
                StrSql = StrSql + "ELSE "
                StrSql = StrSql + "(CASE WHEN RESULTSPL.FINVOLMUNITS >0 THEN "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetResultsEOLIN:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPalletInout(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetPalletInout:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetScoreCard(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetScoreCard:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetOperationsOut(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT1 "
                StrSql = StrSql + "ON OPOUT1.PROCID = OPOUT.M1 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT2 "
                StrSql = StrSql + "ON OPOUT2.PROCID = OPOUT.M2 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT3 "
                StrSql = StrSql + "ON OPOUT3.PROCID = OPOUT.M3 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT4 "
                StrSql = StrSql + "ON OPOUT4.PROCID = OPOUT.M4 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT5 "
                StrSql = StrSql + "ON OPOUT5.PROCID = OPOUT.M5 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT6 "
                StrSql = StrSql + "ON OPOUT6.PROCID = OPOUT.M6 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT7 "
                StrSql = StrSql + "ON OPOUT7.PROCID = OPOUT.M7 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT8 "
                StrSql = StrSql + "ON OPOUT8.PROCID = OPOUT.M8 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT9 "
                StrSql = StrSql + "ON OPOUT9.PROCID = OPOUT.M9 "
                StrSql = StrSql + "INNER JOIN Echem1.PROCESS OPOUT10 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetOperationsOut:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Results Pages"
        Public Function GetEnergyResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "TOT.CUSSALESVOLUME, "
                ...
                'StrSql = StrSql + "'Process Energy(Schem1)' AS A8, "
                'StrSql = StrSql + "'Packaged Product Packaging(Schem1)' AS A9, "
                'StrSql = StrSql + "'PPP Transport(Schem1)' AS A10, "
                'StrSql = StrSql + "'Packaged Product Transport(Schem1)' AS A11, "
                ...
                StrSql = StrSql + "TOT.PROCERGYS2 AS T4, "
                StrSql = StrSql + "TOT.PACKGEDPRODPACK AS T5, "
                StrSql = StrSql + "TOT.PPPTRNSPT AS T6, "
                StrSql = StrSql + "TOT.PACKGEDPRODTRNSPT AS T7, "
                ...
                StrSql = StrSql + "(TOT.RMERGY+TOT.RMPACKERGY+TOT.RMANDPACKTRNSPTERGY+TOT.PROCERGYS2+TOT.PACKGEDPRODPACK+TOT.PPPTRNSPT+TOT.PACKGEDPRODTRNSPT) T8, "
                StrSql = StrSql + "(TOT.RMERGY+TOT.RMPACKERGY+TOT.PACKGEDPRODPACK) AS T9, "
                StrSql = StrSql + "(TOT.PROCERGYS2)AS T10, "
                StrSql = StrSql + "(TOT.RMANDPACKTRNSPTERGY+TOT.PPPTRNSPT+TOT.PACKGEDPRODTRNSPT) AS  T11, "
                StrSql = StrSql + "(TOT.RMERGY+TOT.RMPACKERGY+TOT.RMANDPACKTRNSPTERGY+TOT.PROCERGYS2+TOT.PACKGEDPRODPACK+TOT.PPPTRNSPT+TOT.PACKGEDPRODTRNSPT) T12, "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEnergyResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEOLResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEOLResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetScoreCardResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetScoreCardResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetGhgResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "(TOT.PROCGRNHUSGASS2*PREF.CONVWT) AS T4, "
                StrSql = StrSql + "(TOT.PACKGEDPRODPACKGRNHUSGAS*PREF.CONVWT) AS T5, "
                StrSql = StrSql + "(TOT.PPPTRNSPTGRNHUSGAS*PREF.CONVWT) AS T6, "
                StrSql = StrSql + "(TOT.PACKGEDPRODTRNSPTGRNHUSGAS*PREF.CONVWT) AS T7, "
                ...
                StrSql = StrSql + "((TOT.RMGRNHUSGAS+TOT.RMPACKGRNHUSGAS+TOT.RMANDPACKTRNSPTGRNHUSGAS+TOT.PROCGRNHUSGASS2+TOT.PACKGEDPRODPACKGRNHUSGAS+TOT.PPPTRNSPTGRNHUSGAS+TOT.PACKGEDPRODTRNSPTGRNHUSGAS)*PREF.CONVWT) T8, "
                StrSql = StrSql + "((TOT.RMGRNHUSGAS+TOT.RMPACKGRNHUSGAS+TOT.PACKGEDPRODPACKGRNHUSGAS)*PREF.CONVWT) AS T9, "
                StrSql = StrSql + "(TOT.PROCGRNHUSGASS2)*PREF.CONVWT AS T10, "
                StrSql = StrSql + "((TOT.RMANDPACKTRNSPTGRNHUSGAS+TOT.PPPTRNSPTGRNHUSGAS+TOT.PACKGEDPRODTRNSPTGRNHUSGAS)*PREF.CONVWT) AS  T11, "
                StrSql = StrSql + "((TOT.RMGRNHUSGAS+TOT.RMPACKGRNHUSGAS+TOT.RMANDPACKTRNSPTGRNHUSGAS+TOT.PROCGRNHUSGASS2+TOT.PACKGEDPRODPACKGRNHUSGAS+TOT.PPPTRNSPTGRNHUSGAS+TOT.PACKGEDPRODTRNSPTGRNHUSGAS)*PREF.CONVWT) T12, "
                StrSql = StrSql + "(CASE WHEN RSPL.PVOLUSE=0 THEN RSPL.VOLUME*PREF.CONVWT "
                StrSql = StrSql + "ELSE RSPL.SVOLUME*PREF.CONVWT END) AS SALESVOLUMELB, "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetGhgResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetWaterResults(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "(TOT.PROCWATERS2*PREF.CONVGALLON) AS T4, "
                StrSql = StrSql + "(TOT.PACKGEDPRODPACKWATER*PREF.CONVGALLON) AS T5, "
                StrSql = StrSql + "(TOT.PPPTRNSPTWATER*PREF.CONVGALLON) AS T6, "
                StrSql = StrSql + "(TOT.PACKGEDPRODTRNSPTWATER*PREF.CONVGALLON) AS T7, "
                ...
                StrSql = StrSql + "((TOT.RMWATER+TOT.RMPACKWATER+TOT.RMANDPACKTRNSPTWATER+TOT.PROCWATERS2+TOT.PACKGEDPRODPACKWATER+TOT.PPPTRNSPTWATER+TOT.PACKGEDPRODTRNSPTWATER)*PREF.CONVGALLON) T8, "
                StrSql = StrSql + "((TOT.RMWATER+TOT.RMPACKWATER+TOT.PACKGEDPRODPACKWATER)*PREF.CONVGALLON) AS T9, "
                StrSql = StrSql + "(TOT.PROCWATERS2)*PREF.CONVGALLON AS T10, "
                StrSql = StrSql + "((TOT.RMANDPACKTRNSPTWATER+TOT.PPPTRNSPTWATER+TOT.PACKGEDPRODTRNSPTWATER)*PREF.CONVGALLON) AS  T11, "
                StrSql = StrSql + "((TOT.RMWATER+TOT.RMPACKWATER+TOT.RMANDPACKTRNSPTWATER+TOT.PROCWATERS2+TOT.PACKGEDPRODPACKWATER+TOT.PPPTRNSPTWATER+TOT.PACKGEDPRODTRNSPTWATER)*PREF.CONVGALLON) T12, "
                StrSql = StrSql + "(CASE WHEN RSPL.PVOLUSE=0 THEN RSPL.VOLUME*PREF.CONVWT "
                StrSql = StrSql + "ELSE RSPL.SVOLUME*PREF.CONVWT END) AS SALESVOLUMELB, "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetWaterResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetGhgResultsProd(ByVal CaseId As Integer) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
                ...
                StrSql = StrSql + "(CASE WHEN RSPL.FINVOLMUNITS > 0 THEN 'Sales Volume (unit)' END) VOLUNI2, "
                StrSql = StrSql + "PREF.TITLE1, "
                StrSql = StrSql + "PREF.TITLE3, "
                StrSql = StrSql + "PREF.TITLE2, "
                StrSql = StrSql + "PREF.TITLE4, "
                ...
                StrSql = StrSql + "PREF.Convwt, "
                StrSql = StrSql + "PREF.UNITS "
                StrSql = StrSql + "FROM TOTALPROD TOT "
                StrSql = StrSql + "INNER JOIN PREFERENCES PREF "
                StrSql = StrSql + "ON PREF.CASEID = TOT.CASEID "
                StrSql = StrSql + "INNER JOIN RESULTSPLPROD RSPL "
                StrSql = StrSql + "ON RSPL.CASEID = TOT.CASEID "
                StrSql = StrSql + "WHERE TOT.CASEID =" + CaseId.ToString() + " "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetDataProd:GetGhgResults:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetEnergyResultsProd(ByVal CaseId As Integer) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEnergyResultsProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetWaterResultsProd(ByVal CaseId As Integer) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetWaterResultsProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetEOLResultsProd(ByVal CaseId As Integer) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
                ...
                StrSql = StrSql + "PREF.CONVWT ,"
                StrSql = StrSql + "PREF.UNITS "
                StrSql = StrSql + "FROM MATERIALBALANCEPROD MATB "
                StrSql = StrSql + "INNER JOIN PREFERENCES PREF "
                StrSql = StrSql + "ON PREF.CASEID = MATB.CASEID "
                StrSql = StrSql + "INNER JOIN MATERIALBALANCEWASTEPROD MATBW "
                StrSql = StrSql + "ON MATBW.CASEID = MATB.CASEID "
                StrSql = StrSql + "INNER JOIN MATENDOFLIFEOUTPROD MALOUT "
                StrSql = StrSql + "ON MALOUT.CASEID = MATB.CASEID "
                StrSql = StrSql + "INNER JOIN RESULTSPLPROD RSPL "
                StrSql = StrSql + "ON RSPL.CASEID = MATB.CASEID "
                StrSql = StrSql + "INNER JOIN Total TOT "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Schem1GetData:GetEOLResultsProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Error"
        Public Function GetErrors(ByVal ErrorCode As String) As DataSet
            ...
            Try
                ...
                MyConnectionString = System.Configuration.ConfigurationManager.AppSettings("Schem1ConnectionString")
                Dim StrSql As String = ""
...
#Region "Charts"
        ...
        Public Function GetChartErgy() As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM DUAL "
                StrSql = StrSql + "UNION "
                StrSql = StrSql + "SELECT 'Process Energy(Schem1)' AS TEXT, "
                StrSql = StrSql + "'PROCERGYS2' AS VALUE, "
                StrSql = StrSql + "8 AS SEQ "
                StrSql = StrSql + "FROM DUAL "
                StrSql = StrSql + "UNION "
                StrSql = StrSql + "SELECT 'Packaged Product Packaging(Schem1)' AS TEXT, "
                StrSql = StrSql + "'PACKGEDPRODPACK' AS VALUE, "
                StrSql = StrSql + "9 AS SEQ "
                StrSql = StrSql + "FROM DUAL "
                StrSql = StrSql + "UNION "
                StrSql = StrSql + "SELECT 'PPP Transport(Schem1)' AS TEXT, "
                StrSql = StrSql + "'PPPTRNSPT' AS VALUE, "
                StrSql = StrSql + "10 AS SEQ "
                StrSql = StrSql + "FROM DUAL "
                StrSql = StrSql + "UNION "
                StrSql = StrSql + "SELECT 'Packaged Product Transport(Schem1)' AS TEXT, "
        ...
        Public Function GetChartGhg() As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM DUAL "
                StrSql = StrSql + "UNION "
                StrSql = StrSql + "SELECT 'Process (Schem1)' AS TEXT, "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetChartGhg:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartPref(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("S1GetData:GetChartPref:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Case Grouping:"
        ...
        Public Function GetPCaseGrpDetails(ByVal UserName As String, ByVal UserID As String, ByVal keyWord As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "FROM EChem1.GROUPS "
                StrSql = StrSql + "INNER JOIN EChem1.GROUPCASES "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("SChem1GetData:GetPCaseGrpDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetGroupIDByUSer(ByVal UserID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("SChem1GetData:GetGroupIDByUSer:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetGroupDetails(ByVal UserID As String, ByVal flag As Char) As DataSet
            ...
            Try
                ...
                DtRes = odbUtil.FillDataSet(strSQL, Echem1Connection)
                If DtRes.Tables(0).Rows.Count > 0 Then
                    For j = 0 To DtRes.Tables(0).Rows.Count - 1
                        'Getting CaseID
                        strSQL = "SELECT GROUPID,  "
                        strSQL = strSQL + "CASEID "
                        strSQL = strSQL + "FROM EChem1.GROUPCASES "
                    ...
                    dtOutPut = odbUtil.FillDataSet(strSqlOutPut, Echem1Connection)
        ...
        Public Function GetAllGroupDetails(ByVal UserID As String) As DataSet
            ...
            Dim dtOutPut As New DataSet()
            Dim strSqlOutPut As String = String.Empty
            MyConnectionString = System.Configuration.ConfigurationManager.AppSettings("EChem1ConnectionString")
            Try
        ...
        Public Function GetPCaseDetailsByGroup(ByVal USERID As String, ByVal grpId As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + " INNER JOIN EChem1.GROUPCASES ON GROUPCASES.CASEID=PERMISSIONSCASES.CASEID "
                StrSql = StrSql + "WHERE USERID ='" + USERID.ToString() + "'  AND GROUPCASES.GROUPID=" + grpId + " "
                StrSql = StrSql + " AND PERMISSIONSCASES.CASEID IN(SELECT CASEID FROM EChem1.GROUPCASES WHERE GROUPID =" + grpId + ")"
                StrSql = StrSql + "ORDER BY UPPER(CASEDE1),CASEID "

                Dts = odbUtil.FillDataSet(StrSql, Schem1Connection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("SChem1GetData:GetPCaseDetailsByGroup:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetGroupCases(ByVal USERID As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal groupID As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND NVL(UPPER(CASEDE1),'#') LIKE '%" + CaseDe1.ToUpper() + "%' "
                StrSql = StrSql + "AND NVL(UPPER(CASEDE2),'#') LIKE '%" + CaseDe2.ToUpper() + "%' "
                StrSql = StrSql + "AND CASEID IN(SELECT CASEID FROM EChem1.GROUPCASES WHERE GROUPID=" + groupID + " ) "
                StrSql = StrSql + "ORDER BY  UPPER(CASEDE1),CASEID "
                Dts = odbUtil.FillDataSet(StrSql, Schem1Connection)
                Return Dts
            Catch ex As Exception

...
#Region "Fixed Cost"
        ...
        Public Function GetFixedCostArch() As DataSet
            ...
            Catch ex As Exception
                Throw New Exception("E2GetData:GetFixedCostArch:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Equipment"
        ...
        Public Function GetPopUpEquipment(ByVal CaseID As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetExtrusionDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEditEquip(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                ds = odbUtil.FillDataSet(strSql, Econ2Connection)
                Return ds
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEditEquip:" + ex.Message.ToString())
                Return ds
            End Try
        End Function
#End Region
#Region "UserDetails"
        ...
        Public Function GetTotalCaseCount(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetTotalCaseCount:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSelectedUserDetails(ByVal UserId As String, ByVal Schema As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetSelectedUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Supporting Assumptions Pages"
        Public Function GetCaseDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetBCaseDetails() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetBCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPCaseDetails(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetMaterials(ByVal MatId As Integer, ByVal MatDe1 As String, ByVal MatDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetMaterials:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim CaseId As String = HttpContext.Current.Session("E2CaseId").ToString()
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetDept:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDeptN(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetDeptN:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPref(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPref:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetBCases(ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetBCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseViewer(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCaseViewer:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseNoteDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCaseNoteDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCountry() As DataSet
            ...
            Dim StrSql As String = String.Empty
            Try
                  StrSql = "SELECT COUNTRYID,COUNTRYDES COUNTRYDE1 FROM ADMINSITE.DIMCOUNTRIES WHERE ISSAVVY='Y' ORDER BY COUNTRYDES"
                Dts = odbUtil.FillDataSet(StrSql, EconConnection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCountry:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetCountry(ByVal countryId As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "ELSE "
                StrSql = StrSql + "" + countryId.ToString() + " END AND ISSAVVY='Y' "
        ...
        Public Function GetEffDate() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEffDate:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCurrancy() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCurrancy:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCurrancyArch(ByVal CaseId As String, ByVal CurID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCurrancyArch:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetConversionFactor() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetConversionFactor:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetProductFormat(ByVal FormtId As Integer, ByVal FormtDe1 As String, ByVal FormtDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetProductFormat:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDeptPlantConfig(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetDeptPlantConfig:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetSupportEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCountryTable(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEFFCOUNTRY:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInfo(ByVal PersId As Integer, ByVal PersDe1 As String, ByVal PersDe2 As String, ByVal Country As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPersonnelInfo:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInfoE3(ByVal CaseID As String, ByVal PersId As Integer, ByVal PersDe1 As String, ByVal PersDe2 As String, ByVal Country As String) As DataSet
            ...
            Dim StrSql As String = String.Empty
            Try
                StrSql = "select persid, persde1,persde2,(persde1 || ' ' ||  persde2) as persDES, persde2,replace((persde1 || ' ' ||  persde2),Chr(34) ,'##') persDES1,'" + Country + "' TBL, '" + CaseID + "' CASEID "
                StrSql = StrSql + " from PERSONNELALL "
                StrSql = StrSql + " WHERE persid = CASE WHEN " + PersId.ToString() + " = -1 THEN "
                StrSql = StrSql + "persid "
                StrSql = StrSql + "ELSE "
        ...
        Public Function GetCostTypeInfo(ByVal CostId As Integer, ByVal Costde1 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCostTypeInfo:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPallets(ByVal PalletId As Integer, ByVal PalDe1 As String, ByVal PalDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPallets:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetEcon1Cases(ByVal CaseIdE1 As Integer, ByVal CaseIdE2 As Integer, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal UserId As String) As DataSet
            ...
            Try
                If CaseIdE2 >= 1000 Then
                    ...
                    Else
                        StrSql = "SELECT CaseId, (Casede1||'  '||Casede2)CASDES,Casede1,Casede2,replace((Casede1 || ' ' ||  Casede2),'''' ,'##') CASDES1  "
                        StrSql = StrSql + "FROM PermissionsCases "
                        StrSql = StrSql + "WHERE USERID=" + UserId.ToString() + " AND CaseId = CASE WHEN " + CaseIdE1.ToString() + " = -1 THEN "
            ...
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEcon1Cases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function getUnits(ByVal caseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:getUnits:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Assumptions Pages"
        Public Function GetExtrusionDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "Left Join Econ.Total Case1 "
                StrSql = StrSql + "on Case1.CaseId=MI.C1 "
                StrSql = StrSql + "Left Join Econ.Total Case2 "
                StrSql = StrSql + "on Case2.CaseId=MI.C2 "
                StrSql = StrSql + "Left Join Econ.Total Case3 "
                StrSql = StrSql + "on Case3.CaseId=MI.C3 "
                StrSql = StrSql + "Left Join Econ.Total Case4 "
                StrSql = StrSql + "on Case4.CaseId=MI.C4 "
                StrSql = StrSql + "Left Join Econ.Total Case5 "
                StrSql = StrSql + "on Case5.CaseId=MI.C5 "
                StrSql = StrSql + "Left Join Econ.Total Case6 "
                StrSql = StrSql + "on Case6.CaseId=MI.C6 "
                StrSql = StrSql + "Left Join Econ.Total Case7 "
                StrSql = StrSql + "on Case7.CaseId=MI.C7 "
                StrSql = StrSql + "Left Join Econ.Total Case8 "
                StrSql = StrSql + "on Case8.CaseId=MI.C8 "
                StrSql = StrSql + "Left Join Econ.Total Case9 "
                StrSql = StrSql + "on Case9.CaseId=MI.C9 "
                StrSql = StrSql + "Left Join Econ.Total Case10 "
                StrSql = StrSql + "on Case10.CaseId=MI.C10 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price1 "
                StrSql = StrSql + "on Price1.CaseId=MI.C1 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price2 "
                StrSql = StrSql + "on Price2.CaseId=MI.C2 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price3 "
                StrSql = StrSql + "on Price3.CaseId=MI.C3 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price4 "
                StrSql = StrSql + "on Price4.CaseId=MI.C4 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price5 "
                StrSql = StrSql + "on Price5.CaseId=MI.C5 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price6 "
                StrSql = StrSql + "on Price6.CaseId=MI.C6 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price7 "
                StrSql = StrSql + "on Price7.CaseId=MI.C7 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price8 "
                StrSql = StrSql + "on Price8.CaseId=MI.C8 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price9 "
                StrSql = StrSql + "on Price9.CaseId=MI.C9 "
                StrSql = StrSql + "Left Join Econ.RESULTSPL Price10 "
        ...
        Public Function GetProductFromatIn(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetProductFromatIn:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletAndTruck(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPalletAndTruck:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfigDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPlanConfigDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffiencyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEffiencyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEquipmentDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetSupportEquipmentInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetOperationInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetOperationInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInDetails(ByVal CaseId As Integer, ByVal EFFCOUNTRY As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "PREF.CASEID=PERSPOS.CASEID "
                 StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch PERSPOS1 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS2 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS3 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS4 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS5 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS6 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS7 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS8 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS9 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS10 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS11 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS12 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS13 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS14 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS15 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS16 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS17 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS18 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS19 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS20 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS21 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS22 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS23 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS24 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS25 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS26 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS27 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS28 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS29 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECon.persArch  PERSPOS30 "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPersonnelInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfig2Details(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPlantConfig2Details:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEnergyDetailsOLD(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetEnergyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEnergyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                'StrSql = StrSql + "ON B2.ENERGYID=2 "
                'StrSql = StrSql + "AND B2.EFFDATE =PENG.EFFDATE "
                StrSql = StrSql + "LEFT OUTER JOIN ECON.ENERGYARCHNEW B1 "
                StrSql = StrSql + "ON B1.ENERGYID = 1 "
                ...
                StrSql = StrSql + "LEFT OUTER JOIN ECON.ENERGYARCHNEW B2 "
                StrSql = StrSql + "ON B2.ENERGYID=2 "
        ...
        Public Function GetCustomerINDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCustomerINDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetFixedCostDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC1 ON FC1.FIXEDCOSTID =1 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA1 ON FCA1.FIXEDCOSTID =FC1.FIXEDCOSTID AND FCA1.COUNTRYID=PREF.OCOUNTRY AND FCA1.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC2 ON FC2.FIXEDCOSTID =2 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA2 ON FCA2.FIXEDCOSTID =FC2.FIXEDCOSTID AND FCA2.COUNTRYID=PREF.OCOUNTRY AND FCA2.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC3 ON FC3.FIXEDCOSTID =3 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA3 ON FCA3.FIXEDCOSTID =FC3.FIXEDCOSTID AND FCA3.COUNTRYID=PREF.OCOUNTRY AND FCA3.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC4 ON FC4.FIXEDCOSTID =4 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA4 ON FCA4.FIXEDCOSTID =FC4.FIXEDCOSTID AND FCA4.COUNTRYID=PREF.OCOUNTRY AND FCA4.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC5 ON FC5.FIXEDCOSTID =5 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA5 ON FCA5.FIXEDCOSTID =FC5.FIXEDCOSTID AND FCA5.COUNTRYID=PREF.OCOUNTRY AND FCA5.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC6 ON FC6.FIXEDCOSTID =6 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA6 ON FCA6.FIXEDCOSTID =FC6.FIXEDCOSTID AND FCA6.COUNTRYID=PREF.OCOUNTRY AND FCA6.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC7 ON FC7.FIXEDCOSTID =7 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA7 ON FCA7.FIXEDCOSTID =FC7.FIXEDCOSTID AND FCA7.COUNTRYID=PREF.OCOUNTRY AND FCA7.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC8 ON FC8.FIXEDCOSTID =8 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA8 ON FCA8.FIXEDCOSTID =FC8.FIXEDCOSTID AND FCA8.COUNTRYID=PREF.OCOUNTRY AND FCA8.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC9 ON FC9.FIXEDCOSTID =9 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA9 ON FCA9.FIXEDCOSTID =FC9.FIXEDCOSTID AND FCA9.COUNTRYID=PREF.OCOUNTRY AND FCA9.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC10 ON FC10.FIXEDCOSTID =10 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA10 ON FCA10.FIXEDCOSTID =FC10.FIXEDCOSTID AND FCA10.COUNTRYID=PREF.OCOUNTRY AND FCA10.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC11 ON FC11.FIXEDCOSTID =11 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA11 ON FCA11.FIXEDCOSTID =FC11.FIXEDCOSTID AND FCA11.COUNTRYID=PREF.OCOUNTRY AND FCA11.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC12 ON FC12.FIXEDCOSTID =12 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA12 ON FCA12.FIXEDCOSTID =FC12.FIXEDCOSTID AND FCA12.COUNTRYID=PREF.OCOUNTRY AND FCA12.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC13 ON FC13.FIXEDCOSTID =13 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA13 ON FCA13.FIXEDCOSTID =FC13.FIXEDCOSTID AND FCA13.COUNTRYID=PREF.OCOUNTRY AND FCA13.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC14 ON FC14.FIXEDCOSTID =14 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA14 ON FCA14.FIXEDCOSTID =FC14.FIXEDCOSTID AND FCA14.COUNTRYID=PREF.OCOUNTRY AND FCA14.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC15 ON FC15.FIXEDCOSTID =15 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA15 ON FCA15.FIXEDCOSTID =FC15.FIXEDCOSTID AND FCA15.COUNTRYID=PREF.OCOUNTRY AND FCA15.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC16 ON FC16.FIXEDCOSTID =16 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA16 ON FCA16.FIXEDCOSTID =FC16.FIXEDCOSTID AND FCA16.COUNTRYID=PREF.OCOUNTRY AND FCA16.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC17 ON FC17.FIXEDCOSTID =17 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA17 ON FCA17.FIXEDCOSTID =FC17.FIXEDCOSTID AND FCA17.COUNTRYID=PREF.OCOUNTRY AND FCA17.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC18 ON FC18.FIXEDCOSTID =18 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA18 ON FCA18.FIXEDCOSTID =FC18.FIXEDCOSTID AND FCA18.COUNTRYID=PREF.OCOUNTRY AND FCA18.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC19 ON FC19.FIXEDCOSTID =19 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA19 ON FCA19.FIXEDCOSTID =FC19.FIXEDCOSTID AND FCA19.COUNTRYID=PREF.OCOUNTRY AND FCA19.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC20 ON FC20.FIXEDCOSTID =20 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA20 ON FCA20.FIXEDCOSTID =FC20.FIXEDCOSTID AND FCA20.COUNTRYID=PREF.OCOUNTRY AND FCA20.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC21 ON FC21.FIXEDCOSTID =21 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA21 ON FCA21.FIXEDCOSTID =FC21.FIXEDCOSTID AND FCA21.COUNTRYID=PREF.OCOUNTRY AND FCA21.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC22 ON FC22.FIXEDCOSTID =22 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA22 ON FCA22.FIXEDCOSTID =FC22.FIXEDCOSTID AND FCA22.COUNTRYID=PREF.OCOUNTRY AND FCA22.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC23 ON FC23.FIXEDCOSTID =23 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA23 ON FCA23.FIXEDCOSTID =FC23.FIXEDCOSTID AND FCA23.COUNTRYID=PREF.OCOUNTRY AND FCA23.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC24 ON FC24.FIXEDCOSTID =24 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA24 ON FCA24.FIXEDCOSTID =FC24.FIXEDCOSTID AND FCA24.COUNTRYID=PREF.OCOUNTRY AND FCA24.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC25 ON FC25.FIXEDCOSTID =25 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA25 ON FCA25.FIXEDCOSTID =FC25.FIXEDCOSTID AND FCA25.COUNTRYID=PREF.OCOUNTRY AND FCA25.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC26 ON FC26.FIXEDCOSTID =26 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA26 ON FCA26.FIXEDCOSTID =FC26.FIXEDCOSTID AND FCA26.COUNTRYID=PREF.OCOUNTRY AND FCA26.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC27 ON FC27.FIXEDCOSTID =27 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA27 ON FCA27.FIXEDCOSTID =FC27.FIXEDCOSTID AND FCA27.COUNTRYID=PREF.OCOUNTRY AND FCA27.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC28 ON FC28.FIXEDCOSTID =28 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA28 ON FCA28.FIXEDCOSTID =FC28.FIXEDCOSTID AND FCA28.COUNTRYID=PREF.OCOUNTRY AND FCA28.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC29 ON FC29.FIXEDCOSTID =29 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA29 ON FCA29.FIXEDCOSTID =FC29.FIXEDCOSTID AND FCA29.COUNTRYID=PREF.OCOUNTRY AND FCA29.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "INNER JOIN ECON.FIXEDCOST FC30 ON FC30.FIXEDCOSTID =30 "
                StrSql = StrSql + "LEFT JOIN ECON.FIXEDCOSTARCH FCA30 ON FCA30.FIXEDCOSTID =FC30.FIXEDCOSTID AND FCA30.COUNTRYID=PREF.OCOUNTRY AND FCA30.EFFDATE=PREF.EFFDATE "

                StrSql = StrSql + "WHERE FIXCOST.CASEID=" + CaseId.ToString() + ""
                Dts = odbUtil.FillDataSet(StrSql, Econ2Connection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetFixedCostDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPalletInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetAdditionalEnergyInfo(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetAdditionalEnergyInfo:" + ex.Message.ToString())
                Return Dts
...
#Region "Intermediate Results"
        Public Function GetExtrusionOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetExtrusionOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetOpreationsOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetOpreationsOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPersonnelOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Results"
        Public Function GetProfitAndLossDetails(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetProfitAndLossDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetProfitAndLossDetailsWithDep(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetProfitAndLossDetailsWithDep:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCostDetails(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCostDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCostDetailsWithDep(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCostDetailsWithDep:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Error"
        Public Function GetErrors(ByVal ErrorCode As String) As DataSet
            ...
            Try
                ...
                MyConnectionString = System.Configuration.ConfigurationManager.AppSettings("Econ2ConnectionString")
                Dim StrSql As String = ""
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetErrors:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Notes"
        Public Function GetAssumptionPageDetails(ByVal AssumptionType As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetAssumptionPageDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Charts"
        Public Function GetChartProfitAndLoss(ByVal IsDep As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetChartProfitAndLoss:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartCost(ByVal IsDep As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetChartCost:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartProfitAndLossRes(ByVal CaseId1 As String, ByVal CaseId2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetChartProfitAndLossRes:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetChartCostRes(ByVal CaseId1 As String, ByVal CaseId2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetChartCostRes:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
#Region "LicenseAdministrator"
        Public Function GetPCaseDetailsByLicense(ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPCaseDetailsByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetCasesByLicense(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetCasesByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
#Region "Case Grouping"
        Public Function ValidateGroupName(ByVal Des1 As String, ByVal Des2 As String, ByVal USERID As String) As DataSet
            ...
            Catch ex As Exception
                Return Dts
                Throw New Exception("E2GetData:ValidateGroupName:" + ex.Message.ToString())
            End Try
        End Function
        ...
        Public Function ValiDateGroupcases(ByVal CaseIDs As String, ByVal UserID As String) As DataSet
            ...
            Try
                ...
                End If
                If strQuery <> "" Then
                    Dts = odbUtil.FillDataSet(strQuery, Econ2Connection)
                Else
        ...
        Public Function GetPCaseDetailsByGroup(ByVal UserId As String, ByVal grpId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPCaseDetailsByGroup:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetGroupCaseDetails(ByVal UserID As String) As DataSet
            ...
            Try
                ...
                End If
                If strSQL <> "" Then
                    DtRes = odbUtil.FillDataSet(strSQL, Econ2Connection)
                Else
        ...
        Public Function GetGroupCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal groupID As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND NVL(UPPER(CASEDE1),'#') LIKE '%" + CaseDe1.ToUpper() + "%' "
                StrSql = StrSql + "AND NVL(UPPER(CASEDE2),'#') LIKE '%" + CaseDe2.ToUpper() + "%' "
                StrSql = StrSql + "AND CASEID IN(SELECT CASEID FROM ECON2.GROUPCASES WHERE GROUPID=" + groupID + " ) "
                StrSql = StrSql + "ORDER BY  UPPER(CASEDE1),CASEID"
                Dts = odbUtil.FillDataSet(StrSql, Econ2Connection)
                Return Dts
            Catch ex As Exception
            ...
            Try
                ...
                If DtRes.Tables(0).Rows.Count > 0 Then
                    For j = 0 To DtRes.Tables(0).Rows.Count - 1
                        ...
                        strSQL = "SELECT GROUPID,  "
                        strSQL = strSQL + "CASEID "
                        strSQL = strSQL + "FROM ECON2.GROUPCASES "
                    ...
                    dtOutPut = odbUtil.FillDataSet(strSqlOutPut, Econ2Connection)
                Else
...
#Region "Bemis"
        Public Function GetStatusForSister(ByVal Schema As String, ByVal CaseId As String, ByVal UserId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetStatusForSister:" + ex.Message.ToString())
            End Try
        End Function
        ...
        Public Function GetPropCasesById(ByVal UserId As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPropCasesById:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetGroupCaseDet(ByVal UserID As String) As DataSet
            ...
            Try
                ...
                If strSQL <> "" Then
                    ...
                    DtRes = odbUtil.FillDataSet(strSQL2, Econ2Connection)
                Else
                    strSQL2 = strSQL2 + ""
                    DtRes = odbUtil.FillDataSet(strSQL2, Econ2Connection)
                End If
        ...
        Public Function GetApprovedCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "ON USERS.USERID=PERMISSIONSCASES.USERID "
                'StrSql = StrSql + "ON UPPER(ECON.USERS.USERNAME)=UPPER(PERMISSIONSCASES.USERNAME) "
                ...
                StrSql = StrSql + "WHERE USERS.LICENSEID IN (SELECT LICENSEID FROM ECON.USERS WHERE USERID=" + UserId.ToString() + ") "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetApprovedCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPropCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPropCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPropCaseStatus(ByVal UserId As String) As String
            ...
            Try
                ...
                Return CaseIds
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPropCaseStatus:" + ex.Message.ToString())
                Return CaseIds
            End Try
        End Function
        Public Function GetPropDisAppStatus(ByVal UserId As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPropDisAppStatus:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPropCasesByLicense(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetPropCasesByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetStatusDetailsByID(ByVal CaseId As String, ByVal UserName As String) As DataSet
            ...
            Try
                ...
                StrSql = "INNER JOIN ECON.USERS ON USERS.USERID=STATUSUPDATE.USERID WHERE "
                StrSql = StrSql + "CASEID = " + CaseId + " AND UPPER(USERS.USERNAME)='" + UserName.ToUpper() + "' ORDER BY DATED ASC "

                Dts = odbUtil.FillDataSet(StrSql, Econ2Connection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetStatusDetailsByID:" + ex.Message.ToString())
            End Try
        End Function
        Public Function GetGrpStatusDetailsByID(ByVal CaseId As String, ByVal UserId As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "CASEID = " + CaseId + " AND USERID=" + UserId.ToString() + " ORDER BY DATED ASC  "
                'StrSql = StrSql + "CASEID = " + CaseId + " AND UPPER(USERNAME)='" + UserName.ToUpper() + "' ORDER BY DATED ASC "

                Dts = odbUtil.FillDataSet(StrSql, Econ2Connection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetGrpStatusDetailsByID:" + ex.Message.ToString())
            End Try
        End Function
        ...
        Public Function GetGroupPCases(ByVal UserId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal groupID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetGroupPCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetUserCompanyUsersBem(ByVal UserId As String) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Try
                ...
                StrSql = StrSql + "INNER JOIN SERVICES "
                StrSql = StrSql + "ON SERVICES.SERVICEID = USERPERMISSIONS.SERVICEID "
                StrSql = StrSql + "WHERE USERS.LICENSEID=(SELECT LICENSEID FROM ECON.USERS WHERE USERID=" + UserId.ToString() + ") "
                'StrSql = StrSql + "WHERE USERS.LICENSEID=(SELECT LICENSEID FROM USERS WHERE UPPER(USERNAME)='" + UserName.ToUpper.ToString() + "') "
                StrSql = StrSql + "AND SERVICES.SERVICEDE IN ('ECON1','ECON2','SUSTAIN1','SUSTAIN2') "
                StrSql = StrSql + "AND UPPER(USERPERMISSIONS.USERROLE)='READWRITE' "
                StrSql = StrSql + "GROUP BY USERS.USERID,USERS.USERNAME) "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetUserCompanyUsersBem:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "DepreciationCost"
        Public Function GetAssetC(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetAssetC:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetAssetS(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("E2GetData:GetAssetS:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region

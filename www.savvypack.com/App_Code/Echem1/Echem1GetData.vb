...
#Region "Equipment "
        ...
        Public Function GetPopUpEquipment(ByVal CaseID As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPopUpEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEditEquip(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                ds = odbUtil.FillDataSet(strSql, Echem1Connection)
                Return ds
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEditEquip:" + ex.Message.ToString())
                Return ds
            End Try
        End Function
#End Region
#Region "UserDetails"
        Public Function GetUserDetails(ByVal Id As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND SERVICES.SERVICEDE='ECHEM1' "

                Dts = odbUtil.FillDataSet(StrSql, EconConnection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPCaseDetailsByLicense(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPCaseDetailsByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetCasesByLicense(ByVal USERID As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCasesByLicense:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetTotalCaseCount(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetTotalCaseCount:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSelectedUserDetails(ByVal usreName As String, ByVal Schema As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "WHERE UPPER(USERS.USERNAME)='" + usreName.ToUpper() + "' AND UPPER(SERVICES.SERVICEDE)='" + Schema.ToUpper() + "' "
                Dts = odbUtil.FillDataSet(StrSql, EconConnection)
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetSelectedUserDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Supporting Assumptions Pages"
        Public Function GetCaseDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetBCaseDetails() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetBCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPCaseDetails(ByVal USERID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPCaseDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetMaterials(ByVal MatId As Integer, ByVal MatDe1 As String, ByVal MatDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetMaterials:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            Dim CaseId As String = HttpContext.Current.Session("Echem1CaseId").ToString()
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetDept:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetDept(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String, ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetExtrusionDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        Public Function GetPref(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPref:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCases(ByVal USERID As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetBCases(ByVal CaseDe1 As String, ByVal CaseDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetBCases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseViewer(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCaseViewer:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCaseNoteDetails(ByVal CaseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCaseNoteDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCountry() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCountry:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffDate() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEffDate:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCurrancy() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCurrancy:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCurrancyArch(ByVal CaseId As String, ByVal CurID As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCurrancyArch:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetConversionFactor() As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetConversionFactor:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetProductFormat(ByVal FormtId As Integer, ByVal FormtDe1 As String, ByVal FormtDe2 As String) As DataSet
            ...
            Try
                ...
                StrSql = StrSql + "AND NVL(UPPER(FormatDe2),'#') LIKE '" + FormtDe2.ToUpper() + "%' "
                StrSql = StrSql + "UNION "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetProductFormat:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetDeptPlantConfig(ByVal ProcId As Integer, ByVal ProcDe1 As String, ByVal ProcDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetDeptPlantConfig:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipment(ByVal EqId As Integer, ByVal EqDe1 As String, ByVal EqlDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetSupportEquipment:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCountryTable(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEFFCOUNTRY:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInfo(ByVal PersId As Integer, ByVal PersDe1 As String, ByVal PersDe2 As String, ByVal Country As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPersonnelInfo:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCostTypeInfo(ByVal CostId As Integer, ByVal Costde1 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCostTypeInfo:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPallets(ByVal PalletId As Integer, ByVal PalDe1 As String, ByVal PalDe2 As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPallets:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEcon1Cases(ByVal CaseIdE1 As Integer, ByVal CaseIdE2 As Integer, ByVal CaseDe1 As String, ByVal CaseDe2 As String, ByVal USERID As String) As DataSet
            ...
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEcon1Cases:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function getUnits(ByVal caseId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:getUnits:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Assumptions Pages"
        Public Function GetExtrusionDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                'Cost Distribution
                StrSql = StrSql + "MI.CD1, "
                StrSql = StrSql + "MI.CD2, "
                StrSql = StrSql + "MI.CD3, "
                StrSql = StrSql + "MI.CD4, "
                StrSql = StrSql + "MI.CD5, "
                StrSql = StrSql + "MI.CD6, "
                StrSql = StrSql + "MI.CD7, "
                StrSql = StrSql + "MI.CD8, "
                StrSql = StrSql + "MI.CD9, "
                StrSql = StrSql + "MI.CD10, "
                ...
                StrSql = StrSql + "CASE WHEN MI.C1=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M1)  "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C1),0)<=0 THEN 0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C1)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C1))*PREF.CURR/PREF.CONVWT) END)END PRICES1, "
                StrSql = StrSql + "CASE WHEN MI.C2=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M2) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C2),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C2)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C2))*PREF.CURR/PREF.CONVWT) END)END PRICES2, "
                StrSql = StrSql + "CASE WHEN MI.C3=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M3) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C3),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C3)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C3))*PREF.CURR/PREF.CONVWT) END)END PRICES3, "
                StrSql = StrSql + "CASE WHEN MI.C4=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M4) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C4),0)<=0 THEN 0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C4)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C4))*PREF.CURR/PREF.CONVWT) END)END PRICES4, "
                StrSql = StrSql + "CASE WHEN MI.C5=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M5) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C5),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C5)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C5))*PREF.CURR/PREF.CONVWT) END)END PRICES5, "
                StrSql = StrSql + "CASE WHEN MI.C6=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M6) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C6),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C6)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C6))*PREF.CURR/PREF.CONVWT) END)END PRICES6, "
                StrSql = StrSql + "CASE WHEN MI.C7=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M7) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C7),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C7)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C7))*PREF.CURR/PREF.CONVWT) END)END PRICES7, "
                StrSql = StrSql + "CASE WHEN MI.C8=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M8) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C8),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C8)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C8))*PREF.CURR/PREF.CONVWT) END)END PRICES8, "
                StrSql = StrSql + "CASE WHEN MI.C9=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M9) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C9),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C9)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C9))*PREF.CURR/PREF.CONVWT) END)END PRICES9, "
                StrSql = StrSql + "CASE WHEN MI.C10=0 THEN (SELECT NVL(PRICE,0)/PREF.CONVWT*PREF.CURR FROM MATERIALS WHERE MATID=MI.M10) "
                StrSql = StrSql + "ELSE(CASE WHEN NVL((SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C10),0)<=0 THEN  0 "
                StrSql = StrSql + "ELSE (((SELECT REVENUE FROM Econ.RESULTSPL WHERE CASEID=MI.C10)/(SELECT VOLUME FROM Econ.RESULTSPL WHERE CASEID=MI.C10))*PREF.CURR/PREF.CONVWT) END)END PRICES10, "
                ...
                'New Weight n Cost Distribution Changes Start
                StrSql = StrSql + "TOTAL.WEIGHTDIS*100 AS TOTWGHTDIS, "
                StrSql = StrSql + "TOTAL.COSTDIS*100 AS TOTCOSTDIS, "
                'New Weight n Cost Distribution Changes Stop
        ...
        Public Function GetProductFromatIn(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetProductFromatIn:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletAndTruck(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPalletAndTruck:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfigDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPlanConfigDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEffiencyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEffiencyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEquipmentDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetSupportEquipmentInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetSupportEquipmentInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetOperationInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetOperationInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelInDetails(ByVal CaseId As Integer, ByVal EFFCOUNTRY As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPersonnelInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPlantConfig2Details(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                'StrSql = StrSql + "(PLS.M6* PREF.CURR) AS PRODTOTAL, "
                'StrSql = StrSql + "(PLS.M7* PREF.CURR) AS WARHTOTAL, "
                'StrSql = StrSql + "(PLS.M8* PREF.CURR) AS OFFTOTAL, "
                'StrSql = StrSql + "(PLS.M9* PREF.CURR) AS SUPPTOTAL, "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPlantConfig2Details:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetEnergyDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetEnergyDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCustomerINDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCustomerINDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetFixedCostDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetFixedCostDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPalletInDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPalletInDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetAdditionalEnergyInfo(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetAdditionalEnergyInfo:" + ex.Message.ToString())
                Return Dts
...
#Region "Intermediate Results"
        Public Function GetExtrusionOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetExtrusionOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetOpreationsOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetOpreationsOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetPersonnelOutDetails(ByVal CaseId As Integer) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPersonnelOutDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Results"
        Public Function GetProfitAndLossDetails(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetProfitAndLossDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetProfitAndLossDetailsWithDep(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetProfitAndLossDetailsWithDep:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCostDetails(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCostDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetCostDetailsWithDep(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCostDetailsWithDep:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetProfitAndLossDetailsProd(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            ...
            Try
                ...
                StrSql = StrSql + "PREF.TITLE12, "
                StrSql = StrSql + "PREF.UNITS "
                StrSql = StrSql + "FROM RESULTSPLPROD RSPL "
                StrSql = StrSql + "INNER JOIN PREFERENCES PREF "
                StrSql = StrSql + "ON PREF.CASEID=RSPL.CASEID "
                StrSql = StrSql + "INNER JOIN CUSTOMERIN "
                StrSql = StrSql + "ON CUSTOMERIN.CASEID=RSPL.CASEID "
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetProfitAndLossDetailsProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetProfitAndLossDetailsWithDepProd(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetProfitAndLossDetailsWithDepProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetCostDetailsProd(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCostDetailsProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

        Public Function GetCostDetailsWithDepProd(ByVal CaseId As String, ByVal Isdep As Boolean) As DataSet
            Dim Dts As New DataSet()
            Dim odbUtil As New DBUtil()
            Dim StrSql As String = String.Empty
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetCostDetailsWithDepProd:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Error"
        Public Function GetErrors(ByVal ErrorCode As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetErrors:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
#End Region
...
#Region "Notes"
        Public Function GetAssumptionPageDetails(ByVal AssumptionType As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetAssumptionPageDetails:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
...
#Region "Case Grouping"
        ...
        Public Function ValiDateGroupcases(ByVal CaseIDs As String, ByVal UserID As String) As DataSet
            ...
            Try
                ...
                End If
                If strQuery <> "" Then
                    Dts = odbUtil.FillDataSet(strQuery, Echem1Connection)
                Else
        ...
        Public Function GetPCaseDetailsByGroup(ByVal USERID As String, ByVal grpId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetPCaseDetailsByGroup:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function
        ...
        Public Function GetMaxSEQGCASE(ByVal grpId As String) As DataSet
            ...
            Try
                ...
                Return Dts
            Catch ex As Exception
                Throw New Exception("Echem1GetData:GetMaxSEQGCASE:" + ex.Message.ToString())
                Return Dts
            End Try
        End Function

            ...
            Try
                ...
                If Des <> "" Then
                    ...
                    If ds.Tables(0).Rows.Count > 0 Then
                        ...
                        odbUtil.UpIns(StrSql, Echem1Connection)
                    Else
...
#Region "Case Details"
        Public Sub CaseDesUpdate(ByVal CaseId As String, ByVal CaseDe1 As String, ByVal CaseDe2 As String)
            Try
                ...
                odbUtil.UpIns(StrSqlUpadate, Echem1Connection)
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:CaseDesUpdate:" + ex.Message.ToString())
            End Try
...
#Region "Assumptions"
        Public Sub ExtrusionUpdate(ByVal CaseID As String, ByVal Material() As String, ByVal Weight() As String, ByVal Price() As String, ByVal Recyle() As String, ByVal Extra() As String, ByVal PC() As String, ByVal Dept() As String, ByVal E1Cases() As String, ByVal plate As String, ByVal Quant() As String, ByVal WeightDis() As String, ByVal CostDis() As String, ByVal IsDisUpdate As Boolean)
            Try
                ...
                For Mat = 0 To 9
                    ...
                    'Weight Dis
                    StrSqlIUpadate = StrSqlIUpadate + " WD" + Matid.ToString() + " = " + WeightDis(Mat).ToString() + ","
                    'Cost Dis
                    StrSqlIUpadate = StrSqlIUpadate + " CD" + Matid.ToString() + " = " + CostDis(Mat).ToString() + ","
                Next
                ...
                'PARChildCaseUpdate(CaseID, E1Cases)   


            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:ExtrusionUpdate:" + ex.Message.ToString())
            End Try

        End Sub
        Public Sub PARChildCaseUpdate(ByVal CaseID As String, ByVal E1Cases() As String)
            ...
            Try
                ...
                strsql.Append("DELETE FROM PARCHILDCASES ")
                strsql.Append("WHERE CHILDCASEID=" + CaseID)
                odbUtil.UpIns(strsql.ToString(), EconConnection)

                'Inserting data
                For i = 0 To E1Cases.Length - 1
                    strsql = New StringBuilder
                    If E1Cases(i) <> "0" Then
                        strsql.Append("INSERT INTO PARCHILDCASES ")
                        strsql.Append("( ")
                        strsql.Append("PARCHILDCASESID, PARENTCASEID, CHILDCASEID, PARENTMOD, CHILDMOD ")
                        strsql.Append(") ")
                        strsql.Append("SELECT SEQPARCHILDCASESID.NEXTVAL, ")
                        strsql.Append(E1Cases(i).ToString() + ", ")
                        strsql.Append(CaseID + ", ")
                        strsql.Append("'ECON1',")
                        strsql.Append("'ECON2'")
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PARChildCaseUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PrefrencesUpdate(ByVal CaseID As String, ByVal Ocountry As String, ByVal DCountry As String, ByVal Currancy As String, ByVal Units As String, ByVal Effdate As String, ByVal PVOLUSE As String, ByVal ErgyCalc As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PrefrencesUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub ProductFormatUpdate(ByVal CaseID As String, ByVal M1 As String, ByVal Input() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:ProductFormatUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PalletAndTruckUpdate(ByVal CaseID As String, ByVal Pallet() As String, ByVal Truck() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PalletAndTruckUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PlantConfigUpdate(ByVal CaseID As String, ByVal DEPTA() As String, ByVal DEPTB() As String, ByVal DEPTC() As String, ByVal DEPTD() As String, ByVal DEPTE() As String, ByVal DEPTF() As String, ByVal DEPTG() As String, ByVal DEPTH() As String, ByVal DEPTI() As String, ByVal DEPTJ() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PlantConfigUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub EfficiencyUpdate(ByVal CaseID As String, ByVal MATA() As String, ByVal MATB() As String, ByVal MATC() As String, ByVal MATD() As String, ByVal MATE() As String, ByVal MATF() As String, ByVal MATG() As String, ByVal MATH() As String, ByVal MATI() As String, ByVal MATJ() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:EfficiencyUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub EquipmentUpdate(ByVal CaseID As String, ByVal hidAssetId() As String, ByVal ASSETP() As String, ByVal PARP() As String, ByVal ECP() As String, ByVal NGCP() As String, ByVal hidAssetDep() As String, ByVal ASSETNUM() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:EquipmentUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub SupportEquipmentUpdate(ByVal CaseID As String, ByVal hidAssetId() As String, ByVal ASSETP() As String, ByVal ECP() As String, ByVal NGCP() As String, ByVal HRS() As String, ByVal CostType() As String, ByVal hidAssetDep() As String, ByVal ASSETNUM() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:SupportEquipmentUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub OperationInUpdate(ByVal CaseID As String, ByVal OMAXRH() As String, ByVal OPINSTR() As String, ByVal DT() As String, ByVal OPWASTE() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:OperationInUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PersonnelInUpdate(ByVal CaseID As String, ByVal PosDes() As String, ByVal NoWorker() As String, ByVal PrefSal() As String, ByVal CostType() As String, ByVal DEPTID() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PersonnelInUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PlantConfig2Update(ByVal CaseID As String, ByVal AREA() As String, ByVal PrefLease() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PlantConfig2Update:" + ex.Message.ToString())
            End Try
        ...
        Public Sub EnergyUpdate(ByVal CaseID As String, ByVal ERGPPREF() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:EnergyUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub CustomerInUpdate(ByVal CaseID As String, ByVal PRODPUR As String, ByVal SHIPDIST As String, ByVal MILCOST As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:CustomerInUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub FixedCostUpdate(ByVal CaseID As String, ByVal FixedCostVal() As String, ByVal FixedCostPref() As String, ByVal Dept() As String, ByVal depreciate As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:FixedCostUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub PalletUpdate(ByVal CaseID As String, ByVal Pallet() As String, ByVal Number() As String, ByVal NoOfUses() As String, ByVal PrefWeight() As String, ByVal PrefPrice() As String, ByVal Dept() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:PalletUpdate:" + ex.Message.ToString())
            End Try
        ...
        Public Sub AdditionalEnergyUpdate(ByVal CaseID As String, ByVal EnergyConsum1() As String, ByVal EnergyConsum2() As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpdateData:AdditionalEnergyUpdate:" + ex.Message.ToString())
            End Try
...
#Region "Results"
        Public Sub ResultsPl(ByVal CaseId As String, ByVal UnitPrice As String, ByVal UnitType As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:ResultsPl:" + ex.Message.ToString())
            End Try

        End Sub
        Public Sub ResultsPlProd(ByVal CaseId As String, ByVal UnitPrice As String, ByVal UnitType As String)
            Try
                'Creating Database Connection
                Dim odbUtil As New DBUtil()
                Dim ObjGetData As New Echem1GetData.Selectdata()
                ...
                Dim StrSqlIUpadate As String = ""
                UnitPriceP = CDbl(UnitPrice) / Curr * Convwt
                StrSqlUpadate = "UPDATE RESULTSPLProd SET UNITPRICE=" + UnitPriceP.ToString() + ", "
                StrSqlUpadate = StrSqlUpadate + "UNITTYPE=" + UnitType.ToString() + " "
                StrSqlUpadate = StrSqlUpadate + "WHERE CASEID = " + CaseId.ToString() + ""
                odbUtil.UpIns(StrSqlUpadate, Echem1Connection)

            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:ResultsPlProd:" + ex.Message.ToString())
            End Try
...
#Region "Notes"
        Public Sub NotesUpdate(ByVal CaseId As String, ByVal AssumptionCode As String, ByVal Notes As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1UpInsData:NotesUpdate:" + ex.Message.ToString())
            End Try
...
#Region "Wizard"
        Public Function UpdateWizard(ByVal CaseId As String) As Integer
            ...
            Try
                ...
                odbUtil.UpIns(StrSqlUpadate, Echem1Connection)
            Catch ex As Exception
                Throw (New Exception("Echem1UpInsData:UpdateWizard:" + ex.Message.ToString()))
            End Try
            Return WSessionID
        End Function
#End Region
...
#Region "Case Grouping"
        Public Sub AddGroupName(ByVal Des1 As String, ByVal Des2 As String, ByVal USERID As String)
            ...
            Catch ex As Exception
                Throw New Exception("Echem1GetData:AddGroup:" + ex.Message.ToString())
            End Try
        End Sub
        ...
        Public Sub UpdateGroupByCaseID(ByVal OldgrpID As String, ByVal grpID As String, ByVal CaseID As String)
            ...
            Try
                ...
                End If
            Catch ex As Exception
                Throw New Exception("Echem1GetData:UpdateGroupByCaseID:" + ex.Message.ToString())
            End Try
        End Sub
        Public Sub UpdateGroupName(ByVal groupName() As String, ByVal groupDes() As String, ByVal GroupID() As String, ByVal count As Integer)
            ...
            Try
                ...
                Next
            Catch ex As Exception
                Throw New Exception("Echem1GetData:UpdateGroupName:" + ex.Message.ToString())
            End Try
        End Sub
        Public Sub DeleteGroups(ByVal grpId As String)
            ...
            Try
                ...
                odButil.UpIns(StrSqlUpadate, Echem1Connection)
            Catch ex As Exception
                Throw New Exception("Echem1Update:DeleteGroup:" + ex.Message.ToString())
            End Try
        End Sub
#End Region

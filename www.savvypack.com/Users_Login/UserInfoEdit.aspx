<%@ Page Language="VB" AutoEventWireup="false" CodeFile="UserInfoEdit.aspx.vb" Inherits="Users_Login_UserInfoEdit" %>
                                    ...
                                    <td>
                                        <table width="100%" cellpadding="1px" cellspacing="1px">
                                            <tr class="TdHeading" align="center">
                                                <td class="PageSHeading" style="font-size: 14px;" colspan="2">Edit User Address
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="AlterNateColor2">
                                                ...
                                                <td style="width: 65%; text-align: left">
                                                    ...
                                                    <asp:Button ID="btnCancelE" Style="margin-left: 4px;" runat="server" CssClass="Button"
                                                        Text="Cancel" Height="26px" Width="60px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
